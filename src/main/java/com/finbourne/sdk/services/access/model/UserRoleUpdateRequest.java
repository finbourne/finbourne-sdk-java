 ...
 */
@JsonPropertyOrder({
  UserRoleUpdateRequest.JSON_PROPERTY_RESOURCE
})
...
public class UserRoleUpdateRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to UserRoleUpdateRequest
   */
  public static UserRoleUpdateRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, UserRoleUpdateRequest.class);
  }
