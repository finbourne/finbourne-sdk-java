 ...
 */
@JsonPropertyOrder({
  RemoveFromPolicyCollectionRequest.JSON_PROPERTY_POLICIES,
  RemoveFromPolicyCollectionRequest.JSON_PROPERTY_POLICY_COLLECTIONS
})
...
public class RemoveFromPolicyCollectionRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to RemoveFromPolicyCollectionRequest
   */
  public static RemoveFromPolicyCollectionRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, RemoveFromPolicyCollectionRequest.class);
  }
