...
public class UserRolesApi {
     ...
     */
    private HttpRequest addPolicyCollectionToUserRoleCall(String userid, AddPolicyCollectionToRoleRequest addPolicyCollectionToRoleRequest, final ApiCallback _callback) throws ApiException {
        return addPolicyCollectionToUserRoleCall(userid, addPolicyCollectionToRoleRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for addPolicyCollectionToUserRole. Use any specified configuration options to override any other configuration for this request only.
     * @param userid Id of the User Role to get (required). Use any specified configuration options to override any other configuration for this request only.
     * @param addPolicyCollectionToRoleRequest Dto of the policy collection to be added. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest addPolicyCollectionToUserRoleCall(String userid, AddPolicyCollectionToRoleRequest addPolicyCollectionToRoleRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/access/api/userroles/{userid}/policycollections"
    ...
    private HttpRequest addPolicyCollectionToUserRoleValidateBeforeCall(String userid, AddPolicyCollectionToRoleRequest addPolicyCollectionToRoleRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UserRoleResponse> addPolicyCollectionToUserRoleWithHttpInfo(String userid, AddPolicyCollectionToRoleRequest addPolicyCollectionToRoleRequest) throws ApiException {
        HttpRequest localVarCall = addPolicyCollectionToUserRoleValidateBeforeCall(userid, addPolicyCollectionToRoleRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * AddPolicyCollectionToUserRole: Add a policy collection to a user-role
     * Adds a policy collection to a user-role.Use any specified configuration options to override any other configuration for this request only
     * @param userid Id of the User Role to get (required)
     * @param addPolicyCollectionToRoleRequest Dto of the policy collection to be added. (required)
     * @return ApiResponse&lt;UserRoleResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<UserRoleResponse> addPolicyCollectionToUserRoleWithHttpInfo(String userid, AddPolicyCollectionToRoleRequest addPolicyCollectionToRoleRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = addPolicyCollectionToUserRoleValidateBeforeCall(userid, addPolicyCollectionToRoleRequest, null, opts);
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * AddPolicyCollectionToUserRole: Add a policy collection to a user-role (asynchronously)
     * Adds a policy collection to a user-role.
     * @param userid Id of the User Role to get (required)
     * @param addPolicyCollectionToRoleRequest Dto of the policy collection to be added. (required)
     ...
     */
    private void addPolicyCollectionToUserRoleAsync(String userid, AddPolicyCollectionToRoleRequest addPolicyCollectionToRoleRequest, final ApiCallback<UserRoleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = addPolicyCollectionToUserRoleValidateBeforeCall(userid, addPolicyCollectionToRoleRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
     ...
     */
    private void addPolicyCollectionToUserRoleAsync(String userid, AddPolicyCollectionToRoleRequest addPolicyCollectionToRoleRequest, final ApiCallback<UserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = addPolicyCollectionToUserRoleValidateBeforeCall(userid, addPolicyCollectionToRoleRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIaddPolicyCollectionToUserRoleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserRoleResponse> _callback) throws ApiException {
            addPolicyCollectionToUserRoleAsync(userid, addPolicyCollectionToRoleRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            addPolicyCollectionToUserRoleAsync(userid, addPolicyCollectionToRoleRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest addPolicyToUserRoleCall(String userid, AddPolicyToRoleRequest addPolicyToRoleRequest, final ApiCallback _callback) throws ApiException {
        return addPolicyToUserRoleCall(userid, addPolicyToRoleRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for addPolicyToUserRole. Use any specified configuration options to override any other configuration for this request only.
     * @param userid Id of the User Role to get (required). Use any specified configuration options to override any other configuration for this request only.
     * @param addPolicyToRoleRequest Dto of the policy to be added. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest addPolicyToUserRoleCall(String userid, AddPolicyToRoleRequest addPolicyToRoleRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/access/api/userroles/{userid}/policies"
            .replace("{" + "userid" + "}", localVarApiClient.escapeString(userid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest addPolicyToUserRoleValidateBeforeCall(String userid, AddPolicyToRoleRequest addPolicyToRoleRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'userid' is set
        if (userid == null) {
    ...
    private ApiResponse<UserRoleResponse> addPolicyToUserRoleWithHttpInfo(String userid, AddPolicyToRoleRequest addPolicyToRoleRequest) throws ApiException {
        HttpRequest localVarCall = addPolicyToUserRoleValidateBeforeCall(userid, addPolicyToRoleRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * AddPolicyToUserRole: Add a policy to a user-role
     * Adds a policy to a user-role.Use any specified configuration options to override any other configuration for this request only
     * @param userid Id of the User Role to get (required)
     * @param addPolicyToRoleRequest Dto of the policy to be added. (required)
     * @return ApiResponse&lt;UserRoleResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<UserRoleResponse> addPolicyToUserRoleWithHttpInfo(String userid, AddPolicyToRoleRequest addPolicyToRoleRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = addPolicyToUserRoleValidateBeforeCall(userid, addPolicyToRoleRequest, null, opts);
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * AddPolicyToUserRole: Add a policy to a user-role (asynchronously)
     * Adds a policy to a user-role.
     * @param userid Id of the User Role to get (required)
     * @param addPolicyToRoleRequest Dto of the policy to be added. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void addPolicyToUserRoleAsync(String userid, AddPolicyToRoleRequest addPolicyToRoleRequest, final ApiCallback<UserRoleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = addPolicyToUserRoleValidateBeforeCall(userid, addPolicyToRoleRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void addPolicyToUserRoleAsync(String userid, AddPolicyToRoleRequest addPolicyToRoleRequest, final ApiCallback<UserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = addPolicyToUserRoleValidateBeforeCall(userid, addPolicyToRoleRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIaddPolicyToUserRoleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserRoleResponse> _callback) throws ApiException {
            addPolicyToUserRoleAsync(userid, addPolicyToRoleRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            addPolicyToUserRoleAsync(userid, addPolicyToRoleRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest createUserRoleCall(UserRoleCreationRequest userRoleCreationRequest, final ApiCallback _callback) throws ApiException {
        return createUserRoleCall(userRoleCreationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createUserRole. Use any specified configuration options to override any other configuration for this request only.
     * @param userRoleCreationRequest Definition of the user-role to create. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createUserRoleCall(UserRoleCreationRequest userRoleCreationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/access/api/userroles";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest createUserRoleValidateBeforeCall(UserRoleCreationRequest userRoleCreationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UserRoleResponse> createUserRoleWithHttpInfo(UserRoleCreationRequest userRoleCreationRequest) throws ApiException {
        HttpRequest localVarCall = createUserRoleValidateBeforeCall(userRoleCreationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * CreateUserRole: Create a user-role
     * Creates a new user-role.Use any specified configuration options to override any other configuration for this request only
     * @param userRoleCreationRequest Definition of the user-role to create. (required)
     * @return ApiResponse&lt;UserRoleResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<UserRoleResponse> createUserRoleWithHttpInfo(UserRoleCreationRequest userRoleCreationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createUserRoleValidateBeforeCall(userRoleCreationRequest, null, opts);
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CreateUserRole: Create a user-role (asynchronously)
     * Creates a new user-role.
     * @param userRoleCreationRequest Definition of the user-role to create. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void createUserRoleAsync(UserRoleCreationRequest userRoleCreationRequest, final ApiCallback<UserRoleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = createUserRoleValidateBeforeCall(userRoleCreationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void createUserRoleAsync(UserRoleCreationRequest userRoleCreationRequest, final ApiCallback<UserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createUserRoleValidateBeforeCall(userRoleCreationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateUserRoleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserRoleResponse> _callback) throws ApiException {
            createUserRoleAsync(userRoleCreationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            createUserRoleAsync(userRoleCreationRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteUserRoleCall(String userid, final ApiCallback _callback) throws ApiException {
        return deleteUserRoleCall(userid,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteUserRole. Use any specified configuration options to override any other configuration for this request only.
     * @param userid Id of the user-role to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteUserRoleCall(String userid, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/access/api/userroles/{userid}"
            .replace("{" + "userid" + "}", localVarApiClient.escapeString(userid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteUserRoleValidateBeforeCall(String userid, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'userid' is set
        if (userid == null) {
    ...
    private ApiResponse<Void> deleteUserRoleWithHttpInfo(String userid) throws ApiException {
        HttpRequest localVarCall = deleteUserRoleValidateBeforeCall(userid, null, new ConfigurationOptions());
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * DeleteUserRole: Delete a user-role
     * Deletes an identified user-role.Use any specified configuration options to override any other configuration for this request only
     * @param userid Id of the user-role to delete. (required)
     * @return ApiResponse&lt;Void&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<Void> deleteUserRoleWithHttpInfo(String userid, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteUserRoleValidateBeforeCall(userid, null, opts);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * DeleteUserRole: Delete a user-role (asynchronously)
     * Deletes an identified user-role.
     * @param userid Id of the user-role to delete. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void deleteUserRoleAsync(String userid, final ApiCallback<Void> _callback) throws ApiException {

        HttpRequest localVarCall = deleteUserRoleValidateBeforeCall(userid, _callback, new ConfigurationOptions());
     ...
     */
    private void deleteUserRoleAsync(String userid, final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteUserRoleValidateBeforeCall(userid, _callback, opts);
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
    ...
    public class APIdeleteUserRoleRequest {
        ...
        public void executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            deleteUserRoleAsync(userid, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {
            deleteUserRoleAsync(userid, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getUserRoleCall(String userid, final ApiCallback _callback) throws ApiException {
        return getUserRoleCall(userid,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getUserRole. Use any specified configuration options to override any other configuration for this request only.
     * @param userid Id of the user-role to get. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getUserRoleCall(String userid, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getUserRoleValidateBeforeCall(String userid, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'userid' is set
        if (userid == null) {
    ...
    private ApiResponse<UserRoleResponse> getUserRoleWithHttpInfo(String userid) throws ApiException {
        HttpRequest localVarCall = getUserRoleValidateBeforeCall(userid, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * GetUserRole: Get a user-role
     * Get an identified user-role.Use any specified configuration options to override any other configuration for this request only
     * @param userid Id of the user-role to get. (required)
     * @return ApiResponse&lt;UserRoleResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<UserRoleResponse> getUserRoleWithHttpInfo(String userid, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getUserRoleValidateBeforeCall(userid, null, opts);
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetUserRole: Get a user-role (asynchronously)
     * Get an identified user-role.
     * @param userid Id of the user-role to get. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void getUserRoleAsync(String userid, final ApiCallback<UserRoleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getUserRoleValidateBeforeCall(userid, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getUserRoleAsync(String userid, final ApiCallback<UserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getUserRoleValidateBeforeCall(userid, _callback, opts);
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetUserRoleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserRoleResponse> _callback) throws ApiException {
            getUserRoleAsync(userid, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getUserRoleAsync(userid, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listUserRolesCall(String filter, String sortBy, Integer limit, String page, final ApiCallback _callback) throws ApiException {
        return listUserRolesCall(filter, sortBy, limit, page,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listUserRoles. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listUserRolesCall(String filter, String sortBy, Integer limit, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listUserRolesValidateBeforeCall(String filter, String sortBy, Integer limit, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfUserRoleResponse> listUserRolesWithHttpInfo(String filter, String sortBy, Integer limit, String page) throws ApiException {
        HttpRequest localVarCall = listUserRolesValidateBeforeCall(filter, sortBy, limit, page, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfUserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListUserRoles: List user-roles
     * Lists all user-roles and pages.Use any specified configuration options to override any other configuration for this request only
     * @param filter Optional. Expression to filter the result set (optional)
     * @param sortBy Optional. Order the results by these fields. Use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @param page Optional. Encoded page string returned from a previous search result that will retrieve             the next page of data. (optional)
    ...
    private ApiResponse<ResourceListOfUserRoleResponse> listUserRolesWithHttpInfo(String filter, String sortBy, Integer limit, String page, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listUserRolesValidateBeforeCall(filter, sortBy, limit, page, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfUserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListUserRoles: List user-roles (asynchronously)
     * Lists all user-roles and pages.
     * @param filter Optional. Expression to filter the result set (optional)
     * @param sortBy Optional. Order the results by these fields. Use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     ...
     */
    private void listUserRolesAsync(String filter, String sortBy, Integer limit, String page, final ApiCallback<ResourceListOfUserRoleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = listUserRolesValidateBeforeCall(filter, sortBy, limit, page, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfUserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listUserRolesAsync(String filter, String sortBy, Integer limit, String page, final ApiCallback<ResourceListOfUserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listUserRolesValidateBeforeCall(filter, sortBy, limit, page, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfUserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistUserRolesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfUserRoleResponse> _callback) throws ApiException {
            listUserRolesAsync(filter, sortBy, limit, page, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfUserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            listUserRolesAsync(filter, sortBy, limit, page, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest removePolicyCollectionFromUserRoleCall(String userid, String policyCollectionScope, String policyCollectionCode, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for removePolicyCollectionFromUserRole. Use any specified configuration options to override any other configuration for this request only.
     * @param userid Id of the User Role to get (required). Use any specified configuration options to override any other configuration for this request only.
     * @param policyCollectionScope The scope of policy collection to remove from the User Role (required). Use any specified configuration options to override any other configuration for this request only.
     * @param policyCollectionCode The code of the policy collection to remove from the User Role (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest removePolicyCollectionFromUserRoleCall(String userid, String policyCollectionScope, String policyCollectionCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/access/api/userroles/{userid}/policycollections/{policyCollectionScope}/{policyCollectionCode}"
            .replace("{" + "userid" + "}", localVarApiClient.escapeString(userid.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest removePolicyCollectionFromUserRoleValidateBeforeCall(String userid, String policyCollectionScope, String policyCollectionCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'userid' is set
        if (userid == null) {
    ...
    private ApiResponse<Void> removePolicyCollectionFromUserRoleWithHttpInfo(String userid, String policyCollectionScope, String policyCollectionCode) throws ApiException {
        HttpRequest localVarCall = removePolicyCollectionFromUserRoleValidateBeforeCall(userid, policyCollectionScope, policyCollectionCode, null, new ConfigurationOptions());
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * RemovePolicyCollectionFromUserRole: Remove a policy collection from a user-role
     * Removes a policy collection from a user-role.Use any specified configuration options to override any other configuration for this request only
     * @param userid Id of the User Role to get (required)
     * @param policyCollectionScope The scope of policy collection to remove from the User Role (required)
     * @param policyCollectionCode The code of the policy collection to remove from the User Role (required)
     * @return ApiResponse&lt;Void&gt;
    ...
    private ApiResponse<Void> removePolicyCollectionFromUserRoleWithHttpInfo(String userid, String policyCollectionScope, String policyCollectionCode, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = removePolicyCollectionFromUserRoleValidateBeforeCall(userid, policyCollectionScope, policyCollectionCode, null, opts);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * RemovePolicyCollectionFromUserRole: Remove a policy collection from a user-role (asynchronously)
     * Removes a policy collection from a user-role.
     * @param userid Id of the User Role to get (required)
     * @param policyCollectionScope The scope of policy collection to remove from the User Role (required)
     * @param policyCollectionCode The code of the policy collection to remove from the User Role (required)
     ...
     */
    private void removePolicyCollectionFromUserRoleAsync(String userid, String policyCollectionScope, String policyCollectionCode, final ApiCallback<Void> _callback) throws ApiException {

        HttpRequest localVarCall = removePolicyCollectionFromUserRoleValidateBeforeCall(userid, policyCollectionScope, policyCollectionCode, _callback, new ConfigurationOptions());
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
     ...
     */
    private void removePolicyCollectionFromUserRoleAsync(String userid, String policyCollectionScope, String policyCollectionCode, final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = removePolicyCollectionFromUserRoleValidateBeforeCall(userid, policyCollectionScope, policyCollectionCode, _callback, opts);
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
    ...
    public class APIremovePolicyCollectionFromUserRoleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            removePolicyCollectionFromUserRoleAsync(userid, policyCollectionScope, policyCollectionCode, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {
            removePolicyCollectionFromUserRoleAsync(userid, policyCollectionScope, policyCollectionCode, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest removePolicyFromUserRoleCall(String userid, String policyScope, String policyCode, final ApiCallback _callback) throws ApiException {
        return removePolicyFromUserRoleCall(userid, policyScope, policyCode,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for removePolicyFromUserRole. Use any specified configuration options to override any other configuration for this request only.
     * @param userid Id of the User Role to get (required). Use any specified configuration options to override any other configuration for this request only.
     * @param policyScope The scope of the policy to remove from the User Role (required). Use any specified configuration options to override any other configuration for this request only.
     * @param policyCode The code of the policy to remove from the User Role (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest removePolicyFromUserRoleCall(String userid, String policyScope, String policyCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/access/api/userroles/{userid}/policies/{policyScope}/{policyCode}"
            .replace("{" + "userid" + "}", localVarApiClient.escapeString(userid.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest removePolicyFromUserRoleValidateBeforeCall(String userid, String policyScope, String policyCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'userid' is set
        if (userid == null) {
    ...
    private ApiResponse<Void> removePolicyFromUserRoleWithHttpInfo(String userid, String policyScope, String policyCode) throws ApiException {
        HttpRequest localVarCall = removePolicyFromUserRoleValidateBeforeCall(userid, policyScope, policyCode, null, new ConfigurationOptions());
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * RemovePolicyFromUserRole: Remove a policy from a user-role
     * Removes a policy from a user-role.Use any specified configuration options to override any other configuration for this request only
     * @param userid Id of the User Role to get (required)
     * @param policyScope The scope of the policy to remove from the User Role (required)
     * @param policyCode The code of the policy to remove from the User Role (required)
     * @return ApiResponse&lt;Void&gt;
    ...
    private ApiResponse<Void> removePolicyFromUserRoleWithHttpInfo(String userid, String policyScope, String policyCode, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = removePolicyFromUserRoleValidateBeforeCall(userid, policyScope, policyCode, null, opts);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * RemovePolicyFromUserRole: Remove a policy from a user-role (asynchronously)
     * Removes a policy from a user-role.
     * @param userid Id of the User Role to get (required)
     * @param policyScope The scope of the policy to remove from the User Role (required)
     * @param policyCode The code of the policy to remove from the User Role (required)
     ...
     */
    private void removePolicyFromUserRoleAsync(String userid, String policyScope, String policyCode, final ApiCallback<Void> _callback) throws ApiException {

        HttpRequest localVarCall = removePolicyFromUserRoleValidateBeforeCall(userid, policyScope, policyCode, _callback, new ConfigurationOptions());
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
     ...
     */
    private void removePolicyFromUserRoleAsync(String userid, String policyScope, String policyCode, final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = removePolicyFromUserRoleValidateBeforeCall(userid, policyScope, policyCode, _callback, opts);
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
    ...
    public class APIremovePolicyFromUserRoleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            removePolicyFromUserRoleAsync(userid, policyScope, policyCode, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {
            removePolicyFromUserRoleAsync(userid, policyScope, policyCode, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateUserRoleCall(String userid, UserRoleUpdateRequest userRoleUpdateRequest, final ApiCallback _callback) throws ApiException {
        return updateUserRoleCall(userid, userRoleUpdateRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateUserRole. Use any specified configuration options to override any other configuration for this request only.
     * @param userid Id of the user-role to be updated. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param userRoleUpdateRequest Definition of the update to apply to the user-role. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updateUserRoleCall(String userid, UserRoleUpdateRequest userRoleUpdateRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/access/api/userroles/{userid}/update"
            .replace("{" + "userid" + "}", localVarApiClient.escapeString(userid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateUserRoleValidateBeforeCall(String userid, UserRoleUpdateRequest userRoleUpdateRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'userid' is set
        if (userid == null) {
    ...
    private ApiResponse<UserRoleResponse> updateUserRoleWithHttpInfo(String userid, UserRoleUpdateRequest userRoleUpdateRequest) throws ApiException {
        HttpRequest localVarCall = updateUserRoleValidateBeforeCall(userid, userRoleUpdateRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * UpdateUserRole: Update a user-role
     * Updates an identified user-role.Use any specified configuration options to override any other configuration for this request only
     * @param userid Id of the user-role to be updated. (required)
     * @param userRoleUpdateRequest Definition of the update to apply to the user-role. (required)
     * @return ApiResponse&lt;UserRoleResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<UserRoleResponse> updateUserRoleWithHttpInfo(String userid, UserRoleUpdateRequest userRoleUpdateRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateUserRoleValidateBeforeCall(userid, userRoleUpdateRequest, null, opts);
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpdateUserRole: Update a user-role (asynchronously)
     * Updates an identified user-role.
     * @param userid Id of the user-role to be updated. (required)
     * @param userRoleUpdateRequest Definition of the update to apply to the user-role. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void updateUserRoleAsync(String userid, UserRoleUpdateRequest userRoleUpdateRequest, final ApiCallback<UserRoleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = updateUserRoleValidateBeforeCall(userid, userRoleUpdateRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateUserRoleAsync(String userid, UserRoleUpdateRequest userRoleUpdateRequest, final ApiCallback<UserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateUserRoleValidateBeforeCall(userid, userRoleUpdateRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UserRoleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateUserRoleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserRoleResponse> _callback) throws ApiException {
            updateUserRoleAsync(userid, userRoleUpdateRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserRoleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            updateUserRoleAsync(userid, userRoleUpdateRequest, _callback, opts);
        }
    }
