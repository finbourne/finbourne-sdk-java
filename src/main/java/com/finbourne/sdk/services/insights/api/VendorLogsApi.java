...
public class VendorLogsApi {
     ...
     */
    private HttpRequest getVendorLogCall(String id, final ApiCallback _callback) throws ApiException {
        return getVendorLogCall(id,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getVendorLog. Use any specified configuration options to override any other configuration for this request only.
     * @param id The identifier of the request to obtain the log for. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getVendorLogCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/insights/api/vendor/{id}"
    ...
    private HttpRequest getVendorLogValidateBeforeCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<VendorLog> getVendorLogWithHttpInfo(String id) throws ApiException {
        HttpRequest localVarCall = getVendorLogValidateBeforeCall(id, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<VendorLog>(){}.getType();
    ...
    private ApiResponse<VendorLog> getVendorLogWithHttpInfo(String id, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getVendorLogValidateBeforeCall(id, null, opts);
        Type localVarReturnType = new TypeReference<VendorLog>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getVendorLogAsync(String id, final ApiCallback<VendorLog> _callback) throws ApiException {

        HttpRequest localVarCall = getVendorLogValidateBeforeCall(id, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<VendorLog>(){}.getType();
     ...
     */
    private void getVendorLogAsync(String id, final ApiCallback<VendorLog> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getVendorLogValidateBeforeCall(id, _callback, opts);
        Type localVarReturnType = new TypeReference<VendorLog>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetVendorLogRequest {
         ...
         */
        public void executeAsync(final ApiCallback<VendorLog> _callback) throws ApiException {
            getVendorLogAsync(id, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<VendorLog> _callback, ConfigurationOptions opts) throws ApiException {
            getVendorLogAsync(id, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getVendorRequestCall(String id, final ApiCallback _callback) throws ApiException {
        return getVendorRequestCall(id,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getVendorRequest. Use any specified configuration options to override any other configuration for this request only.
     * @param id The identifier of the request to obtain the content for. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getVendorRequestCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/insights/api/vendor/{id}/request"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getVendorRequestValidateBeforeCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<VendorRequest> getVendorRequestWithHttpInfo(String id) throws ApiException {
        HttpRequest localVarCall = getVendorRequestValidateBeforeCall(id, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<VendorRequest>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<VendorRequest> getVendorRequestWithHttpInfo(String id, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getVendorRequestValidateBeforeCall(id, null, opts);
        Type localVarReturnType = new TypeReference<VendorRequest>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getVendorRequestAsync(String id, final ApiCallback<VendorRequest> _callback) throws ApiException {

        HttpRequest localVarCall = getVendorRequestValidateBeforeCall(id, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<VendorRequest>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getVendorRequestAsync(String id, final ApiCallback<VendorRequest> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getVendorRequestValidateBeforeCall(id, _callback, opts);
        Type localVarReturnType = new TypeReference<VendorRequest>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetVendorRequestRequest {
         ...
         */
        public void executeAsync(final ApiCallback<VendorRequest> _callback) throws ApiException {
            getVendorRequestAsync(id, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<VendorRequest> _callback, ConfigurationOptions opts) throws ApiException {
            getVendorRequestAsync(id, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getVendorResponseCall(String id, final ApiCallback _callback) throws ApiException {
        return getVendorResponseCall(id,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getVendorResponse. Use any specified configuration options to override any other configuration for this request only.
     * @param id The identifier of the request to obtain the response for. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getVendorResponseCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/insights/api/vendor/{id}/response"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getVendorResponseValidateBeforeCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<VendorResponse> getVendorResponseWithHttpInfo(String id) throws ApiException {
        HttpRequest localVarCall = getVendorResponseValidateBeforeCall(id, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<VendorResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<VendorResponse> getVendorResponseWithHttpInfo(String id, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getVendorResponseValidateBeforeCall(id, null, opts);
        Type localVarReturnType = new TypeReference<VendorResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getVendorResponseAsync(String id, final ApiCallback<VendorResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getVendorResponseValidateBeforeCall(id, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<VendorResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getVendorResponseAsync(String id, final ApiCallback<VendorResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getVendorResponseValidateBeforeCall(id, _callback, opts);
        Type localVarReturnType = new TypeReference<VendorResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetVendorResponseRequest {
         ...
         */
        public void executeAsync(final ApiCallback<VendorResponse> _callback) throws ApiException {
            getVendorResponseAsync(id, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<VendorResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getVendorResponseAsync(id, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listVendorLogsCall(String filter, String sortBy, Integer limit, String page, String histogramInterval, final ApiCallback _callback) throws ApiException {
        return listVendorLogsCall(filter, sortBy, limit, page, histogramInterval,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listVendorLogs. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listVendorLogsCall(String filter, String sortBy, Integer limit, String page, String histogramInterval, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/insights/api/vendor";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listVendorLogsValidateBeforeCall(String filter, String sortBy, Integer limit, String page, String histogramInterval, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListWithHistogramOfVendorLog> listVendorLogsWithHttpInfo(String filter, String sortBy, Integer limit, String page, String histogramInterval) throws ApiException {
        HttpRequest localVarCall = listVendorLogsValidateBeforeCall(filter, sortBy, limit, page, histogramInterval, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListWithHistogramOfVendorLog>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListWithHistogramOfVendorLog> listVendorLogsWithHttpInfo(String filter, String sortBy, Integer limit, String page, String histogramInterval, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listVendorLogsValidateBeforeCall(filter, sortBy, limit, page, histogramInterval, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListWithHistogramOfVendorLog>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listVendorLogsAsync(String filter, String sortBy, Integer limit, String page, String histogramInterval, final ApiCallback<ResourceListWithHistogramOfVendorLog> _callback) throws ApiException {

        HttpRequest localVarCall = listVendorLogsValidateBeforeCall(filter, sortBy, limit, page, histogramInterval, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListWithHistogramOfVendorLog>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listVendorLogsAsync(String filter, String sortBy, Integer limit, String page, String histogramInterval, final ApiCallback<ResourceListWithHistogramOfVendorLog> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listVendorLogsValidateBeforeCall(filter, sortBy, limit, page, histogramInterval, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListWithHistogramOfVendorLog>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistVendorLogsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListWithHistogramOfVendorLog> _callback) throws ApiException {
            listVendorLogsAsync(filter, sortBy, limit, page, histogramInterval, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListWithHistogramOfVendorLog> _callback, ConfigurationOptions opts) throws ApiException {
            listVendorLogsAsync(filter, sortBy, limit, page, histogramInterval, _callback, opts);
        }
    }
