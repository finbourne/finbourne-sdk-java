...
public class CandelaTracesApi {
     ...
     */
    private HttpRequest getTraceDiagramCall(String traceId, final ApiCallback _callback) throws ApiException {
        return getTraceDiagramCall(traceId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getTraceDiagram. Use any specified configuration options to override any other configuration for this request only.
     * @param traceId The identifier of the trace. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getTraceDiagramCall(String traceId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/insights/api/candelatraces/{traceId}/diagram"
    ...
    private HttpRequest getTraceDiagramValidateBeforeCall(String traceId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TraceDiagramResponse> getTraceDiagramWithHttpInfo(String traceId) throws ApiException {
        HttpRequest localVarCall = getTraceDiagramValidateBeforeCall(traceId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TraceDiagramResponse>(){}.getType();
    ...
    private ApiResponse<TraceDiagramResponse> getTraceDiagramWithHttpInfo(String traceId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getTraceDiagramValidateBeforeCall(traceId, null, opts);
        Type localVarReturnType = new TypeReference<TraceDiagramResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetTraceDiagram: Get the diagram representation for a specific trace. (asynchronously)
     * 
     * @param traceId The identifier of the trace. (required)
     ...
     */
    private void getTraceDiagramAsync(String traceId, final ApiCallback<TraceDiagramResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getTraceDiagramValidateBeforeCall(traceId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TraceDiagramResponse>(){}.getType();
     ...
     */
    private void getTraceDiagramAsync(String traceId, final ApiCallback<TraceDiagramResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getTraceDiagramValidateBeforeCall(traceId, _callback, opts);
        Type localVarReturnType = new TypeReference<TraceDiagramResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetTraceDiagramRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TraceDiagramResponse> _callback) throws ApiException {
            getTraceDiagramAsync(traceId, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TraceDiagramResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getTraceDiagramAsync(traceId, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getTraceLogCall(String traceId, final ApiCallback _callback) throws ApiException {
        return getTraceLogCall(traceId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getTraceLog. Use any specified configuration options to override any other configuration for this request only.
     * @param traceId The identifier of the request to obtain the log for. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getTraceLogCall(String traceId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/insights/api/candelatraces/{traceId}"
            .replace("{" + "traceId" + "}", localVarApiClient.escapeString(traceId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getTraceLogValidateBeforeCall(String traceId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'traceId' is set
        if (traceId == null) {
    ...
    private ApiResponse<TraceLog> getTraceLogWithHttpInfo(String traceId) throws ApiException {
        HttpRequest localVarCall = getTraceLogValidateBeforeCall(traceId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TraceLog>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<TraceLog> getTraceLogWithHttpInfo(String traceId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getTraceLogValidateBeforeCall(traceId, null, opts);
        Type localVarReturnType = new TypeReference<TraceLog>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetTraceLog: Get the log for a specific trace. (asynchronously)
     * 
     * @param traceId The identifier of the request to obtain the log for. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void getTraceLogAsync(String traceId, final ApiCallback<TraceLog> _callback) throws ApiException {

        HttpRequest localVarCall = getTraceLogValidateBeforeCall(traceId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TraceLog>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getTraceLogAsync(String traceId, final ApiCallback<TraceLog> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getTraceLogValidateBeforeCall(traceId, _callback, opts);
        Type localVarReturnType = new TypeReference<TraceLog>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetTraceLogRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TraceLog> _callback) throws ApiException {
            getTraceLogAsync(traceId, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TraceLog> _callback, ConfigurationOptions opts) throws ApiException {
            getTraceLogAsync(traceId, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listTraceEventLogsCall(String traceId, String page, final ApiCallback _callback) throws ApiException {
        return listTraceEventLogsCall(traceId, page,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listTraceEventLogs. Use any specified configuration options to override any other configuration for this request only.
     * @param traceId The identifier of the request to obtain the log for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param page  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listTraceEventLogsCall(String traceId, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/insights/api/candelatraces/{traceId}/events"
            .replace("{" + "traceId" + "}", localVarApiClient.escapeString(traceId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listTraceEventLogsValidateBeforeCall(String traceId, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'traceId' is set
        if (traceId == null) {
    ...
    private ApiResponse<ResourceListOfTraceEventLog> listTraceEventLogsWithHttpInfo(String traceId, String page) throws ApiException {
        HttpRequest localVarCall = listTraceEventLogsValidateBeforeCall(traceId, page, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfTraceEventLog>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListOfTraceEventLog> listTraceEventLogsWithHttpInfo(String traceId, String page, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listTraceEventLogsValidateBeforeCall(traceId, page, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfTraceEventLog>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListTraceEventLogs: Get the trace event logs for a specific trace. (asynchronously)
     * 
     * @param traceId The identifier of the request to obtain the log for. (required)
     * @param page  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void listTraceEventLogsAsync(String traceId, String page, final ApiCallback<ResourceListOfTraceEventLog> _callback) throws ApiException {

        HttpRequest localVarCall = listTraceEventLogsValidateBeforeCall(traceId, page, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfTraceEventLog>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listTraceEventLogsAsync(String traceId, String page, final ApiCallback<ResourceListOfTraceEventLog> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listTraceEventLogsValidateBeforeCall(traceId, page, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfTraceEventLog>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistTraceEventLogsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfTraceEventLog> _callback) throws ApiException {
            listTraceEventLogsAsync(traceId, page, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfTraceEventLog> _callback, ConfigurationOptions opts) throws ApiException {
            listTraceEventLogsAsync(traceId, page, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listTraceLogsCall(String filter, String sortBy, Integer limit, String page, final ApiCallback _callback) throws ApiException {
        return listTraceLogsCall(filter, sortBy, limit, page,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listTraceLogs. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listTraceLogsCall(String filter, String sortBy, Integer limit, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/insights/api/candelatraces";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listTraceLogsValidateBeforeCall(String filter, String sortBy, Integer limit, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfTraceLog> listTraceLogsWithHttpInfo(String filter, String sortBy, Integer limit, String page) throws ApiException {
        HttpRequest localVarCall = listTraceLogsValidateBeforeCall(filter, sortBy, limit, page, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfTraceLog>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListOfTraceLog> listTraceLogsWithHttpInfo(String filter, String sortBy, Integer limit, String page, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listTraceLogsValidateBeforeCall(filter, sortBy, limit, page, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfTraceLog>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListTraceLogs: Get the logs for traces. (asynchronously)
     * 
     * @param filter Expression to filter the result set. Read more about [filtering results from LUSID](https://support.lusid.com/filtering-results-from-lusid). (optional)
     * @param sortBy Order the results by these fields. Use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName. Multiple fields can be denoted by a comma e.g. -MyFieldName,AnotherFieldName,-AFurtherFieldName (optional)
     * @param limit When paginating, only return this number of records. The minimum value is 0 and the maximum is 10000. (optional)
     ...
     */
    private void listTraceLogsAsync(String filter, String sortBy, Integer limit, String page, final ApiCallback<ResourceListOfTraceLog> _callback) throws ApiException {

        HttpRequest localVarCall = listTraceLogsValidateBeforeCall(filter, sortBy, limit, page, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfTraceLog>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listTraceLogsAsync(String filter, String sortBy, Integer limit, String page, final ApiCallback<ResourceListOfTraceLog> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listTraceLogsValidateBeforeCall(filter, sortBy, limit, page, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfTraceLog>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistTraceLogsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfTraceLog> _callback) throws ApiException {
            listTraceLogsAsync(filter, sortBy, limit, page, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfTraceLog> _callback, ConfigurationOptions opts) throws ApiException {
            listTraceLogsAsync(filter, sortBy, limit, page, _callback, opts);
        }
    }
