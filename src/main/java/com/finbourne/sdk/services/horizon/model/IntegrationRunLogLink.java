 ...
 */
@JsonPropertyOrder({
  IntegrationRunLogLink.JSON_PROPERTY_HREF,
  IntegrationRunLogLink.JSON_PROPERTY_DESCRIPTION
})
...
public class IntegrationRunLogLink {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to IntegrationRunLogLink
   */
  public static IntegrationRunLogLink fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, IntegrationRunLogLink.class);
  }
