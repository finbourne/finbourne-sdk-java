 ...
 */
@JsonPropertyOrder({
  OpenFigiSearchResult.JSON_PROPERTY_RESULTS,
  OpenFigiSearchResult.JSON_PROPERTY_PERM_ID_URI
})
...
public class OpenFigiSearchResult {
  ...
  public static final String JSON_PROPERTY_PERM_ID_URI = "permIdUri";
  @JsonProperty(JSON_PROPERTY_PERM_ID_URI)
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to OpenFigiSearchResult
   */
  public static OpenFigiSearchResult fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, OpenFigiSearchResult.class);
  }
