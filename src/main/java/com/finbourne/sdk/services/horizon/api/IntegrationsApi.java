...
public class IntegrationsApi {
     ...
     */
    private HttpRequest getWorkflowResultFieldsCall(String instanceId, final ApiCallback _callback) throws ApiException {
        return getWorkflowResultFieldsCall(instanceId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getWorkflowResultFields. Use any specified configuration options to override any other configuration for this request only.
     * @param instanceId Instance identifier e.g. \&quot;b64135e7-98a0-41af-a845-d86167d54cc7\&quot;. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getWorkflowResultFieldsCall(String instanceId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/horizon/api/integrations/instances/{instanceId}/workflow/resultfields"
            .replace("{" + "instanceId" + "}", localVarApiClient.escapeString(instanceId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getWorkflowResultFieldsValidateBeforeCall(String instanceId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'instanceId' is set
        if (instanceId == null) {
    ...
    private ApiResponse<WorkflowResultFieldsResponse> getWorkflowResultFieldsWithHttpInfo(String instanceId) throws ApiException {
        HttpRequest localVarCall = getWorkflowResultFieldsValidateBeforeCall(instanceId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<WorkflowResultFieldsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<WorkflowResultFieldsResponse> getWorkflowResultFieldsWithHttpInfo(String instanceId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getWorkflowResultFieldsValidateBeforeCall(instanceId, null, opts);
        Type localVarReturnType = new TypeReference<WorkflowResultFieldsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetWorkflowResultFields: Get the Workflow result fields an integration instance returns (asynchronously)
     * Returns the result fields this instance&#39;s &#x60;RunWorkflow&#x60; post-process tasks declare, so a caller can discover what a run will report back before starting one. An instance with no enabled &#x60;RunWorkflow&#x60; post-process task is not an error: the response has &#x60;reportsToWorkflow&#x60; false and no fields. Note that such an instance will not report back at all, even when a Workflow task starts the run — configuring a &#x60;RunWorkflow&#x60; post-process task is what closes that loop. The user must be authenticated, entitled to call this method, and the user&#39;s domain must be licensed for the integration.
     * @param instanceId Instance identifier e.g. \&quot;b64135e7-98a0-41af-a845-d86167d54cc7\&quot;. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void getWorkflowResultFieldsAsync(String instanceId, final ApiCallback<WorkflowResultFieldsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getWorkflowResultFieldsValidateBeforeCall(instanceId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<WorkflowResultFieldsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getWorkflowResultFieldsAsync(String instanceId, final ApiCallback<WorkflowResultFieldsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getWorkflowResultFieldsValidateBeforeCall(instanceId, _callback, opts);
        Type localVarReturnType = new TypeReference<WorkflowResultFieldsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetWorkflowResultFieldsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<WorkflowResultFieldsResponse> _callback) throws ApiException {
            getWorkflowResultFieldsAsync(instanceId, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<WorkflowResultFieldsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getWorkflowResultFieldsAsync(instanceId, _callback, opts);
        }
    }
