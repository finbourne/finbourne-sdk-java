 ...
 */
@JsonPropertyOrder({
  OrderInstructionSetRequest.JSON_PROPERTY_REQUESTS
})
...
public class OrderInstructionSetRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to OrderInstructionSetRequest
   */
  public static OrderInstructionSetRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, OrderInstructionSetRequest.class);
  }
