 ...
 */
@JsonPropertyOrder({
  ReconciliationRequest.JSON_PROPERTY_LEFT,
  ReconciliationRequest.JSON_PROPERTY_RIGHT,
  ReconciliationRequest.JSON_PROPERTY_LEFT_TO_RIGHT_MAPPING,
  ReconciliationRequest.JSON_PROPERTY_COMPARISON_RULES,
  ReconciliationRequest.JSON_PROPERTY_PRESERVE_KEYS
})
...
public class ReconciliationRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ReconciliationRequest
   */
  public static ReconciliationRequest fromJson(String jsonString) throws java.io.IOException {
