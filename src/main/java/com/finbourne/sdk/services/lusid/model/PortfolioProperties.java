 ...
 */
@JsonPropertyOrder({
  PortfolioProperties.JSON_PROPERTY_HREF,
  PortfolioProperties.JSON_PROPERTY_PROPERTIES,
  PortfolioProperties.JSON_PROPERTY_VERSION,
  PortfolioProperties.JSON_PROPERTY_STAGED_MODIFICATIONS,
  PortfolioProperties.JSON_PROPERTY_LINKS
})
...
public class PortfolioProperties {
 ...
 public int hashCode() {
  ...
  /**
   * Create an instance of PortfolioProperties given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PortfolioProperties
   * @throws java.io.IOException if the JSON string is invalid with respect to PortfolioProperties
   */
  public static PortfolioProperties fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, PortfolioProperties.class);
  }

  /**
   * Convert an instance of PortfolioProperties to an JSON string
   *
   * @return JSON string
   */
