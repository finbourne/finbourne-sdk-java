...
public class PropertyDefinitionsApi {
     ...
     */
    private HttpRequest createDerivedPropertyDefinitionCall(CreateDerivedPropertyDefinitionRequest createDerivedPropertyDefinitionRequest, final ApiCallback _callback) throws ApiException {
        return createDerivedPropertyDefinitionCall(createDerivedPropertyDefinitionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createDerivedPropertyDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param createDerivedPropertyDefinitionRequest The definition of the new derived property. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createDerivedPropertyDefinitionCall(CreateDerivedPropertyDefinitionRequest createDerivedPropertyDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/propertydefinitions/derived";
    ...
    private HttpRequest createDerivedPropertyDefinitionValidateBeforeCall(CreateDerivedPropertyDefinitionRequest createDerivedPropertyDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PropertyDefinition> createDerivedPropertyDefinitionWithHttpInfo(CreateDerivedPropertyDefinitionRequest createDerivedPropertyDefinitionRequest) throws ApiException {
        HttpRequest localVarCall = createDerivedPropertyDefinitionValidateBeforeCall(createDerivedPropertyDefinitionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CreateDerivedPropertyDefinition: Create derived property definition
     * Define a new derived property.Use any specified configuration options to override any other configuration for this request only
     * @param createDerivedPropertyDefinitionRequest The definition of the new derived property. (required)
     * @return ApiResponse&lt;PropertyDefinition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<PropertyDefinition> createDerivedPropertyDefinitionWithHttpInfo(CreateDerivedPropertyDefinitionRequest createDerivedPropertyDefinitionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createDerivedPropertyDefinitionValidateBeforeCall(createDerivedPropertyDefinitionRequest, null, opts);
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createDerivedPropertyDefinitionAsync(CreateDerivedPropertyDefinitionRequest createDerivedPropertyDefinitionRequest, final ApiCallback<PropertyDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = createDerivedPropertyDefinitionValidateBeforeCall(createDerivedPropertyDefinitionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
     ...
     */
    private void createDerivedPropertyDefinitionAsync(CreateDerivedPropertyDefinitionRequest createDerivedPropertyDefinitionRequest, final ApiCallback<PropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createDerivedPropertyDefinitionValidateBeforeCall(createDerivedPropertyDefinitionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateDerivedPropertyDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PropertyDefinition> _callback) throws ApiException {
            createDerivedPropertyDefinitionAsync(createDerivedPropertyDefinitionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            createDerivedPropertyDefinitionAsync(createDerivedPropertyDefinitionRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest createPropertyDefinitionCall(CreatePropertyDefinitionRequest createPropertyDefinitionRequest, final ApiCallback _callback) throws ApiException {
        return createPropertyDefinitionCall(createPropertyDefinitionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createPropertyDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param createPropertyDefinitionRequest The definition of the new property. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createPropertyDefinitionCall(CreatePropertyDefinitionRequest createPropertyDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/propertydefinitions";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest createPropertyDefinitionValidateBeforeCall(CreatePropertyDefinitionRequest createPropertyDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PropertyDefinition> createPropertyDefinitionWithHttpInfo(CreatePropertyDefinitionRequest createPropertyDefinitionRequest) throws ApiException {
        HttpRequest localVarCall = createPropertyDefinitionValidateBeforeCall(createPropertyDefinitionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * CreatePropertyDefinition: Create property definition
     * Define a new property.Use any specified configuration options to override any other configuration for this request only
     * @param createPropertyDefinitionRequest The definition of the new property. (required)
     * @return ApiResponse&lt;PropertyDefinition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<PropertyDefinition> createPropertyDefinitionWithHttpInfo(CreatePropertyDefinitionRequest createPropertyDefinitionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createPropertyDefinitionValidateBeforeCall(createPropertyDefinitionRequest, null, opts);
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createPropertyDefinitionAsync(CreatePropertyDefinitionRequest createPropertyDefinitionRequest, final ApiCallback<PropertyDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = createPropertyDefinitionValidateBeforeCall(createPropertyDefinitionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void createPropertyDefinitionAsync(CreatePropertyDefinitionRequest createPropertyDefinitionRequest, final ApiCallback<PropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createPropertyDefinitionValidateBeforeCall(createPropertyDefinitionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreatePropertyDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PropertyDefinition> _callback) throws ApiException {
            createPropertyDefinitionAsync(createPropertyDefinitionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            createPropertyDefinitionAsync(createPropertyDefinitionRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deletePropertyDefinitionCall(String domain, String scope, String code, final ApiCallback _callback) throws ApiException {
        return deletePropertyDefinitionCall(domain, scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deletePropertyDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param domain The domain of the property to be deleted. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the property to be deleted. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the property to be deleted. Together with the domain and scope this uniquely              identifies the property. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deletePropertyDefinitionCall(String domain, String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/propertydefinitions/{domain}/{scope}/{code}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deletePropertyDefinitionValidateBeforeCall(String domain, String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deletePropertyDefinitionWithHttpInfo(String domain, String scope, String code) throws ApiException {
        HttpRequest localVarCall = deletePropertyDefinitionValidateBeforeCall(domain, scope, code, null, new ConfigurationOptions());
    ...
    /**
     * DeletePropertyDefinition: Delete property definition
     * Delete the definition of the specified property.Use any specified configuration options to override any other configuration for this request only
     * @param domain The domain of the property to be deleted. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required)
     * @param scope The scope of the property to be deleted. (required)
     * @param code The code of the property to be deleted. Together with the domain and scope this uniquely              identifies the property. (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
    ...
    private ApiResponse<DeletedEntityResponse> deletePropertyDefinitionWithHttpInfo(String domain, String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deletePropertyDefinitionValidateBeforeCall(domain, scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deletePropertyDefinitionAsync(String domain, String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deletePropertyDefinitionValidateBeforeCall(domain, scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deletePropertyDefinitionAsync(String domain, String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deletePropertyDefinitionValidateBeforeCall(domain, scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeletePropertyDefinitionRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deletePropertyDefinitionAsync(domain, scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deletePropertyDefinitionAsync(domain, scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deletePropertyDefinitionPropertiesCall(String domain, String scope, String code, List<String> requestBody, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for deletePropertyDefinitionProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param domain The domain of the property definition to delete properties from. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the property definition to delete properties from. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the property definition to delete properties from. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The property keys of the properties to delete. These must take the format              {domain}/{scope}/{code} e.g \&quot;PropertyDefinition/myScope/someAttributeKey\&quot;. Each property must be from the \&quot;PropertyDefinition\&quot; domain. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to delete time-variant properties from.              The property must exist at the specified &#39;effectiveAt&#39; datetime. If the &#39;effectiveAt&#39; is not provided or is before              the time-variant property exists then a failure is returned. Do not specify this parameter if an of the properties to delete are perpetual. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deletePropertyDefinitionPropertiesCall(String domain, String scope, String code, List<String> requestBody, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/propertydefinitions/{domain}/{scope}/{code}/properties/$delete"
            .replace("{" + "domain" + "}", localVarApiClient.escapeString(domain.toString()))
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deletePropertyDefinitionPropertiesValidateBeforeCall(String domain, String scope, String code, List<String> requestBody, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'domain' is set
        if (domain == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deletePropertyDefinitionPropertiesWithHttpInfo(String domain, String scope, String code, List<String> requestBody, String effectiveAt) throws ApiException {
        HttpRequest localVarCall = deletePropertyDefinitionPropertiesValidateBeforeCall(domain, scope, code, requestBody, effectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<DeletedEntityResponse> deletePropertyDefinitionPropertiesWithHttpInfo(String domain, String scope, String code, List<String> requestBody, String effectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deletePropertyDefinitionPropertiesValidateBeforeCall(domain, scope, code, requestBody, effectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deletePropertyDefinitionPropertiesAsync(String domain, String scope, String code, List<String> requestBody, String effectiveAt, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deletePropertyDefinitionPropertiesValidateBeforeCall(domain, scope, code, requestBody, effectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deletePropertyDefinitionPropertiesAsync(String domain, String scope, String code, List<String> requestBody, String effectiveAt, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deletePropertyDefinitionPropertiesValidateBeforeCall(domain, scope, code, requestBody, effectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeletePropertyDefinitionPropertiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deletePropertyDefinitionPropertiesAsync(domain, scope, code, requestBody, effectiveAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deletePropertyDefinitionPropertiesAsync(domain, scope, code, requestBody, effectiveAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getDerivedFormulaExplanationCall(DerivationFormulaExplainRequest derivationFormulaExplainRequest, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getDerivedFormulaExplanation. Use any specified configuration options to override any other configuration for this request only.
     * @param derivationFormulaExplainRequest Information about the derivation formula to explain, and optionally, the entity to resolve the formula against. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to resolve the entity. Defaults to returning the latest asAt in LUSID              if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to resolve the entity. Defaults to the current LUSID              system datetime if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getDerivedFormulaExplanationCall(DerivationFormulaExplainRequest derivationFormulaExplainRequest, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/propertydefinitions/derived/$formulaExplanation";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getDerivedFormulaExplanationValidateBeforeCall(DerivationFormulaExplainRequest derivationFormulaExplainRequest, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DerivedPropertyComponent> getDerivedFormulaExplanationWithHttpInfo(DerivationFormulaExplainRequest derivationFormulaExplainRequest, OffsetDateTime asAt, String effectiveAt) throws ApiException {
        HttpRequest localVarCall = getDerivedFormulaExplanationValidateBeforeCall(derivationFormulaExplainRequest, asAt, effectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DerivedPropertyComponent>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetDerivedFormulaExplanation: Get explanation of a derived property formula
     * Produces a manifest that shows the nested hierarchy of any source properties and the actions taken upon them to create the derived property.  This can either be done against an existing entity, which will produce a manifest that includes the values of the source properties  at the specified effective date time, or it can be done without providing an entity which will produce a manifest without values.Use any specified configuration options to override any other configuration for this request only
     * @param derivationFormulaExplainRequest Information about the derivation formula to explain, and optionally, the entity to resolve the formula against. (required)
     * @param asAt The asAt datetime at which to resolve the entity. Defaults to returning the latest asAt in LUSID              if not specified. (optional)
     * @param effectiveAt The effective datetime or cut label at which to resolve the entity. Defaults to the current LUSID              system datetime if not specified. (optional)
     * @return ApiResponse&lt;DerivedPropertyComponent&gt;
    ...
    private ApiResponse<DerivedPropertyComponent> getDerivedFormulaExplanationWithHttpInfo(DerivationFormulaExplainRequest derivationFormulaExplainRequest, OffsetDateTime asAt, String effectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getDerivedFormulaExplanationValidateBeforeCall(derivationFormulaExplainRequest, asAt, effectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<DerivedPropertyComponent>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetDerivedFormulaExplanation: Get explanation of a derived property formula (asynchronously)
     * Produces a manifest that shows the nested hierarchy of any source properties and the actions taken upon them to create the derived property.  This can either be done against an existing entity, which will produce a manifest that includes the values of the source properties  at the specified effective date time, or it can be done without providing an entity which will produce a manifest without values.
     * @param derivationFormulaExplainRequest Information about the derivation formula to explain, and optionally, the entity to resolve the formula against. (required)
     * @param asAt The asAt datetime at which to resolve the entity. Defaults to returning the latest asAt in LUSID              if not specified. (optional)
     * @param effectiveAt The effective datetime or cut label at which to resolve the entity. Defaults to the current LUSID              system datetime if not specified. (optional)
     ...
     */
    private void getDerivedFormulaExplanationAsync(DerivationFormulaExplainRequest derivationFormulaExplainRequest, OffsetDateTime asAt, String effectiveAt, final ApiCallback<DerivedPropertyComponent> _callback) throws ApiException {

        HttpRequest localVarCall = getDerivedFormulaExplanationValidateBeforeCall(derivationFormulaExplainRequest, asAt, effectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DerivedPropertyComponent>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getDerivedFormulaExplanationAsync(DerivationFormulaExplainRequest derivationFormulaExplainRequest, OffsetDateTime asAt, String effectiveAt, final ApiCallback<DerivedPropertyComponent> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getDerivedFormulaExplanationValidateBeforeCall(derivationFormulaExplainRequest, asAt, effectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<DerivedPropertyComponent>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetDerivedFormulaExplanationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DerivedPropertyComponent> _callback) throws ApiException {
            getDerivedFormulaExplanationAsync(derivationFormulaExplainRequest, asAt, effectiveAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DerivedPropertyComponent> _callback, ConfigurationOptions opts) throws ApiException {
            getDerivedFormulaExplanationAsync(derivationFormulaExplainRequest, asAt, effectiveAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getMultiplePropertyDefinitionsCall(List<String> propertyKeys, OffsetDateTime asAt, String filter, String effectiveAt, final ApiCallback _callback) throws ApiException {
        return getMultiplePropertyDefinitionsCall(propertyKeys, asAt, filter, effectiveAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getMultiplePropertyDefinitions. Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys One or more property keys which identify each property that a definition should              be retrieved for. The format for each property key is {domain}/{scope}/{code}, e.g. &#39;Portfolio/Manager/Id&#39;. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the property definitions. Defaults to return              the latest version of each definition if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the result set.               For example, to filter on the Lifetime, use \&quot;lifeTime eq &#39;Perpetual&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list properties attached to the Property Definition.              Defaults to the current LUSID system datetime if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getMultiplePropertyDefinitionsCall(List<String> propertyKeys, OffsetDateTime asAt, String filter, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getMultiplePropertyDefinitionsValidateBeforeCall(List<String> propertyKeys, OffsetDateTime asAt, String filter, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfPropertyDefinition> getMultiplePropertyDefinitionsWithHttpInfo(List<String> propertyKeys, OffsetDateTime asAt, String filter, String effectiveAt) throws ApiException {
        HttpRequest localVarCall = getMultiplePropertyDefinitionsValidateBeforeCall(propertyKeys, asAt, filter, effectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetMultiplePropertyDefinitions: Get multiple property definitions
     * Retrieve the definition of one or more specified properties.Use any specified configuration options to override any other configuration for this request only
     * @param propertyKeys One or more property keys which identify each property that a definition should              be retrieved for. The format for each property key is {domain}/{scope}/{code}, e.g. &#39;Portfolio/Manager/Id&#39;. (required)
     * @param asAt The asAt datetime at which to retrieve the property definitions. Defaults to return              the latest version of each definition if not specified. (optional)
     * @param filter Expression to filter the result set.               For example, to filter on the Lifetime, use \&quot;lifeTime eq &#39;Perpetual&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @param effectiveAt The effective datetime or cut label at which to list properties attached to the Property Definition.              Defaults to the current LUSID system datetime if not specified. (optional)
    ...
    private ApiResponse<ResourceListOfPropertyDefinition> getMultiplePropertyDefinitionsWithHttpInfo(List<String> propertyKeys, OffsetDateTime asAt, String filter, String effectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getMultiplePropertyDefinitionsValidateBeforeCall(propertyKeys, asAt, filter, effectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getMultiplePropertyDefinitionsAsync(List<String> propertyKeys, OffsetDateTime asAt, String filter, String effectiveAt, final ApiCallback<ResourceListOfPropertyDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = getMultiplePropertyDefinitionsValidateBeforeCall(propertyKeys, asAt, filter, effectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getMultiplePropertyDefinitionsAsync(List<String> propertyKeys, OffsetDateTime asAt, String filter, String effectiveAt, final ApiCallback<ResourceListOfPropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getMultiplePropertyDefinitionsValidateBeforeCall(propertyKeys, asAt, filter, effectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetMultiplePropertyDefinitionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPropertyDefinition> _callback) throws ApiException {
            getMultiplePropertyDefinitionsAsync(propertyKeys, asAt, filter, effectiveAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            getMultiplePropertyDefinitionsAsync(propertyKeys, asAt, filter, effectiveAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPropertyDefinitionCall(String domain, String scope, String code, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback) throws ApiException {
        return getPropertyDefinitionCall(domain, scope, code, asAt, effectiveAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getPropertyDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param domain The domain of the specified property. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the specified property. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified property. Together with the domain and scope this uniquely              identifies the property. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the property definition. Defaults to return              the latest version of the definition if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list properties attached to the Property Definition.              Defaults to the current LUSID system datetime if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getPropertyDefinitionCall(String domain, String scope, String code, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPropertyDefinitionValidateBeforeCall(String domain, String scope, String code, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'domain' is set
        if (domain == null) {
    ...
    private ApiResponse<PropertyDefinition> getPropertyDefinitionWithHttpInfo(String domain, String scope, String code, OffsetDateTime asAt, String effectiveAt) throws ApiException {
        HttpRequest localVarCall = getPropertyDefinitionValidateBeforeCall(domain, scope, code, asAt, effectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * GetPropertyDefinition: Get property definition
     * Retrieve the definition of a specified property.Use any specified configuration options to override any other configuration for this request only
     * @param domain The domain of the specified property. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required)
     * @param scope The scope of the specified property. (required)
     * @param code The code of the specified property. Together with the domain and scope this uniquely              identifies the property. (required)
     * @param asAt The asAt datetime at which to retrieve the property definition. Defaults to return              the latest version of the definition if not specified. (optional)
    ...
    private ApiResponse<PropertyDefinition> getPropertyDefinitionWithHttpInfo(String domain, String scope, String code, OffsetDateTime asAt, String effectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPropertyDefinitionValidateBeforeCall(domain, scope, code, asAt, effectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getPropertyDefinitionAsync(String domain, String scope, String code, OffsetDateTime asAt, String effectiveAt, final ApiCallback<PropertyDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = getPropertyDefinitionValidateBeforeCall(domain, scope, code, asAt, effectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPropertyDefinitionAsync(String domain, String scope, String code, OffsetDateTime asAt, String effectiveAt, final ApiCallback<PropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPropertyDefinitionValidateBeforeCall(domain, scope, code, asAt, effectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPropertyDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PropertyDefinition> _callback) throws ApiException {
            getPropertyDefinitionAsync(domain, scope, code, asAt, effectiveAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            getPropertyDefinitionAsync(domain, scope, code, asAt, effectiveAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPropertyDefinitionPropertyTimeSeriesCall(String domain, String scope, String code, String propertyKey, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getPropertyDefinitionPropertyTimeSeries. Use any specified configuration options to override any other configuration for this request only.
     * @param domain The domain of the property definition to which the property is attached. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the property definition to which the property is attached (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the property definition to which the property is attached (required). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKey The property key of the property whose history to show. This must be from the \&quot;Property Definition\&quot; domain and in the format              {domain}/{scope}/{code}, for example \&quot;PropertyDefinition/myScope/someAttributeKey\&quot;. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to show the history. Defaults to the current datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the results. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getPropertyDefinitionPropertyTimeSeriesCall(String domain, String scope, String code, String propertyKey, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/propertydefinitions/{domain}/{scope}/{code}/properties/time-series"
            .replace("{" + "domain" + "}", localVarApiClient.escapeString(domain.toString()))
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPropertyDefinitionPropertyTimeSeriesValidateBeforeCall(String domain, String scope, String code, String propertyKey, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'domain' is set
        if (domain == null) {
    ...
    private ApiResponse<ResourceListOfPropertyInterval> getPropertyDefinitionPropertyTimeSeriesWithHttpInfo(String domain, String scope, String code, String propertyKey, OffsetDateTime asAt, String filter, String page, Integer limit) throws ApiException {
        HttpRequest localVarCall = getPropertyDefinitionPropertyTimeSeriesValidateBeforeCall(domain, scope, code, propertyKey, asAt, filter, page, limit, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] GetPropertyDefinitionPropertyTimeSeries: Get Property Definition Property Time Series
     * List the complete time series of a property definition property.Use any specified configuration options to override any other configuration for this request only
     * @param domain The domain of the property definition to which the property is attached. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required)
     * @param scope The scope of the property definition to which the property is attached (required)
     * @param code The code of the property definition to which the property is attached (required)
     * @param propertyKey The property key of the property whose history to show. This must be from the \&quot;Property Definition\&quot; domain and in the format              {domain}/{scope}/{code}, for example \&quot;PropertyDefinition/myScope/someAttributeKey\&quot;. (required)
    ...
    private ApiResponse<ResourceListOfPropertyInterval> getPropertyDefinitionPropertyTimeSeriesWithHttpInfo(String domain, String scope, String code, String propertyKey, OffsetDateTime asAt, String filter, String page, Integer limit, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPropertyDefinitionPropertyTimeSeriesValidateBeforeCall(domain, scope, code, propertyKey, asAt, filter, page, limit, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyInterval>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getPropertyDefinitionPropertyTimeSeriesAsync(String domain, String scope, String code, String propertyKey, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback<ResourceListOfPropertyInterval> _callback) throws ApiException {

        HttpRequest localVarCall = getPropertyDefinitionPropertyTimeSeriesValidateBeforeCall(domain, scope, code, propertyKey, asAt, filter, page, limit, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyInterval>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPropertyDefinitionPropertyTimeSeriesAsync(String domain, String scope, String code, String propertyKey, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback<ResourceListOfPropertyInterval> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPropertyDefinitionPropertyTimeSeriesValidateBeforeCall(domain, scope, code, propertyKey, asAt, filter, page, limit, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyInterval>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPropertyDefinitionPropertyTimeSeriesRequest {
        ...
        public void executeAsync(final ApiCallback<ResourceListOfPropertyInterval> _callback) throws ApiException {
            getPropertyDefinitionPropertyTimeSeriesAsync(domain, scope, code, propertyKey, asAt, filter, page, limit, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<ResourceListOfPropertyInterval> _callback, ConfigurationOptions opts) throws ApiException {
            getPropertyDefinitionPropertyTimeSeriesAsync(domain, scope, code, propertyKey, asAt, filter, page, limit, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listPropertyDefinitionsCall(String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for listPropertyDefinitions. Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the property definitions. Defaults to the current LUSID              system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the property definitions. Defaults to returning the latest version              of each property definition if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;Property Definition&#39; domain to decorate onto              property definitions. These must take the format              {domain}/{scope}/{code} e.g \&quot;PropertyDefinition/myScope/someAttributeKey\&quot;. Each property must be from the \&quot;PropertyDefinition\&quot; domain. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing property definitions; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param filter Expression to filter the results.              For example, to filter on the display name, specify \&quot;DisplayName eq &#39;DisplayName&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot; (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listPropertyDefinitionsCall(String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/propertydefinitions/$list";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listPropertyDefinitionsValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfPropertyDefinition> listPropertyDefinitionsWithHttpInfo(String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, String page, Integer limit, String filter, List<String> sortBy) throws ApiException {
        HttpRequest localVarCall = listPropertyDefinitionsValidateBeforeCall(effectiveAt, asAt, propertyKeys, page, limit, filter, sortBy, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfPropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListPropertyDefinitions: List property definitions
     * List all the property definitions matching particular criteria.Use any specified configuration options to override any other configuration for this request only
     * @param effectiveAt The effective datetime or cut label at which to list the property definitions. Defaults to the current LUSID              system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the property definitions. Defaults to returning the latest version              of each property definition if not specified. (optional)
     * @param propertyKeys A list of property keys from the &#39;Property Definition&#39; domain to decorate onto              property definitions. These must take the format              {domain}/{scope}/{code} e.g \&quot;PropertyDefinition/myScope/someAttributeKey\&quot;. Each property must be from the \&quot;PropertyDefinition\&quot; domain. (optional)
     * @param page The pagination token to use to continue listing property definitions; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional)
    ...
    private ApiResponse<PagedResourceListOfPropertyDefinition> listPropertyDefinitionsWithHttpInfo(String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, String page, Integer limit, String filter, List<String> sortBy, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listPropertyDefinitionsValidateBeforeCall(effectiveAt, asAt, propertyKeys, page, limit, filter, sortBy, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfPropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListPropertyDefinitions: List property definitions (asynchronously)
     * List all the property definitions matching particular criteria.
     * @param effectiveAt The effective datetime or cut label at which to list the property definitions. Defaults to the current LUSID              system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the property definitions. Defaults to returning the latest version              of each property definition if not specified. (optional)
     * @param propertyKeys A list of property keys from the &#39;Property Definition&#39; domain to decorate onto              property definitions. These must take the format              {domain}/{scope}/{code} e.g \&quot;PropertyDefinition/myScope/someAttributeKey\&quot;. Each property must be from the \&quot;PropertyDefinition\&quot; domain. (optional)
     ...
     */
    private void listPropertyDefinitionsAsync(String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfPropertyDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = listPropertyDefinitionsValidateBeforeCall(effectiveAt, asAt, propertyKeys, page, limit, filter, sortBy, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfPropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listPropertyDefinitionsAsync(String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfPropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listPropertyDefinitionsValidateBeforeCall(effectiveAt, asAt, propertyKeys, page, limit, filter, sortBy, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfPropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistPropertyDefinitionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfPropertyDefinition> _callback) throws ApiException {
            listPropertyDefinitionsAsync(effectiveAt, asAt, propertyKeys, page, limit, filter, sortBy, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfPropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            listPropertyDefinitionsAsync(effectiveAt, asAt, propertyKeys, page, limit, filter, sortBy, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateDerivedPropertyDefinitionCall(String domain, String scope, String code, UpdateDerivedPropertyDefinitionRequest updateDerivedPropertyDefinitionRequest, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for updateDerivedPropertyDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param domain Domain of the property definition. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param scope Scope of the property definition (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code Code of the property definition (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateDerivedPropertyDefinitionRequest Information about the derived property definition being updated (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updateDerivedPropertyDefinitionCall(String domain, String scope, String code, UpdateDerivedPropertyDefinitionRequest updateDerivedPropertyDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/propertydefinitions/derived/{domain}/{scope}/{code}"
            .replace("{" + "domain" + "}", localVarApiClient.escapeString(domain.toString()))
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateDerivedPropertyDefinitionValidateBeforeCall(String domain, String scope, String code, UpdateDerivedPropertyDefinitionRequest updateDerivedPropertyDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'domain' is set
        if (domain == null) {
    ...
    private ApiResponse<PropertyDefinition> updateDerivedPropertyDefinitionWithHttpInfo(String domain, String scope, String code, UpdateDerivedPropertyDefinitionRequest updateDerivedPropertyDefinitionRequest) throws ApiException {
        HttpRequest localVarCall = updateDerivedPropertyDefinitionValidateBeforeCall(domain, scope, code, updateDerivedPropertyDefinitionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpdateDerivedPropertyDefinition: Update a pre-existing derived property definition
     * This will fail if the property definition does not existUse any specified configuration options to override any other configuration for this request only
     * @param domain Domain of the property definition. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required)
     * @param scope Scope of the property definition (required)
     * @param code Code of the property definition (required)
     * @param updateDerivedPropertyDefinitionRequest Information about the derived property definition being updated (required)
    ...
    private ApiResponse<PropertyDefinition> updateDerivedPropertyDefinitionWithHttpInfo(String domain, String scope, String code, UpdateDerivedPropertyDefinitionRequest updateDerivedPropertyDefinitionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateDerivedPropertyDefinitionValidateBeforeCall(domain, scope, code, updateDerivedPropertyDefinitionRequest, null, opts);
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void updateDerivedPropertyDefinitionAsync(String domain, String scope, String code, UpdateDerivedPropertyDefinitionRequest updateDerivedPropertyDefinitionRequest, final ApiCallback<PropertyDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = updateDerivedPropertyDefinitionValidateBeforeCall(domain, scope, code, updateDerivedPropertyDefinitionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateDerivedPropertyDefinitionAsync(String domain, String scope, String code, UpdateDerivedPropertyDefinitionRequest updateDerivedPropertyDefinitionRequest, final ApiCallback<PropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateDerivedPropertyDefinitionValidateBeforeCall(domain, scope, code, updateDerivedPropertyDefinitionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateDerivedPropertyDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PropertyDefinition> _callback) throws ApiException {
            updateDerivedPropertyDefinitionAsync(domain, scope, code, updateDerivedPropertyDefinitionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            updateDerivedPropertyDefinitionAsync(domain, scope, code, updateDerivedPropertyDefinitionRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updatePropertyDefinitionCall(String domain, String scope, String code, UpdatePropertyDefinitionRequest updatePropertyDefinitionRequest, final ApiCallback _callback) throws ApiException {
        return updatePropertyDefinitionCall(domain, scope, code, updatePropertyDefinitionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updatePropertyDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param domain The domain of the property being updated. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the property being updated. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the property being updated. Together with the domain and scope this uniquely              identifies the property. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updatePropertyDefinitionRequest The updated definition of the property. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updatePropertyDefinitionCall(String domain, String scope, String code, UpdatePropertyDefinitionRequest updatePropertyDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updatePropertyDefinitionValidateBeforeCall(String domain, String scope, String code, UpdatePropertyDefinitionRequest updatePropertyDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'domain' is set
        if (domain == null) {
    ...
    private ApiResponse<PropertyDefinition> updatePropertyDefinitionWithHttpInfo(String domain, String scope, String code, UpdatePropertyDefinitionRequest updatePropertyDefinitionRequest) throws ApiException {
        HttpRequest localVarCall = updatePropertyDefinitionValidateBeforeCall(domain, scope, code, updatePropertyDefinitionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * UpdatePropertyDefinition: Update property definition
     * Update the definition of a specified existing property. Not all elements within a property definition  are modifiable due to the potential implications for values already stored against the property.Use any specified configuration options to override any other configuration for this request only
     * @param domain The domain of the property being updated. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required)
     * @param scope The scope of the property being updated. (required)
     * @param code The code of the property being updated. Together with the domain and scope this uniquely              identifies the property. (required)
     * @param updatePropertyDefinitionRequest The updated definition of the property. (required)
    ...
    private ApiResponse<PropertyDefinition> updatePropertyDefinitionWithHttpInfo(String domain, String scope, String code, UpdatePropertyDefinitionRequest updatePropertyDefinitionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updatePropertyDefinitionValidateBeforeCall(domain, scope, code, updatePropertyDefinitionRequest, null, opts);
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void updatePropertyDefinitionAsync(String domain, String scope, String code, UpdatePropertyDefinitionRequest updatePropertyDefinitionRequest, final ApiCallback<PropertyDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = updatePropertyDefinitionValidateBeforeCall(domain, scope, code, updatePropertyDefinitionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updatePropertyDefinitionAsync(String domain, String scope, String code, UpdatePropertyDefinitionRequest updatePropertyDefinitionRequest, final ApiCallback<PropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updatePropertyDefinitionValidateBeforeCall(domain, scope, code, updatePropertyDefinitionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<PropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdatePropertyDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PropertyDefinition> _callback) throws ApiException {
            updatePropertyDefinitionAsync(domain, scope, code, updatePropertyDefinitionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PropertyDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            updatePropertyDefinitionAsync(domain, scope, code, updatePropertyDefinitionRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertPropertyDefinitionPropertiesCall(String domain, String scope, String code, Map<String, Property> requestBody, String successMode, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for upsertPropertyDefinitionProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param domain The domain of the specified property. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the specified property. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified property. Together with the domain and scope this uniquely (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The properties to be created or updated. Each property in              the request must be keyed by its unique property key. This has the format {domain}/{scope}/{code}, for example              &#39;PropertyDefinition/Manager/Id&#39;. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial. (optional, default to Partial)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertPropertyDefinitionPropertiesCall(String domain, String scope, String code, Map<String, Property> requestBody, String successMode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/propertydefinitions/{domain}/{scope}/{code}/properties"
            .replace("{" + "domain" + "}", localVarApiClient.escapeString(domain.toString()))
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertPropertyDefinitionPropertiesValidateBeforeCall(String domain, String scope, String code, Map<String, Property> requestBody, String successMode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'domain' is set
        if (domain == null) {
    ...
    private ApiResponse<BatchUpsertPropertyDefinitionPropertiesResponse> upsertPropertyDefinitionPropertiesWithHttpInfo(String domain, String scope, String code, Map<String, Property> requestBody, String successMode) throws ApiException {
        HttpRequest localVarCall = upsertPropertyDefinitionPropertiesValidateBeforeCall(domain, scope, code, requestBody, successMode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BatchUpsertPropertyDefinitionPropertiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpsertPropertyDefinitionProperties: Upsert properties to a property definition
     * Create or update properties for a particular property definitionUse any specified configuration options to override any other configuration for this request only
     * @param domain The domain of the specified property. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required)
     * @param scope The scope of the specified property. (required)
     * @param code The code of the specified property. Together with the domain and scope this uniquely (required)
     * @param requestBody The properties to be created or updated. Each property in              the request must be keyed by its unique property key. This has the format {domain}/{scope}/{code}, for example              &#39;PropertyDefinition/Manager/Id&#39;. (required)
    ...
    private ApiResponse<BatchUpsertPropertyDefinitionPropertiesResponse> upsertPropertyDefinitionPropertiesWithHttpInfo(String domain, String scope, String code, Map<String, Property> requestBody, String successMode, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertPropertyDefinitionPropertiesValidateBeforeCall(domain, scope, code, requestBody, successMode, null, opts);
        Type localVarReturnType = new TypeReference<BatchUpsertPropertyDefinitionPropertiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpsertPropertyDefinitionProperties: Upsert properties to a property definition (asynchronously)
     * Create or update properties for a particular property definition
     * @param domain The domain of the specified property. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, IdentifierDefinition, SettlementInstruction, TransactionFeeType. (required)
     * @param scope The scope of the specified property. (required)
     * @param code The code of the specified property. Together with the domain and scope this uniquely (required)
     ...
     */
    private void upsertPropertyDefinitionPropertiesAsync(String domain, String scope, String code, Map<String, Property> requestBody, String successMode, final ApiCallback<BatchUpsertPropertyDefinitionPropertiesResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertPropertyDefinitionPropertiesValidateBeforeCall(domain, scope, code, requestBody, successMode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BatchUpsertPropertyDefinitionPropertiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertPropertyDefinitionPropertiesAsync(String domain, String scope, String code, Map<String, Property> requestBody, String successMode, final ApiCallback<BatchUpsertPropertyDefinitionPropertiesResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertPropertyDefinitionPropertiesValidateBeforeCall(domain, scope, code, requestBody, successMode, _callback, opts);
        Type localVarReturnType = new TypeReference<BatchUpsertPropertyDefinitionPropertiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertPropertyDefinitionPropertiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<BatchUpsertPropertyDefinitionPropertiesResponse> _callback) throws ApiException {
            upsertPropertyDefinitionPropertiesAsync(domain, scope, code, requestBody, successMode, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<BatchUpsertPropertyDefinitionPropertiesResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertPropertyDefinitionPropertiesAsync(domain, scope, code, requestBody, successMode, _callback, opts);
        }
    }
