 ...
 */
@JsonPropertyOrder({
  FxForwardPipsCurveData.JSON_PROPERTY_BASE_DATE,
  FxForwardPipsCurveData.JSON_PROPERTY_DOM_CCY,
...
public class FxForwardPipsCurveData extends ComplexMarketData {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to FxForwardPipsCurveData
   */
  public static FxForwardPipsCurveData fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, FxForwardPipsCurveData.class);
  }
