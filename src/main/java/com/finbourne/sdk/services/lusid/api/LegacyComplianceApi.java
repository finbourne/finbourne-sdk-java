...
public class LegacyComplianceApi {
     ...
     */
    private HttpRequest deleteLegacyComplianceRuleCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteLegacyComplianceRuleCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteLegacyComplianceRule. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The compliance rule scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The compliance rule code. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteLegacyComplianceRuleCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/legacy/compliance/rules/{scope}/{code}"
    ...
    private HttpRequest deleteLegacyComplianceRuleValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteLegacyComplianceRuleWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteLegacyComplianceRuleValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EXPERIMENTAL] DeleteLegacyComplianceRule: Deletes a compliance rule.
     * Deletes the rule for all effective time.                The rule will remain viewable at previous as at times, and as part of the results of compliance runs, but it  will no longer be considered in new compliance runs.                This cannot be undone.Use any specified configuration options to override any other configuration for this request only
     * @param scope The compliance rule scope. (required)
     * @param code The compliance rule code. (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deleteLegacyComplianceRuleWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteLegacyComplianceRuleValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteLegacyComplianceRuleAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteLegacyComplianceRuleValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
     ...
     */
    private void deleteLegacyComplianceRuleAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteLegacyComplianceRuleValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteLegacyComplianceRuleRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteLegacyComplianceRuleAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteLegacyComplianceRuleAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getLegacyBreachedOrdersInfoCall(String runId, String orderScope, String orderCode, Integer limit, final ApiCallback _callback) throws ApiException {
        return getLegacyBreachedOrdersInfoCall(runId, orderScope, orderCode, limit,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getLegacyBreachedOrdersInfo. Use any specified configuration options to override any other configuration for this request only.
     * @param runId The RunId that the results should be checked for (required). Use any specified configuration options to override any other configuration for this request only.
     * @param orderScope Optional. Find rules related to a specific order by providing an Order Scope/Code combination (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param orderCode Optional. Find rules related to a specific order by providing an Order Scope/Code combination (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getLegacyBreachedOrdersInfoCall(String runId, String orderScope, String orderCode, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/legacy/compliance/runs/breached/{runId}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getLegacyBreachedOrdersInfoValidateBeforeCall(String runId, String orderScope, String orderCode, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfComplianceBreachedOrderInfo> getLegacyBreachedOrdersInfoWithHttpInfo(String runId, String orderScope, String orderCode, Integer limit) throws ApiException {
        HttpRequest localVarCall = getLegacyBreachedOrdersInfoValidateBeforeCall(runId, orderScope, orderCode, limit, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceBreachedOrderInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetLegacyBreachedOrdersInfo: Get the Ids of Breached orders in a given compliance run and the corresponding list of rules that could have caused it.
     * Use this endpoint to get a list or breached orders and the set of rules that may have caused the breach.Use any specified configuration options to override any other configuration for this request only
     * @param runId The RunId that the results should be checked for (required)
     * @param orderScope Optional. Find rules related to a specific order by providing an Order Scope/Code combination (optional)
     * @param orderCode Optional. Find rules related to a specific order by providing an Order Scope/Code combination (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
    ...
    private ApiResponse<ResourceListOfComplianceBreachedOrderInfo> getLegacyBreachedOrdersInfoWithHttpInfo(String runId, String orderScope, String orderCode, Integer limit, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getLegacyBreachedOrdersInfoValidateBeforeCall(runId, orderScope, orderCode, limit, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceBreachedOrderInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getLegacyBreachedOrdersInfoAsync(String runId, String orderScope, String orderCode, Integer limit, final ApiCallback<ResourceListOfComplianceBreachedOrderInfo> _callback) throws ApiException {

        HttpRequest localVarCall = getLegacyBreachedOrdersInfoValidateBeforeCall(runId, orderScope, orderCode, limit, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceBreachedOrderInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getLegacyBreachedOrdersInfoAsync(String runId, String orderScope, String orderCode, Integer limit, final ApiCallback<ResourceListOfComplianceBreachedOrderInfo> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getLegacyBreachedOrdersInfoValidateBeforeCall(runId, orderScope, orderCode, limit, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceBreachedOrderInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetLegacyBreachedOrdersInfoRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfComplianceBreachedOrderInfo> _callback) throws ApiException {
            getLegacyBreachedOrdersInfoAsync(runId, orderScope, orderCode, limit, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfComplianceBreachedOrderInfo> _callback, ConfigurationOptions opts) throws ApiException {
            getLegacyBreachedOrdersInfoAsync(runId, orderScope, orderCode, limit, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getLegacyComplianceRuleCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getLegacyComplianceRuleCall(scope, code, effectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getLegacyComplianceRule. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The compliance rule scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The compliance rule code. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getLegacyComplianceRuleCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getLegacyComplianceRuleValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ComplianceRule> getLegacyComplianceRuleWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getLegacyComplianceRuleValidateBeforeCall(scope, code, effectiveAt, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ComplianceRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetLegacyComplianceRule: Retrieve the definition of single compliance rule.
     * Retrieves the compliance rule definition at the given effective and as at times.Use any specified configuration options to override any other configuration for this request only
     * @param scope The compliance rule scope. (required)
     * @param code The compliance rule code. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve the rule definition. Defaults to the current LUSID  system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve the rule definition. Defaults to returning the latest version if not  specified. (optional)
    ...
    private ApiResponse<ComplianceRule> getLegacyComplianceRuleWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getLegacyComplianceRuleValidateBeforeCall(scope, code, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<ComplianceRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getLegacyComplianceRuleAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<ComplianceRule> _callback) throws ApiException {

        HttpRequest localVarCall = getLegacyComplianceRuleValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ComplianceRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getLegacyComplianceRuleAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<ComplianceRule> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getLegacyComplianceRuleValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ComplianceRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetLegacyComplianceRuleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ComplianceRule> _callback) throws ApiException {
            getLegacyComplianceRuleAsync(scope, code, effectiveAt, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ComplianceRule> _callback, ConfigurationOptions opts) throws ApiException {
            getLegacyComplianceRuleAsync(scope, code, effectiveAt, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getLegacyComplianceRunResultsCall(String runId, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        return getLegacyComplianceRunResultsCall(runId, page, limit, filter,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getLegacyComplianceRunResults. Use any specified configuration options to override any other configuration for this request only.
     * @param runId The unique identifier of the compliance run requested. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getLegacyComplianceRunResultsCall(String runId, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/legacy/compliance/runs/{runId}"
            .replace("{" + "runId" + "}", localVarApiClient.escapeString(runId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getLegacyComplianceRunResultsValidateBeforeCall(String runId, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'runId' is set
        if (runId == null) {
    ...
    private ApiResponse<ResourceListOfComplianceRuleResult> getLegacyComplianceRunResultsWithHttpInfo(String runId, String page, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = getLegacyComplianceRunResultsValidateBeforeCall(runId, page, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRuleResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetLegacyComplianceRunResults: Get the details of a single compliance run.
     * Use this endpoint to fetch the detail associated with a specific compliance run, including a breakdown  of the passing state of each rule, portfolio combination.Use any specified configuration options to override any other configuration for this request only
     * @param runId The unique identifier of the compliance run requested. (required)
     * @param page The pagination token to use to continue listing compliance rule results from a previous call to list compliance rule result.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    private ApiResponse<ResourceListOfComplianceRuleResult> getLegacyComplianceRunResultsWithHttpInfo(String runId, String page, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getLegacyComplianceRunResultsValidateBeforeCall(runId, page, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRuleResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getLegacyComplianceRunResultsAsync(String runId, String page, Integer limit, String filter, final ApiCallback<ResourceListOfComplianceRuleResult> _callback) throws ApiException {

        HttpRequest localVarCall = getLegacyComplianceRunResultsValidateBeforeCall(runId, page, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRuleResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getLegacyComplianceRunResultsAsync(String runId, String page, Integer limit, String filter, final ApiCallback<ResourceListOfComplianceRuleResult> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getLegacyComplianceRunResultsValidateBeforeCall(runId, page, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRuleResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetLegacyComplianceRunResultsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfComplianceRuleResult> _callback) throws ApiException {
            getLegacyComplianceRunResultsAsync(runId, page, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfComplianceRuleResult> _callback, ConfigurationOptions opts) throws ApiException {
            getLegacyComplianceRunResultsAsync(runId, page, limit, filter, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listLegacyComplianceRulesCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        return listLegacyComplianceRulesCall(effectiveAt, asAt, page, limit, filter,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listLegacyComplianceRules. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listLegacyComplianceRulesCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/legacy/compliance/rules";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listLegacyComplianceRulesValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfComplianceRule> listLegacyComplianceRulesWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = listLegacyComplianceRulesValidateBeforeCall(effectiveAt, asAt, page, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListOfComplianceRule> listLegacyComplianceRulesWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listLegacyComplianceRulesValidateBeforeCall(effectiveAt, asAt, page, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listLegacyComplianceRulesAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<ResourceListOfComplianceRule> _callback) throws ApiException {

        HttpRequest localVarCall = listLegacyComplianceRulesValidateBeforeCall(effectiveAt, asAt, page, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listLegacyComplianceRulesAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<ResourceListOfComplianceRule> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listLegacyComplianceRulesValidateBeforeCall(effectiveAt, asAt, page, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistLegacyComplianceRulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfComplianceRule> _callback) throws ApiException {
            listLegacyComplianceRulesAsync(effectiveAt, asAt, page, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfComplianceRule> _callback, ConfigurationOptions opts) throws ApiException {
            listLegacyComplianceRulesAsync(effectiveAt, asAt, page, limit, filter, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listLegacyComplianceRunInfoCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        return listLegacyComplianceRunInfoCall(asAt, page, limit, filter,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listLegacyComplianceRunInfo. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listLegacyComplianceRunInfoCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/legacy/compliance/runs";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listLegacyComplianceRunInfoValidateBeforeCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfComplianceRunInfo> listLegacyComplianceRunInfoWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = listLegacyComplianceRunInfoValidateBeforeCall(asAt, page, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRunInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListLegacyComplianceRunInfo: List historical compliance run ids.
     * Use this endpoint to fetch a list of all historical compliance runs.Use any specified configuration options to override any other configuration for this request only
     * @param asAt Optional. The time at which to get results from. Default : latest (optional)
     * @param page The pagination token to use to continue listing compliance runs from a previous call to list compliance runs.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    private ApiResponse<ResourceListOfComplianceRunInfo> listLegacyComplianceRunInfoWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listLegacyComplianceRunInfoValidateBeforeCall(asAt, page, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRunInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listLegacyComplianceRunInfoAsync(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<ResourceListOfComplianceRunInfo> _callback) throws ApiException {

        HttpRequest localVarCall = listLegacyComplianceRunInfoValidateBeforeCall(asAt, page, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRunInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listLegacyComplianceRunInfoAsync(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<ResourceListOfComplianceRunInfo> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listLegacyComplianceRunInfoValidateBeforeCall(asAt, page, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfComplianceRunInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistLegacyComplianceRunInfoRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfComplianceRunInfo> _callback) throws ApiException {
            listLegacyComplianceRunInfoAsync(asAt, page, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfComplianceRunInfo> _callback, ConfigurationOptions opts) throws ApiException {
            listLegacyComplianceRunInfoAsync(asAt, page, limit, filter, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest runLegacyComplianceCall(Boolean isPreTrade, String recipeIdScope, String recipeIdCode, Boolean byTaxlots, final ApiCallback _callback) throws ApiException {
        return runLegacyComplianceCall(isPreTrade, recipeIdScope, recipeIdCode, byTaxlots,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for runLegacyCompliance. Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param recipeIdCode Optional: The code of the recipe to be used. If left blank, the default recipe will be used. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param byTaxlots Optional. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest runLegacyComplianceCall(Boolean isPreTrade, String recipeIdScope, String recipeIdCode, Boolean byTaxlots, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest runLegacyComplianceValidateBeforeCall(Boolean isPreTrade, String recipeIdScope, String recipeIdCode, Boolean byTaxlots, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ComplianceRunInfo> runLegacyComplianceWithHttpInfo(Boolean isPreTrade, String recipeIdScope, String recipeIdCode, Boolean byTaxlots) throws ApiException {
        HttpRequest localVarCall = runLegacyComplianceValidateBeforeCall(isPreTrade, recipeIdScope, recipeIdCode, byTaxlots, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ComplianceRunInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] RunLegacyCompliance: Kick off the compliance check process
     * Use this endpoint to fetch the start a compliance run, based on a pre-set mapping file.Use any specified configuration options to override any other configuration for this request only
     * @param isPreTrade Required: Boolean flag indicating if a run should be PreTrade (Including orders). For post-trade only, set to false (required)
     * @param recipeIdScope Required: the scope of the recipe to be used (required)
     * @param recipeIdCode Optional: The code of the recipe to be used. If left blank, the default recipe will be used. (optional)
     * @param byTaxlots Optional. (optional)
    ...
    private ApiResponse<ComplianceRunInfo> runLegacyComplianceWithHttpInfo(Boolean isPreTrade, String recipeIdScope, String recipeIdCode, Boolean byTaxlots, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = runLegacyComplianceValidateBeforeCall(isPreTrade, recipeIdScope, recipeIdCode, byTaxlots, null, opts);
        Type localVarReturnType = new TypeReference<ComplianceRunInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void runLegacyComplianceAsync(Boolean isPreTrade, String recipeIdScope, String recipeIdCode, Boolean byTaxlots, final ApiCallback<ComplianceRunInfo> _callback) throws ApiException {

        HttpRequest localVarCall = runLegacyComplianceValidateBeforeCall(isPreTrade, recipeIdScope, recipeIdCode, byTaxlots, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ComplianceRunInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void runLegacyComplianceAsync(Boolean isPreTrade, String recipeIdScope, String recipeIdCode, Boolean byTaxlots, final ApiCallback<ComplianceRunInfo> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = runLegacyComplianceValidateBeforeCall(isPreTrade, recipeIdScope, recipeIdCode, byTaxlots, _callback, opts);
        Type localVarReturnType = new TypeReference<ComplianceRunInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIrunLegacyComplianceRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ComplianceRunInfo> _callback) throws ApiException {
            runLegacyComplianceAsync(isPreTrade, recipeIdScope, recipeIdCode, byTaxlots, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ComplianceRunInfo> _callback, ConfigurationOptions opts) throws ApiException {
            runLegacyComplianceAsync(isPreTrade, recipeIdScope, recipeIdCode, byTaxlots, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertLegacyComplianceRulesCall(Map<String, ComplianceRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback _callback) throws ApiException {
        return upsertLegacyComplianceRulesCall(requestBody, effectiveAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertLegacyComplianceRules. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody A dictionary of upsert request identifiers to rule upsert requests. The request               identifiers are valid for the request only and can be used to link the upserted compliance rule to the code               of a created compliance rule. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which the rule will take effect. Defaults to the current LUSID  system datetime if not specified. In the case of an update, the changes will take place from this effective  time until the next effective time that the rule as been upserted at. For example, consider a rule that  already exists, and has previously had an update applied so that the definition will change on the first day  of the coming month. An upsert effective from the current day will only change the definition until the  first day of the coming month. An additional upsert at the same time (first day of the month) is required  if the newly-updated definition is to supersede the future definition. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertLegacyComplianceRulesCall(Map<String, ComplianceRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertLegacyComplianceRulesValidateBeforeCall(Map<String, ComplianceRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ComplianceRuleUpsertResponse> upsertLegacyComplianceRulesWithHttpInfo(Map<String, ComplianceRuleUpsertRequest> requestBody, String effectiveAt) throws ApiException {
        HttpRequest localVarCall = upsertLegacyComplianceRulesValidateBeforeCall(requestBody, effectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ComplianceRuleUpsertResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] UpsertLegacyComplianceRules: Upsert compliance rules.
     * To upsert a new rule, the code field must be left empty, a code will then be assigned and returned as part  of the response. To update an existing rule, include the rule code. It is possible to both create and update  compliance rules in the same request.                The upsert is transactional - either all create/update operations will succeed or none of them will.Use any specified configuration options to override any other configuration for this request only
     * @param requestBody A dictionary of upsert request identifiers to rule upsert requests. The request               identifiers are valid for the request only and can be used to link the upserted compliance rule to the code               of a created compliance rule. (required)
     * @param effectiveAt The effective datetime or cut label at which the rule will take effect. Defaults to the current LUSID  system datetime if not specified. In the case of an update, the changes will take place from this effective  time until the next effective time that the rule as been upserted at. For example, consider a rule that  already exists, and has previously had an update applied so that the definition will change on the first day  of the coming month. An upsert effective from the current day will only change the definition until the  first day of the coming month. An additional upsert at the same time (first day of the month) is required  if the newly-updated definition is to supersede the future definition. (optional)
     * @return ApiResponse&lt;ComplianceRuleUpsertResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<ComplianceRuleUpsertResponse> upsertLegacyComplianceRulesWithHttpInfo(Map<String, ComplianceRuleUpsertRequest> requestBody, String effectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertLegacyComplianceRulesValidateBeforeCall(requestBody, effectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<ComplianceRuleUpsertResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertLegacyComplianceRulesAsync(Map<String, ComplianceRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback<ComplianceRuleUpsertResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertLegacyComplianceRulesValidateBeforeCall(requestBody, effectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ComplianceRuleUpsertResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertLegacyComplianceRulesAsync(Map<String, ComplianceRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback<ComplianceRuleUpsertResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertLegacyComplianceRulesValidateBeforeCall(requestBody, effectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ComplianceRuleUpsertResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertLegacyComplianceRulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ComplianceRuleUpsertResponse> _callback) throws ApiException {
            upsertLegacyComplianceRulesAsync(requestBody, effectiveAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ComplianceRuleUpsertResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertLegacyComplianceRulesAsync(requestBody, effectiveAt, _callback, opts);
        }
    }
