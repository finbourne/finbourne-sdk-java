 ...
 */
@JsonPropertyOrder({
  CreateTransactionPortfolioRequest.JSON_PROPERTY_DISPLAY_NAME,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_DESCRIPTION,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_CODE,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_CREATED,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_ENABLEMENT_DATE,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_BASE_CURRENCY,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_CORPORATE_ACTION_SOURCE_ID,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_ACCOUNTING_METHOD,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_SUB_HOLDING_KEYS,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_PROPERTIES,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_INSTRUMENT_SCOPES,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_AMORTISATION_METHOD,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_TRANSACTION_TYPE_SCOPE,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_CASH_GAIN_LOSS_CALCULATION_DATE,
  CreateTransactionPortfolioRequest.JSON_PROPERTY_INSTRUMENT_EVENT_CONFIGURATION,
...
public class CreateTransactionPortfolioRequest {
  ...
  public CreateTransactionPortfolioRequest taxRuleSetScope(String taxRuleSetScope) {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to CreateTransactionPortfolioRequest
   */
  public static CreateTransactionPortfolioRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, CreateTransactionPortfolioRequest.class);
  }
