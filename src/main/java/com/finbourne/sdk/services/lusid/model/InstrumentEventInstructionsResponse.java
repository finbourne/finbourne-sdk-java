 ...
 */
@JsonPropertyOrder({
  InstrumentEventInstructionsResponse.JSON_PROPERTY_VALUES,
  InstrumentEventInstructionsResponse.JSON_PROPERTY_FAILED
})
...
public class InstrumentEventInstructionsResponse {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to InstrumentEventInstructionsResponse
   */
  public static InstrumentEventInstructionsResponse fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, InstrumentEventInstructionsResponse.class);
  }
