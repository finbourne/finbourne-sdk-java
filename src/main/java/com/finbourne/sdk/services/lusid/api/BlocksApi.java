...
public class BlocksApi {
     ...
     */
    private HttpRequest deleteBlockCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteBlockCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteBlock. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The block scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The block&#39;s code. This, together with the scope uniquely identifies the block to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteBlockCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/blocks/{scope}/{code}"
    ...
    private HttpRequest deleteBlockValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteBlockWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteBlockValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] DeleteBlock: Delete block
     * Delete an block. Deletion will be valid from the block&#39;s creation datetime.  This means that the block will no longer exist at any effective datetime from the asAt datetime of deletion.Use any specified configuration options to override any other configuration for this request only
     * @param scope The block scope. (required)
     * @param code The block&#39;s code. This, together with the scope uniquely identifies the block to delete. (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deleteBlockWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteBlockValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteBlockAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteBlockValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
     ...
     */
    private void deleteBlockAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteBlockValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteBlockRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteBlockAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteBlockAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getBlockCall(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return getBlockCall(scope, code, asAt, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getBlock. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope to which the block belongs. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The block&#39;s unique identifier. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the block. Defaults to return the latest version of the block if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the \&quot;Block\&quot; domain to decorate onto the block.              These take the format {domain}/{scope}/{code} e.g. \&quot;Block/system/Name\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getBlockCall(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getBlockValidateBeforeCall(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Block> getBlockWithHttpInfo(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = getBlockValidateBeforeCall(scope, code, asAt, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Block>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetBlock: Get Block
     * Fetch a Block that matches the specified identifierUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope to which the block belongs. (required)
     * @param code The block&#39;s unique identifier. (required)
     * @param asAt The asAt datetime at which to retrieve the block. Defaults to return the latest version of the block if not specified. (optional)
     * @param propertyKeys A list of property keys from the \&quot;Block\&quot; domain to decorate onto the block.              These take the format {domain}/{scope}/{code} e.g. \&quot;Block/system/Name\&quot;. (optional)
    ...
    private ApiResponse<Block> getBlockWithHttpInfo(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getBlockValidateBeforeCall(scope, code, asAt, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<Block>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getBlockAsync(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Block> _callback) throws ApiException {

        HttpRequest localVarCall = getBlockValidateBeforeCall(scope, code, asAt, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Block>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getBlockAsync(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Block> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getBlockValidateBeforeCall(scope, code, asAt, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<Block>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetBlockRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Block> _callback) throws ApiException {
            getBlockAsync(scope, code, asAt, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Block> _callback, ConfigurationOptions opts) throws ApiException {
            getBlockAsync(scope, code, asAt, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listBlocksCall(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return listBlocksCall(asAt, page, sortBy, limit, filter, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listBlocks. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the block. Defaults to return the latest version of the block if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing blocks from a previous call to list blocks.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listBlocksCall(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/blocks";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listBlocksValidateBeforeCall(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfBlock> listBlocksWithHttpInfo(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = listBlocksValidateBeforeCall(asAt, page, sortBy, limit, filter, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfBlock>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListBlocks: List Blocks
     * Fetch the last pre-AsAt date version of each block in scope (does not fetch the entire history).Use any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to retrieve the block. Defaults to return the latest version of the block if not specified. (optional)
     * @param page The pagination token to use to continue listing blocks from a previous call to list blocks.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request. (optional)
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
    ...
    private ApiResponse<PagedResourceListOfBlock> listBlocksWithHttpInfo(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listBlocksValidateBeforeCall(asAt, page, sortBy, limit, filter, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfBlock>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listBlocksAsync(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfBlock> _callback) throws ApiException {

        HttpRequest localVarCall = listBlocksValidateBeforeCall(asAt, page, sortBy, limit, filter, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfBlock>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listBlocksAsync(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfBlock> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listBlocksValidateBeforeCall(asAt, page, sortBy, limit, filter, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfBlock>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistBlocksRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfBlock> _callback) throws ApiException {
            listBlocksAsync(asAt, page, sortBy, limit, filter, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfBlock> _callback, ConfigurationOptions opts) throws ApiException {
            listBlocksAsync(asAt, page, sortBy, limit, filter, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertBlocksCall(BlockSetRequest blockSetRequest, final ApiCallback _callback) throws ApiException {
        return upsertBlocksCall(blockSetRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertBlocks. Use any specified configuration options to override any other configuration for this request only.
     * @param blockSetRequest The collection of block requests. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertBlocksCall(BlockSetRequest blockSetRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertBlocksValidateBeforeCall(BlockSetRequest blockSetRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfBlock> upsertBlocksWithHttpInfo(BlockSetRequest blockSetRequest) throws ApiException {
        HttpRequest localVarCall = upsertBlocksValidateBeforeCall(blockSetRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfBlock>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpsertBlocks: Upsert Block
     * Upsert; update existing blocks with given ids, or create new blocks otherwise.Use any specified configuration options to override any other configuration for this request only
     * @param blockSetRequest The collection of block requests. (optional)
     * @return ApiResponse&lt;ResourceListOfBlock&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfBlock> upsertBlocksWithHttpInfo(BlockSetRequest blockSetRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertBlocksValidateBeforeCall(blockSetRequest, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfBlock>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertBlocksAsync(BlockSetRequest blockSetRequest, final ApiCallback<ResourceListOfBlock> _callback) throws ApiException {

        HttpRequest localVarCall = upsertBlocksValidateBeforeCall(blockSetRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfBlock>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertBlocksAsync(BlockSetRequest blockSetRequest, final ApiCallback<ResourceListOfBlock> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertBlocksValidateBeforeCall(blockSetRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfBlock>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertBlocksRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfBlock> _callback) throws ApiException {
            upsertBlocksAsync(blockSetRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfBlock> _callback, ConfigurationOptions opts) throws ApiException {
            upsertBlocksAsync(blockSetRequest, _callback, opts);
        }
    }
