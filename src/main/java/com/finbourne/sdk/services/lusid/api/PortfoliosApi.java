...
public class PortfoliosApi {
     ...
     */
    private HttpRequest batchUpsertPortfolioAccessMetadataCall(Map<String, BatchUpsertPortfolioAccessMetadataRequest> requestBody, String effectiveAt, String effectiveUntil, final ApiCallback _callback) throws ApiException {
        return batchUpsertPortfolioAccessMetadataCall(requestBody, effectiveAt, effectiveUntil,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for batchUpsertPortfolioAccessMetadata. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The Access Metadata Rules to upsert and the Portfolio identifiers to upsert for (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The date these rules will be effective from (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveUntil The effective date until which the Access Metadata is valid. If not supplied, this will be valid indefinitely, or until the next &#39;effectiveAt&#39; date of the Access Metadata (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest batchUpsertPortfolioAccessMetadataCall(Map<String, BatchUpsertPortfolioAccessMetadataRequest> requestBody, String effectiveAt, String effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/portfolios/metadata";
    ...
    private HttpRequest batchUpsertPortfolioAccessMetadataValidateBeforeCall(Map<String, BatchUpsertPortfolioAccessMetadataRequest> requestBody, String effectiveAt, String effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<BatchUpsertPortfolioAccessMetadataResponse> batchUpsertPortfolioAccessMetadataWithHttpInfo(Map<String, BatchUpsertPortfolioAccessMetadataRequest> requestBody, String effectiveAt, String effectiveUntil) throws ApiException {
        HttpRequest localVarCall = batchUpsertPortfolioAccessMetadataValidateBeforeCall(requestBody, effectiveAt, effectiveUntil, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BatchUpsertPortfolioAccessMetadataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] BatchUpsertPortfolioAccessMetadata: Upsert multiple Portfolio Access Metadata Rules to multiple Portfolios
     * Update or insert multiple Access Metadata rules for multiple Portfolios. Items will be updated if they already exist  and inserted if they do not. No other items will be affected    The response will return the successfully updated or inserted Portfolio Access Metadata Rules or a failure message if unsuccessful                Multiple rules for a metadataKey can exist with different effective at dates, when resources are accessed the rule that is active for the current time will be fetchedUse any specified configuration options to override any other configuration for this request only
     * @param requestBody The Access Metadata Rules to upsert and the Portfolio identifiers to upsert for (required)
     * @param effectiveAt The date these rules will be effective from (optional)
     * @param effectiveUntil The effective date until which the Access Metadata is valid. If not supplied, this will be valid indefinitely, or until the next &#39;effectiveAt&#39; date of the Access Metadata (optional)
     * @return ApiResponse&lt;BatchUpsertPortfolioAccessMetadataResponse&gt;
    ...
    private ApiResponse<BatchUpsertPortfolioAccessMetadataResponse> batchUpsertPortfolioAccessMetadataWithHttpInfo(Map<String, BatchUpsertPortfolioAccessMetadataRequest> requestBody, String effectiveAt, String effectiveUntil, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = batchUpsertPortfolioAccessMetadataValidateBeforeCall(requestBody, effectiveAt, effectiveUntil, null, opts);
        Type localVarReturnType = new TypeReference<BatchUpsertPortfolioAccessMetadataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] BatchUpsertPortfolioAccessMetadata: Upsert multiple Portfolio Access Metadata Rules to multiple Portfolios (asynchronously)
     * Update or insert multiple Access Metadata rules for multiple Portfolios. Items will be updated if they already exist  and inserted if they do not. No other items will be affected    The response will return the successfully updated or inserted Portfolio Access Metadata Rules or a failure message if unsuccessful                Multiple rules for a metadataKey can exist with different effective at dates, when resources are accessed the rule that is active for the current time will be fetched
     * @param requestBody The Access Metadata Rules to upsert and the Portfolio identifiers to upsert for (required)
     * @param effectiveAt The date these rules will be effective from (optional)
     * @param effectiveUntil The effective date until which the Access Metadata is valid. If not supplied, this will be valid indefinitely, or until the next &#39;effectiveAt&#39; date of the Access Metadata (optional)
     ...
     */
    private void batchUpsertPortfolioAccessMetadataAsync(Map<String, BatchUpsertPortfolioAccessMetadataRequest> requestBody, String effectiveAt, String effectiveUntil, final ApiCallback<BatchUpsertPortfolioAccessMetadataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = batchUpsertPortfolioAccessMetadataValidateBeforeCall(requestBody, effectiveAt, effectiveUntil, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BatchUpsertPortfolioAccessMetadataResponse>(){}.getType();
     ...
     */
    private void batchUpsertPortfolioAccessMetadataAsync(Map<String, BatchUpsertPortfolioAccessMetadataRequest> requestBody, String effectiveAt, String effectiveUntil, final ApiCallback<BatchUpsertPortfolioAccessMetadataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = batchUpsertPortfolioAccessMetadataValidateBeforeCall(requestBody, effectiveAt, effectiveUntil, _callback, opts);
        Type localVarReturnType = new TypeReference<BatchUpsertPortfolioAccessMetadataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIbatchUpsertPortfolioAccessMetadataRequest {
         ...
         */
        public void executeAsync(final ApiCallback<BatchUpsertPortfolioAccessMetadataResponse> _callback) throws ApiException {
            batchUpsertPortfolioAccessMetadataAsync(requestBody, effectiveAt, effectiveUntil, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<BatchUpsertPortfolioAccessMetadataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            batchUpsertPortfolioAccessMetadataAsync(requestBody, effectiveAt, effectiveUntil, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteInstrumentEventInstructionCall(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for deleteInstrumentEventInstruction. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param instrumentEventInstructionId The id of the instruction to be deleted. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param portfolioEffectiveAt The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteInstrumentEventInstructionCall(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/instrumenteventinstructions/{instrumentEventInstructionId}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteInstrumentEventInstructionValidateBeforeCall(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteInstrumentEventInstructionWithHttpInfo(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt) throws ApiException {
        HttpRequest localVarCall = deleteInstrumentEventInstructionValidateBeforeCall(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] DeleteInstrumentEventInstruction: Delete Instrument Event Instruction
     * Delete a particular instruction for a particular portfolioUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param instrumentEventInstructionId The id of the instruction to be deleted. (required)
     * @param portfolioEffectiveAt The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional)
    ...
    private ApiResponse<DeletedEntityResponse> deleteInstrumentEventInstructionWithHttpInfo(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteInstrumentEventInstructionValidateBeforeCall(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] DeleteInstrumentEventInstruction: Delete Instrument Event Instruction (asynchronously)
     * Delete a particular instruction for a particular portfolio
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param instrumentEventInstructionId The id of the instruction to be deleted. (required)
     ...
     */
    private void deleteInstrumentEventInstructionAsync(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteInstrumentEventInstructionValidateBeforeCall(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteInstrumentEventInstructionAsync(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteInstrumentEventInstructionValidateBeforeCall(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteInstrumentEventInstructionRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteInstrumentEventInstructionAsync(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteInstrumentEventInstructionAsync(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteKeyFromPortfolioAccessMetadataCall(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for deleteKeyFromPortfolioAccessMetadata. Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param code Portfolio code (required). Use any specified configuration options to override any other configuration for this request only.
     * @param metadataKey The metadataKey identifying the access metadata entry to delete (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest deleteKeyFromPortfolioAccessMetadataCall(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/metadata/{metadataKey}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteKeyFromPortfolioAccessMetadataValidateBeforeCall(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteKeyFromPortfolioAccessMetadataWithHttpInfo(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime effectiveUntil) throws ApiException {
        HttpRequest localVarCall = deleteKeyFromPortfolioAccessMetadataValidateBeforeCall(scope, code, metadataKey, effectiveAt, effectiveUntil, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * DeleteKeyFromPortfolioAccessMetadata: Delete a Portfolio Access Metadata Rule
     * Delete the Portfolio Access Metadata Rule that exactly matches the provided identifier partsUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Quote Access Metadata Rule to retrieve. (required)
     * @param code Portfolio code (required)
     * @param metadataKey The metadataKey identifying the access metadata entry to delete (required)
     * @param effectiveAt The effective date to delete at, if this is not supplied, it will delete all data found (optional)
    ...
    private ApiResponse<DeletedEntityResponse> deleteKeyFromPortfolioAccessMetadataWithHttpInfo(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime effectiveUntil, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteKeyFromPortfolioAccessMetadataValidateBeforeCall(scope, code, metadataKey, effectiveAt, effectiveUntil, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * DeleteKeyFromPortfolioAccessMetadata: Delete a Portfolio Access Metadata Rule (asynchronously)
     * Delete the Portfolio Access Metadata Rule that exactly matches the provided identifier parts
     * @param scope The scope of the Quote Access Metadata Rule to retrieve. (required)
     * @param code Portfolio code (required)
     * @param metadataKey The metadataKey identifying the access metadata entry to delete (required)
     ...
     */
    private void deleteKeyFromPortfolioAccessMetadataAsync(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteKeyFromPortfolioAccessMetadataValidateBeforeCall(scope, code, metadataKey, effectiveAt, effectiveUntil, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteKeyFromPortfolioAccessMetadataAsync(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteKeyFromPortfolioAccessMetadataValidateBeforeCall(scope, code, metadataKey, effectiveAt, effectiveUntil, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteKeyFromPortfolioAccessMetadataRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteKeyFromPortfolioAccessMetadataAsync(scope, code, metadataKey, effectiveAt, effectiveUntil, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteKeyFromPortfolioAccessMetadataAsync(scope, code, metadataKey, effectiveAt, effectiveUntil, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deletePortfolioCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deletePortfolioCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deletePortfolio. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest deletePortfolioCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deletePortfolioValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deletePortfolioWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deletePortfolioValidateBeforeCall(scope, code, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * DeletePortfolio: Delete portfolio
     * Delete a particular portfolio.                The deletion will take effect from the portfolio&#39;s creation datetime. This means that the portfolio will no longer exist at any effective datetime, as per the asAt datetime of deletion.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deletePortfolioWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deletePortfolioValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deletePortfolioAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deletePortfolioValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deletePortfolioAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deletePortfolioValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeletePortfolioRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deletePortfolioAsync(scope, code, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deletePortfolioAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deletePortfolioPropertiesCall(String scope, String code, List<String> propertyKeys, String effectiveAt, final ApiCallback _callback) throws ApiException {
        return deletePortfolioPropertiesCall(scope, code, propertyKeys, effectiveAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deletePortfolioProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys The property keys of the properties to delete. These must take the format              {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. Each property must be from the &#39;Portfolio&#39; domain. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to delete time-variant properties from.              The property must exist at the specified &#39;effectiveAt&#39; datetime. If the &#39;effectiveAt&#39; is not provided or is              before the time-variant property exists then a failure is returned. Do not specify this parameter if any of              the properties to delete are perpetual. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deletePortfolioPropertiesCall(String scope, String code, List<String> propertyKeys, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/properties"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deletePortfolioPropertiesValidateBeforeCall(String scope, String code, List<String> propertyKeys, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deletePortfolioPropertiesWithHttpInfo(String scope, String code, List<String> propertyKeys, String effectiveAt) throws ApiException {
        HttpRequest localVarCall = deletePortfolioPropertiesValidateBeforeCall(scope, code, propertyKeys, effectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * DeletePortfolioProperties: Delete portfolio properties
     * Delete one or more properties from a particular portfolio. If the properties are time-variant then an effective datetime from which  to delete properties must be specified. If the properties are perpetual then it is invalid to specify an effective datetime for deletion.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param propertyKeys The property keys of the properties to delete. These must take the format              {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. Each property must be from the &#39;Portfolio&#39; domain. (required)
     * @param effectiveAt The effective datetime or cut label at which to delete time-variant properties from.              The property must exist at the specified &#39;effectiveAt&#39; datetime. If the &#39;effectiveAt&#39; is not provided or is              before the time-variant property exists then a failure is returned. Do not specify this parameter if any of              the properties to delete are perpetual. (optional)
    ...
    private ApiResponse<DeletedEntityResponse> deletePortfolioPropertiesWithHttpInfo(String scope, String code, List<String> propertyKeys, String effectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deletePortfolioPropertiesValidateBeforeCall(scope, code, propertyKeys, effectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deletePortfolioPropertiesAsync(String scope, String code, List<String> propertyKeys, String effectiveAt, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deletePortfolioPropertiesValidateBeforeCall(scope, code, propertyKeys, effectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deletePortfolioPropertiesAsync(String scope, String code, List<String> propertyKeys, String effectiveAt, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deletePortfolioPropertiesValidateBeforeCall(scope, code, propertyKeys, effectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeletePortfolioPropertiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deletePortfolioPropertiesAsync(scope, code, propertyKeys, effectiveAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deletePortfolioPropertiesAsync(scope, code, propertyKeys, effectiveAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deletePortfolioReturnsCall(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for deletePortfolioReturns. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the  Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param returnScope The scope of the Returns. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param returnCode The code of the Returns. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param fromEffectiveAt The start date from which to delete the Returns. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param toEffectiveAt The end date from which to delete the Returns. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param period The period of the Returns to be deleted. Default value: Daily. Available values: Daily, Monthly. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deletePortfolioReturnsCall(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/returns/{returnScope}/{returnCode}/$delete"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deletePortfolioReturnsValidateBeforeCall(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deletePortfolioReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period) throws ApiException {
        HttpRequest localVarCall = deletePortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] DeletePortfolioReturns: Delete Returns
     * Cancel one or more Returns which exist into the specified portfolio.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param returnScope The scope of the Returns. (required)
     * @param returnCode The code of the Returns. (required)
    ...
    private ApiResponse<DeletedEntityResponse> deletePortfolioReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deletePortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deletePortfolioReturnsAsync(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deletePortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deletePortfolioReturnsAsync(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deletePortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeletePortfolioReturnsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deletePortfolioReturnsAsync(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deletePortfolioReturnsAsync(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getAggregatedReturnsDispersionMetricsCall(String scope, String code, AggregatedReturnsDispersionRequest aggregatedReturnsDispersionRequest, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getAggregatedReturnsDispersionMetrics. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the  Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param aggregatedReturnsDispersionRequest The request used in the AggregatedReturnsDispersionMetric. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Returns. Defaults to the latest. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getAggregatedReturnsDispersionMetricsCall(String scope, String code, AggregatedReturnsDispersionRequest aggregatedReturnsDispersionRequest, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/returns/dispersion/$aggregated"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getAggregatedReturnsDispersionMetricsValidateBeforeCall(String scope, String code, AggregatedReturnsDispersionRequest aggregatedReturnsDispersionRequest, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CompositeDispersionResponse> getAggregatedReturnsDispersionMetricsWithHttpInfo(String scope, String code, AggregatedReturnsDispersionRequest aggregatedReturnsDispersionRequest, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getAggregatedReturnsDispersionMetricsValidateBeforeCall(scope, code, aggregatedReturnsDispersionRequest, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CompositeDispersionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetAggregatedReturnsDispersionMetrics: Get the Aggregated Returns Dispersion metric
     * Calculate the dispersion metric with the Aggregate Returns which are on the specified portfolio.             This works only for composites which have at least 6 constituents for a full year in.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param aggregatedReturnsDispersionRequest The request used in the AggregatedReturnsDispersionMetric. (required)
     * @param asAt The asAt datetime at which to retrieve the Returns. Defaults to the latest. (optional)
    ...
    private ApiResponse<CompositeDispersionResponse> getAggregatedReturnsDispersionMetricsWithHttpInfo(String scope, String code, AggregatedReturnsDispersionRequest aggregatedReturnsDispersionRequest, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getAggregatedReturnsDispersionMetricsValidateBeforeCall(scope, code, aggregatedReturnsDispersionRequest, asAt, null, opts);
        Type localVarReturnType = new TypeReference<CompositeDispersionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getAggregatedReturnsDispersionMetricsAsync(String scope, String code, AggregatedReturnsDispersionRequest aggregatedReturnsDispersionRequest, OffsetDateTime asAt, final ApiCallback<CompositeDispersionResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getAggregatedReturnsDispersionMetricsValidateBeforeCall(scope, code, aggregatedReturnsDispersionRequest, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CompositeDispersionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getAggregatedReturnsDispersionMetricsAsync(String scope, String code, AggregatedReturnsDispersionRequest aggregatedReturnsDispersionRequest, OffsetDateTime asAt, final ApiCallback<CompositeDispersionResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getAggregatedReturnsDispersionMetricsValidateBeforeCall(scope, code, aggregatedReturnsDispersionRequest, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<CompositeDispersionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetAggregatedReturnsDispersionMetricsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CompositeDispersionResponse> _callback) throws ApiException {
            getAggregatedReturnsDispersionMetricsAsync(scope, code, aggregatedReturnsDispersionRequest, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CompositeDispersionResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getAggregatedReturnsDispersionMetricsAsync(scope, code, aggregatedReturnsDispersionRequest, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getCompositeBreakdownCall(String scope, String code, CompositeBreakdownRequest compositeBreakdownRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getCompositeBreakdown. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the  Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param compositeBreakdownRequest The request used in the GetCompositeBreakdown. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param fromEffectiveAt The start date from which to calculate the Returns. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param toEffectiveAt The end date for which to calculate the Returns. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Returns. Defaults to the latest. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getCompositeBreakdownCall(String scope, String code, CompositeBreakdownRequest compositeBreakdownRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/returns/breakdown"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCompositeBreakdownValidateBeforeCall(String scope, String code, CompositeBreakdownRequest compositeBreakdownRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CompositeBreakdownResponse> getCompositeBreakdownWithHttpInfo(String scope, String code, CompositeBreakdownRequest compositeBreakdownRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getCompositeBreakdownValidateBeforeCall(scope, code, compositeBreakdownRequest, fromEffectiveAt, toEffectiveAt, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CompositeBreakdownResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetCompositeBreakdown: Get the Composite Breakdown on how the composite Returns are calculated
     * Calculate the Composite Returns and return this with the constituents which are included in this calculationUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param compositeBreakdownRequest The request used in the GetCompositeBreakdown. (required)
     * @param fromEffectiveAt The start date from which to calculate the Returns. (optional)
    ...
    private ApiResponse<CompositeBreakdownResponse> getCompositeBreakdownWithHttpInfo(String scope, String code, CompositeBreakdownRequest compositeBreakdownRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCompositeBreakdownValidateBeforeCall(scope, code, compositeBreakdownRequest, fromEffectiveAt, toEffectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<CompositeBreakdownResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getCompositeBreakdownAsync(String scope, String code, CompositeBreakdownRequest compositeBreakdownRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback<CompositeBreakdownResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getCompositeBreakdownValidateBeforeCall(scope, code, compositeBreakdownRequest, fromEffectiveAt, toEffectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CompositeBreakdownResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCompositeBreakdownAsync(String scope, String code, CompositeBreakdownRequest compositeBreakdownRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback<CompositeBreakdownResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCompositeBreakdownValidateBeforeCall(scope, code, compositeBreakdownRequest, fromEffectiveAt, toEffectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<CompositeBreakdownResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCompositeBreakdownRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CompositeBreakdownResponse> _callback) throws ApiException {
            getCompositeBreakdownAsync(scope, code, compositeBreakdownRequest, fromEffectiveAt, toEffectiveAt, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CompositeBreakdownResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getCompositeBreakdownAsync(scope, code, compositeBreakdownRequest, fromEffectiveAt, toEffectiveAt, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getInstrumentEventInstructionCall(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, OffsetDateTime asAt, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getInstrumentEventInstruction. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param instrumentEventInstructionId The id of the instruction to be retrieved. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param portfolioEffectiveAt The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the instruction. Defaults to return the latest version of the instruction if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getInstrumentEventInstructionCall(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, OffsetDateTime asAt, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private ApiResponse<InstrumentEventInstruction> getInstrumentEventInstructionWithHttpInfo(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, OffsetDateTime asAt, String timelineScope, String timelineCode, String closedPeriodId) throws ApiException {
        HttpRequest localVarCall = getInstrumentEventInstructionValidateBeforeCall(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, asAt, timelineScope, timelineCode, closedPeriodId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<InstrumentEventInstruction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetInstrumentEventInstruction: Get Instrument Event Instruction
     * Get a particular instruction for a particular portfolioUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param instrumentEventInstructionId The id of the instruction to be retrieved. (required)
     * @param portfolioEffectiveAt The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional)
    ...
    private ApiResponse<InstrumentEventInstruction> getInstrumentEventInstructionWithHttpInfo(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, OffsetDateTime asAt, String timelineScope, String timelineCode, String closedPeriodId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getInstrumentEventInstructionValidateBeforeCall(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, asAt, timelineScope, timelineCode, closedPeriodId, null, opts);
        Type localVarReturnType = new TypeReference<InstrumentEventInstruction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetInstrumentEventInstruction: Get Instrument Event Instruction (asynchronously)
     * Get a particular instruction for a particular portfolio
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param instrumentEventInstructionId The id of the instruction to be retrieved. (required)
     ...
     */
    private void getInstrumentEventInstructionAsync(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, OffsetDateTime asAt, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback<InstrumentEventInstruction> _callback) throws ApiException {

        HttpRequest localVarCall = getInstrumentEventInstructionValidateBeforeCall(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, asAt, timelineScope, timelineCode, closedPeriodId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<InstrumentEventInstruction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getInstrumentEventInstructionAsync(String scope, String code, String instrumentEventInstructionId, String portfolioEffectiveAt, OffsetDateTime asAt, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback<InstrumentEventInstruction> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getInstrumentEventInstructionValidateBeforeCall(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, asAt, timelineScope, timelineCode, closedPeriodId, _callback, opts);
        Type localVarReturnType = new TypeReference<InstrumentEventInstruction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetInstrumentEventInstructionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<InstrumentEventInstruction> _callback) throws ApiException {
            getInstrumentEventInstructionAsync(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, asAt, timelineScope, timelineCode, closedPeriodId, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<InstrumentEventInstruction> _callback, ConfigurationOptions opts) throws ApiException {
            getInstrumentEventInstructionAsync(scope, code, instrumentEventInstructionId, portfolioEffectiveAt, asAt, timelineScope, timelineCode, closedPeriodId, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfolioCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getPortfolio. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the portfolio definition. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the portfolio definition. Defaults to returning the latest version of the portfolio definition if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;Portfolio&#39; domain to decorate onto the portfolio,              or from any domain that supports relationships to decorate onto related entities. These must take the format              {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param relationshipDefinitionIds A list of relationship definitions that are used to decorate related entities              onto the portfolio in the response. These must take the form {relationshipDefinitionScope}/{relationshipDefinitionCode}. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getPortfolioCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Portfolio> getPortfolioWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, List<String> relationshipDefinitionIds) throws ApiException {
        HttpRequest localVarCall = getPortfolioValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, relationshipDefinitionIds, null, new ConfigurationOptions());
    ...
    /**
     * GetPortfolio: Get portfolio
     * Retrieve the definition of a particular portfolio.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve the portfolio definition. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve the portfolio definition. Defaults to returning the latest version of the portfolio definition if not specified. (optional)
    ...
    private ApiResponse<Portfolio> getPortfolioWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, List<String> relationshipDefinitionIds, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, relationshipDefinitionIds, null, opts);
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getPortfolioAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback<Portfolio> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, relationshipDefinitionIds, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfolioAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback<Portfolio> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfolioValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, relationshipDefinitionIds, _callback, opts);
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioRequest {
        ...
        public void executeAsync(final ApiCallback<Portfolio> _callback) throws ApiException {
            getPortfolioAsync(scope, code, effectiveAt, asAt, propertyKeys, relationshipDefinitionIds, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<Portfolio> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioAsync(scope, code, effectiveAt, asAt, propertyKeys, relationshipDefinitionIds, _callback, opts);
        }
    }
    ...
    /**
     * Build call for getPortfolioAggregateReturns. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the  Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param returnScope The scope of the Returns. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param returnCode The code of the Returns. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param recipeIdScope The Recipe Scope for getting the fx rates (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param recipeIdCode The Recipe Code for getting the fx rates (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param fromEffectiveAt The start date from which to calculate the Returns. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param toEffectiveAt The end date for which to calculate the Returns. (optional). Use any specified configuration options to override any other configuration for this request only.
    ...
    private HttpRequest getPortfolioAggregateReturnsCall(String scope, String code, String returnScope, String returnCode, String recipeIdScope, String recipeIdCode, String fromEffectiveAt, String toEffectiveAt, String compositeMethod, String period, String outputFrequency, List<String> metrics, OffsetDateTime asAt, String alternativeIncDate, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/returns/{returnScope}/{returnCode}/aggregated"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
            .replace("{" + "returnScope" + "}", localVarApiClient.escapeString(returnScope.toString()))
            .replace("{" + "returnCode" + "}", localVarApiClient.escapeString(returnCode.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioAggregateReturnsValidateBeforeCall(String scope, String code, String returnScope, String returnCode, String recipeIdScope, String recipeIdCode, String fromEffectiveAt, String toEffectiveAt, String compositeMethod, String period, String outputFrequency, List<String> metrics, OffsetDateTime asAt, String alternativeIncDate, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfAggregatedReturn> getPortfolioAggregateReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, String recipeIdScope, String recipeIdCode, String fromEffectiveAt, String toEffectiveAt, String compositeMethod, String period, String outputFrequency, List<String> metrics, OffsetDateTime asAt, String alternativeIncDate) throws ApiException {
        HttpRequest localVarCall = getPortfolioAggregateReturnsValidateBeforeCall(scope, code, returnScope, returnCode, recipeIdScope, recipeIdCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt, alternativeIncDate, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfAggregatedReturn>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [DEPRECATED] GetPortfolioAggregateReturns: Aggregate Returns (This is a deprecated endpoint).
     * Aggregate Returns which are on the specified portfolio.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param returnScope The scope of the Returns. (required)
     * @param returnCode The code of the Returns. (required)
    ...
    private ApiResponse<ResourceListOfAggregatedReturn> getPortfolioAggregateReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, String recipeIdScope, String recipeIdCode, String fromEffectiveAt, String toEffectiveAt, String compositeMethod, String period, String outputFrequency, List<String> metrics, OffsetDateTime asAt, String alternativeIncDate, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioAggregateReturnsValidateBeforeCall(scope, code, returnScope, returnCode, recipeIdScope, recipeIdCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt, alternativeIncDate, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfAggregatedReturn>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [DEPRECATED] GetPortfolioAggregateReturns: Aggregate Returns (This is a deprecated endpoint). (asynchronously)
     * Aggregate Returns which are on the specified portfolio.
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param returnScope The scope of the Returns. (required)
     ...
     */
    private void getPortfolioAggregateReturnsAsync(String scope, String code, String returnScope, String returnCode, String recipeIdScope, String recipeIdCode, String fromEffectiveAt, String toEffectiveAt, String compositeMethod, String period, String outputFrequency, List<String> metrics, OffsetDateTime asAt, String alternativeIncDate, final ApiCallback<ResourceListOfAggregatedReturn> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioAggregateReturnsValidateBeforeCall(scope, code, returnScope, returnCode, recipeIdScope, recipeIdCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt, alternativeIncDate, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfAggregatedReturn>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    private void getPortfolioAggregateReturnsAsync(String scope, String code, String returnScope, String returnCode, String recipeIdScope, String recipeIdCode, String fromEffectiveAt, String toEffectiveAt, String compositeMethod, String period, String outputFrequency, List<String> metrics, OffsetDateTime asAt, String alternativeIncDate, final ApiCallback<ResourceListOfAggregatedReturn> _callback, ConfigurationOptions opts) throws ApiException {
        ...
        HttpRequest localVarCall = getPortfolioAggregateReturnsValidateBeforeCall(scope, code, returnScope, returnCode, recipeIdScope, recipeIdCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt, alternativeIncDate, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfAggregatedReturn>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioAggregateReturnsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfAggregatedReturn> _callback) throws ApiException {
            getPortfolioAggregateReturnsAsync(scope, code, returnScope, returnCode, recipeIdScope, recipeIdCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt, alternativeIncDate, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfAggregatedReturn> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioAggregateReturnsAsync(scope, code, returnScope, returnCode, recipeIdScope, recipeIdCode, fromEffectiveAt, toEffectiveAt, compositeMethod, period, outputFrequency, metrics, asAt, alternativeIncDate, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfolioAggregatedReturnsCall(String scope, String code, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getPortfolioAggregatedReturns. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the  Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param aggregatedReturnsRequest The request used in the AggregatedReturns. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param fromEffectiveAt The start date from which to calculate the Returns. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param toEffectiveAt The end date for which to calculate the Returns. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Returns. Defaults to the latest. (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest getPortfolioAggregatedReturnsCall(String scope, String code, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/returns/$aggregated"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioAggregatedReturnsValidateBeforeCall(String scope, String code, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AggregatedReturnsResponse> getPortfolioAggregatedReturnsWithHttpInfo(String scope, String code, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getPortfolioAggregatedReturnsValidateBeforeCall(scope, code, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AggregatedReturnsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<AggregatedReturnsResponse> getPortfolioAggregatedReturnsWithHttpInfo(String scope, String code, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioAggregatedReturnsValidateBeforeCall(scope, code, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<AggregatedReturnsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetPortfolioAggregatedReturns: Aggregated Returns (asynchronously)
     * Aggregate Returns which are on the specified portfolio.
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param aggregatedReturnsRequest The request used in the AggregatedReturns. (required)
     ...
     */
    private void getPortfolioAggregatedReturnsAsync(String scope, String code, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback<AggregatedReturnsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioAggregatedReturnsValidateBeforeCall(scope, code, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AggregatedReturnsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfolioAggregatedReturnsAsync(String scope, String code, AggregatedReturnsRequest aggregatedReturnsRequest, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, final ApiCallback<AggregatedReturnsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfolioAggregatedReturnsValidateBeforeCall(scope, code, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<AggregatedReturnsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioAggregatedReturnsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AggregatedReturnsResponse> _callback) throws ApiException {
            getPortfolioAggregatedReturnsAsync(scope, code, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AggregatedReturnsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioAggregatedReturnsAsync(scope, code, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfolioCommandsCall(String scope, String code, OffsetDateTime fromAsAt, OffsetDateTime toAsAt, String filter, String page, Integer limit, final ApiCallback _callback) throws ApiException {
        return getPortfolioCommandsCall(scope, code, fromAsAt, toAsAt, filter, page, limit,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getPortfolioCommands. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getPortfolioCommandsCall(String scope, String code, OffsetDateTime fromAsAt, OffsetDateTime toAsAt, String filter, String page, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/commands"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioCommandsValidateBeforeCall(String scope, String code, OffsetDateTime fromAsAt, OffsetDateTime toAsAt, String filter, String page, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfProcessedCommand> getPortfolioCommandsWithHttpInfo(String scope, String code, OffsetDateTime fromAsAt, OffsetDateTime toAsAt, String filter, String page, Integer limit) throws ApiException {
        HttpRequest localVarCall = getPortfolioCommandsValidateBeforeCall(scope, code, fromAsAt, toAsAt, filter, page, limit, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfProcessedCommand>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetPortfolioCommands: Get portfolio commands
     * Get all the commands that modified a particular portfolio, including any input transactions.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param fromAsAt The lower bound asAt datetime (inclusive) from which to retrieve commands. There is no lower bound if this is not specified. (optional)
     * @param toAsAt The upper bound asAt datetime (inclusive) from which to retrieve commands. There is no upper bound if this is not specified. (optional)
    ...
    private ApiResponse<ResourceListOfProcessedCommand> getPortfolioCommandsWithHttpInfo(String scope, String code, OffsetDateTime fromAsAt, OffsetDateTime toAsAt, String filter, String page, Integer limit, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioCommandsValidateBeforeCall(scope, code, fromAsAt, toAsAt, filter, page, limit, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfProcessedCommand>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getPortfolioCommandsAsync(String scope, String code, OffsetDateTime fromAsAt, OffsetDateTime toAsAt, String filter, String page, Integer limit, final ApiCallback<ResourceListOfProcessedCommand> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioCommandsValidateBeforeCall(scope, code, fromAsAt, toAsAt, filter, page, limit, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfProcessedCommand>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfolioCommandsAsync(String scope, String code, OffsetDateTime fromAsAt, OffsetDateTime toAsAt, String filter, String page, Integer limit, final ApiCallback<ResourceListOfProcessedCommand> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfolioCommandsValidateBeforeCall(scope, code, fromAsAt, toAsAt, filter, page, limit, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfProcessedCommand>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioCommandsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfProcessedCommand> _callback) throws ApiException {
            getPortfolioCommandsAsync(scope, code, fromAsAt, toAsAt, filter, page, limit, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfProcessedCommand> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioCommandsAsync(scope, code, fromAsAt, toAsAt, filter, page, limit, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfolioMetadataCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getPortfolioMetadataCall(scope, code, effectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getPortfolioMetadata. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code Portfolio code (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effectiveAt datetime at which to retrieve the access metadata rule. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the portfolio access metadata. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getPortfolioMetadataCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/metadata"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioMetadataValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Map<String, List<AccessMetadataValue>>> getPortfolioMetadataWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getPortfolioMetadataValidateBeforeCall(scope, code, effectiveAt, asAt, null, new ConfigurationOptions());
    ...
    /**
     * GetPortfolioMetadata: Get access metadata rules for a portfolio
     * Pass the scope and portfolio code parameters to retrieve the AccessMetadata associated with a portfolioUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve. (required)
     * @param code Portfolio code (required)
     * @param effectiveAt The effectiveAt datetime at which to retrieve the access metadata rule. (optional)
     * @param asAt The asAt datetime at which to retrieve the portfolio access metadata. (optional)
    ...
    private ApiResponse<Map<String, List<AccessMetadataValue>>> getPortfolioMetadataWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioMetadataValidateBeforeCall(scope, code, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetPortfolioMetadata: Get access metadata rules for a portfolio (asynchronously)
     * Pass the scope and portfolio code parameters to retrieve the AccessMetadata associated with a portfolio
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve. (required)
     * @param code Portfolio code (required)
     * @param effectiveAt The effectiveAt datetime at which to retrieve the access metadata rule. (optional)
     ...
     */
    private void getPortfolioMetadataAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioMetadataValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfolioMetadataAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfolioMetadataValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioMetadataRequest {
        ...
        public void executeAsync(final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {
            getPortfolioMetadataAsync(scope, code, effectiveAt, asAt, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioMetadataAsync(scope, code, effectiveAt, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfolioPropertiesCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getPortfolioPropertiesCall(scope, code, effectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getPortfolioProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the portfolio&#39;s properties. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the portfolio&#39;s properties. Defaults to returning the latest version of each property if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getPortfolioPropertiesCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioPropertiesValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PortfolioProperties> getPortfolioPropertiesWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getPortfolioPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PortfolioProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetPortfolioProperties: Get portfolio properties
     * List all the properties of a particular portfolio.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param effectiveAt The effective datetime or cut label at which to list the portfolio&#39;s properties. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the portfolio&#39;s properties. Defaults to returning the latest version of each property if not specified. (optional)
    ...
    private ApiResponse<PortfolioProperties> getPortfolioPropertiesWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<PortfolioProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getPortfolioPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<PortfolioProperties> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PortfolioProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfolioPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<PortfolioProperties> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfolioPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<PortfolioProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioPropertiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PortfolioProperties> _callback) throws ApiException {
            getPortfolioPropertiesAsync(scope, code, effectiveAt, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PortfolioProperties> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioPropertiesAsync(scope, code, effectiveAt, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfolioPropertiesTimeSeriesCall(String scope, String code, List<String> propertyKeys, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getPortfolioPropertiesTimeSeries. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getPortfolioPropertiesTimeSeriesCall(String scope, String code, List<String> propertyKeys, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/properties/time-series/batch"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioPropertiesTimeSeriesValidateBeforeCall(String scope, String code, List<String> propertyKeys, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfPropertyIntervalTimeSeries> getPortfolioPropertiesTimeSeriesWithHttpInfo(String scope, String code, List<String> propertyKeys, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit) throws ApiException {
        HttpRequest localVarCall = getPortfolioPropertiesTimeSeriesValidateBeforeCall(scope, code, propertyKeys, portfolioEffectiveAt, asAt, filter, page, limit, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyIntervalTimeSeries>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListOfPropertyIntervalTimeSeries> getPortfolioPropertiesTimeSeriesWithHttpInfo(String scope, String code, List<String> propertyKeys, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioPropertiesTimeSeriesValidateBeforeCall(scope, code, propertyKeys, portfolioEffectiveAt, asAt, filter, page, limit, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyIntervalTimeSeries>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getPortfolioPropertiesTimeSeriesAsync(String scope, String code, List<String> propertyKeys, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback<ResourceListOfPropertyIntervalTimeSeries> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioPropertiesTimeSeriesValidateBeforeCall(scope, code, propertyKeys, portfolioEffectiveAt, asAt, filter, page, limit, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyIntervalTimeSeries>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfolioPropertiesTimeSeriesAsync(String scope, String code, List<String> propertyKeys, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback<ResourceListOfPropertyIntervalTimeSeries> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfolioPropertiesTimeSeriesValidateBeforeCall(scope, code, propertyKeys, portfolioEffectiveAt, asAt, filter, page, limit, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyIntervalTimeSeries>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioPropertiesTimeSeriesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPropertyIntervalTimeSeries> _callback) throws ApiException {
            getPortfolioPropertiesTimeSeriesAsync(scope, code, propertyKeys, portfolioEffectiveAt, asAt, filter, page, limit, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPropertyIntervalTimeSeries> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioPropertiesTimeSeriesAsync(scope, code, propertyKeys, portfolioEffectiveAt, asAt, filter, page, limit, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfolioPropertyTimeSeriesCall(String scope, String code, String propertyKey, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getPortfolioPropertyTimeSeries. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getPortfolioPropertyTimeSeriesCall(String scope, String code, String propertyKey, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/properties/time-series"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioPropertyTimeSeriesValidateBeforeCall(String scope, String code, String propertyKey, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfPropertyInterval> getPortfolioPropertyTimeSeriesWithHttpInfo(String scope, String code, String propertyKey, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit) throws ApiException {
        HttpRequest localVarCall = getPortfolioPropertyTimeSeriesValidateBeforeCall(scope, code, propertyKey, portfolioEffectiveAt, asAt, filter, page, limit, null, new ConfigurationOptions());
    ...
    /**
     * GetPortfolioPropertyTimeSeries: Get portfolio property time series
     * Show the complete time series (history) for a particular portfolio property.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param propertyKey The property key of the property whose history to show.              This must be from the &#39;Portfolio&#39; domain and in the format {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. (required)
     * @param portfolioEffectiveAt The effective datetime used to resolve the portfolio. Defaults to the current LUSID system datetime if not specified. (optional)
    ...
    private ApiResponse<ResourceListOfPropertyInterval> getPortfolioPropertyTimeSeriesWithHttpInfo(String scope, String code, String propertyKey, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioPropertyTimeSeriesValidateBeforeCall(scope, code, propertyKey, portfolioEffectiveAt, asAt, filter, page, limit, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyInterval>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetPortfolioPropertyTimeSeries: Get portfolio property time series (asynchronously)
     * Show the complete time series (history) for a particular portfolio property.
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param propertyKey The property key of the property whose history to show.              This must be from the &#39;Portfolio&#39; domain and in the format {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. (required)
     ...
     */
    private void getPortfolioPropertyTimeSeriesAsync(String scope, String code, String propertyKey, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback<ResourceListOfPropertyInterval> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioPropertyTimeSeriesValidateBeforeCall(scope, code, propertyKey, portfolioEffectiveAt, asAt, filter, page, limit, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyInterval>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfolioPropertyTimeSeriesAsync(String scope, String code, String propertyKey, String portfolioEffectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback<ResourceListOfPropertyInterval> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfolioPropertyTimeSeriesValidateBeforeCall(scope, code, propertyKey, portfolioEffectiveAt, asAt, filter, page, limit, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPropertyInterval>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioPropertyTimeSeriesRequest {
        ...
        public void executeAsync(final ApiCallback<ResourceListOfPropertyInterval> _callback) throws ApiException {
            getPortfolioPropertyTimeSeriesAsync(scope, code, propertyKey, portfolioEffectiveAt, asAt, filter, page, limit, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<ResourceListOfPropertyInterval> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioPropertyTimeSeriesAsync(scope, code, propertyKey, portfolioEffectiveAt, asAt, filter, page, limit, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfolioRelationsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback _callback) throws ApiException {
        return getPortfolioRelationsCall(scope, code, effectiveAt, asAt, filter, identifierTypes,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getPortfolioRelations. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to retrieve relations. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve relations. Defaults to returning the latest LUSID AsAt time if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the relations. Provide a null or empty string for this field until further notice. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierTypes Identifier types (as property keys) used for referencing Persons or Legal Entities.              These must be from the &#39;Person&#39; or &#39;LegalEntity&#39; domains and have the format {domain}/{scope}/{code}, for example              &#39;Person/CompanyDetails/Role&#39;. Only identifier types provided will be used to look up relevant entities in relations. If not applicable, provide an empty array. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getPortfolioRelationsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/relations"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioRelationsValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfRelation> getPortfolioRelationsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes) throws ApiException {
        HttpRequest localVarCall = getPortfolioRelationsValidateBeforeCall(scope, code, effectiveAt, asAt, filter, identifierTypes, null, new ConfigurationOptions());
    ...
    /**
     * [EXPERIMENTAL] GetPortfolioRelations: Get portfolio relations
     * Get relations for a particular portfolio.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve relations. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve relations. Defaults to returning the latest LUSID AsAt time if not specified. (optional)
    ...
    private ApiResponse<ResourceListOfRelation> getPortfolioRelationsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioRelationsValidateBeforeCall(scope, code, effectiveAt, asAt, filter, identifierTypes, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfRelation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getPortfolioRelationsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback<ResourceListOfRelation> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioRelationsValidateBeforeCall(scope, code, effectiveAt, asAt, filter, identifierTypes, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfRelation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfolioRelationsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback<ResourceListOfRelation> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfolioRelationsValidateBeforeCall(scope, code, effectiveAt, asAt, filter, identifierTypes, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfRelation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioRelationsRequest {
        ...
        public void executeAsync(final ApiCallback<ResourceListOfRelation> _callback) throws ApiException {
            getPortfolioRelationsAsync(scope, code, effectiveAt, asAt, filter, identifierTypes, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<ResourceListOfRelation> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioRelationsAsync(scope, code, effectiveAt, asAt, filter, identifierTypes, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfolioRelationshipsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getPortfolioRelationships. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to retrieve relationships. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve relationships. Defaults to returning the latest LUSID AsAt time if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the relationships. Provide a null or empty string for this field until further notice. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierTypes Identifier types (as property keys) used for referencing Persons or Legal Entities.              These can be specified from the &#39;Person&#39; or &#39;LegalEntity&#39; domains and have the format {domain}/{scope}/{code}, for example              &#39;Person/CompanyDetails/Role&#39;. An Empty array may be used to return all related Entities. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getPortfolioRelationshipsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/relationships"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioRelationshipsValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfRelationship> getPortfolioRelationshipsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes) throws ApiException {
        HttpRequest localVarCall = getPortfolioRelationshipsValidateBeforeCall(scope, code, effectiveAt, asAt, filter, identifierTypes, null, new ConfigurationOptions());
    ...
    /**
     * GetPortfolioRelationships: Get portfolio relationships
     * Get relationships for a particular portfolio.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve relationships. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve relationships. Defaults to returning the latest LUSID AsAt time if not specified. (optional)
    ...
    private ApiResponse<ResourceListOfRelationship> getPortfolioRelationshipsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioRelationshipsValidateBeforeCall(scope, code, effectiveAt, asAt, filter, identifierTypes, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfRelationship>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetPortfolioRelationships: Get portfolio relationships (asynchronously)
     * Get relationships for a particular portfolio.
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve relationships. Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     */
    private void getPortfolioRelationshipsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback<ResourceListOfRelationship> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioRelationshipsValidateBeforeCall(scope, code, effectiveAt, asAt, filter, identifierTypes, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfRelationship>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfolioRelationshipsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback<ResourceListOfRelationship> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfolioRelationshipsValidateBeforeCall(scope, code, effectiveAt, asAt, filter, identifierTypes, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfRelationship>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioRelationshipsRequest {
        ...
        public void executeAsync(final ApiCallback<ResourceListOfRelationship> _callback) throws ApiException {
            getPortfolioRelationshipsAsync(scope, code, effectiveAt, asAt, filter, identifierTypes, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<ResourceListOfRelationship> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioRelationshipsAsync(scope, code, effectiveAt, asAt, filter, identifierTypes, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfolioReturnsCall(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getPortfolioReturns. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the  Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param returnScope The scope of the Returns. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param returnCode The code of the Returns. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param fromEffectiveAt The start date from which to get the Returns. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param toEffectiveAt The end date from which to get the Returns. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param period The period for which to show the Returns. Default value: Daily. Available values: Daily, Monthly. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Returns. Defaults to the latest. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getPortfolioReturnsCall(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/returns/{returnScope}/{returnCode}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
            .replace("{" + "returnScope" + "}", localVarApiClient.escapeString(returnScope.toString()))
            .replace("{" + "returnCode" + "}", localVarApiClient.escapeString(returnCode.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfolioReturnsValidateBeforeCall(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfPerformanceReturn> getPortfolioReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getPortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPerformanceReturn>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetPortfolioReturns: Get Returns
     * Get Returns which are on the specified portfolio.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param returnScope The scope of the Returns. (required)
     * @param returnCode The code of the Returns. (required)
    ...
    private ApiResponse<ResourceListOfPerformanceReturn> getPortfolioReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, asAt, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPerformanceReturn>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetPortfolioReturns: Get Returns (asynchronously)
     * Get Returns which are on the specified portfolio.
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param returnScope The scope of the Returns. (required)
     ...
     */
    private void getPortfolioReturnsAsync(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, OffsetDateTime asAt, final ApiCallback<ResourceListOfPerformanceReturn> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPerformanceReturn>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfolioReturnsAsync(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, OffsetDateTime asAt, final ApiCallback<ResourceListOfPerformanceReturn> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPerformanceReturn>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfolioReturnsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPerformanceReturn> _callback) throws ApiException {
            getPortfolioReturnsAsync(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPerformanceReturn> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfolioReturnsAsync(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPortfoliosAccessMetadataByKeyCall(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getPortfoliosAccessMetadataByKeyCall(scope, code, metadataKey, effectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getPortfoliosAccessMetadataByKey. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio (required). Use any specified configuration options to override any other configuration for this request only.
     * @param metadataKey Key of the metadata to retrieve (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getPortfoliosAccessMetadataByKeyCall(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPortfoliosAccessMetadataByKeyValidateBeforeCall(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<List<AccessMetadataValue>> getPortfoliosAccessMetadataByKeyWithHttpInfo(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getPortfoliosAccessMetadataByKeyValidateBeforeCall(scope, code, metadataKey, effectiveAt, asAt, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] GetPortfoliosAccessMetadataByKey: Get an entry identified by a metadataKey in the access metadata object
     * Get a specific portfolio access metadata rule by specifying the corresponding identifier parts                No matching will be performed through this endpoint. To retrieve a rule, it is necessary to specify, exactly, the identifier of the ruleUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve. (required)
     * @param code The code of the portfolio (required)
     * @param metadataKey Key of the metadata to retrieve (required)
     * @param effectiveAt The effective date of the rule (optional)
    ...
    private ApiResponse<List<AccessMetadataValue>> getPortfoliosAccessMetadataByKeyWithHttpInfo(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPortfoliosAccessMetadataByKeyValidateBeforeCall(scope, code, metadataKey, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<List<AccessMetadataValue>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getPortfoliosAccessMetadataByKeyAsync(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime asAt, final ApiCallback<List<AccessMetadataValue>> _callback) throws ApiException {

        HttpRequest localVarCall = getPortfoliosAccessMetadataByKeyValidateBeforeCall(scope, code, metadataKey, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<List<AccessMetadataValue>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPortfoliosAccessMetadataByKeyAsync(String scope, String code, String metadataKey, String effectiveAt, OffsetDateTime asAt, final ApiCallback<List<AccessMetadataValue>> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPortfoliosAccessMetadataByKeyValidateBeforeCall(scope, code, metadataKey, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<List<AccessMetadataValue>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPortfoliosAccessMetadataByKeyRequest {
        ...
        public void executeAsync(final ApiCallback<List<AccessMetadataValue>> _callback) throws ApiException {
            getPortfoliosAccessMetadataByKeyAsync(scope, code, metadataKey, effectiveAt, asAt, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<List<AccessMetadataValue>> _callback, ConfigurationOptions opts) throws ApiException {
            getPortfoliosAccessMetadataByKeyAsync(scope, code, metadataKey, effectiveAt, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listInstrumentEventInstructionsCall(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for listInstrumentEventInstructions. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param portfolioEffectiveAt The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listInstrumentEventInstructionsCall(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/instrumenteventinstructions"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listInstrumentEventInstructionsValidateBeforeCall(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PagedResourceListOfInstrumentEventInstruction> listInstrumentEventInstructionsWithHttpInfo(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String timelineScope, String timelineCode, String closedPeriodId) throws ApiException {
        HttpRequest localVarCall = listInstrumentEventInstructionsValidateBeforeCall(scope, code, portfolioEffectiveAt, asAt, page, limit, filter, sortBy, timelineScope, timelineCode, closedPeriodId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfInstrumentEventInstruction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListInstrumentEventInstructions: List Instrument Event Instructions
     * Lists all instructions for a particular portfolioUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param portfolioEffectiveAt The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve the instructions. Defaults to latest if not specified. (optional)
     ...
     */
    private ApiResponse<PagedResourceListOfInstrumentEventInstruction> listInstrumentEventInstructionsWithHttpInfo(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String timelineScope, String timelineCode, String closedPeriodId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listInstrumentEventInstructionsValidateBeforeCall(scope, code, portfolioEffectiveAt, asAt, page, limit, filter, sortBy, timelineScope, timelineCode, closedPeriodId, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfInstrumentEventInstruction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListInstrumentEventInstructions: List Instrument Event Instructions (asynchronously)
     * Lists all instructions for a particular portfolio
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param portfolioEffectiveAt The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional)
     ...
     */
    private void listInstrumentEventInstructionsAsync(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback<PagedResourceListOfInstrumentEventInstruction> _callback) throws ApiException {

        HttpRequest localVarCall = listInstrumentEventInstructionsValidateBeforeCall(scope, code, portfolioEffectiveAt, asAt, page, limit, filter, sortBy, timelineScope, timelineCode, closedPeriodId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfInstrumentEventInstruction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    private void listInstrumentEventInstructionsAsync(String scope, String code, String portfolioEffectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback<PagedResourceListOfInstrumentEventInstruction> _callback, ConfigurationOptions opts) throws ApiException {
        ...
        HttpRequest localVarCall = listInstrumentEventInstructionsValidateBeforeCall(scope, code, portfolioEffectiveAt, asAt, page, limit, filter, sortBy, timelineScope, timelineCode, closedPeriodId, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfInstrumentEventInstruction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistInstrumentEventInstructionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfInstrumentEventInstruction> _callback) throws ApiException {
            listInstrumentEventInstructionsAsync(scope, code, portfolioEffectiveAt, asAt, page, limit, filter, sortBy, timelineScope, timelineCode, closedPeriodId, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfInstrumentEventInstruction> _callback, ConfigurationOptions opts) throws ApiException {
            listInstrumentEventInstructionsAsync(scope, code, portfolioEffectiveAt, asAt, page, limit, filter, sortBy, timelineScope, timelineCode, closedPeriodId, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listPortfolioPropertiesCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, final ApiCallback _callback) throws ApiException {
        return listPortfolioPropertiesCall(scope, code, effectiveAt, asAt, page, limit,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listPortfolioProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the portfolio&#39;s properties. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the portfolio&#39;s properties. Defaults to returning the latest version of each property if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing commands; this value is returned from the previous call. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit When paginating, limit the results per page to this number. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest listPortfolioPropertiesCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}/{code}/properties/list"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listPortfolioPropertiesValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfProperty> listPortfolioPropertiesWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit) throws ApiException {
        HttpRequest localVarCall = listPortfolioPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, page, limit, null, new ConfigurationOptions());
    ...
    private ApiResponse<ResourceListOfProperty> listPortfolioPropertiesWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listPortfolioPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, page, limit, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfProperty>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listPortfolioPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, final ApiCallback<ResourceListOfProperty> _callback) throws ApiException {

        HttpRequest localVarCall = listPortfolioPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, page, limit, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfProperty>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listPortfolioPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, final ApiCallback<ResourceListOfProperty> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listPortfolioPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, page, limit, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfProperty>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistPortfolioPropertiesRequest {
        ...
        public void executeAsync(final ApiCallback<ResourceListOfProperty> _callback) throws ApiException {
            listPortfolioPropertiesAsync(scope, code, effectiveAt, asAt, page, limit, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<ResourceListOfProperty> _callback, ConfigurationOptions opts) throws ApiException {
            listPortfolioPropertiesAsync(scope, code, effectiveAt, asAt, page, limit, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listPortfoliosCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String query, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for listPortfolios. Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the portfolios. Defaults to the current LUSID              system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listPortfoliosCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String query, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listPortfoliosValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String query, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfPortfolio> listPortfoliosWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String query, List<String> propertyKeys, List<String> relationshipDefinitionIds) throws ApiException {
        HttpRequest localVarCall = listPortfoliosValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, query, propertyKeys, relationshipDefinitionIds, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolio>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListPortfolios: List portfolios
     * List all the portfolios matching particular criteria.Use any specified configuration options to override any other configuration for this request only
     * @param effectiveAt The effective datetime or cut label at which to list the portfolios. Defaults to the current LUSID              system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the portfolios. Defaults to returning the latest version              of each portfolio if not specified. (optional)
     * @param page The pagination token to use to continue listing portfolios; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional)
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional)
    ...
    private ApiResponse<ResourceListOfPortfolio> listPortfoliosWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String query, List<String> propertyKeys, List<String> relationshipDefinitionIds, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listPortfoliosValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, query, propertyKeys, relationshipDefinitionIds, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolio>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listPortfoliosAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String query, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback<ResourceListOfPortfolio> _callback) throws ApiException {

        HttpRequest localVarCall = listPortfoliosValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, query, propertyKeys, relationshipDefinitionIds, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolio>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listPortfoliosAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, String query, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback<ResourceListOfPortfolio> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listPortfoliosValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, query, propertyKeys, relationshipDefinitionIds, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolio>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistPortfoliosRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPortfolio> _callback) throws ApiException {
            listPortfoliosAsync(effectiveAt, asAt, page, limit, filter, sortBy, query, propertyKeys, relationshipDefinitionIds, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPortfolio> _callback, ConfigurationOptions opts) throws ApiException {
            listPortfoliosAsync(effectiveAt, asAt, page, limit, filter, sortBy, query, propertyKeys, relationshipDefinitionIds, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listPortfoliosForScopeCall(String scope, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for listPortfoliosForScope. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope whose portfolios to list. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the portfolios. Defaults to the current LUSID              system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the portfolios. Defaults to returning the latest version              of each portfolio if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing portfolios. This  value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt  and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listPortfoliosForScopeCall(String scope, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/{scope}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listPortfoliosForScopeValidateBeforeCall(String scope, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfPortfolio> listPortfoliosForScopeWithHttpInfo(String scope, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, List<String> relationshipDefinitionIds) throws ApiException {
        HttpRequest localVarCall = listPortfoliosForScopeValidateBeforeCall(scope, effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, relationshipDefinitionIds, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolio>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * ListPortfoliosForScope: List portfolios for scope
     * List all the portfolios in a particular scope.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope whose portfolios to list. (required)
     * @param effectiveAt The effective datetime or cut label at which to list the portfolios. Defaults to the current LUSID              system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the portfolios. Defaults to returning the latest version              of each portfolio if not specified. (optional)
     * @param page The pagination token to use to continue listing portfolios. This  value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt  and asAt fields must not have changed since the original request. (optional)
    ...
    private ApiResponse<ResourceListOfPortfolio> listPortfoliosForScopeWithHttpInfo(String scope, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, List<String> relationshipDefinitionIds, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listPortfoliosForScopeValidateBeforeCall(scope, effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, relationshipDefinitionIds, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolio>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listPortfoliosForScopeAsync(String scope, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback<ResourceListOfPortfolio> _callback) throws ApiException {

        HttpRequest localVarCall = listPortfoliosForScopeValidateBeforeCall(scope, effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, relationshipDefinitionIds, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolio>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listPortfoliosForScopeAsync(String scope, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, List<String> relationshipDefinitionIds, final ApiCallback<ResourceListOfPortfolio> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listPortfoliosForScopeValidateBeforeCall(scope, effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, relationshipDefinitionIds, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolio>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistPortfoliosForScopeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPortfolio> _callback) throws ApiException {
            listPortfoliosForScopeAsync(scope, effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, relationshipDefinitionIds, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPortfolio> _callback, ConfigurationOptions opts) throws ApiException {
            listPortfoliosForScopeAsync(scope, effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, relationshipDefinitionIds, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest patchPortfolioCall(String scope, String code, List<Operation> operation, final ApiCallback _callback) throws ApiException {
        return patchPortfolioCall(scope, code, operation,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for patchPortfolio. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the              scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param operation The json patch document. For more check: https://datatracker.ietf.org/doc/html/rfc6902. (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest patchPortfolioCall(String scope, String code, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest patchPortfolioValidateBeforeCall(String scope, String code, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Portfolio> patchPortfolioWithHttpInfo(String scope, String code, List<Operation> operation) throws ApiException {
        HttpRequest localVarCall = patchPortfolioValidateBeforeCall(scope, code, operation, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * PatchPortfolio: Patch portfolio.
     * Create or update certain fields for a particular  portfolio.  The behaviour is defined by the JSON Patch specification.    Currently supported fields are: Created, InstrumentScopes, Type.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the              scope this uniquely identifies the portfolio. (required)
     * @param operation The json patch document. For more check: https://datatracker.ietf.org/doc/html/rfc6902. (required)
     * @return ApiResponse&lt;Portfolio&gt;
    ...
    private ApiResponse<Portfolio> patchPortfolioWithHttpInfo(String scope, String code, List<Operation> operation, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = patchPortfolioValidateBeforeCall(scope, code, operation, null, opts);
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * PatchPortfolio: Patch portfolio. (asynchronously)
     * Create or update certain fields for a particular  portfolio.  The behaviour is defined by the JSON Patch specification.    Currently supported fields are: Created, InstrumentScopes, Type.
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the              scope this uniquely identifies the portfolio. (required)
     * @param operation The json patch document. For more check: https://datatracker.ietf.org/doc/html/rfc6902. (required)
     ...
     */
    private void patchPortfolioAsync(String scope, String code, List<Operation> operation, final ApiCallback<Portfolio> _callback) throws ApiException {

        HttpRequest localVarCall = patchPortfolioValidateBeforeCall(scope, code, operation, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void patchPortfolioAsync(String scope, String code, List<Operation> operation, final ApiCallback<Portfolio> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = patchPortfolioValidateBeforeCall(scope, code, operation, _callback, opts);
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIpatchPortfolioRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Portfolio> _callback) throws ApiException {
            patchPortfolioAsync(scope, code, operation, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Portfolio> _callback, ConfigurationOptions opts) throws ApiException {
            patchPortfolioAsync(scope, code, operation, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest patchPortfolioAccessMetadataCall(String scope, String code, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for patchPortfolioAccessMetadata. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Portfolio Access Metadata Rule. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code Portfolio code (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest patchPortfolioAccessMetadataCall(String scope, String code, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest patchPortfolioAccessMetadataValidateBeforeCall(String scope, String code, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Map<String, List<AccessMetadataValue>>> patchPortfolioAccessMetadataWithHttpInfo(String scope, String code, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil) throws ApiException {
        HttpRequest localVarCall = patchPortfolioAccessMetadataValidateBeforeCall(scope, code, accessMetadataOperation, effectiveAt, effectiveUntil, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<Map<String, List<AccessMetadataValue>>> patchPortfolioAccessMetadataWithHttpInfo(String scope, String code, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = patchPortfolioAccessMetadataValidateBeforeCall(scope, code, accessMetadataOperation, effectiveAt, effectiveUntil, null, opts);
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void patchPortfolioAccessMetadataAsync(String scope, String code, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {

        HttpRequest localVarCall = patchPortfolioAccessMetadataValidateBeforeCall(scope, code, accessMetadataOperation, effectiveAt, effectiveUntil, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void patchPortfolioAccessMetadataAsync(String scope, String code, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = patchPortfolioAccessMetadataValidateBeforeCall(scope, code, accessMetadataOperation, effectiveAt, effectiveUntil, _callback, opts);
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIpatchPortfolioAccessMetadataRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {
            patchPortfolioAccessMetadataAsync(scope, code, accessMetadataOperation, effectiveAt, effectiveUntil, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback, ConfigurationOptions opts) throws ApiException {
            patchPortfolioAccessMetadataAsync(scope, code, accessMetadataOperation, effectiveAt, effectiveUntil, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updatePortfolioCall(String scope, String code, UpdatePortfolioRequest updatePortfolioRequest, String effectiveAt, final ApiCallback _callback) throws ApiException {
        return updatePortfolioCall(scope, code, updatePortfolioRequest, effectiveAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updatePortfolio. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updatePortfolioRequest The updated portfolio definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to update the definition. Defaults to the current               LUSID system datetime if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updatePortfolioCall(String scope, String code, UpdatePortfolioRequest updatePortfolioRequest, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updatePortfolioValidateBeforeCall(String scope, String code, UpdatePortfolioRequest updatePortfolioRequest, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Portfolio> updatePortfolioWithHttpInfo(String scope, String code, UpdatePortfolioRequest updatePortfolioRequest, String effectiveAt) throws ApiException {
        HttpRequest localVarCall = updatePortfolioValidateBeforeCall(scope, code, updatePortfolioRequest, effectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * UpdatePortfolio: Update portfolio
     * Update the definition of a particular portfolio.                Note that not all elements of a portfolio definition are  modifiable due to the potential implications for data already stored.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param updatePortfolioRequest The updated portfolio definition. (required)
     * @param effectiveAt The effective datetime or cut label at which to update the definition. Defaults to the current               LUSID system datetime if not specified. (optional)
    ...
    private ApiResponse<Portfolio> updatePortfolioWithHttpInfo(String scope, String code, UpdatePortfolioRequest updatePortfolioRequest, String effectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updatePortfolioValidateBeforeCall(scope, code, updatePortfolioRequest, effectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void updatePortfolioAsync(String scope, String code, UpdatePortfolioRequest updatePortfolioRequest, String effectiveAt, final ApiCallback<Portfolio> _callback) throws ApiException {

        HttpRequest localVarCall = updatePortfolioValidateBeforeCall(scope, code, updatePortfolioRequest, effectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updatePortfolioAsync(String scope, String code, UpdatePortfolioRequest updatePortfolioRequest, String effectiveAt, final ApiCallback<Portfolio> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updatePortfolioValidateBeforeCall(scope, code, updatePortfolioRequest, effectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<Portfolio>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdatePortfolioRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Portfolio> _callback) throws ApiException {
            updatePortfolioAsync(scope, code, updatePortfolioRequest, effectiveAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Portfolio> _callback, ConfigurationOptions opts) throws ApiException {
            updatePortfolioAsync(scope, code, updatePortfolioRequest, effectiveAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertInstrumentEventInstructionsCall(String scope, String code, String successMode, Map<String, InstrumentEventInstructionRequest> requestBody, String portfolioEffectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for upsertInstrumentEventInstructions. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param successMode Whether the batch request should fail atomically or in a partial fashion - allowed values: Atomic, Partial (default) (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The instructions to be upserted to the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param portfolioEffectiveAt The effective date at which the portfolio will be resolved. Defaults to current time if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertInstrumentEventInstructionsCall(String scope, String code, String successMode, Map<String, InstrumentEventInstructionRequest> requestBody, String portfolioEffectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertInstrumentEventInstructionsValidateBeforeCall(String scope, String code, String successMode, Map<String, InstrumentEventInstructionRequest> requestBody, String portfolioEffectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<InstrumentEventInstructionsResponse> upsertInstrumentEventInstructionsWithHttpInfo(String scope, String code, String successMode, Map<String, InstrumentEventInstructionRequest> requestBody, String portfolioEffectiveAt) throws ApiException {
        HttpRequest localVarCall = upsertInstrumentEventInstructionsValidateBeforeCall(scope, code, successMode, requestBody, portfolioEffectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<InstrumentEventInstructionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpsertInstrumentEventInstructions: Upsert Instrument Event Instructions
     * Batch upsert for instrument event instructions, for the portfolio or individual holdingsUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param successMode Whether the batch request should fail atomically or in a partial fashion - allowed values: Atomic, Partial (default) (required)
     * @param requestBody The instructions to be upserted to the portfolio. (required)
    ...
    private ApiResponse<InstrumentEventInstructionsResponse> upsertInstrumentEventInstructionsWithHttpInfo(String scope, String code, String successMode, Map<String, InstrumentEventInstructionRequest> requestBody, String portfolioEffectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertInstrumentEventInstructionsValidateBeforeCall(scope, code, successMode, requestBody, portfolioEffectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<InstrumentEventInstructionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpsertInstrumentEventInstructions: Upsert Instrument Event Instructions (asynchronously)
     * Batch upsert for instrument event instructions, for the portfolio or individual holdings
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param successMode Whether the batch request should fail atomically or in a partial fashion - allowed values: Atomic, Partial (default) (required)
     ...
     */
    private void upsertInstrumentEventInstructionsAsync(String scope, String code, String successMode, Map<String, InstrumentEventInstructionRequest> requestBody, String portfolioEffectiveAt, final ApiCallback<InstrumentEventInstructionsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertInstrumentEventInstructionsValidateBeforeCall(scope, code, successMode, requestBody, portfolioEffectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<InstrumentEventInstructionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertInstrumentEventInstructionsAsync(String scope, String code, String successMode, Map<String, InstrumentEventInstructionRequest> requestBody, String portfolioEffectiveAt, final ApiCallback<InstrumentEventInstructionsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertInstrumentEventInstructionsValidateBeforeCall(scope, code, successMode, requestBody, portfolioEffectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<InstrumentEventInstructionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertInstrumentEventInstructionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<InstrumentEventInstructionsResponse> _callback) throws ApiException {
            upsertInstrumentEventInstructionsAsync(scope, code, successMode, requestBody, portfolioEffectiveAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<InstrumentEventInstructionsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertInstrumentEventInstructionsAsync(scope, code, successMode, requestBody, portfolioEffectiveAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertPortfolioAccessMetadataCall(String scope, String code, String metadataKey, UpsertPortfolioAccessMetadataRequest upsertPortfolioAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for upsertPortfolioAccessMetadata. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope to use when updating or inserting the Portfolio Access Metadata Rule. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code Portfolio code (required). Use any specified configuration options to override any other configuration for this request only.
     * @param metadataKey Key of the access metadata to upsert (required). Use any specified configuration options to override any other configuration for this request only.
     * @param upsertPortfolioAccessMetadataRequest The Portfolio Access Metadata Rule to update or insert (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The date this rule will effective from (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveUntil The effective date until which the Access Metadata is valid. If not supplied this will be valid indefinitely, or until the next &#39;effectiveAt&#39; date of the Access Metadata (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest upsertPortfolioAccessMetadataCall(String scope, String code, String metadataKey, UpsertPortfolioAccessMetadataRequest upsertPortfolioAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private ApiResponse<ResourceListOfAccessMetadataValueOf> upsertPortfolioAccessMetadataWithHttpInfo(String scope, String code, String metadataKey, UpsertPortfolioAccessMetadataRequest upsertPortfolioAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil) throws ApiException {
        HttpRequest localVarCall = upsertPortfolioAccessMetadataValidateBeforeCall(scope, code, metadataKey, upsertPortfolioAccessMetadataRequest, effectiveAt, effectiveUntil, null, new ConfigurationOptions());
    ...
    /**
     * UpsertPortfolioAccessMetadata: Upsert a Portfolio Access Metadata Rule associated with specific metadataKey. This creates or updates the data in LUSID.
     * Update or insert one Portfolio Access Metadata Rule in a single scope. An item will be updated if it already exists  and inserted if it does not.    The response will return the successfully updated or inserted Portfolio Access Metadata Rule or failure message if unsuccessful    It is important to always check to verify success (or failure).                Multiple rules for a metadataKey can exists with different effective at dates, when resources are accessed the rule that is active for the current time will be fetchedUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope to use when updating or inserting the Portfolio Access Metadata Rule. (required)
     * @param code Portfolio code (required)
     * @param metadataKey Key of the access metadata to upsert (required)
     * @param upsertPortfolioAccessMetadataRequest The Portfolio Access Metadata Rule to update or insert (required)
    ...
    private ApiResponse<ResourceListOfAccessMetadataValueOf> upsertPortfolioAccessMetadataWithHttpInfo(String scope, String code, String metadataKey, UpsertPortfolioAccessMetadataRequest upsertPortfolioAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertPortfolioAccessMetadataValidateBeforeCall(scope, code, metadataKey, upsertPortfolioAccessMetadataRequest, effectiveAt, effectiveUntil, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfAccessMetadataValueOf>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpsertPortfolioAccessMetadata: Upsert a Portfolio Access Metadata Rule associated with specific metadataKey. This creates or updates the data in LUSID. (asynchronously)
     * Update or insert one Portfolio Access Metadata Rule in a single scope. An item will be updated if it already exists  and inserted if it does not.    The response will return the successfully updated or inserted Portfolio Access Metadata Rule or failure message if unsuccessful    It is important to always check to verify success (or failure).                Multiple rules for a metadataKey can exists with different effective at dates, when resources are accessed the rule that is active for the current time will be fetched
     * @param scope The scope to use when updating or inserting the Portfolio Access Metadata Rule. (required)
     * @param code Portfolio code (required)
     * @param metadataKey Key of the access metadata to upsert (required)
     ...
     */
    private void upsertPortfolioAccessMetadataAsync(String scope, String code, String metadataKey, UpsertPortfolioAccessMetadataRequest upsertPortfolioAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<ResourceListOfAccessMetadataValueOf> _callback) throws ApiException {

        HttpRequest localVarCall = upsertPortfolioAccessMetadataValidateBeforeCall(scope, code, metadataKey, upsertPortfolioAccessMetadataRequest, effectiveAt, effectiveUntil, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfAccessMetadataValueOf>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertPortfolioAccessMetadataAsync(String scope, String code, String metadataKey, UpsertPortfolioAccessMetadataRequest upsertPortfolioAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<ResourceListOfAccessMetadataValueOf> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertPortfolioAccessMetadataValidateBeforeCall(scope, code, metadataKey, upsertPortfolioAccessMetadataRequest, effectiveAt, effectiveUntil, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfAccessMetadataValueOf>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertPortfolioAccessMetadataRequest {
        ...
        public void executeAsync(final ApiCallback<ResourceListOfAccessMetadataValueOf> _callback) throws ApiException {
            upsertPortfolioAccessMetadataAsync(scope, code, metadataKey, upsertPortfolioAccessMetadataRequest, effectiveAt, effectiveUntil, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<ResourceListOfAccessMetadataValueOf> _callback, ConfigurationOptions opts) throws ApiException {
            upsertPortfolioAccessMetadataAsync(scope, code, metadataKey, upsertPortfolioAccessMetadataRequest, effectiveAt, effectiveUntil, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertPortfolioPropertiesCall(String scope, String code, Map<String, Property> requestBody, final ApiCallback _callback) throws ApiException {
        return upsertPortfolioPropertiesCall(scope, code, requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertPortfolioProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The properties to be created or updated. Each property in               the request must be keyed by its unique property key. This has the format {domain}/{scope}/{code}, for example               &#39;Portfolio/Manager/Id&#39;. (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest upsertPortfolioPropertiesCall(String scope, String code, Map<String, Property> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertPortfolioPropertiesValidateBeforeCall(String scope, String code, Map<String, Property> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PortfolioProperties> upsertPortfolioPropertiesWithHttpInfo(String scope, String code, Map<String, Property> requestBody) throws ApiException {
        HttpRequest localVarCall = upsertPortfolioPropertiesValidateBeforeCall(scope, code, requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PortfolioProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PortfolioProperties> upsertPortfolioPropertiesWithHttpInfo(String scope, String code, Map<String, Property> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertPortfolioPropertiesValidateBeforeCall(scope, code, requestBody, null, opts);
        Type localVarReturnType = new TypeReference<PortfolioProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertPortfolioPropertiesAsync(String scope, String code, Map<String, Property> requestBody, final ApiCallback<PortfolioProperties> _callback) throws ApiException {

        HttpRequest localVarCall = upsertPortfolioPropertiesValidateBeforeCall(scope, code, requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PortfolioProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertPortfolioPropertiesAsync(String scope, String code, Map<String, Property> requestBody, final ApiCallback<PortfolioProperties> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertPortfolioPropertiesValidateBeforeCall(scope, code, requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<PortfolioProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertPortfolioPropertiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PortfolioProperties> _callback) throws ApiException {
            upsertPortfolioPropertiesAsync(scope, code, requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PortfolioProperties> _callback, ConfigurationOptions opts) throws ApiException {
            upsertPortfolioPropertiesAsync(scope, code, requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertPortfolioReturnsCall(String scope, String code, String returnScope, String returnCode, List<PerformanceReturn> performanceReturn, final ApiCallback _callback) throws ApiException {
        return upsertPortfolioReturnsCall(scope, code, returnScope, returnCode, performanceReturn,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertPortfolioReturns. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the  Portfolio. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param returnScope The scope of the Returns. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param returnCode The code of the Returns. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest upsertPortfolioReturnsCall(String scope, String code, String returnScope, String returnCode, List<PerformanceReturn> performanceReturn, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertPortfolioReturnsValidateBeforeCall(String scope, String code, String returnScope, String returnCode, List<PerformanceReturn> performanceReturn, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<UpsertReturnsResponse> upsertPortfolioReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, List<PerformanceReturn> performanceReturn) throws ApiException {
        HttpRequest localVarCall = upsertPortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, performanceReturn, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertReturnsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpsertPortfolioReturns: Upsert Returns
     * Update or insert returns into the specified portfolio.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param returnScope The scope of the Returns. (required)
     * @param returnCode The code of the Returns. (required)
    ...
    private ApiResponse<UpsertReturnsResponse> upsertPortfolioReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, List<PerformanceReturn> performanceReturn, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertPortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, performanceReturn, null, opts);
        Type localVarReturnType = new TypeReference<UpsertReturnsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpsertPortfolioReturns: Upsert Returns (asynchronously)
     * Update or insert returns into the specified portfolio.
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param returnScope The scope of the Returns. (required)
     ...
     */
    private void upsertPortfolioReturnsAsync(String scope, String code, String returnScope, String returnCode, List<PerformanceReturn> performanceReturn, final ApiCallback<UpsertReturnsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertPortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, performanceReturn, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertReturnsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertPortfolioReturnsAsync(String scope, String code, String returnScope, String returnCode, List<PerformanceReturn> performanceReturn, final ApiCallback<UpsertReturnsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertPortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, performanceReturn, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertReturnsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertPortfolioReturnsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UpsertReturnsResponse> _callback) throws ApiException {
            upsertPortfolioReturnsAsync(scope, code, returnScope, returnCode, performanceReturn, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UpsertReturnsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertPortfolioReturnsAsync(scope, code, returnScope, returnCode, performanceReturn, _callback, opts);
        }
    }
