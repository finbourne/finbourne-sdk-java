...
public class GetAddressKeyAliasResponse {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to GetAddressKeyAliasResponse
   */
  public static GetAddressKeyAliasResponse fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, GetAddressKeyAliasResponse.class);
  }
