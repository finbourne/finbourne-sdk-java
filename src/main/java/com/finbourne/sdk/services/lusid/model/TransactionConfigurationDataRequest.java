 ...
 */
@JsonPropertyOrder({
  TransactionConfigurationDataRequest.JSON_PROPERTY_ALIASES,
  TransactionConfigurationDataRequest.JSON_PROPERTY_MOVEMENTS,
  TransactionConfigurationDataRequest.JSON_PROPERTY_PROPERTIES
})
...
public class TransactionConfigurationDataRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to TransactionConfigurationDataRequest
   */
  public static TransactionConfigurationDataRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, TransactionConfigurationDataRequest.class);
  }
