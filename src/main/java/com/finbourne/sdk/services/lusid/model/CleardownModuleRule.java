...
public class CleardownModuleRule {
  ...
  /**
   * The filter syntax for the Cleardown Rule. See https://support.lusid.com/docs/assigning-economic-activity-to-general-ledger-accounts-using-posting-rules for more information on filter syntax.
   * @return ruleFilter
   */
  @javax.annotation.Nonnull
