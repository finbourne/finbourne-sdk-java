 ...
 */
@JsonPropertyOrder({
  StockSplitEvent.JSON_PROPERTY_PAYMENT_DATE,
  StockSplitEvent.JSON_PROPERTY_EX_DATE,
  StockSplitEvent.JSON_PROPERTY_UNITS_RATIO,
  StockSplitEvent.JSON_PROPERTY_RECORD_DATE,
  StockSplitEvent.JSON_PROPERTY_ANNOUNCEMENT_DATE,
...
public class StockSplitEvent extends InstrumentEvent {
  ...
  public StockSplitEvent fractionalUnitsRoundingConvention(String fractionalUnitsRoundingConvention) {
  ...
  public StockSplitEvent fractionalUnitsDecimalPlaces(Integer fractionalUnitsDecimalPlaces) {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to StockSplitEvent
   */
  public static StockSplitEvent fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, StockSplitEvent.class);
  }
