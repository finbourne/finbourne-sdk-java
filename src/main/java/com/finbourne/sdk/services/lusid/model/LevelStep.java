 ...
 */
@JsonPropertyOrder({
  LevelStep.JSON_PROPERTY_DATE,
  LevelStep.JSON_PROPERTY_QUANTITY
})
...
public class LevelStep {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to LevelStep
   */
  public static LevelStep fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, LevelStep.class);
  }
