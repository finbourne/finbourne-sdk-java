...
public class CustomEntitiesApi {
     ...
     */
    private HttpRequest deleteCustomEntityCall(String entityType, String identifierType, String identifierValue, String identifierScope, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for deleteCustomEntity. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of Custom Entity to remove. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierType An identifier type attached to the Custom Entity instance. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierValue The identifier value. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierScope The identifier scope. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteCustomEntityCall(String entityType, String identifierType, String identifierValue, String identifierScope, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/customentities/{entityType}/{identifierType}/{identifierValue}"
    ...
    private HttpRequest deleteCustomEntityValidateBeforeCall(String entityType, String identifierType, String identifierValue, String identifierScope, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteCustomEntityWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope) throws ApiException {
        HttpRequest localVarCall = deleteCustomEntityValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, null, new ConfigurationOptions());
    ...
    /**
     * DeleteCustomEntity: Delete a Custom Entity instance.
     * Delete a Custom Entity instance by a specific entity type.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The type of Custom Entity to remove. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     * @param identifierScope The identifier scope. (required)
    ...
    private ApiResponse<DeletedEntityResponse> deleteCustomEntityWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCustomEntityValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * DeleteCustomEntity: Delete a Custom Entity instance. (asynchronously)
     * Delete a Custom Entity instance by a specific entity type.
     * @param entityType The type of Custom Entity to remove. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     ...
     */
    private void deleteCustomEntityAsync(String entityType, String identifierType, String identifierValue, String identifierScope, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCustomEntityValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
     ...
     */
    private void deleteCustomEntityAsync(String entityType, String identifierType, String identifierValue, String identifierScope, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCustomEntityValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCustomEntityRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteCustomEntityAsync(entityType, identifierType, identifierValue, identifierScope, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCustomEntityAsync(entityType, identifierType, identifierValue, identifierScope, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteCustomEntityAccessMetadataCall(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for deleteCustomEntityAccessMetadata. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of the Custom Entity. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierType An identifier type attached to the Custom Entity instance. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierValue The identifier value. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param identifierScope The identifier scope. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest deleteCustomEntityAccessMetadataCall(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/customentities/{entityType}/{identifierType}/{identifierValue}/metadata/{metadataKey}"
            .replace("{" + "entityType" + "}", localVarApiClient.escapeString(entityType.toString()))
            .replace("{" + "identifierType" + "}", localVarApiClient.escapeString(identifierType.toString()))
            .replace("{" + "identifierValue" + "}", localVarApiClient.escapeString(identifierValue.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteCustomEntityAccessMetadataValidateBeforeCall(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteCustomEntityAccessMetadataWithHttpInfo(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime effectiveUntil) throws ApiException {
        HttpRequest localVarCall = deleteCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, effectiveUntil, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] DeleteCustomEntityAccessMetadata: Delete a Custom Entity Access Metadata entry
     * Deletes the Custom Entity Access Metadata entry that exactly matches the provided identifier parts.    It is important to always check to verify success (or failure).Use any specified configuration options to override any other configuration for this request only
     * @param entityType The type of the Custom Entity. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     * @param metadataKey Key of the metadata entry to delete. (required)
    ...
    private ApiResponse<DeletedEntityResponse> deleteCustomEntityAccessMetadataWithHttpInfo(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime effectiveUntil, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, effectiveUntil, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteCustomEntityAccessMetadataAsync(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, effectiveUntil, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteCustomEntityAccessMetadataAsync(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, effectiveUntil, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCustomEntityAccessMetadataRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteCustomEntityAccessMetadataAsync(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, effectiveUntil, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCustomEntityAccessMetadataAsync(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, effectiveUntil, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getAllCustomEntityAccessMetadataCall(String entityType, String identifierType, String identifierValue, String identifierScope, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getAllCustomEntityAccessMetadata. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of the Custom Entity. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierType An identifier type attached to the Custom Entity instance. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierValue The identifier value. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierScope The identifier scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to get the entities. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Access Metadata. Defaults to returning the latest version of the metadata if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getAllCustomEntityAccessMetadataCall(String entityType, String identifierType, String identifierValue, String identifierScope, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/customentities/{entityType}/{identifierType}/{identifierValue}/metadata"
            .replace("{" + "entityType" + "}", localVarApiClient.escapeString(entityType.toString()))
            .replace("{" + "identifierType" + "}", localVarApiClient.escapeString(identifierType.toString()))
            .replace("{" + "identifierValue" + "}", localVarApiClient.escapeString(identifierValue.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getAllCustomEntityAccessMetadataValidateBeforeCall(String entityType, String identifierType, String identifierValue, String identifierScope, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<Map<String, List<AccessMetadataValue>>> getAllCustomEntityAccessMetadataWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getAllCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, effectiveAt, asAt, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] GetAllCustomEntityAccessMetadata: Get all the Access Metadata rules for a Custom Entity
     * Get all the Custom Entity access metadata for the specified identifier scope, code and valueUse any specified configuration options to override any other configuration for this request only
     * @param entityType The type of the Custom Entity. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     * @param identifierScope The identifier scope. (required)
    ...
    private ApiResponse<Map<String, List<AccessMetadataValue>>> getAllCustomEntityAccessMetadataWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getAllCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getAllCustomEntityAccessMetadataAsync(String entityType, String identifierType, String identifierValue, String identifierScope, String effectiveAt, OffsetDateTime asAt, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {

        HttpRequest localVarCall = getAllCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getAllCustomEntityAccessMetadataAsync(String entityType, String identifierType, String identifierValue, String identifierScope, String effectiveAt, OffsetDateTime asAt, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getAllCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetAllCustomEntityAccessMetadataRequest {
        ...
        public void executeAsync(final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {
            getAllCustomEntityAccessMetadataAsync(entityType, identifierType, identifierValue, identifierScope, effectiveAt, asAt, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback, ConfigurationOptions opts) throws ApiException {
            getAllCustomEntityAccessMetadataAsync(entityType, identifierType, identifierValue, identifierScope, effectiveAt, asAt, _callback, opts);
        }
    }
    ...
    /**
     * Build call for getAllCustomEntityProperties
     * @param entityType The type of Custom Entity. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     * @param identifierScope The identifier scope. (required)
     * @param asAt The AsAt datetime at which to retrieve the Custom Entity properties. (optional)
     * @param effectiveAt The effective datetime at which to get the Custom Entity properties. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Get all properties for a custom entity instance. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    private HttpRequest getAllCustomEntityPropertiesCall(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback) throws ApiException {
        return getAllCustomEntityPropertiesCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getAllCustomEntityProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of Custom Entity. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierType An identifier type attached to the Custom Entity instance. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierValue The identifier value. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierScope The identifier scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The AsAt datetime at which to retrieve the Custom Entity properties. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime at which to get the Custom Entity properties. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getAllCustomEntityPropertiesCall(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/customentities/{entityType}/{identifierType}/{identifierValue}/properties"
            .replace("{" + "entityType" + "}", localVarApiClient.escapeString(entityType.toString()))
            .replace("{" + "identifierType" + "}", localVarApiClient.escapeString(identifierType.toString()))
            .replace("{" + "identifierValue" + "}", localVarApiClient.escapeString(identifierValue.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getAllCustomEntityPropertiesValidateBeforeCall(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
            throw new ApiException("Missing the required parameter 'entityType' when calling getAllCustomEntityProperties(Async)");
        }

        // verify the required parameter 'identifierType' is set
        if (identifierType == null) {
            throw new ApiException("Missing the required parameter 'identifierType' when calling getAllCustomEntityProperties(Async)");
        }

        // verify the required parameter 'identifierValue' is set
        if (identifierValue == null) {
            throw new ApiException("Missing the required parameter 'identifierValue' when calling getAllCustomEntityProperties(Async)");
        }

        // verify the required parameter 'identifierScope' is set
        if (identifierScope == null) {
            throw new ApiException("Missing the required parameter 'identifierScope' when calling getAllCustomEntityProperties(Async)");
        }

        return getAllCustomEntityPropertiesCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, _callback, opts);
     ...
     * @param asAt The AsAt datetime at which to retrieve the Custom Entity properties. (optional)
     * @param effectiveAt The effective datetime at which to get the Custom Entity properties. Defaults to the current LUSID system datetime if not specified. (optional)
     * @return ApiResponse&lt;CustomEntityProperties&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    private ApiResponse<CustomEntityProperties> getAllCustomEntityPropertiesWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt) throws ApiException {
        HttpRequest localVarCall = getAllCustomEntityPropertiesValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomEntityProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetAllCustomEntityProperties: Get all properties related to a Custom Entity instance.
     * Returns only properties that a user has permissions to read             and that are applicable to the specific entity type as per PropertyDefinition CustomEntityTypes.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The type of Custom Entity. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     * @param identifierScope The identifier scope. (required)
     ...
     */
    private ApiResponse<CustomEntityProperties> getAllCustomEntityPropertiesWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getAllCustomEntityPropertiesValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<CustomEntityProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetAllCustomEntityProperties: Get all properties related to a Custom Entity instance. (asynchronously)
     * Returns only properties that a user has permissions to read             and that are applicable to the specific entity type as per PropertyDefinition CustomEntityTypes.
     * @param entityType The type of Custom Entity. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     ...
     */
    private void getAllCustomEntityPropertiesAsync(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, final ApiCallback<CustomEntityProperties> _callback) throws ApiException {

        HttpRequest localVarCall = getAllCustomEntityPropertiesValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomEntityProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getAllCustomEntityPropertiesAsync(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, final ApiCallback<CustomEntityProperties> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getAllCustomEntityPropertiesValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<CustomEntityProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }

    public class APIgetAllCustomEntityPropertiesRequest {
        private final String entityType;
        private final String identifierType;
        private final String identifierValue;
        private final String identifierScope;
        ...
        private APIgetAllCustomEntityPropertiesRequest(String entityType, String identifierType, String identifierValue, String identifierScope) {
            this.entityType = entityType;
            this.identifierType = identifierType;
            this.identifierValue = identifierValue;
            this.identifierScope = identifierScope;
         ...
         * Set asAt
         * @param asAt The AsAt datetime at which to retrieve the Custom Entity properties. (optional)
         * @return APIgetAllCustomEntityPropertiesRequest
         */
        public APIgetAllCustomEntityPropertiesRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }
         ...
         * @return APIgetAllCustomEntityPropertiesRequest
         */
        public APIgetAllCustomEntityPropertiesRequest effectiveAt(String effectiveAt) {
            this.effectiveAt = effectiveAt;
            return this;
        }
         ...
         */
        public HttpRequest buildCall(final ApiCallback _callback) throws ApiException {
            return getAllCustomEntityPropertiesCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, _callback);
        }

        /**
         * Execute getAllCustomEntityProperties request
         ...
         */
        public CustomEntityProperties execute() throws ApiException {
            ApiResponse<CustomEntityProperties> localVarResp = getAllCustomEntityPropertiesWithHttpInfo(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt);
            return localVarResp.getData();
        }

        /**
         * Execute getAllCustomEntityProperties request. Use any specified configuration options to override any other configuration for this request only.
         * @return CustomEntityProperties
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public CustomEntityProperties execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<CustomEntityProperties> localVarResp = getAllCustomEntityPropertiesWithHttpInfo(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, opts);
            return localVarResp.getData();
        }

        /**
         * Execute getAllCustomEntityProperties request with HTTP info returned
         * @return ApiResponse&lt;CustomEntityProperties&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<CustomEntityProperties> executeWithHttpInfo() throws ApiException {
            return getAllCustomEntityPropertiesWithHttpInfo(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt);
        }

        /**
         * Execute getAllCustomEntityProperties request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;CustomEntityProperties&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<CustomEntityProperties> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return getAllCustomEntityPropertiesWithHttpInfo(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, opts);
        }

        /**
         * Execute getAllCustomEntityProperties request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public void executeAsync(final ApiCallback<CustomEntityProperties> _callback) throws ApiException {
            getAllCustomEntityPropertiesAsync(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, _callback);
        }

        /**
         * Execute getAllCustomEntityProperties request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public void executeAsync(final ApiCallback<CustomEntityProperties> _callback, ConfigurationOptions opts) throws ApiException {
            getAllCustomEntityPropertiesAsync(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, _callback, opts);
        }
    }
     ...
     */
    public APIgetAllCustomEntityPropertiesRequest getAllCustomEntityProperties(String entityType, String identifierType, String identifierValue, String identifierScope) {
        return new APIgetAllCustomEntityPropertiesRequest(entityType, identifierType, identifierValue, identifierScope);
    }
    /**
    ...
    /**
     * Build call for getCustomEntity. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of Custom Entity to retrieve. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierType An identifier type attached to the Custom Entity instance. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierValue The identifier value. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierScope The identifier scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The AsAt datetime at which to retrieve the Custom Entity instance. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to get the Custom Entity instance. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param relationshipDefinitionIds A list of relationship definitions that are used to decorate related entities              onto the entity in the response. These must take the form {relationshipDefinitionScope}/{relationshipDefinitionCode}. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;CustomEntity&#39; domain to decorate onto              the custom entities of any type supported by that property (defined within the property definition CustomEntityTypes).              These must have the format {domain}/{scope}/{code}, for example &#39;CustomEntity/someScope/id&#39;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCustomEntityValidateBeforeCall(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<CustomEntityResponse> getCustomEntityWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = getCustomEntityValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetCustomEntity: Get a Custom Entity instance.
     * Retrieve a Custom Entity instance by a specific entity type at a point in AsAt time.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The type of Custom Entity to retrieve. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     * @param identifierScope The identifier scope. (required)
    ...
    private ApiResponse<CustomEntityResponse> getCustomEntityWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCustomEntityValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<CustomEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetCustomEntity: Get a Custom Entity instance. (asynchronously)
     * Retrieve a Custom Entity instance by a specific entity type at a point in AsAt time.
     * @param entityType The type of Custom Entity to retrieve. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     ...
     */
    private void getCustomEntityAsync(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys, final ApiCallback<CustomEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getCustomEntityValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    private void getCustomEntityAsync(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys, final ApiCallback<CustomEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
        ...
        HttpRequest localVarCall = getCustomEntityValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<CustomEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCustomEntityRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CustomEntityResponse> _callback) throws ApiException {
            getCustomEntityAsync(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CustomEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getCustomEntityAsync(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getCustomEntityAccessMetadataByKeyCall(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getCustomEntityAccessMetadataByKey. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of the Custom Entity. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierType An identifier type attached to the Custom Entity instance. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierValue The identifier value. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getCustomEntityAccessMetadataByKeyCall(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCustomEntityAccessMetadataByKeyValidateBeforeCall(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<List<AccessMetadataValue>> getCustomEntityAccessMetadataByKeyWithHttpInfo(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getCustomEntityAccessMetadataByKeyValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, asAt, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] GetCustomEntityAccessMetadataByKey: Get an entry identified by a metadataKey in the Access Metadata of a Custom Entity
     * Get Custom Entity access metadata for the specified metadata keyUse any specified configuration options to override any other configuration for this request only
     * @param entityType The type of the Custom Entity. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     * @param metadataKey Key of the metadata entry to retrieve (required)
    ...
    private ApiResponse<List<AccessMetadataValue>> getCustomEntityAccessMetadataByKeyWithHttpInfo(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCustomEntityAccessMetadataByKeyValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<List<AccessMetadataValue>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getCustomEntityAccessMetadataByKeyAsync(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime asAt, final ApiCallback<List<AccessMetadataValue>> _callback) throws ApiException {

        HttpRequest localVarCall = getCustomEntityAccessMetadataByKeyValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<List<AccessMetadataValue>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCustomEntityAccessMetadataByKeyAsync(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, String effectiveAt, OffsetDateTime asAt, final ApiCallback<List<AccessMetadataValue>> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCustomEntityAccessMetadataByKeyValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<List<AccessMetadataValue>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCustomEntityAccessMetadataByKeyRequest {
        ...
        public void executeAsync(final ApiCallback<List<AccessMetadataValue>> _callback) throws ApiException {
            getCustomEntityAccessMetadataByKeyAsync(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, asAt, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<List<AccessMetadataValue>> _callback, ConfigurationOptions opts) throws ApiException {
            getCustomEntityAccessMetadataByKeyAsync(entityType, identifierType, identifierValue, metadataKey, identifierScope, effectiveAt, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getCustomEntityRelationshipsCall(String entityType, String identifierScope, String identifierType, String identifierValue, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getCustomEntityRelationships. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of entity get relationships for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierScope The identifier scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierType An identifier type attached to the Custom Entity. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierValue The identifier value. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getCustomEntityRelationshipsCall(String entityType, String identifierScope, String identifierType, String identifierValue, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/customentities/{entityType}/{identifierType}/{identifierValue}/relationships"
            .replace("{" + "entityType" + "}", localVarApiClient.escapeString(entityType.toString()))
            .replace("{" + "identifierType" + "}", localVarApiClient.escapeString(identifierType.toString()))
            .replace("{" + "identifierValue" + "}", localVarApiClient.escapeString(identifierValue.toString()));
    ...
    private ApiResponse<ResourceListOfRelationship> getCustomEntityRelationshipsWithHttpInfo(String entityType, String identifierScope, String identifierType, String identifierValue, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes) throws ApiException {
        HttpRequest localVarCall = getCustomEntityRelationshipsValidateBeforeCall(entityType, identifierScope, identifierType, identifierValue, effectiveAt, asAt, filter, identifierTypes, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] GetCustomEntityRelationships: Get Relationships for Custom Entity
     * Get relationships for the specified Custom Entity.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The type of entity get relationships for. (required)
     * @param identifierScope The identifier scope. (required)
     * @param identifierType An identifier type attached to the Custom Entity. (required)
     * @param identifierValue The identifier value. (required)
    ...
    private ApiResponse<ResourceListOfRelationship> getCustomEntityRelationshipsWithHttpInfo(String entityType, String identifierScope, String identifierType, String identifierValue, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCustomEntityRelationshipsValidateBeforeCall(entityType, identifierScope, identifierType, identifierValue, effectiveAt, asAt, filter, identifierTypes, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfRelationship>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getCustomEntityRelationshipsAsync(String entityType, String identifierScope, String identifierType, String identifierValue, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback<ResourceListOfRelationship> _callback) throws ApiException {

        HttpRequest localVarCall = getCustomEntityRelationshipsValidateBeforeCall(entityType, identifierScope, identifierType, identifierValue, effectiveAt, asAt, filter, identifierTypes, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfRelationship>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCustomEntityRelationshipsAsync(String entityType, String identifierScope, String identifierType, String identifierValue, String effectiveAt, OffsetDateTime asAt, String filter, List<String> identifierTypes, final ApiCallback<ResourceListOfRelationship> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCustomEntityRelationshipsValidateBeforeCall(entityType, identifierScope, identifierType, identifierValue, effectiveAt, asAt, filter, identifierTypes, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfRelationship>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCustomEntityRelationshipsRequest {
        ...
        public void executeAsync(final ApiCallback<ResourceListOfRelationship> _callback) throws ApiException {
            getCustomEntityRelationshipsAsync(entityType, identifierScope, identifierType, identifierValue, effectiveAt, asAt, filter, identifierTypes, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<ResourceListOfRelationship> _callback, ConfigurationOptions opts) throws ApiException {
            getCustomEntityRelationshipsAsync(entityType, identifierScope, identifierType, identifierValue, effectiveAt, asAt, filter, identifierTypes, _callback, opts);
        }
    }
    ...
    /**
     * Build call for listCustomEntities. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of Custom Entity to list. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the entities. Defaults to the current LUSID              system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param page The pagination token to use to continue listing entities; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param relatedEntityPropertyKeys A list of property keys from any domain that supports relationships              to decorate onto related entities. These must take the format {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param relationshipDefinitionIds A list of relationship definitions that are used to decorate related entities              onto the entities in the response. These must take the form {relationshipDefinitionScope}/{relationshipDefinitionCode}. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;CustomEntity&#39; domain to decorate onto              the custom entities of any type supported by that property (defined within the property definition CustomEntityTypes).              These must have the format {domain}/{scope}/{code}, for example &#39;CustomEntity/someScope/id&#39;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    private HttpRequest listCustomEntitiesCall(String entityType, String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, List<String> sortBy, String page, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/api/customentities/{entityType}"
            .replace("{" + "entityType" + "}", localVarApiClient.escapeString(entityType.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listCustomEntitiesValidateBeforeCall(String entityType, String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, List<String> sortBy, String page, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<PagedResourceListOfCustomEntityResponse> listCustomEntitiesWithHttpInfo(String entityType, String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, List<String> sortBy, String page, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = listCustomEntitiesValidateBeforeCall(entityType, effectiveAt, asAt, limit, filter, sortBy, page, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCustomEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListCustomEntities: List Custom Entities of the specified entityType.
     * List all the Custom Entities matching particular criteria.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The type of Custom Entity to list. (required)
     * @param effectiveAt The effective datetime or cut label at which to list the entities. Defaults to the current LUSID              system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the entities. Defaults to returning the latest version              of each portfolio if not specified. (optional)
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional)
     ...
     */
    private ApiResponse<PagedResourceListOfCustomEntityResponse> listCustomEntitiesWithHttpInfo(String entityType, String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, List<String> sortBy, String page, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listCustomEntitiesValidateBeforeCall(entityType, effectiveAt, asAt, limit, filter, sortBy, page, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCustomEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListCustomEntities: List Custom Entities of the specified entityType. (asynchronously)
     * List all the Custom Entities matching particular criteria.
     * @param entityType The type of Custom Entity to list. (required)
     * @param effectiveAt The effective datetime or cut label at which to list the entities. Defaults to the current LUSID              system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the entities. Defaults to returning the latest version              of each portfolio if not specified. (optional)
     ...
     */
    private void listCustomEntitiesAsync(String entityType, String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, List<String> sortBy, String page, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys, final ApiCallback<PagedResourceListOfCustomEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = listCustomEntitiesValidateBeforeCall(entityType, effectiveAt, asAt, limit, filter, sortBy, page, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCustomEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    private void listCustomEntitiesAsync(String entityType, String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, List<String> sortBy, String page, List<String> relatedEntityPropertyKeys, List<String> relationshipDefinitionIds, List<String> propertyKeys, final ApiCallback<PagedResourceListOfCustomEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
        ...
        HttpRequest localVarCall = listCustomEntitiesValidateBeforeCall(entityType, effectiveAt, asAt, limit, filter, sortBy, page, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCustomEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistCustomEntitiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCustomEntityResponse> _callback) throws ApiException {
            listCustomEntitiesAsync(entityType, effectiveAt, asAt, limit, filter, sortBy, page, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCustomEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            listCustomEntitiesAsync(entityType, effectiveAt, asAt, limit, filter, sortBy, page, relatedEntityPropertyKeys, relationshipDefinitionIds, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest patchCustomEntityAccessMetadataCall(String entityType, String identifierType, String identifierValue, String identifierScope, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for patchCustomEntityAccessMetadata. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of the Custom Entity. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierType An identifier type attached to the Custom Entity instance. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierValue The identifier value. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierScope The identifier scope. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param effectiveAt The effectiveAt datetime at which the Access Metadata will be effective from (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveUntil The effective datetime until which the Access Metadata is valid. If not supplied this will be valid indefinitely, or until the next &#39;effectiveAt&#39; datetime of the Access Metadata (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest patchCustomEntityAccessMetadataCall(String entityType, String identifierType, String identifierValue, String identifierScope, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest patchCustomEntityAccessMetadataValidateBeforeCall(String entityType, String identifierType, String identifierValue, String identifierScope, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<Map<String, List<AccessMetadataValue>>> patchCustomEntityAccessMetadataWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil) throws ApiException {
        HttpRequest localVarCall = patchCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, accessMetadataOperation, effectiveAt, effectiveUntil, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<Map<String, List<AccessMetadataValue>>> patchCustomEntityAccessMetadataWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = patchCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, accessMetadataOperation, effectiveAt, effectiveUntil, null, opts);
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void patchCustomEntityAccessMetadataAsync(String entityType, String identifierType, String identifierValue, String identifierScope, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {

        HttpRequest localVarCall = patchCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, accessMetadataOperation, effectiveAt, effectiveUntil, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void patchCustomEntityAccessMetadataAsync(String entityType, String identifierType, String identifierValue, String identifierScope, List<AccessMetadataOperation> accessMetadataOperation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = patchCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, accessMetadataOperation, effectiveAt, effectiveUntil, _callback, opts);
        Type localVarReturnType = new TypeReference<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIpatchCustomEntityAccessMetadataRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {
            patchCustomEntityAccessMetadataAsync(entityType, identifierType, identifierValue, identifierScope, accessMetadataOperation, effectiveAt, effectiveUntil, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback, ConfigurationOptions opts) throws ApiException {
            patchCustomEntityAccessMetadataAsync(entityType, identifierType, identifierValue, identifierScope, accessMetadataOperation, effectiveAt, effectiveUntil, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertCustomEntitiesCall(String entityType, String successMode, Map<String, CustomEntityRequest> requestBody, final ApiCallback _callback) throws ApiException {
        return upsertCustomEntitiesCall(entityType, successMode, requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertCustomEntities. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of the Custom Entity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest upsertCustomEntitiesCall(String entityType, String successMode, Map<String, CustomEntityRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/customentities/{entityType}/$batchUpsert"
            .replace("{" + "entityType" + "}", localVarApiClient.escapeString(entityType.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertCustomEntitiesValidateBeforeCall(String entityType, String successMode, Map<String, CustomEntityRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<UpsertCustomEntitiesResponse> upsertCustomEntitiesWithHttpInfo(String entityType, String successMode, Map<String, CustomEntityRequest> requestBody) throws ApiException {
        HttpRequest localVarCall = upsertCustomEntitiesValidateBeforeCall(entityType, successMode, requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertCustomEntitiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpsertCustomEntities: Batch upsert instances of Custom Entities
     * Note: If using partial failure modes, then it is important to check the response body for failures as any failures will still return a 200 status codeUse any specified configuration options to override any other configuration for this request only
     * @param entityType The type of the Custom Entity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required)
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial (required)
     * @param requestBody The payload describing the Custom Entity instances (required)
     * @return ApiResponse&lt;UpsertCustomEntitiesResponse&gt;
    ...
    private ApiResponse<UpsertCustomEntitiesResponse> upsertCustomEntitiesWithHttpInfo(String entityType, String successMode, Map<String, CustomEntityRequest> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertCustomEntitiesValidateBeforeCall(entityType, successMode, requestBody, null, opts);
        Type localVarReturnType = new TypeReference<UpsertCustomEntitiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertCustomEntitiesAsync(String entityType, String successMode, Map<String, CustomEntityRequest> requestBody, final ApiCallback<UpsertCustomEntitiesResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertCustomEntitiesValidateBeforeCall(entityType, successMode, requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertCustomEntitiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertCustomEntitiesAsync(String entityType, String successMode, Map<String, CustomEntityRequest> requestBody, final ApiCallback<UpsertCustomEntitiesResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertCustomEntitiesValidateBeforeCall(entityType, successMode, requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertCustomEntitiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertCustomEntitiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UpsertCustomEntitiesResponse> _callback) throws ApiException {
            upsertCustomEntitiesAsync(entityType, successMode, requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UpsertCustomEntitiesResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertCustomEntitiesAsync(entityType, successMode, requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertCustomEntityCall(String entityType, CustomEntityRequest customEntityRequest, final ApiCallback _callback) throws ApiException {
        return upsertCustomEntityCall(entityType, customEntityRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertCustomEntity. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of the Custom Entity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param customEntityRequest The payload describing the Custom Entity instance. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest upsertCustomEntityCall(String entityType, CustomEntityRequest customEntityRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertCustomEntityValidateBeforeCall(String entityType, CustomEntityRequest customEntityRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<CustomEntityResponse> upsertCustomEntityWithHttpInfo(String entityType, CustomEntityRequest customEntityRequest) throws ApiException {
        HttpRequest localVarCall = upsertCustomEntityValidateBeforeCall(entityType, customEntityRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * UpsertCustomEntity: Upsert a Custom Entity instance
     * Insert the Custom Entity if it does not exist or update the Custom Entity with the supplied state if it does exist.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The type of the Custom Entity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required)
     * @param customEntityRequest The payload describing the Custom Entity instance. (required)
     * @return ApiResponse&lt;CustomEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<CustomEntityResponse> upsertCustomEntityWithHttpInfo(String entityType, CustomEntityRequest customEntityRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertCustomEntityValidateBeforeCall(entityType, customEntityRequest, null, opts);
        Type localVarReturnType = new TypeReference<CustomEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpsertCustomEntity: Upsert a Custom Entity instance (asynchronously)
     * Insert the Custom Entity if it does not exist or update the Custom Entity with the supplied state if it does exist.
     * @param entityType The type of the Custom Entity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required)
     * @param customEntityRequest The payload describing the Custom Entity instance. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void upsertCustomEntityAsync(String entityType, CustomEntityRequest customEntityRequest, final ApiCallback<CustomEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertCustomEntityValidateBeforeCall(entityType, customEntityRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertCustomEntityAsync(String entityType, CustomEntityRequest customEntityRequest, final ApiCallback<CustomEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertCustomEntityValidateBeforeCall(entityType, customEntityRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<CustomEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertCustomEntityRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CustomEntityResponse> _callback) throws ApiException {
            upsertCustomEntityAsync(entityType, customEntityRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CustomEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertCustomEntityAsync(entityType, customEntityRequest, _callback, opts);
        }
    }
    ...
    /**
     * Build call for upsertCustomEntityAccessMetadata. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of the Custom Entity. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierType An identifier type attached to the Custom Entity instance. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierValue The identifier value. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param metadataKey Key of the metadata entry to retrieve (required). Use any specified configuration options to override any other configuration for this request only.
     * @param identifierScope The identifier scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param upsertCustomEntityAccessMetadataRequest The Custom Entity Access Metadata entry to upsert (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effectiveAt datetime at which the Access Metadata will be effective from (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveUntil The effective datetime until which the Access Metadata is valid. If not supplied this will be valid indefinitely, or until the next &#39;effectiveAt&#39; datetime of the Access Metadata (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertCustomEntityAccessMetadataValidateBeforeCall(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, UpsertCustomEntityAccessMetadataRequest upsertCustomEntityAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<List<AccessMetadataValue>> upsertCustomEntityAccessMetadataWithHttpInfo(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, UpsertCustomEntityAccessMetadataRequest upsertCustomEntityAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil) throws ApiException {
        HttpRequest localVarCall = upsertCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, upsertCustomEntityAccessMetadataRequest, effectiveAt, effectiveUntil, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<List<AccessMetadataValue>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpsertCustomEntityAccessMetadata: Upsert a Custom Entity Access Metadata entry associated with a specific metadataKey. This creates or updates the data in LUSID.
     * Update or insert one Custom Entity Access Metadata entry in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted Custom Entity Access Metadata rule or failure message if unsuccessful.                It is important to always check to verify success (or failure).                Multiple rules for a metadataKey can exist with different effective at dates, when resources are accessed the rule that is active for the current time will be fetched.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The type of the Custom Entity. (required)
     * @param identifierType An identifier type attached to the Custom Entity instance. (required)
     * @param identifierValue The identifier value. (required)
     * @param metadataKey Key of the metadata entry to retrieve (required)
    ...
    private ApiResponse<List<AccessMetadataValue>> upsertCustomEntityAccessMetadataWithHttpInfo(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, UpsertCustomEntityAccessMetadataRequest upsertCustomEntityAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, upsertCustomEntityAccessMetadataRequest, effectiveAt, effectiveUntil, null, opts);
        Type localVarReturnType = new TypeReference<List<AccessMetadataValue>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertCustomEntityAccessMetadataAsync(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, UpsertCustomEntityAccessMetadataRequest upsertCustomEntityAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<List<AccessMetadataValue>> _callback) throws ApiException {

        HttpRequest localVarCall = upsertCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, upsertCustomEntityAccessMetadataRequest, effectiveAt, effectiveUntil, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<List<AccessMetadataValue>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertCustomEntityAccessMetadataAsync(String entityType, String identifierType, String identifierValue, String metadataKey, String identifierScope, UpsertCustomEntityAccessMetadataRequest upsertCustomEntityAccessMetadataRequest, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<List<AccessMetadataValue>> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertCustomEntityAccessMetadataValidateBeforeCall(entityType, identifierType, identifierValue, metadataKey, identifierScope, upsertCustomEntityAccessMetadataRequest, effectiveAt, effectiveUntil, _callback, opts);
        Type localVarReturnType = new TypeReference<List<AccessMetadataValue>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertCustomEntityAccessMetadataRequest {
         ...
         */
        public void executeAsync(final ApiCallback<List<AccessMetadataValue>> _callback) throws ApiException {
            upsertCustomEntityAccessMetadataAsync(entityType, identifierType, identifierValue, metadataKey, identifierScope, upsertCustomEntityAccessMetadataRequest, effectiveAt, effectiveUntil, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<List<AccessMetadataValue>> _callback, ConfigurationOptions opts) throws ApiException {
            upsertCustomEntityAccessMetadataAsync(entityType, identifierType, identifierValue, metadataKey, identifierScope, upsertCustomEntityAccessMetadataRequest, effectiveAt, effectiveUntil, _callback, opts);
        }
    }
