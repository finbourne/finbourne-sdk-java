...
public class TransactionFeesApi {
     ...
     */
    private HttpRequest deleteTransactionFeeRuleCall(String code, final ApiCallback _callback) throws ApiException {
        return deleteTransactionFeeRuleCall(code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteTransactionFeeRule. Use any specified configuration options to override any other configuration for this request only.
     * @param code The fee rule code. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteTransactionFeeRuleCall(String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/transactions/fees/rules/{code}"
    ...
    private HttpRequest deleteTransactionFeeRuleValidateBeforeCall(String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteTransactionFeeRuleWithHttpInfo(String code) throws ApiException {
        HttpRequest localVarCall = deleteTransactionFeeRuleValidateBeforeCall(code, null, new ConfigurationOptions());
    ...
    /**
     * DeleteTransactionFeeRule: Deletes a fee rule.
     * Deletes the rule for all effective time.    The rule will remain viewable at previous as at times, but it will no longer be considered by  GetApplicableFees.    This cannot be undone.Use any specified configuration options to override any other configuration for this request only
     * @param code The fee rule code. (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<DeletedEntityResponse> deleteTransactionFeeRuleWithHttpInfo(String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteTransactionFeeRuleValidateBeforeCall(code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * DeleteTransactionFeeRule: Deletes a fee rule. (asynchronously)
     * Deletes the rule for all effective time.    The rule will remain viewable at previous as at times, but it will no longer be considered by  GetApplicableFees.    This cannot be undone.
     * @param code The fee rule code. (required)
     ...
     */
    private void deleteTransactionFeeRuleAsync(String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteTransactionFeeRuleValidateBeforeCall(code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
     ...
     */
    private void deleteTransactionFeeRuleAsync(String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteTransactionFeeRuleValidateBeforeCall(code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteTransactionFeeRuleRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteTransactionFeeRuleAsync(code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteTransactionFeeRuleAsync(code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getApplicableTransactionFeesCall(String effectiveAt, OffsetDateTime asAt, String instrumentIdentifierType, String instrumentIdentifier, String portfolioScope, String portfolioCode, Map<String, String> requestBody, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getApplicableTransactionFees. Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to match rule definitions. Defaults to the current LUSID  system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to match rule definitions. Defaults to returning the latest version if not  specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param instrumentIdentifierType Optional. The unique identifier type to use, eg &#39;Figi&#39; or &#39;LusidInstrumentId&#39;. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param instrumentIdentifier Optional. The Instrument Identifier to get properties for. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param portfolioScope Optional. The scope of the portfolio to fetch properties from. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param portfolioCode Optional. The code of the portfolio to fetch properties from. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody Any other property keys or fields, including the top-level fields of the              fee rule (e.g. \&quot;ExecutionBroker\&quot; and \&quot;SettlementCurrency\&quot; ) and those defined in AdditionalKeys, along with              their corresponding values that should be matched for fees. Eg. \&quot;Instrument/default/Name&#x3D;exampleValue\&quot; or              \&quot;AdditionalKey2&#x3D;Value2\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getApplicableTransactionFeesCall(String effectiveAt, OffsetDateTime asAt, String instrumentIdentifierType, String instrumentIdentifier, String portfolioScope, String portfolioCode, Map<String, String> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/transactions/fees/$GetApplicableFees";
    ...
    private ApiResponse<ResourceListOfFeeRule> getApplicableTransactionFeesWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String instrumentIdentifierType, String instrumentIdentifier, String portfolioScope, String portfolioCode, Map<String, String> requestBody) throws ApiException {
        HttpRequest localVarCall = getApplicableTransactionFeesValidateBeforeCall(effectiveAt, asAt, instrumentIdentifierType, instrumentIdentifier, portfolioScope, portfolioCode, requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfFeeRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetApplicableTransactionFees: Get the Fees and Commissions that may be applicable to a transaction.
     * Additionally, matching can be based on the instrument&#39;s properties, its portfolio properties, and any additional property keys present in the data file.Use any specified configuration options to override any other configuration for this request only
     * @param effectiveAt The effective datetime or cut label at which to match rule definitions. Defaults to the current LUSID  system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to match rule definitions. Defaults to returning the latest version if not  specified. (optional)
     * @param instrumentIdentifierType Optional. The unique identifier type to use, eg &#39;Figi&#39; or &#39;LusidInstrumentId&#39;. (optional)
     * @param instrumentIdentifier Optional. The Instrument Identifier to get properties for. (optional)
    ...
    private ApiResponse<ResourceListOfFeeRule> getApplicableTransactionFeesWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String instrumentIdentifierType, String instrumentIdentifier, String portfolioScope, String portfolioCode, Map<String, String> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getApplicableTransactionFeesValidateBeforeCall(effectiveAt, asAt, instrumentIdentifierType, instrumentIdentifier, portfolioScope, portfolioCode, requestBody, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfFeeRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetApplicableTransactionFees: Get the Fees and Commissions that may be applicable to a transaction. (asynchronously)
     * Additionally, matching can be based on the instrument&#39;s properties, its portfolio properties, and any additional property keys present in the data file.
     * @param effectiveAt The effective datetime or cut label at which to match rule definitions. Defaults to the current LUSID  system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to match rule definitions. Defaults to returning the latest version if not  specified. (optional)
     * @param instrumentIdentifierType Optional. The unique identifier type to use, eg &#39;Figi&#39; or &#39;LusidInstrumentId&#39;. (optional)
     ...
     */
    private void getApplicableTransactionFeesAsync(String effectiveAt, OffsetDateTime asAt, String instrumentIdentifierType, String instrumentIdentifier, String portfolioScope, String portfolioCode, Map<String, String> requestBody, final ApiCallback<ResourceListOfFeeRule> _callback) throws ApiException {

        HttpRequest localVarCall = getApplicableTransactionFeesValidateBeforeCall(effectiveAt, asAt, instrumentIdentifierType, instrumentIdentifier, portfolioScope, portfolioCode, requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfFeeRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getApplicableTransactionFeesAsync(String effectiveAt, OffsetDateTime asAt, String instrumentIdentifierType, String instrumentIdentifier, String portfolioScope, String portfolioCode, Map<String, String> requestBody, final ApiCallback<ResourceListOfFeeRule> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getApplicableTransactionFeesValidateBeforeCall(effectiveAt, asAt, instrumentIdentifierType, instrumentIdentifier, portfolioScope, portfolioCode, requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfFeeRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetApplicableTransactionFeesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfFeeRule> _callback) throws ApiException {
            getApplicableTransactionFeesAsync(effectiveAt, asAt, instrumentIdentifierType, instrumentIdentifier, portfolioScope, portfolioCode, requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfFeeRule> _callback, ConfigurationOptions opts) throws ApiException {
            getApplicableTransactionFeesAsync(effectiveAt, asAt, instrumentIdentifierType, instrumentIdentifier, portfolioScope, portfolioCode, requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getTransactionFeeRuleCall(String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getTransactionFeeRuleCall(code, effectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getTransactionFeeRule. Use any specified configuration options to override any other configuration for this request only.
     * @param code The fee rule code. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getTransactionFeeRuleCall(String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getTransactionFeeRuleValidateBeforeCall(String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'code' is set
        if (code == null) {
    ...
    private ApiResponse<FeeRule> getTransactionFeeRuleWithHttpInfo(String code, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getTransactionFeeRuleValidateBeforeCall(code, effectiveAt, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<FeeRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetTransactionFeeRule: Retrieve the definition of single fee rule.
     * Retrieves the fee rule definition at the given effective and as at times.Use any specified configuration options to override any other configuration for this request only
     * @param code The fee rule code. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve the rule definition. Defaults to the current LUSID  system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve the rule definition. Defaults to returning the latest version if not  specified. (optional)
     * @return ApiResponse&lt;FeeRule&gt;
    ...
    private ApiResponse<FeeRule> getTransactionFeeRuleWithHttpInfo(String code, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getTransactionFeeRuleValidateBeforeCall(code, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<FeeRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetTransactionFeeRule: Retrieve the definition of single fee rule. (asynchronously)
     * Retrieves the fee rule definition at the given effective and as at times.
     * @param code The fee rule code. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve the rule definition. Defaults to the current LUSID  system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve the rule definition. Defaults to returning the latest version if not  specified. (optional)
     ...
     */
    private void getTransactionFeeRuleAsync(String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<FeeRule> _callback) throws ApiException {

        HttpRequest localVarCall = getTransactionFeeRuleValidateBeforeCall(code, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<FeeRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getTransactionFeeRuleAsync(String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<FeeRule> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getTransactionFeeRuleValidateBeforeCall(code, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<FeeRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetTransactionFeeRuleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<FeeRule> _callback) throws ApiException {
            getTransactionFeeRuleAsync(code, effectiveAt, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<FeeRule> _callback, ConfigurationOptions opts) throws ApiException {
            getTransactionFeeRuleAsync(code, effectiveAt, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listTransactionFeeRulesCall(String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback _callback) throws ApiException {
        return listTransactionFeeRulesCall(effectiveAt, asAt, limit, filter, page,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listTransactionFeeRules. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listTransactionFeeRulesCall(String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/transactions/fees/rules";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listTransactionFeeRulesValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfFeeRule> listTransactionFeeRulesWithHttpInfo(String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, String page) throws ApiException {
        HttpRequest localVarCall = listTransactionFeeRulesValidateBeforeCall(effectiveAt, asAt, limit, filter, page, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfFeeRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListOfFeeRule> listTransactionFeeRulesWithHttpInfo(String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, String page, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listTransactionFeeRulesValidateBeforeCall(effectiveAt, asAt, limit, filter, page, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfFeeRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listTransactionFeeRulesAsync(String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback<ResourceListOfFeeRule> _callback) throws ApiException {

        HttpRequest localVarCall = listTransactionFeeRulesValidateBeforeCall(effectiveAt, asAt, limit, filter, page, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfFeeRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listTransactionFeeRulesAsync(String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback<ResourceListOfFeeRule> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listTransactionFeeRulesValidateBeforeCall(effectiveAt, asAt, limit, filter, page, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfFeeRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistTransactionFeeRulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfFeeRule> _callback) throws ApiException {
            listTransactionFeeRulesAsync(effectiveAt, asAt, limit, filter, page, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfFeeRule> _callback, ConfigurationOptions opts) throws ApiException {
            listTransactionFeeRulesAsync(effectiveAt, asAt, limit, filter, page, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertTransactionFeeRulesCall(Map<String, FeeRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback _callback) throws ApiException {
        return upsertTransactionFeeRulesCall(requestBody, effectiveAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertTransactionFeeRules. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody A dictionary of upsert request identifiers to rule upsert requests. The request              identifiers are valid for the request only and can be used to link the upserted fee rule to the code of a              created fee rule. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which the rule will take effect. Defaults to the current LUSID  system datetime if not specified. In the case of an update, the changes will take place from this effective  time until the next effective time that the rule as been upserted at. For example, consider a rule that  already exists, and has previously had an update applied so that the definition will change on the first day  of the coming month. An upsert effective from the current day will only change the definition until the  first day of the coming month. An additional upsert at the same time (first day of the month) is required  if the newly-updated definition is to supersede the future definition. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertTransactionFeeRulesCall(Map<String, FeeRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertTransactionFeeRulesValidateBeforeCall(Map<String, FeeRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<FeeRuleUpsertResponse> upsertTransactionFeeRulesWithHttpInfo(Map<String, FeeRuleUpsertRequest> requestBody, String effectiveAt) throws ApiException {
        HttpRequest localVarCall = upsertTransactionFeeRulesValidateBeforeCall(requestBody, effectiveAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<FeeRuleUpsertResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<FeeRuleUpsertResponse> upsertTransactionFeeRulesWithHttpInfo(Map<String, FeeRuleUpsertRequest> requestBody, String effectiveAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertTransactionFeeRulesValidateBeforeCall(requestBody, effectiveAt, null, opts);
        Type localVarReturnType = new TypeReference<FeeRuleUpsertResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpsertTransactionFeeRules: Upsert fee rules. (asynchronously)
     * To upsert a new rule, the code field must be left empty, a code will then be assigned and returned as part  of the response. To update an existing rule, include the fee code. It is possible to both create and update  fee rules in the same request.    The upsert is transactional - either all create/update operations will succeed or none of them will.
     * @param requestBody A dictionary of upsert request identifiers to rule upsert requests. The request              identifiers are valid for the request only and can be used to link the upserted fee rule to the code of a              created fee rule. (required)
     * @param effectiveAt The effective datetime or cut label at which the rule will take effect. Defaults to the current LUSID  system datetime if not specified. In the case of an update, the changes will take place from this effective  time until the next effective time that the rule as been upserted at. For example, consider a rule that  already exists, and has previously had an update applied so that the definition will change on the first day  of the coming month. An upsert effective from the current day will only change the definition until the  first day of the coming month. An additional upsert at the same time (first day of the month) is required  if the newly-updated definition is to supersede the future definition. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void upsertTransactionFeeRulesAsync(Map<String, FeeRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback<FeeRuleUpsertResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertTransactionFeeRulesValidateBeforeCall(requestBody, effectiveAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<FeeRuleUpsertResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertTransactionFeeRulesAsync(Map<String, FeeRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback<FeeRuleUpsertResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertTransactionFeeRulesValidateBeforeCall(requestBody, effectiveAt, _callback, opts);
        Type localVarReturnType = new TypeReference<FeeRuleUpsertResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertTransactionFeeRulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<FeeRuleUpsertResponse> _callback) throws ApiException {
            upsertTransactionFeeRulesAsync(requestBody, effectiveAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<FeeRuleUpsertResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertTransactionFeeRulesAsync(requestBody, effectiveAt, _callback, opts);
        }
    }
