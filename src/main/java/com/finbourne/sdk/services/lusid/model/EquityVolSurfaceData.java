 ...
 */
@JsonPropertyOrder({
  EquityVolSurfaceData.JSON_PROPERTY_BASE_DATE,
  EquityVolSurfaceData.JSON_PROPERTY_INSTRUMENTS,
  EquityVolSurfaceData.JSON_PROPERTY_QUOTES,
  EquityVolSurfaceData.JSON_PROPERTY_LINEAGE,
  EquityVolSurfaceData.JSON_PROPERTY_VERSION
})
...
public class EquityVolSurfaceData extends ComplexMarketData {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to EquityVolSurfaceData
   */
  public static EquityVolSurfaceData fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, EquityVolSurfaceData.class);
  }
