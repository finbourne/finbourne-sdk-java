 ...
 */
@JsonPropertyOrder({
  SetTransactionConfigurationSourceRequest.JSON_PROPERTY_ALIASES,
  SetTransactionConfigurationSourceRequest.JSON_PROPERTY_MOVEMENTS,
  SetTransactionConfigurationSourceRequest.JSON_PROPERTY_PROPERTIES
})
...
public class SetTransactionConfigurationSourceRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to SetTransactionConfigurationSourceRequest
   */
  public static SetTransactionConfigurationSourceRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, SetTransactionConfigurationSourceRequest.class);
  }
