...
public class ApplicationMetadataApi {
     ...
     */
    private HttpRequest getLatestAsAtCall(final ApiCallback _callback) throws ApiException {
     ...
     */
    private HttpRequest getLatestAsAtCall(final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/metadata/asat";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getLatestAsAtValidateBeforeCall(final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<LatestAsAt> getLatestAsAtWithHttpInfo() throws ApiException {
        HttpRequest localVarCall = getLatestAsAtValidateBeforeCall(null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<LatestAsAt>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetLatestAsAt: Get latest AsAt
     * Get the latest asAt datetime of the system, i.e. the asAt datetime of the most recent write.  This is the asAt datetime that a request made without an explicit asAt resolves to.Use any specified configuration options to override any other configuration for this request only
     * @return ApiResponse&lt;LatestAsAt&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
    ...
    private ApiResponse<LatestAsAt> getLatestAsAtWithHttpInfo(ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getLatestAsAtValidateBeforeCall(null, opts);
        Type localVarReturnType = new TypeReference<LatestAsAt>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetLatestAsAt: Get latest AsAt (asynchronously)
     * Get the latest asAt datetime of the system, i.e. the asAt datetime of the most recent write.  This is the asAt datetime that a request made without an explicit asAt resolves to.
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     * @http.response.details
     ...
     */
    private void getLatestAsAtAsync(final ApiCallback<LatestAsAt> _callback) throws ApiException {

        HttpRequest localVarCall = getLatestAsAtValidateBeforeCall(_callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<LatestAsAt>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getLatestAsAtAsync(final ApiCallback<LatestAsAt> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getLatestAsAtValidateBeforeCall(_callback, opts);
        Type localVarReturnType = new TypeReference<LatestAsAt>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetLatestAsAtRequest {
         ...
         */
        public void executeAsync(final ApiCallback<LatestAsAt> _callback) throws ApiException {
            getLatestAsAtAsync(_callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<LatestAsAt> _callback, ConfigurationOptions opts) throws ApiException {
            getLatestAsAtAsync(_callback, opts);
        }
    }
