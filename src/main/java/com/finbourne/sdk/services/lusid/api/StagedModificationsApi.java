...
public class StagedModificationsApi {
     ...
     */
    private HttpRequest addDecisionCall(String id, StagedModificationDecisionRequest stagedModificationDecisionRequest, final ApiCallback _callback) throws ApiException {
        return addDecisionCall(id, stagedModificationDecisionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for addDecision. Use any specified configuration options to override any other configuration for this request only.
     * @param id Unique Id for a staged modification.. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param stagedModificationDecisionRequest The decision on the requested staged modification, \&quot;Approve\&quot; or \&quot;Reject\&quot;. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest addDecisionCall(String id, StagedModificationDecisionRequest stagedModificationDecisionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/stagedmodifications/{id}/decision"
    ...
    private HttpRequest addDecisionValidateBeforeCall(String id, StagedModificationDecisionRequest stagedModificationDecisionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<StagedModification> addDecisionWithHttpInfo(String id, StagedModificationDecisionRequest stagedModificationDecisionRequest) throws ApiException {
        HttpRequest localVarCall = addDecisionValidateBeforeCall(id, stagedModificationDecisionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<StagedModification>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * AddDecision: AddDecision
     * Add decision to staged modification, Approve or Reject.Use any specified configuration options to override any other configuration for this request only
     * @param id Unique Id for a staged modification.. (required)
     * @param stagedModificationDecisionRequest The decision on the requested staged modification, \&quot;Approve\&quot; or \&quot;Reject\&quot;. (required)
     * @return ApiResponse&lt;StagedModification&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<StagedModification> addDecisionWithHttpInfo(String id, StagedModificationDecisionRequest stagedModificationDecisionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = addDecisionValidateBeforeCall(id, stagedModificationDecisionRequest, null, opts);
        Type localVarReturnType = new TypeReference<StagedModification>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * AddDecision: AddDecision (asynchronously)
     * Add decision to staged modification, Approve or Reject.
     * @param id Unique Id for a staged modification.. (required)
     * @param stagedModificationDecisionRequest The decision on the requested staged modification, \&quot;Approve\&quot; or \&quot;Reject\&quot;. (required)
     ...
     */
    private void addDecisionAsync(String id, StagedModificationDecisionRequest stagedModificationDecisionRequest, final ApiCallback<StagedModification> _callback) throws ApiException {

        HttpRequest localVarCall = addDecisionValidateBeforeCall(id, stagedModificationDecisionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<StagedModification>(){}.getType();
     ...
     */
    private void addDecisionAsync(String id, StagedModificationDecisionRequest stagedModificationDecisionRequest, final ApiCallback<StagedModification> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = addDecisionValidateBeforeCall(id, stagedModificationDecisionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<StagedModification>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIaddDecisionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<StagedModification> _callback) throws ApiException {
            addDecisionAsync(id, stagedModificationDecisionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<StagedModification> _callback, ConfigurationOptions opts) throws ApiException {
            addDecisionAsync(id, stagedModificationDecisionRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getStagedModificationCall(String id, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getStagedModificationCall(id, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getStagedModification. Use any specified configuration options to override any other configuration for this request only.
     * @param id The unique identifier for a staged modification. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the staged modification. Defaults to latest if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getStagedModificationCall(String id, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/stagedmodifications/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getStagedModificationValidateBeforeCall(String id, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<StagedModification> getStagedModificationWithHttpInfo(String id, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getStagedModificationValidateBeforeCall(id, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<StagedModification>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * GetStagedModification: GetStagedModification
     * Retrieve the details of a staged modification.Use any specified configuration options to override any other configuration for this request only
     * @param id The unique identifier for a staged modification. (required)
     * @param asAt The asAt datetime at which to retrieve the staged modification. Defaults to latest if not specified. (optional)
     * @return ApiResponse&lt;StagedModification&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<StagedModification> getStagedModificationWithHttpInfo(String id, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getStagedModificationValidateBeforeCall(id, asAt, null, opts);
        Type localVarReturnType = new TypeReference<StagedModification>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetStagedModification: GetStagedModification (asynchronously)
     * Retrieve the details of a staged modification.
     * @param id The unique identifier for a staged modification. (required)
     * @param asAt The asAt datetime at which to retrieve the staged modification. Defaults to latest if not specified. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void getStagedModificationAsync(String id, OffsetDateTime asAt, final ApiCallback<StagedModification> _callback) throws ApiException {

        HttpRequest localVarCall = getStagedModificationValidateBeforeCall(id, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<StagedModification>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getStagedModificationAsync(String id, OffsetDateTime asAt, final ApiCallback<StagedModification> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getStagedModificationValidateBeforeCall(id, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<StagedModification>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetStagedModificationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<StagedModification> _callback) throws ApiException {
            getStagedModificationAsync(id, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<StagedModification> _callback, ConfigurationOptions opts) throws ApiException {
            getStagedModificationAsync(id, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listRequestedChangesCall(String id, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback) throws ApiException {
        return listRequestedChangesCall(id, asAt, page, limit, filter, sortBy,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listRequestedChanges. Use any specified configuration options to override any other configuration for this request only.
     * @param id Unique Id for a staged modification.. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list changes. Defaults to return the latest version              of each staged change if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listRequestedChangesCall(String id, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/stagedmodifications/{id}/requestedChanges"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listRequestedChangesValidateBeforeCall(String id, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<PagedResourceListOfStagedModificationsRequestedChangeInterval> listRequestedChangesWithHttpInfo(String id, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy) throws ApiException {
        HttpRequest localVarCall = listRequestedChangesValidateBeforeCall(id, asAt, page, limit, filter, sortBy, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfStagedModificationsRequestedChangeInterval>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListRequestedChanges: ListRequestedChanges
     * List the requested changes for a staged modification.Use any specified configuration options to override any other configuration for this request only
     * @param id Unique Id for a staged modification.. (required)
     * @param asAt The asAt datetime at which to list changes. Defaults to return the latest version              of each staged change if not specified. (optional)
     * @param page The pagination token to use to continue listing requested staged modification changes from a previous call to list requested              staged modifications. This value is returned from the previous call. If a pagination token is provided the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional)
     * @param limit When paginating, limit the number of returned results to this many. Defaults to 100 if not specified. (optional)
    ...
    private ApiResponse<PagedResourceListOfStagedModificationsRequestedChangeInterval> listRequestedChangesWithHttpInfo(String id, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listRequestedChangesValidateBeforeCall(id, asAt, page, limit, filter, sortBy, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfStagedModificationsRequestedChangeInterval>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListRequestedChanges: ListRequestedChanges (asynchronously)
     * List the requested changes for a staged modification.
     * @param id Unique Id for a staged modification.. (required)
     * @param asAt The asAt datetime at which to list changes. Defaults to return the latest version              of each staged change if not specified. (optional)
     * @param page The pagination token to use to continue listing requested staged modification changes from a previous call to list requested              staged modifications. This value is returned from the previous call. If a pagination token is provided the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional)
     ...
     */
    private void listRequestedChangesAsync(String id, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfStagedModificationsRequestedChangeInterval> _callback) throws ApiException {

        HttpRequest localVarCall = listRequestedChangesValidateBeforeCall(id, asAt, page, limit, filter, sortBy, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfStagedModificationsRequestedChangeInterval>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listRequestedChangesAsync(String id, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfStagedModificationsRequestedChangeInterval> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listRequestedChangesValidateBeforeCall(id, asAt, page, limit, filter, sortBy, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfStagedModificationsRequestedChangeInterval>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistRequestedChangesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfStagedModificationsRequestedChangeInterval> _callback) throws ApiException {
            listRequestedChangesAsync(id, asAt, page, limit, filter, sortBy, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfStagedModificationsRequestedChangeInterval> _callback, ConfigurationOptions opts) throws ApiException {
            listRequestedChangesAsync(id, asAt, page, limit, filter, sortBy, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listStagedModificationsCall(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback) throws ApiException {
        return listStagedModificationsCall(asAt, page, limit, filter, sortBy,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listStagedModifications. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list staged modifications. Defaults to return the latest version              of each staged modification if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing staged modifications from a previous call to list staged modifications. This              value is returned from the previous call. If a pagination token is provided the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit When paginating, limit the number of returned results to this many. Defaults to 100 if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the result set.               Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy A list of field names suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot; (optional)
     ...
     */
    private HttpRequest listStagedModificationsCall(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/stagedmodifications";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listStagedModificationsValidateBeforeCall(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfStagedModification> listStagedModificationsWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy) throws ApiException {
        HttpRequest localVarCall = listStagedModificationsValidateBeforeCall(asAt, page, limit, filter, sortBy, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfStagedModification>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListStagedModifications: ListStagedModifications
     * List summaries of the staged modifications.Use any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to list staged modifications. Defaults to return the latest version              of each staged modification if not specified. (optional)
     * @param page The pagination token to use to continue listing staged modifications from a previous call to list staged modifications. This              value is returned from the previous call. If a pagination token is provided the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional)
     * @param limit When paginating, limit the number of returned results to this many. Defaults to 100 if not specified. (optional)
     * @param filter Expression to filter the result set.               Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    private ApiResponse<PagedResourceListOfStagedModification> listStagedModificationsWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listStagedModificationsValidateBeforeCall(asAt, page, limit, filter, sortBy, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfStagedModification>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListStagedModifications: ListStagedModifications (asynchronously)
     * List summaries of the staged modifications.
     * @param asAt The asAt datetime at which to list staged modifications. Defaults to return the latest version              of each staged modification if not specified. (optional)
     * @param page The pagination token to use to continue listing staged modifications from a previous call to list staged modifications. This              value is returned from the previous call. If a pagination token is provided the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional)
     * @param limit When paginating, limit the number of returned results to this many. Defaults to 100 if not specified. (optional)
     ...
     */
    private void listStagedModificationsAsync(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfStagedModification> _callback) throws ApiException {

        HttpRequest localVarCall = listStagedModificationsValidateBeforeCall(asAt, page, limit, filter, sortBy, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfStagedModification>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listStagedModificationsAsync(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfStagedModification> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listStagedModificationsValidateBeforeCall(asAt, page, limit, filter, sortBy, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfStagedModification>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistStagedModificationsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfStagedModification> _callback) throws ApiException {
            listStagedModificationsAsync(asAt, page, limit, filter, sortBy, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfStagedModification> _callback, ConfigurationOptions opts) throws ApiException {
            listStagedModificationsAsync(asAt, page, limit, filter, sortBy, _callback, opts);
        }
    }
