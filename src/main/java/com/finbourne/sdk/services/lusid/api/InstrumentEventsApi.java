...
public class InstrumentEventsApi {
     ...
     */
    private HttpRequest queryApplicableInstrumentEventsCall(OffsetDateTime asAt, Integer limit, String page, QueryApplicableInstrumentEventsRequest queryApplicableInstrumentEventsRequest, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for queryApplicableInstrumentEvents. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The as at time to use. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest queryApplicableInstrumentEventsCall(OffsetDateTime asAt, Integer limit, String page, QueryApplicableInstrumentEventsRequest queryApplicableInstrumentEventsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/instrumentevents/$queryApplicableInstrumentEvents";
    ...
    private HttpRequest queryApplicableInstrumentEventsValidateBeforeCall(OffsetDateTime asAt, Integer limit, String page, QueryApplicableInstrumentEventsRequest queryApplicableInstrumentEventsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfApplicableInstrumentEvent> queryApplicableInstrumentEventsWithHttpInfo(OffsetDateTime asAt, Integer limit, String page, QueryApplicableInstrumentEventsRequest queryApplicableInstrumentEventsRequest) throws ApiException {
        HttpRequest localVarCall = queryApplicableInstrumentEventsValidateBeforeCall(asAt, limit, page, queryApplicableInstrumentEventsRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfApplicableInstrumentEvent>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * QueryApplicableInstrumentEvents: Returns a list of applicable instrument events based on the holdings of the portfolios and date range specified in the query.
     * Returns a list of applicable instrument events based on the holdings of the portfolios and date range specified in the query.Use any specified configuration options to override any other configuration for this request only
     * @param asAt The as at time to use. (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 100 is used. (optional, default to 100)
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this (optional)
     * @param queryApplicableInstrumentEventsRequest The filter parameters used to retrieve applicable instrument events. (optional)
    ...
    private ApiResponse<ResourceListOfApplicableInstrumentEvent> queryApplicableInstrumentEventsWithHttpInfo(OffsetDateTime asAt, Integer limit, String page, QueryApplicableInstrumentEventsRequest queryApplicableInstrumentEventsRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = queryApplicableInstrumentEventsValidateBeforeCall(asAt, limit, page, queryApplicableInstrumentEventsRequest, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfApplicableInstrumentEvent>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * QueryApplicableInstrumentEvents: Returns a list of applicable instrument events based on the holdings of the portfolios and date range specified in the query. (asynchronously)
     * Returns a list of applicable instrument events based on the holdings of the portfolios and date range specified in the query.
     * @param asAt The as at time to use. (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 100 is used. (optional, default to 100)
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this (optional)
     ...
     */
    private void queryApplicableInstrumentEventsAsync(OffsetDateTime asAt, Integer limit, String page, QueryApplicableInstrumentEventsRequest queryApplicableInstrumentEventsRequest, final ApiCallback<ResourceListOfApplicableInstrumentEvent> _callback) throws ApiException {

        HttpRequest localVarCall = queryApplicableInstrumentEventsValidateBeforeCall(asAt, limit, page, queryApplicableInstrumentEventsRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfApplicableInstrumentEvent>(){}.getType();
     ...
     */
    private void queryApplicableInstrumentEventsAsync(OffsetDateTime asAt, Integer limit, String page, QueryApplicableInstrumentEventsRequest queryApplicableInstrumentEventsRequest, final ApiCallback<ResourceListOfApplicableInstrumentEvent> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = queryApplicableInstrumentEventsValidateBeforeCall(asAt, limit, page, queryApplicableInstrumentEventsRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfApplicableInstrumentEvent>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIqueryApplicableInstrumentEventsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfApplicableInstrumentEvent> _callback) throws ApiException {
            queryApplicableInstrumentEventsAsync(asAt, limit, page, queryApplicableInstrumentEventsRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfApplicableInstrumentEvent> _callback, ConfigurationOptions opts) throws ApiException {
            queryApplicableInstrumentEventsAsync(asAt, limit, page, queryApplicableInstrumentEventsRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest queryBucketedCashFlowsCall(QueryBucketedCashFlowsRequest queryBucketedCashFlowsRequest, final ApiCallback _callback) throws ApiException {
        return queryBucketedCashFlowsCall(queryBucketedCashFlowsRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for queryBucketedCashFlows. Use any specified configuration options to override any other configuration for this request only.
     * @param queryBucketedCashFlowsRequest The Query Information. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest queryBucketedCashFlowsCall(QueryBucketedCashFlowsRequest queryBucketedCashFlowsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/instrumentevents/$queryBucketedCashFlows";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest queryBucketedCashFlowsValidateBeforeCall(QueryBucketedCashFlowsRequest queryBucketedCashFlowsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<BucketedCashFlowResponse> queryBucketedCashFlowsWithHttpInfo(QueryBucketedCashFlowsRequest queryBucketedCashFlowsRequest) throws ApiException {
        HttpRequest localVarCall = queryBucketedCashFlowsValidateBeforeCall(queryBucketedCashFlowsRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BucketedCashFlowResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * QueryBucketedCashFlows: Returns bucketed cashflows based on the holdings of the portfolios and date range specified in the query.
     * Returns bucketed cashflows based on the holdings of the portfolios and date range specified in the query.Use any specified configuration options to override any other configuration for this request only
     * @param queryBucketedCashFlowsRequest The Query Information. (optional)
     * @return ApiResponse&lt;BucketedCashFlowResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<BucketedCashFlowResponse> queryBucketedCashFlowsWithHttpInfo(QueryBucketedCashFlowsRequest queryBucketedCashFlowsRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = queryBucketedCashFlowsValidateBeforeCall(queryBucketedCashFlowsRequest, null, opts);
        Type localVarReturnType = new TypeReference<BucketedCashFlowResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * QueryBucketedCashFlows: Returns bucketed cashflows based on the holdings of the portfolios and date range specified in the query. (asynchronously)
     * Returns bucketed cashflows based on the holdings of the portfolios and date range specified in the query.
     * @param queryBucketedCashFlowsRequest The Query Information. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void queryBucketedCashFlowsAsync(QueryBucketedCashFlowsRequest queryBucketedCashFlowsRequest, final ApiCallback<BucketedCashFlowResponse> _callback) throws ApiException {

        HttpRequest localVarCall = queryBucketedCashFlowsValidateBeforeCall(queryBucketedCashFlowsRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BucketedCashFlowResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void queryBucketedCashFlowsAsync(QueryBucketedCashFlowsRequest queryBucketedCashFlowsRequest, final ApiCallback<BucketedCashFlowResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = queryBucketedCashFlowsValidateBeforeCall(queryBucketedCashFlowsRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<BucketedCashFlowResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIqueryBucketedCashFlowsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<BucketedCashFlowResponse> _callback) throws ApiException {
            queryBucketedCashFlowsAsync(queryBucketedCashFlowsRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<BucketedCashFlowResponse> _callback, ConfigurationOptions opts) throws ApiException {
            queryBucketedCashFlowsAsync(queryBucketedCashFlowsRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest queryCashFlowsCall(Integer limit, String page, QueryCashFlowsRequest queryCashFlowsRequest, final ApiCallback _callback) throws ApiException {
        return queryCashFlowsCall(limit, page, queryCashFlowsRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for queryCashFlows. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest queryCashFlowsCall(Integer limit, String page, QueryCashFlowsRequest queryCashFlowsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/instrumentevents/$queryCashFlows";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest queryCashFlowsValidateBeforeCall(Integer limit, String page, QueryCashFlowsRequest queryCashFlowsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfInstrumentCashFlow> queryCashFlowsWithHttpInfo(Integer limit, String page, QueryCashFlowsRequest queryCashFlowsRequest) throws ApiException {
        HttpRequest localVarCall = queryCashFlowsValidateBeforeCall(limit, page, queryCashFlowsRequest, null, new ConfigurationOptions());
    ...
    /**
     * QueryCashFlows: Returns a list of cashflows based on the holdings of the portfolios and date range specified in the query.
     * Returns a list of cashflows based on the holdings of the portfolios and date range specified in the query.Use any specified configuration options to override any other configuration for this request only
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000)
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional)
     * @param queryCashFlowsRequest The filter parameters used to retrieve instrument events. (optional)
     * @return ApiResponse&lt;ResourceListOfInstrumentCashFlow&gt;
    ...
    private ApiResponse<ResourceListOfInstrumentCashFlow> queryCashFlowsWithHttpInfo(Integer limit, String page, QueryCashFlowsRequest queryCashFlowsRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = queryCashFlowsValidateBeforeCall(limit, page, queryCashFlowsRequest, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfInstrumentCashFlow>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * QueryCashFlows: Returns a list of cashflows based on the holdings of the portfolios and date range specified in the query. (asynchronously)
     * Returns a list of cashflows based on the holdings of the portfolios and date range specified in the query.
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000)
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional)
     * @param queryCashFlowsRequest The filter parameters used to retrieve instrument events. (optional)
     ...
     */
    private void queryCashFlowsAsync(Integer limit, String page, QueryCashFlowsRequest queryCashFlowsRequest, final ApiCallback<ResourceListOfInstrumentCashFlow> _callback) throws ApiException {

        HttpRequest localVarCall = queryCashFlowsValidateBeforeCall(limit, page, queryCashFlowsRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfInstrumentCashFlow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void queryCashFlowsAsync(Integer limit, String page, QueryCashFlowsRequest queryCashFlowsRequest, final ApiCallback<ResourceListOfInstrumentCashFlow> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = queryCashFlowsValidateBeforeCall(limit, page, queryCashFlowsRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfInstrumentCashFlow>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIqueryCashFlowsRequest {
        ...
        public void executeAsync(final ApiCallback<ResourceListOfInstrumentCashFlow> _callback) throws ApiException {
            queryCashFlowsAsync(limit, page, queryCashFlowsRequest, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<ResourceListOfInstrumentCashFlow> _callback, ConfigurationOptions opts) throws ApiException {
            queryCashFlowsAsync(limit, page, queryCashFlowsRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest queryInstrumentEventsCall(Integer limit, String page, QueryInstrumentEventsRequest queryInstrumentEventsRequest, final ApiCallback _callback) throws ApiException {
        return queryInstrumentEventsCall(limit, page, queryInstrumentEventsRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for queryInstrumentEvents. Use any specified configuration options to override any other configuration for this request only.
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000). Use any specified configuration options to override any other configuration for this request only.
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param queryInstrumentEventsRequest The filter parameters used to retrieve instrument events. (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest queryInstrumentEventsCall(Integer limit, String page, QueryInstrumentEventsRequest queryInstrumentEventsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/instrumentevents/$query";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest queryInstrumentEventsValidateBeforeCall(Integer limit, String page, QueryInstrumentEventsRequest queryInstrumentEventsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfInstrumentEventHolder> queryInstrumentEventsWithHttpInfo(Integer limit, String page, QueryInstrumentEventsRequest queryInstrumentEventsRequest) throws ApiException {
        HttpRequest localVarCall = queryInstrumentEventsValidateBeforeCall(limit, page, queryInstrumentEventsRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfInstrumentEventHolder>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * QueryInstrumentEvents: Returns a list of instrument events based on the holdings of the portfolios and date range specified in the query.
     * Returns a list of instrument events based on the holdings of the portfolios and date range specified in the query.Use any specified configuration options to override any other configuration for this request only
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000)
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional)
     * @param queryInstrumentEventsRequest The filter parameters used to retrieve instrument events. (optional)
     * @return ApiResponse&lt;ResourceListOfInstrumentEventHolder&gt;
    ...
    private ApiResponse<ResourceListOfInstrumentEventHolder> queryInstrumentEventsWithHttpInfo(Integer limit, String page, QueryInstrumentEventsRequest queryInstrumentEventsRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = queryInstrumentEventsValidateBeforeCall(limit, page, queryInstrumentEventsRequest, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfInstrumentEventHolder>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * QueryInstrumentEvents: Returns a list of instrument events based on the holdings of the portfolios and date range specified in the query. (asynchronously)
     * Returns a list of instrument events based on the holdings of the portfolios and date range specified in the query.
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000)
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional)
     * @param queryInstrumentEventsRequest The filter parameters used to retrieve instrument events. (optional)
     ...
     */
    private void queryInstrumentEventsAsync(Integer limit, String page, QueryInstrumentEventsRequest queryInstrumentEventsRequest, final ApiCallback<ResourceListOfInstrumentEventHolder> _callback) throws ApiException {

        HttpRequest localVarCall = queryInstrumentEventsValidateBeforeCall(limit, page, queryInstrumentEventsRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfInstrumentEventHolder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void queryInstrumentEventsAsync(Integer limit, String page, QueryInstrumentEventsRequest queryInstrumentEventsRequest, final ApiCallback<ResourceListOfInstrumentEventHolder> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = queryInstrumentEventsValidateBeforeCall(limit, page, queryInstrumentEventsRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfInstrumentEventHolder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIqueryInstrumentEventsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfInstrumentEventHolder> _callback) throws ApiException {
            queryInstrumentEventsAsync(limit, page, queryInstrumentEventsRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfInstrumentEventHolder> _callback, ConfigurationOptions opts) throws ApiException {
            queryInstrumentEventsAsync(limit, page, queryInstrumentEventsRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest queryTradeTicketsCall(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest, final ApiCallback _callback) throws ApiException {
        return queryTradeTicketsCall(limit, page, queryTradeTicketsRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for queryTradeTickets. Use any specified configuration options to override any other configuration for this request only.
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000). Use any specified configuration options to override any other configuration for this request only.
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param queryTradeTicketsRequest The filter parameters used to retrieve instrument events. (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest queryTradeTicketsCall(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/instrumentevents/$queryTradeTickets";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest queryTradeTicketsValidateBeforeCall(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfPortfolioTradeTicket> queryTradeTicketsWithHttpInfo(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest) throws ApiException {
        HttpRequest localVarCall = queryTradeTicketsValidateBeforeCall(limit, page, queryTradeTicketsRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolioTradeTicket>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * QueryTradeTickets: Returns a list of trade tickets based on the holdings of the portfolios and date range specified in the query.
     * Returns a list of trade tickets based on the holdings of the portfolios and date range specified in the query.    These trade tickets are derived from events that involve transition of instrument states, such as transitions  on exercise or default of an instrument. The trade tickets are to allow the new position to be created given the  existing portfolio configuration.Use any specified configuration options to override any other configuration for this request only
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000)
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional)
     * @param queryTradeTicketsRequest The filter parameters used to retrieve instrument events. (optional)
     * @return ApiResponse&lt;ResourceListOfPortfolioTradeTicket&gt;
    ...
    private ApiResponse<ResourceListOfPortfolioTradeTicket> queryTradeTicketsWithHttpInfo(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = queryTradeTicketsValidateBeforeCall(limit, page, queryTradeTicketsRequest, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolioTradeTicket>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * QueryTradeTickets: Returns a list of trade tickets based on the holdings of the portfolios and date range specified in the query. (asynchronously)
     * Returns a list of trade tickets based on the holdings of the portfolios and date range specified in the query.    These trade tickets are derived from events that involve transition of instrument states, such as transitions  on exercise or default of an instrument. The trade tickets are to allow the new position to be created given the  existing portfolio configuration.
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000)
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional)
     * @param queryTradeTicketsRequest The filter parameters used to retrieve instrument events. (optional)
     ...
     */
    private void queryTradeTicketsAsync(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest, final ApiCallback<ResourceListOfPortfolioTradeTicket> _callback) throws ApiException {

        HttpRequest localVarCall = queryTradeTicketsValidateBeforeCall(limit, page, queryTradeTicketsRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolioTradeTicket>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void queryTradeTicketsAsync(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest, final ApiCallback<ResourceListOfPortfolioTradeTicket> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = queryTradeTicketsValidateBeforeCall(limit, page, queryTradeTicketsRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPortfolioTradeTicket>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIqueryTradeTicketsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPortfolioTradeTicket> _callback) throws ApiException {
            queryTradeTicketsAsync(limit, page, queryTradeTicketsRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPortfolioTradeTicket> _callback, ConfigurationOptions opts) throws ApiException {
            queryTradeTicketsAsync(limit, page, queryTradeTicketsRequest, _callback, opts);
        }
    }
