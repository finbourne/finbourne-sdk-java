 ...
 */
@JsonPropertyOrder({
  OptionEntry.JSON_PROPERTY_STRIKE,
  OptionEntry.JSON_PROPERTY_DATE,
  OptionEntry.JSON_PROPERTY_END_DATE
})
...
public class OptionEntry {
  ...
  public OptionEntry strike(java.math.BigDecimal strike) {
    this.strike = strike;
    return this;
  }
  ...
  public OptionEntry date(OffsetDateTime date) {
    this.date = date;
    return this;
  }
 ...
 public int hashCode() {
  ...
  /**
   * Create an instance of OptionEntry given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OptionEntry
   * @throws java.io.IOException if the JSON string is invalid with respect to OptionEntry
   */
  public static OptionEntry fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, OptionEntry.class);
  }

  /**
   * Convert an instance of OptionEntry to an JSON string
   *
   * @return JSON string
   */
