 ...
 */
@JsonPropertyOrder({
  CancelSingleHoldingAdjustmentRequest.JSON_PROPERTY_INSTRUMENT_IDENTIFIERS,
  CancelSingleHoldingAdjustmentRequest.JSON_PROPERTY_SUB_HOLDING_KEYS,
  CancelSingleHoldingAdjustmentRequest.JSON_PROPERTY_CURRENCY,
  CancelSingleHoldingAdjustmentRequest.JSON_PROPERTY_CUSTODIAN_ACCOUNT_ID
})
...
public class CancelSingleHoldingAdjustmentRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to CancelSingleHoldingAdjustmentRequest
   */
  public static CancelSingleHoldingAdjustmentRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, CancelSingleHoldingAdjustmentRequest.class);
  }
