...
public class AddressKeyDefinitionApi {
     ...
     */
    private HttpRequest createAddressKeyDefinitionCall(CreateAddressKeyDefinitionRequest createAddressKeyDefinitionRequest, final ApiCallback _callback) throws ApiException {
        return createAddressKeyDefinitionCall(createAddressKeyDefinitionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createAddressKeyDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param createAddressKeyDefinitionRequest The request used to create the address key definition. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createAddressKeyDefinitionCall(CreateAddressKeyDefinitionRequest createAddressKeyDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/addresskeydefinitions";
    ...
    private HttpRequest createAddressKeyDefinitionValidateBeforeCall(CreateAddressKeyDefinitionRequest createAddressKeyDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<AddressKeyDefinition> createAddressKeyDefinitionWithHttpInfo(CreateAddressKeyDefinitionRequest createAddressKeyDefinitionRequest) throws ApiException {
        HttpRequest localVarCall = createAddressKeyDefinitionValidateBeforeCall(createAddressKeyDefinitionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AddressKeyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CreateAddressKeyDefinition: Create an AddressKeyDefinition.
     * Create the given address key definition.Use any specified configuration options to override any other configuration for this request only
     * @param createAddressKeyDefinitionRequest The request used to create the address key definition. (required)
     * @return ApiResponse&lt;AddressKeyDefinition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<AddressKeyDefinition> createAddressKeyDefinitionWithHttpInfo(CreateAddressKeyDefinitionRequest createAddressKeyDefinitionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createAddressKeyDefinitionValidateBeforeCall(createAddressKeyDefinitionRequest, null, opts);
        Type localVarReturnType = new TypeReference<AddressKeyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createAddressKeyDefinitionAsync(CreateAddressKeyDefinitionRequest createAddressKeyDefinitionRequest, final ApiCallback<AddressKeyDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = createAddressKeyDefinitionValidateBeforeCall(createAddressKeyDefinitionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AddressKeyDefinition>(){}.getType();
     ...
     */
    private void createAddressKeyDefinitionAsync(CreateAddressKeyDefinitionRequest createAddressKeyDefinitionRequest, final ApiCallback<AddressKeyDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createAddressKeyDefinitionValidateBeforeCall(createAddressKeyDefinitionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<AddressKeyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateAddressKeyDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AddressKeyDefinition> _callback) throws ApiException {
            createAddressKeyDefinitionAsync(createAddressKeyDefinitionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AddressKeyDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            createAddressKeyDefinitionAsync(createAddressKeyDefinitionRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getAddressKeyDefinitionCall(String key, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getAddressKeyDefinitionCall(key, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getAddressKeyDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param key The address key of the address key definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the address key definition. Defaults to return the latest version of the address key definition if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getAddressKeyDefinitionCall(String key, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/addresskeydefinitions/{key}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getAddressKeyDefinitionValidateBeforeCall(String key, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<AddressKeyDefinition> getAddressKeyDefinitionWithHttpInfo(String key, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getAddressKeyDefinitionValidateBeforeCall(key, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AddressKeyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] GetAddressKeyDefinition: Get an AddressKeyDefinition.
     * Get the address key definition with the given address key at the specific asAt time.Use any specified configuration options to override any other configuration for this request only
     * @param key The address key of the address key definition. (required)
     * @param asAt The asAt datetime at which to retrieve the address key definition. Defaults to return the latest version of the address key definition if not specified. (optional)
     * @return ApiResponse&lt;AddressKeyDefinition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<AddressKeyDefinition> getAddressKeyDefinitionWithHttpInfo(String key, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getAddressKeyDefinitionValidateBeforeCall(key, asAt, null, opts);
        Type localVarReturnType = new TypeReference<AddressKeyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getAddressKeyDefinitionAsync(String key, OffsetDateTime asAt, final ApiCallback<AddressKeyDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = getAddressKeyDefinitionValidateBeforeCall(key, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AddressKeyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getAddressKeyDefinitionAsync(String key, OffsetDateTime asAt, final ApiCallback<AddressKeyDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getAddressKeyDefinitionValidateBeforeCall(key, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<AddressKeyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetAddressKeyDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AddressKeyDefinition> _callback) throws ApiException {
            getAddressKeyDefinitionAsync(key, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AddressKeyDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            getAddressKeyDefinitionAsync(key, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listAddressKeyDefinitionsCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        return listAddressKeyDefinitionsCall(asAt, page, limit, filter,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listAddressKeyDefinitions. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the address key definition.              Defaults to return the latest version of the address key definition if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listAddressKeyDefinitionsCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listAddressKeyDefinitionsValidateBeforeCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfAddressKeyDefinition> listAddressKeyDefinitionsWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = listAddressKeyDefinitionsValidateBeforeCall(asAt, page, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfAddressKeyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListAddressKeyDefinitions: List AddressKeyDefinitions.
     * Fetch the last pre-AsAt date version of each address key definition.Use any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to retrieve the address key definition.              Defaults to return the latest version of the address key definition if not specified. (optional)
     * @param page The pagination token to use to continue listing address key definitions from a previous call to list address key definitions.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    private ApiResponse<PagedResourceListOfAddressKeyDefinition> listAddressKeyDefinitionsWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listAddressKeyDefinitionsValidateBeforeCall(asAt, page, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfAddressKeyDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listAddressKeyDefinitionsAsync(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfAddressKeyDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = listAddressKeyDefinitionsValidateBeforeCall(asAt, page, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfAddressKeyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listAddressKeyDefinitionsAsync(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfAddressKeyDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listAddressKeyDefinitionsValidateBeforeCall(asAt, page, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfAddressKeyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistAddressKeyDefinitionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfAddressKeyDefinition> _callback) throws ApiException {
            listAddressKeyDefinitionsAsync(asAt, page, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfAddressKeyDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            listAddressKeyDefinitionsAsync(asAt, page, limit, filter, _callback, opts);
        }
    }
