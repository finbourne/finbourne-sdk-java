 ...
 */
@JsonPropertyOrder({
  ComplianceTemplateVariationRequest.JSON_PROPERTY_LABEL,
  ComplianceTemplateVariationRequest.JSON_PROPERTY_DESCRIPTION,
  ComplianceTemplateVariationRequest.JSON_PROPERTY_OUTCOME_DESCRIPTION,
  ComplianceTemplateVariationRequest.JSON_PROPERTY_REFERENCED_GROUP_LABEL,
  ComplianceTemplateVariationRequest.JSON_PROPERTY_STEPS
})
...
public class ComplianceTemplateVariationRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ComplianceTemplateVariationRequest
   */
  public static ComplianceTemplateVariationRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ComplianceTemplateVariationRequest.class);
  }
