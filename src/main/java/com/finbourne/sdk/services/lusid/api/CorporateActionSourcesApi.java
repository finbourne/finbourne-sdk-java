...
public class CorporateActionSourcesApi {
     ...
     */
    private HttpRequest batchUpsertCorporateActionsCall(String scope, String code, List<UpsertCorporateActionRequest> upsertCorporateActionRequest, final ApiCallback _callback) throws ApiException {
        return batchUpsertCorporateActionsCall(scope, code, upsertCorporateActionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for batchUpsertCorporateActions. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of corporate action source (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the corporate action source (required). Use any specified configuration options to override any other configuration for this request only.
     * @param upsertCorporateActionRequest The corporate action definitions (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest batchUpsertCorporateActionsCall(String scope, String code, List<UpsertCorporateActionRequest> upsertCorporateActionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/corporateactionsources/{scope}/{code}/corporateactions"
    ...
    private HttpRequest batchUpsertCorporateActionsValidateBeforeCall(String scope, String code, List<UpsertCorporateActionRequest> upsertCorporateActionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UpsertCorporateActionsResponse> batchUpsertCorporateActionsWithHttpInfo(String scope, String code, List<UpsertCorporateActionRequest> upsertCorporateActionRequest) throws ApiException {
        HttpRequest localVarCall = batchUpsertCorporateActionsValidateBeforeCall(scope, code, upsertCorporateActionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertCorporateActionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] BatchUpsertCorporateActions: Batch upsert corporate actions (instrument transition events) to corporate action source.
     * Create or update one or more corporate actions in a particular corporate action source. Failures are identified in the body of the response.                If a corporate action is upserted at exactly the same effective datetime as a transaction for the same instrument, the corporate action takes precedence. Depending on the nature of the corporate action, this may mean it affects the transaction.                The maximum number of corporate actions that this method can upsert per request is 10,000.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of corporate action source (required)
     * @param code The code of the corporate action source (required)
     * @param upsertCorporateActionRequest The corporate action definitions (optional)
     * @return ApiResponse&lt;UpsertCorporateActionsResponse&gt;
    ...
    private ApiResponse<UpsertCorporateActionsResponse> batchUpsertCorporateActionsWithHttpInfo(String scope, String code, List<UpsertCorporateActionRequest> upsertCorporateActionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = batchUpsertCorporateActionsValidateBeforeCall(scope, code, upsertCorporateActionRequest, null, opts);
        Type localVarReturnType = new TypeReference<UpsertCorporateActionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void batchUpsertCorporateActionsAsync(String scope, String code, List<UpsertCorporateActionRequest> upsertCorporateActionRequest, final ApiCallback<UpsertCorporateActionsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = batchUpsertCorporateActionsValidateBeforeCall(scope, code, upsertCorporateActionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertCorporateActionsResponse>(){}.getType();
     ...
     */
    private void batchUpsertCorporateActionsAsync(String scope, String code, List<UpsertCorporateActionRequest> upsertCorporateActionRequest, final ApiCallback<UpsertCorporateActionsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = batchUpsertCorporateActionsValidateBeforeCall(scope, code, upsertCorporateActionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertCorporateActionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIbatchUpsertCorporateActionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UpsertCorporateActionsResponse> _callback) throws ApiException {
            batchUpsertCorporateActionsAsync(scope, code, upsertCorporateActionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UpsertCorporateActionsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            batchUpsertCorporateActionsAsync(scope, code, upsertCorporateActionRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest createCorporateActionSourceCall(CreateCorporateActionSourceRequest createCorporateActionSourceRequest, final ApiCallback _callback) throws ApiException {
        return createCorporateActionSourceCall(createCorporateActionSourceRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createCorporateActionSource. Use any specified configuration options to override any other configuration for this request only.
     * @param createCorporateActionSourceRequest The corporate action source definition (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createCorporateActionSourceCall(CreateCorporateActionSourceRequest createCorporateActionSourceRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/corporateactionsources";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest createCorporateActionSourceValidateBeforeCall(CreateCorporateActionSourceRequest createCorporateActionSourceRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<CorporateActionSource> createCorporateActionSourceWithHttpInfo(CreateCorporateActionSourceRequest createCorporateActionSourceRequest) throws ApiException {
        HttpRequest localVarCall = createCorporateActionSourceValidateBeforeCall(createCorporateActionSourceRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CorporateActionSource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CreateCorporateActionSource: Create corporate action source
     * Create a corporate action source.Use any specified configuration options to override any other configuration for this request only
     * @param createCorporateActionSourceRequest The corporate action source definition (required)
     * @return ApiResponse&lt;CorporateActionSource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<CorporateActionSource> createCorporateActionSourceWithHttpInfo(CreateCorporateActionSourceRequest createCorporateActionSourceRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createCorporateActionSourceValidateBeforeCall(createCorporateActionSourceRequest, null, opts);
        Type localVarReturnType = new TypeReference<CorporateActionSource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createCorporateActionSourceAsync(CreateCorporateActionSourceRequest createCorporateActionSourceRequest, final ApiCallback<CorporateActionSource> _callback) throws ApiException {

        HttpRequest localVarCall = createCorporateActionSourceValidateBeforeCall(createCorporateActionSourceRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CorporateActionSource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void createCorporateActionSourceAsync(CreateCorporateActionSourceRequest createCorporateActionSourceRequest, final ApiCallback<CorporateActionSource> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createCorporateActionSourceValidateBeforeCall(createCorporateActionSourceRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<CorporateActionSource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateCorporateActionSourceRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CorporateActionSource> _callback) throws ApiException {
            createCorporateActionSourceAsync(createCorporateActionSourceRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CorporateActionSource> _callback, ConfigurationOptions opts) throws ApiException {
            createCorporateActionSourceAsync(createCorporateActionSourceRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteCorporateActionSourceCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteCorporateActionSourceCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteCorporateActionSource. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the corporate action source to be deleted (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the corporate action source to be deleted (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteCorporateActionSourceCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/corporateactionsources/{scope}/{code}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteCorporateActionSourceValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteCorporateActionSourceWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteCorporateActionSourceValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] DeleteCorporateActionSource: Delete a corporate action source
     * Deletes a single corporate action sourceUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the corporate action source to be deleted (required)
     * @param code The code of the corporate action source to be deleted (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deleteCorporateActionSourceWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCorporateActionSourceValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] DeleteCorporateActionSource: Delete a corporate action source (asynchronously)
     * Deletes a single corporate action source
     * @param scope The scope of the corporate action source to be deleted (required)
     * @param code The code of the corporate action source to be deleted (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void deleteCorporateActionSourceAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCorporateActionSourceValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteCorporateActionSourceAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCorporateActionSourceValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCorporateActionSourceRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteCorporateActionSourceAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCorporateActionSourceAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteCorporateActionsCall(String scope, String code, List<String> corporateActionIds, final ApiCallback _callback) throws ApiException {
        return deleteCorporateActionsCall(scope, code, corporateActionIds,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteCorporateActions. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the corporate action source (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the corporate action source (required). Use any specified configuration options to override any other configuration for this request only.
     * @param corporateActionIds The IDs of the corporate actions to delete (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest deleteCorporateActionsCall(String scope, String code, List<String> corporateActionIds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteCorporateActionsValidateBeforeCall(String scope, String code, List<String> corporateActionIds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteCorporateActionsWithHttpInfo(String scope, String code, List<String> corporateActionIds) throws ApiException {
        HttpRequest localVarCall = deleteCorporateActionsValidateBeforeCall(scope, code, corporateActionIds, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] DeleteCorporateActions: Delete corporate actions (instrument transition events) from a corporate action source
     * Delete one or more corporate actions from a particular corporate action source.                The maximum number of corporate actions that this method can delete per request is 1,000.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the corporate action source (required)
     * @param code The code of the corporate action source (required)
     * @param corporateActionIds The IDs of the corporate actions to delete (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
    ...
    private ApiResponse<DeletedEntityResponse> deleteCorporateActionsWithHttpInfo(String scope, String code, List<String> corporateActionIds, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCorporateActionsValidateBeforeCall(scope, code, corporateActionIds, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] DeleteCorporateActions: Delete corporate actions (instrument transition events) from a corporate action source (asynchronously)
     * Delete one or more corporate actions from a particular corporate action source.                The maximum number of corporate actions that this method can delete per request is 1,000.
     * @param scope The scope of the corporate action source (required)
     * @param code The code of the corporate action source (required)
     * @param corporateActionIds The IDs of the corporate actions to delete (required)
     ...
     */
    private void deleteCorporateActionsAsync(String scope, String code, List<String> corporateActionIds, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCorporateActionsValidateBeforeCall(scope, code, corporateActionIds, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteCorporateActionsAsync(String scope, String code, List<String> corporateActionIds, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCorporateActionsValidateBeforeCall(scope, code, corporateActionIds, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCorporateActionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteCorporateActionsAsync(scope, code, corporateActionIds, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCorporateActionsAsync(scope, code, corporateActionIds, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteInstrumentEventsCall(String scope, String code, List<String> instrumentEventIds, final ApiCallback _callback) throws ApiException {
        return deleteInstrumentEventsCall(scope, code, instrumentEventIds,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteInstrumentEvents. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the corporate action source (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the corporate action source (required). Use any specified configuration options to override any other configuration for this request only.
     * @param instrumentEventIds The IDs of the instrument events to delete (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest deleteInstrumentEventsCall(String scope, String code, List<String> instrumentEventIds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/corporateactionsources/{scope}/{code}/instrumentevents"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteInstrumentEventsValidateBeforeCall(String scope, String code, List<String> instrumentEventIds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteInstrumentEventsWithHttpInfo(String scope, String code, List<String> instrumentEventIds) throws ApiException {
        HttpRequest localVarCall = deleteInstrumentEventsValidateBeforeCall(scope, code, instrumentEventIds, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] DeleteInstrumentEvents: Delete instrument events from a corporate action source
     * Delete one or more corporate actions from a particular corporate action source.                The maximum number of instrument events that this method can delete per request is 1,000.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the corporate action source (required)
     * @param code The code of the corporate action source (required)
     * @param instrumentEventIds The IDs of the instrument events to delete (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
    ...
    private ApiResponse<DeletedEntityResponse> deleteInstrumentEventsWithHttpInfo(String scope, String code, List<String> instrumentEventIds, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteInstrumentEventsValidateBeforeCall(scope, code, instrumentEventIds, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] DeleteInstrumentEvents: Delete instrument events from a corporate action source (asynchronously)
     * Delete one or more corporate actions from a particular corporate action source.                The maximum number of instrument events that this method can delete per request is 1,000.
     * @param scope The scope of the corporate action source (required)
     * @param code The code of the corporate action source (required)
     * @param instrumentEventIds The IDs of the instrument events to delete (required)
     ...
     */
    private void deleteInstrumentEventsAsync(String scope, String code, List<String> instrumentEventIds, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteInstrumentEventsValidateBeforeCall(scope, code, instrumentEventIds, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteInstrumentEventsAsync(String scope, String code, List<String> instrumentEventIds, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteInstrumentEventsValidateBeforeCall(scope, code, instrumentEventIds, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteInstrumentEventsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteInstrumentEventsAsync(scope, code, instrumentEventIds, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteInstrumentEventsAsync(scope, code, instrumentEventIds, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getCorporateActionsCall(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getCorporateActions. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the corporate action source. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the corporate action source. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param fromEffectiveAt Optional. The start effective date of the data range. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param toEffectiveAt Optional. The end effective date of the data range. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt Optional. The AsAt date of the data. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param limit Optional. When paginating, limit the results to this number. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Optional. Expression to filter the result set.              For example, to filter on the Announcement Date, use \&quot;announcementDate eq &#39;2020-03-06&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getCorporateActionsCall(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCorporateActionsValidateBeforeCall(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfCorporateAction> getCorporateActionsWithHttpInfo(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = getCorporateActionsValidateBeforeCall(scope, code, fromEffectiveAt, toEffectiveAt, asAt, sortBy, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfCorporateAction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetCorporateActions: List corporate actions (instrument transition events) from the corporate action source.
     * Get corporate actions from a particular corporate action source.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the corporate action source. (required)
     * @param code The code of the corporate action source. (required)
     * @param fromEffectiveAt Optional. The start effective date of the data range. (optional)
     * @param toEffectiveAt Optional. The end effective date of the data range. (optional)
    ...
    private ApiResponse<ResourceListOfCorporateAction> getCorporateActionsWithHttpInfo(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCorporateActionsValidateBeforeCall(scope, code, fromEffectiveAt, toEffectiveAt, asAt, sortBy, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfCorporateAction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getCorporateActionsAsync(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, final ApiCallback<ResourceListOfCorporateAction> _callback) throws ApiException {

        HttpRequest localVarCall = getCorporateActionsValidateBeforeCall(scope, code, fromEffectiveAt, toEffectiveAt, asAt, sortBy, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfCorporateAction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCorporateActionsAsync(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, final ApiCallback<ResourceListOfCorporateAction> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCorporateActionsValidateBeforeCall(scope, code, fromEffectiveAt, toEffectiveAt, asAt, sortBy, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfCorporateAction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCorporateActionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfCorporateAction> _callback) throws ApiException {
            getCorporateActionsAsync(scope, code, fromEffectiveAt, toEffectiveAt, asAt, sortBy, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfCorporateAction> _callback, ConfigurationOptions opts) throws ApiException {
            getCorporateActionsAsync(scope, code, fromEffectiveAt, toEffectiveAt, asAt, sortBy, limit, filter, _callback, opts);
        }
    }
     ...
     * @param timelineScope The scope of the Timeline, used to override the AsAt, and fetch post close activity data.              If this is provided, timelineCode and closedPeriodId must also be provided. (optional)
     * @param timelineCode The code of the Timeline, used to override the AsAt, and fetch post close activity data.              If this is provided, timelineScope and closedPeriodId must also be provided. (optional)
     * @param closedPeriodId The code of the ClosedPeriod attached to the timeline, used to override the AsAt, and fetch post close activity data.              If this is provided, timelineScope and timelineCode must also be provided. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    private HttpRequest getInstrumentEventsCall(String scope, String code, OffsetDateTime asAt, Integer limit, String page, String filter, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback) throws ApiException {
        return getInstrumentEventsCall(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getInstrumentEvents. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the corporate action source. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the corporate action source. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt Optional. The AsAt date of the data. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000). Use any specified configuration options to override any other configuration for this request only.
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, asAt, filter and limit must not  be modified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param timelineScope The scope of the Timeline, used to override the AsAt, and fetch post close activity data.              If this is provided, timelineCode and closedPeriodId must also be provided. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param timelineCode The code of the Timeline, used to override the AsAt, and fetch post close activity data.              If this is provided, timelineScope and closedPeriodId must also be provided. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param closedPeriodId The code of the ClosedPeriod attached to the timeline, used to override the AsAt, and fetch post close activity data.              If this is provided, timelineScope and timelineCode must also be provided. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getInstrumentEventsCall(String scope, String code, OffsetDateTime asAt, Integer limit, String page, String filter, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getInstrumentEventsValidateBeforeCall(String scope, String code, OffsetDateTime asAt, Integer limit, String page, String filter, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
        ...
        return getInstrumentEventsCall(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId, _callback, opts);
     ...
     */
    private ApiResponse<PagedResourceListOfInstrumentEventHolder> getInstrumentEventsWithHttpInfo(String scope, String code, OffsetDateTime asAt, Integer limit, String page, String filter, String timelineScope, String timelineCode, String closedPeriodId) throws ApiException {
        HttpRequest localVarCall = getInstrumentEventsValidateBeforeCall(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfInstrumentEventHolder>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetInstrumentEvents: Get extrinsic instrument events out of a given corporate actions source.
     * Retrieves extrinsic corporate actions out of a corporate actions sourceUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the corporate action source. (required)
     * @param code The code of the corporate action source. (required)
     * @param asAt Optional. The AsAt date of the data. (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000)
     ...
     */
    private ApiResponse<PagedResourceListOfInstrumentEventHolder> getInstrumentEventsWithHttpInfo(String scope, String code, OffsetDateTime asAt, Integer limit, String page, String filter, String timelineScope, String timelineCode, String closedPeriodId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getInstrumentEventsValidateBeforeCall(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfInstrumentEventHolder>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getInstrumentEventsAsync(String scope, String code, OffsetDateTime asAt, Integer limit, String page, String filter, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback<PagedResourceListOfInstrumentEventHolder> _callback) throws ApiException {

        HttpRequest localVarCall = getInstrumentEventsValidateBeforeCall(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfInstrumentEventHolder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getInstrumentEventsAsync(String scope, String code, OffsetDateTime asAt, Integer limit, String page, String filter, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback<PagedResourceListOfInstrumentEventHolder> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getInstrumentEventsValidateBeforeCall(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfInstrumentEventHolder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetInstrumentEventsRequest {
         ...
         * @return APIgetInstrumentEventsRequest
         */
        public APIgetInstrumentEventsRequest timelineScope(String timelineScope) {
         ...
         * @return APIgetInstrumentEventsRequest
         */
        public APIgetInstrumentEventsRequest timelineCode(String timelineCode) {
         ...
         * @return APIgetInstrumentEventsRequest
         */
        public APIgetInstrumentEventsRequest closedPeriodId(String closedPeriodId) {
         ...
         */
        public HttpRequest buildCall(final ApiCallback _callback) throws ApiException {
            return getInstrumentEventsCall(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId, _callback);
        }
        ...
        public PagedResourceListOfInstrumentEventHolder execute() throws ApiException {
            ApiResponse<PagedResourceListOfInstrumentEventHolder> localVarResp = getInstrumentEventsWithHttpInfo(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId);
            return localVarResp.getData();
        }
        ...
        public PagedResourceListOfInstrumentEventHolder execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<PagedResourceListOfInstrumentEventHolder> localVarResp = getInstrumentEventsWithHttpInfo(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId, opts);
            return localVarResp.getData();
        }
        ...
        public ApiResponse<PagedResourceListOfInstrumentEventHolder> executeWithHttpInfo() throws ApiException {
            return getInstrumentEventsWithHttpInfo(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId);
        }
        ...
        public ApiResponse<PagedResourceListOfInstrumentEventHolder> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return getInstrumentEventsWithHttpInfo(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId, opts);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfInstrumentEventHolder> _callback) throws ApiException {
            getInstrumentEventsAsync(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfInstrumentEventHolder> _callback, ConfigurationOptions opts) throws ApiException {
            getInstrumentEventsAsync(scope, code, asAt, limit, page, filter, timelineScope, timelineCode, closedPeriodId, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listCorporateActionSourcesCall(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback _callback) throws ApiException {
        return listCorporateActionSourcesCall(asAt, sortBy, limit, filter, page,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listCorporateActionSources. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt Optional. The AsAt date of the data (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 100 is used. (optional, default to 100). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Optional. Expression to filter the result set. For example, to  filter on the Display Name, use \&quot;displayName eq &#39;string&#39;\&quot;  Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, the filter, asAt, and limit must not  be modified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listCorporateActionSourcesCall(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listCorporateActionSourcesValidateBeforeCall(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfCorporateActionSource> listCorporateActionSourcesWithHttpInfo(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page) throws ApiException {
        HttpRequest localVarCall = listCorporateActionSourcesValidateBeforeCall(asAt, sortBy, limit, filter, page, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCorporateActionSource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListCorporateActionSources: List corporate action sources
     * Gets a list of all corporate action sourcesUse any specified configuration options to override any other configuration for this request only
     * @param asAt Optional. The AsAt date of the data (optional)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 100 is used. (optional, default to 100)
     * @param filter Optional. Expression to filter the result set. For example, to  filter on the Display Name, use \&quot;displayName eq &#39;string&#39;\&quot;  Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    private ApiResponse<PagedResourceListOfCorporateActionSource> listCorporateActionSourcesWithHttpInfo(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listCorporateActionSourcesValidateBeforeCall(asAt, sortBy, limit, filter, page, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCorporateActionSource>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listCorporateActionSourcesAsync(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback<PagedResourceListOfCorporateActionSource> _callback) throws ApiException {

        HttpRequest localVarCall = listCorporateActionSourcesValidateBeforeCall(asAt, sortBy, limit, filter, page, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCorporateActionSource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listCorporateActionSourcesAsync(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback<PagedResourceListOfCorporateActionSource> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listCorporateActionSourcesValidateBeforeCall(asAt, sortBy, limit, filter, page, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCorporateActionSource>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistCorporateActionSourcesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCorporateActionSource> _callback) throws ApiException {
            listCorporateActionSourcesAsync(asAt, sortBy, limit, filter, page, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCorporateActionSource> _callback, ConfigurationOptions opts) throws ApiException {
            listCorporateActionSourcesAsync(asAt, sortBy, limit, filter, page, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertInstrumentEventsCall(String scope, String code, List<UpsertInstrumentEventRequest> upsertInstrumentEventRequest, final ApiCallback _callback) throws ApiException {
        return upsertInstrumentEventsCall(scope, code, upsertInstrumentEventRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertInstrumentEvents. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the corporate action source. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the corporate action source. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param upsertInstrumentEventRequest The instrument event definitions. (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest upsertInstrumentEventsCall(String scope, String code, List<UpsertInstrumentEventRequest> upsertInstrumentEventRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertInstrumentEventsValidateBeforeCall(String scope, String code, List<UpsertInstrumentEventRequest> upsertInstrumentEventRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<UpsertInstrumentEventsResponse> upsertInstrumentEventsWithHttpInfo(String scope, String code, List<UpsertInstrumentEventRequest> upsertInstrumentEventRequest) throws ApiException {
        HttpRequest localVarCall = upsertInstrumentEventsValidateBeforeCall(scope, code, upsertInstrumentEventRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertInstrumentEventsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpsertInstrumentEvents: Upsert instrument events to the provided corporate actions source.
     * Batch upsert instrument events to corporate action sources.                The maximum number of instrument events that this method can upsert per request is 10,000.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the corporate action source. (required)
     * @param code The code of the corporate action source. (required)
     * @param upsertInstrumentEventRequest The instrument event definitions. (optional)
     * @return ApiResponse&lt;UpsertInstrumentEventsResponse&gt;
    ...
    private ApiResponse<UpsertInstrumentEventsResponse> upsertInstrumentEventsWithHttpInfo(String scope, String code, List<UpsertInstrumentEventRequest> upsertInstrumentEventRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertInstrumentEventsValidateBeforeCall(scope, code, upsertInstrumentEventRequest, null, opts);
        Type localVarReturnType = new TypeReference<UpsertInstrumentEventsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertInstrumentEventsAsync(String scope, String code, List<UpsertInstrumentEventRequest> upsertInstrumentEventRequest, final ApiCallback<UpsertInstrumentEventsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertInstrumentEventsValidateBeforeCall(scope, code, upsertInstrumentEventRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertInstrumentEventsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertInstrumentEventsAsync(String scope, String code, List<UpsertInstrumentEventRequest> upsertInstrumentEventRequest, final ApiCallback<UpsertInstrumentEventsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertInstrumentEventsValidateBeforeCall(scope, code, upsertInstrumentEventRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertInstrumentEventsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertInstrumentEventsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UpsertInstrumentEventsResponse> _callback) throws ApiException {
            upsertInstrumentEventsAsync(scope, code, upsertInstrumentEventRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UpsertInstrumentEventsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertInstrumentEventsAsync(scope, code, upsertInstrumentEventRequest, _callback, opts);
        }
    }
