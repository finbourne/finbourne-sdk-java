...
public class AggregatedReturnsApi {
     ...
     */
    private HttpRequest deleteReturnsEntityCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteReturnsEntityCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteReturnsEntity. Use any specified configuration options to override any other configuration for this request only.
     * @param scope Returns entity scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code Returns entity code. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteReturnsEntityCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/returns/{scope}/{code}"
    ...
    private HttpRequest deleteReturnsEntityValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteReturnsEntityWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteReturnsEntityValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EXPERIMENTAL] DeleteReturnsEntity: Delete returns entity.
     * Delete returns entity.Use any specified configuration options to override any other configuration for this request only
     * @param scope Returns entity scope. (required)
     * @param code Returns entity code. (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deleteReturnsEntityWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteReturnsEntityValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] DeleteReturnsEntity: Delete returns entity. (asynchronously)
     * Delete returns entity.
     * @param scope Returns entity scope. (required)
     * @param code Returns entity code. (required)
     ...
     */
    private void deleteReturnsEntityAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteReturnsEntityValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
     ...
     */
    private void deleteReturnsEntityAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteReturnsEntityValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteReturnsEntityRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteReturnsEntityAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteReturnsEntityAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getAggregatedReturnsCall(AggregatedReturnsEntityRequest aggregatedReturnsEntityRequest, final ApiCallback _callback) throws ApiException {
        return getAggregatedReturnsCall(aggregatedReturnsEntityRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getAggregatedReturns. Use any specified configuration options to override any other configuration for this request only.
     * @param aggregatedReturnsEntityRequest The entity to calculate returns for, the Returns entity that configures the              calculation, the effective window and the metrics to calculate. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getAggregatedReturnsCall(AggregatedReturnsEntityRequest aggregatedReturnsEntityRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/returns/$aggregated";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getAggregatedReturnsValidateBeforeCall(AggregatedReturnsEntityRequest aggregatedReturnsEntityRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<AggregatedReturnsResponse> getAggregatedReturnsWithHttpInfo(AggregatedReturnsEntityRequest aggregatedReturnsEntityRequest) throws ApiException {
        HttpRequest localVarCall = getAggregatedReturnsValidateBeforeCall(aggregatedReturnsEntityRequest, null, new ConfigurationOptions());
    ...
    private ApiResponse<AggregatedReturnsResponse> getAggregatedReturnsWithHttpInfo(AggregatedReturnsEntityRequest aggregatedReturnsEntityRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getAggregatedReturnsValidateBeforeCall(aggregatedReturnsEntityRequest, null, opts);
        Type localVarReturnType = new TypeReference<AggregatedReturnsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getAggregatedReturnsAsync(AggregatedReturnsEntityRequest aggregatedReturnsEntityRequest, final ApiCallback<AggregatedReturnsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getAggregatedReturnsValidateBeforeCall(aggregatedReturnsEntityRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AggregatedReturnsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getAggregatedReturnsAsync(AggregatedReturnsEntityRequest aggregatedReturnsEntityRequest, final ApiCallback<AggregatedReturnsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getAggregatedReturnsValidateBeforeCall(aggregatedReturnsEntityRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<AggregatedReturnsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetAggregatedReturnsRequest {
        ...
        public void executeAsync(final ApiCallback<AggregatedReturnsResponse> _callback) throws ApiException {
            getAggregatedReturnsAsync(aggregatedReturnsEntityRequest, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<AggregatedReturnsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getAggregatedReturnsAsync(aggregatedReturnsEntityRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getReturnsEntityCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getReturnsEntityCall(scope, code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getReturnsEntity. Use any specified configuration options to override any other configuration for this request only.
     * @param scope Returns entity scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code Returns entity code. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the returns entity. Defaults to return              the latest version of the definition if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getReturnsEntityCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getReturnsEntityValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ReturnsEntity> getReturnsEntityWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getReturnsEntityValidateBeforeCall(scope, code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ReturnsEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetReturnsEntity: Get returns entity.
     * Get returns entity.Use any specified configuration options to override any other configuration for this request only
     * @param scope Returns entity scope. (required)
     * @param code Returns entity code. (required)
     * @param asAt The asAt datetime at which to retrieve the returns entity. Defaults to return              the latest version of the definition if not specified. (optional)
     * @return ApiResponse&lt;ReturnsEntity&gt;
    ...
    private ApiResponse<ReturnsEntity> getReturnsEntityWithHttpInfo(String scope, String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getReturnsEntityValidateBeforeCall(scope, code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<ReturnsEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetReturnsEntity: Get returns entity. (asynchronously)
     * Get returns entity.
     * @param scope Returns entity scope. (required)
     * @param code Returns entity code. (required)
     * @param asAt The asAt datetime at which to retrieve the returns entity. Defaults to return              the latest version of the definition if not specified. (optional)
     ...
     */
    private void getReturnsEntityAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<ReturnsEntity> _callback) throws ApiException {

        HttpRequest localVarCall = getReturnsEntityValidateBeforeCall(scope, code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ReturnsEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getReturnsEntityAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<ReturnsEntity> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getReturnsEntityValidateBeforeCall(scope, code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ReturnsEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetReturnsEntityRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ReturnsEntity> _callback) throws ApiException {
            getReturnsEntityAsync(scope, code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ReturnsEntity> _callback, ConfigurationOptions opts) throws ApiException {
            getReturnsEntityAsync(scope, code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listReturnsEntitiesCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return listReturnsEntitiesCall(asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listReturnsEntities. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the relation definitions. Defaults to return              the latest version of each definition if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listReturnsEntitiesCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/returns";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listReturnsEntitiesValidateBeforeCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfReturnsEntity> listReturnsEntitiesWithHttpInfo(OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = listReturnsEntitiesValidateBeforeCall(asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfReturnsEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListReturnsEntities: List returns entities.
     * List returns entities.Use any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to retrieve the relation definitions. Defaults to return              the latest version of each definition if not specified. (optional)
     * @return ApiResponse&lt;ResourceListOfReturnsEntity&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfReturnsEntity> listReturnsEntitiesWithHttpInfo(OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listReturnsEntitiesValidateBeforeCall(asAt, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfReturnsEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListReturnsEntities: List returns entities. (asynchronously)
     * List returns entities.
     * @param asAt The asAt datetime at which to retrieve the relation definitions. Defaults to return              the latest version of each definition if not specified. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void listReturnsEntitiesAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfReturnsEntity> _callback) throws ApiException {

        HttpRequest localVarCall = listReturnsEntitiesValidateBeforeCall(asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfReturnsEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listReturnsEntitiesAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfReturnsEntity> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listReturnsEntitiesValidateBeforeCall(asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfReturnsEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistReturnsEntitiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfReturnsEntity> _callback) throws ApiException {
            listReturnsEntitiesAsync(asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfReturnsEntity> _callback, ConfigurationOptions opts) throws ApiException {
            listReturnsEntitiesAsync(asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertReturnsEntityCall(ReturnsEntity returnsEntity, final ApiCallback _callback) throws ApiException {
        return upsertReturnsEntityCall(returnsEntity,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertReturnsEntity. Use any specified configuration options to override any other configuration for this request only.
     * @param returnsEntity Definition of the returns entity. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertReturnsEntityCall(ReturnsEntity returnsEntity, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertReturnsEntityValidateBeforeCall(ReturnsEntity returnsEntity, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ReturnsEntity> upsertReturnsEntityWithHttpInfo(ReturnsEntity returnsEntity) throws ApiException {
        HttpRequest localVarCall = upsertReturnsEntityValidateBeforeCall(returnsEntity, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ReturnsEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EXPERIMENTAL] UpsertReturnsEntity: Upsert returns entity.
     * Upsert returns entity.Use any specified configuration options to override any other configuration for this request only
     * @param returnsEntity Definition of the returns entity. (required)
     * @return ApiResponse&lt;ReturnsEntity&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ReturnsEntity> upsertReturnsEntityWithHttpInfo(ReturnsEntity returnsEntity, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertReturnsEntityValidateBeforeCall(returnsEntity, null, opts);
        Type localVarReturnType = new TypeReference<ReturnsEntity>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] UpsertReturnsEntity: Upsert returns entity. (asynchronously)
     * Upsert returns entity.
     * @param returnsEntity Definition of the returns entity. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void upsertReturnsEntityAsync(ReturnsEntity returnsEntity, final ApiCallback<ReturnsEntity> _callback) throws ApiException {

        HttpRequest localVarCall = upsertReturnsEntityValidateBeforeCall(returnsEntity, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ReturnsEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertReturnsEntityAsync(ReturnsEntity returnsEntity, final ApiCallback<ReturnsEntity> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertReturnsEntityValidateBeforeCall(returnsEntity, _callback, opts);
        Type localVarReturnType = new TypeReference<ReturnsEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertReturnsEntityRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ReturnsEntity> _callback) throws ApiException {
            upsertReturnsEntityAsync(returnsEntity, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ReturnsEntity> _callback, ConfigurationOptions opts) throws ApiException {
            upsertReturnsEntityAsync(returnsEntity, _callback, opts);
        }
    }
