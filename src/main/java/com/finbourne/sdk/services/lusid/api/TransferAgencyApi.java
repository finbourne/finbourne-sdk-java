...
import com.finbourne.sdk.services.lusid.model.DeleteTransferAgencyOrderRequest;
...
import com.finbourne.sdk.services.lusid.model.UpsertTransferAgencyOrderRequest;
...
public class TransferAgencyApi {
     ...
     */
    private HttpRequest calculateOrderDatesCall(Map<String, CalculateOrderDatesRequest> requestBody, final ApiCallback _callback) throws ApiException {
        return calculateOrderDatesCall(requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for calculateOrderDates. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The request containing the dates used for calculation (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest calculateOrderDatesCall(Map<String, CalculateOrderDatesRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/transferagency/orderdates";
    ...
    private HttpRequest calculateOrderDatesValidateBeforeCall(Map<String, CalculateOrderDatesRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<CalculateOrderDatesResponse> calculateOrderDatesWithHttpInfo(Map<String, CalculateOrderDatesRequest> requestBody) throws ApiException {
        HttpRequest localVarCall = calculateOrderDatesValidateBeforeCall(requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CalculateOrderDatesResponse>(){}.getType();
    ...
    private ApiResponse<CalculateOrderDatesResponse> calculateOrderDatesWithHttpInfo(Map<String, CalculateOrderDatesRequest> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = calculateOrderDatesValidateBeforeCall(requestBody, null, opts);
        Type localVarReturnType = new TypeReference<CalculateOrderDatesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] CalculateOrderDates: Calculate the key dates associated with transfer agency orders (asynchronously)
     * The response contains both the collection of successfully calculated dates and any failed calculations,  each in the form of a dictionary keyed by the request&#39;s keys.  For each failure, a reason is provided. It is important to check the failed set for unsuccessful results.
     * @param requestBody The request containing the dates used for calculation (required)
     ...
     */
    private void calculateOrderDatesAsync(Map<String, CalculateOrderDatesRequest> requestBody, final ApiCallback<CalculateOrderDatesResponse> _callback) throws ApiException {

        HttpRequest localVarCall = calculateOrderDatesValidateBeforeCall(requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CalculateOrderDatesResponse>(){}.getType();
     ...
     */
    private void calculateOrderDatesAsync(Map<String, CalculateOrderDatesRequest> requestBody, final ApiCallback<CalculateOrderDatesResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = calculateOrderDatesValidateBeforeCall(requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<CalculateOrderDatesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcalculateOrderDatesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CalculateOrderDatesResponse> _callback) throws ApiException {
            calculateOrderDatesAsync(requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CalculateOrderDatesResponse> _callback, ConfigurationOptions opts) throws ApiException {
            calculateOrderDatesAsync(requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteTransferAgencyOrdersCall(Map<String, DeleteTransferAgencyOrderRequest> requestBody, final ApiCallback _callback) throws ApiException {
        return deleteTransferAgencyOrdersCall(requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteTransferAgencyOrders. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The transfer agency orders to delete, keyed by a unique request identifier. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteTransferAgencyOrdersCall(Map<String, DeleteTransferAgencyOrderRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/transferagency/orders/$delete";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteTransferAgencyOrdersValidateBeforeCall(Map<String, DeleteTransferAgencyOrderRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
    ...
    private ApiResponse<DeleteTransferAgencyOrdersResponse> deleteTransferAgencyOrdersWithHttpInfo(Map<String, DeleteTransferAgencyOrderRequest> requestBody) throws ApiException {
        HttpRequest localVarCall = deleteTransferAgencyOrdersValidateBeforeCall(requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeleteTransferAgencyOrdersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<DeleteTransferAgencyOrdersResponse> deleteTransferAgencyOrdersWithHttpInfo(Map<String, DeleteTransferAgencyOrderRequest> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteTransferAgencyOrdersValidateBeforeCall(requestBody, null, opts);
        Type localVarReturnType = new TypeReference<DeleteTransferAgencyOrdersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] DeleteTransferAgencyOrders: Delete transfer agency orders (asynchronously)
     * Deletes each order supplied, cancelling any cash transaction(s) already booked for it. Only an order in  &#39;New&#39; or &#39;Pending&#39; can be deleted. A priced order must be un-priced first. An order with no cash transaction  booked against it is deleted successfully and reports no cancelled transactions. Transaction staging rules are not applied to these  cancellations.  The response contains both successfully deleted orders and any failures, each in the form of a  dictionary keyed by the request&#39;s keys. For each failure, a reason is provided. It is important to  check the failed set for unsuccessful results.
     * @param requestBody The transfer agency orders to delete, keyed by a unique request identifier. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void deleteTransferAgencyOrdersAsync(Map<String, DeleteTransferAgencyOrderRequest> requestBody, final ApiCallback<DeleteTransferAgencyOrdersResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteTransferAgencyOrdersValidateBeforeCall(requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeleteTransferAgencyOrdersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteTransferAgencyOrdersAsync(Map<String, DeleteTransferAgencyOrderRequest> requestBody, final ApiCallback<DeleteTransferAgencyOrdersResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteTransferAgencyOrdersValidateBeforeCall(requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<DeleteTransferAgencyOrdersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteTransferAgencyOrdersRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeleteTransferAgencyOrdersResponse> _callback) throws ApiException {
            deleteTransferAgencyOrdersAsync(requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeleteTransferAgencyOrdersResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteTransferAgencyOrdersAsync(requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest estimateTransferAgencyOrdersCall(Map<String, EstimateTransferAgencyOrderRequest> requestBody, final ApiCallback _callback) throws ApiException {
        return estimateTransferAgencyOrdersCall(requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for estimateTransferAgencyOrders. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The transfer agency orders to estimate, keyed by a unique request identifier. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest estimateTransferAgencyOrdersCall(Map<String, EstimateTransferAgencyOrderRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/transferagency/orders/$estimate";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest estimateTransferAgencyOrdersValidateBeforeCall(Map<String, EstimateTransferAgencyOrderRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
    ...
    private ApiResponse<EstimateTransferAgencyOrdersResponse> estimateTransferAgencyOrdersWithHttpInfo(Map<String, EstimateTransferAgencyOrderRequest> requestBody) throws ApiException {
        HttpRequest localVarCall = estimateTransferAgencyOrdersValidateBeforeCall(requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<EstimateTransferAgencyOrdersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] EstimateTransferAgencyOrders: Estimate the values of transfer agency orders
     * Estimates the units and the cash each order supplied would move, from the share class&#39;s most recent price.  Nothing is written.                An order may be named by its identifier, to estimate it as it stands, or supplied whole, to estimate values  that have not been saved yet. Both forms may appear in the same request. Where an order is supplied whole,  those values are estimated in place of the saved order&#39;s.                A switch or a transfer is two orders, and each leg is estimated independently.                The price is reported in the currency the share class is quoted in, which is not necessarily the order&#39;s  currency, so it is returned alongside that currency and the rate used.                The response contains both the successful estimates and any failures, each in the form of a dictionary  keyed by the request&#39;s keys. A share class with no price available fails only its own orders. It is  important to check the failed set for unsuccessful results.Use any specified configuration options to override any other configuration for this request only
     * @param requestBody The transfer agency orders to estimate, keyed by a unique request identifier. (required)
     * @return ApiResponse&lt;EstimateTransferAgencyOrdersResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<EstimateTransferAgencyOrdersResponse> estimateTransferAgencyOrdersWithHttpInfo(Map<String, EstimateTransferAgencyOrderRequest> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = estimateTransferAgencyOrdersValidateBeforeCall(requestBody, null, opts);
        Type localVarReturnType = new TypeReference<EstimateTransferAgencyOrdersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] EstimateTransferAgencyOrders: Estimate the values of transfer agency orders (asynchronously)
     * Estimates the units and the cash each order supplied would move, from the share class&#39;s most recent price.  Nothing is written.                An order may be named by its identifier, to estimate it as it stands, or supplied whole, to estimate values  that have not been saved yet. Both forms may appear in the same request. Where an order is supplied whole,  those values are estimated in place of the saved order&#39;s.                A switch or a transfer is two orders, and each leg is estimated independently.                The price is reported in the currency the share class is quoted in, which is not necessarily the order&#39;s  currency, so it is returned alongside that currency and the rate used.                The response contains both the successful estimates and any failures, each in the form of a dictionary  keyed by the request&#39;s keys. A share class with no price available fails only its own orders. It is  important to check the failed set for unsuccessful results.
     * @param requestBody The transfer agency orders to estimate, keyed by a unique request identifier. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void estimateTransferAgencyOrdersAsync(Map<String, EstimateTransferAgencyOrderRequest> requestBody, final ApiCallback<EstimateTransferAgencyOrdersResponse> _callback) throws ApiException {

        HttpRequest localVarCall = estimateTransferAgencyOrdersValidateBeforeCall(requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<EstimateTransferAgencyOrdersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void estimateTransferAgencyOrdersAsync(Map<String, EstimateTransferAgencyOrderRequest> requestBody, final ApiCallback<EstimateTransferAgencyOrdersResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = estimateTransferAgencyOrdersValidateBeforeCall(requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<EstimateTransferAgencyOrdersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIestimateTransferAgencyOrdersRequest {
         ...
         */
        public void executeAsync(final ApiCallback<EstimateTransferAgencyOrdersResponse> _callback) throws ApiException {
            estimateTransferAgencyOrdersAsync(requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<EstimateTransferAgencyOrdersResponse> _callback, ConfigurationOptions opts) throws ApiException {
            estimateTransferAgencyOrdersAsync(requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertTransferAgencyOrdersCall(Map<String, UpsertTransferAgencyOrderRequest> requestBody, final ApiCallback _callback) throws ApiException {
        return upsertTransferAgencyOrdersCall(requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertTransferAgencyOrders. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The transfer agency orders to upsert, keyed by a unique request identifier. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertTransferAgencyOrdersCall(Map<String, UpsertTransferAgencyOrderRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/transferagency/orders";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertTransferAgencyOrdersValidateBeforeCall(Map<String, UpsertTransferAgencyOrderRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
    ...
    private ApiResponse<TransferAgencyOrdersResponse> upsertTransferAgencyOrdersWithHttpInfo(Map<String, UpsertTransferAgencyOrderRequest> requestBody) throws ApiException {
        HttpRequest localVarCall = upsertTransferAgencyOrdersValidateBeforeCall(requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransferAgencyOrdersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<TransferAgencyOrdersResponse> upsertTransferAgencyOrdersWithHttpInfo(Map<String, UpsertTransferAgencyOrderRequest> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertTransferAgencyOrdersValidateBeforeCall(requestBody, null, opts);
        Type localVarReturnType = new TypeReference<TransferAgencyOrdersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] UpsertTransferAgencyOrders: Upsert transfer agency orders (asynchronously)
     * Creates a transaction and updates the relevant order for each order supplied.  The response contains both successfully processed orders and any failures, each in the form of a  dictionary keyed by the request&#39;s keys. For each failure, a reason is provided. It is important to  check the failed set for unsuccessful results.
     * @param requestBody The transfer agency orders to upsert, keyed by a unique request identifier. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void upsertTransferAgencyOrdersAsync(Map<String, UpsertTransferAgencyOrderRequest> requestBody, final ApiCallback<TransferAgencyOrdersResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertTransferAgencyOrdersValidateBeforeCall(requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransferAgencyOrdersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertTransferAgencyOrdersAsync(Map<String, UpsertTransferAgencyOrderRequest> requestBody, final ApiCallback<TransferAgencyOrdersResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertTransferAgencyOrdersValidateBeforeCall(requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<TransferAgencyOrdersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertTransferAgencyOrdersRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransferAgencyOrdersResponse> _callback) throws ApiException {
            upsertTransferAgencyOrdersAsync(requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransferAgencyOrdersResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertTransferAgencyOrdersAsync(requestBody, _callback, opts);
        }
    }
