...
public class ReconciliationsApi {
     ...
     */
    private HttpRequest createScheduledReconciliationCall(String scope, CreateReconciliationRequest createReconciliationRequest, final ApiCallback _callback) throws ApiException {
        return createScheduledReconciliationCall(scope, createReconciliationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createScheduledReconciliation. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the reconciliation (required). Use any specified configuration options to override any other configuration for this request only.
     * @param createReconciliationRequest The definition of the reconciliation (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createScheduledReconciliationCall(String scope, CreateReconciliationRequest createReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/portfolios/$scheduledReconciliations/{scope}"
    ...
    private HttpRequest createScheduledReconciliationValidateBeforeCall(String scope, CreateReconciliationRequest createReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<Reconciliation> createScheduledReconciliationWithHttpInfo(String scope, CreateReconciliationRequest createReconciliationRequest) throws ApiException {
        HttpRequest localVarCall = createScheduledReconciliationValidateBeforeCall(scope, createReconciliationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] CreateScheduledReconciliation: Create a scheduled reconciliation
     * Create a scheduled reconciliation for the given requestUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the reconciliation (required)
     * @param createReconciliationRequest The definition of the reconciliation (optional)
     * @return ApiResponse&lt;Reconciliation&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<Reconciliation> createScheduledReconciliationWithHttpInfo(String scope, CreateReconciliationRequest createReconciliationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createScheduledReconciliationValidateBeforeCall(scope, createReconciliationRequest, null, opts);
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createScheduledReconciliationAsync(String scope, CreateReconciliationRequest createReconciliationRequest, final ApiCallback<Reconciliation> _callback) throws ApiException {

        HttpRequest localVarCall = createScheduledReconciliationValidateBeforeCall(scope, createReconciliationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
     ...
     */
    private void createScheduledReconciliationAsync(String scope, CreateReconciliationRequest createReconciliationRequest, final ApiCallback<Reconciliation> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createScheduledReconciliationValidateBeforeCall(scope, createReconciliationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateScheduledReconciliationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Reconciliation> _callback) throws ApiException {
            createScheduledReconciliationAsync(scope, createReconciliationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Reconciliation> _callback, ConfigurationOptions opts) throws ApiException {
            createScheduledReconciliationAsync(scope, createReconciliationRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteReconciliationCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteReconciliationCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteReconciliation. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the scheduled reconciliation (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the scheduled reconciliation (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteReconciliationCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/$scheduledReconciliations/{scope}/{code}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteReconciliationValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteReconciliationWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteReconciliationValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EXPERIMENTAL] DeleteReconciliation: Delete scheduled reconciliation
     * Delete the given scheduled reconciliationUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the scheduled reconciliation (required)
     * @param code The code of the scheduled reconciliation (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deleteReconciliationWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteReconciliationValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteReconciliationAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteReconciliationValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteReconciliationAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteReconciliationValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteReconciliationRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteReconciliationAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteReconciliationAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteReconciliationMappingCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteReconciliationMappingCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteReconciliationMapping. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the mapping. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code fof the mapping. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteReconciliationMappingCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/mapping/{scope}/{code}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteReconciliationMappingValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<String> deleteReconciliationMappingWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteReconciliationMappingValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] DeleteReconciliationMapping: Delete a mapping
     * Deletes the mapping identified by the scope and codeUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the mapping. (required)
     * @param code The code fof the mapping. (required)
     * @return ApiResponse&lt;String&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<String> deleteReconciliationMappingWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteReconciliationMappingValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteReconciliationMappingAsync(String scope, String code, final ApiCallback<String> _callback) throws ApiException {

        HttpRequest localVarCall = deleteReconciliationMappingValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteReconciliationMappingAsync(String scope, String code, final ApiCallback<String> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteReconciliationMappingValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteReconciliationMappingRequest {
        ...
        public void executeAsync(final ApiCallback<String> _callback) throws ApiException {
            deleteReconciliationMappingAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<String> _callback, ConfigurationOptions opts) throws ApiException {
            deleteReconciliationMappingAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getReconciliationCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return getReconciliationCall(scope, code, effectiveAt, asAt, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getReconciliation. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the scheduled reconciliation (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the scheduled reconciliation (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the scheduled reconciliation. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the scheduled reconciliation. Defaults to returning the latest version of the reconciliation if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;Reconciliation&#39; property domain to decorate onto the reconciliation.              These must take the form {domain}/{scope}/{code}, for example &#39;Reconciliation/Broker/Id&#39;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getReconciliationCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getReconciliationValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Reconciliation> getReconciliationWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = getReconciliationValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EXPERIMENTAL] GetReconciliation: Get scheduled reconciliation
     * Get the requested scheduled reconciliationUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the scheduled reconciliation (required)
     * @param code The code of the scheduled reconciliation (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve the scheduled reconciliation. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve the scheduled reconciliation. Defaults to returning the latest version of the reconciliation if not specified. (optional)
    ...
    private ApiResponse<Reconciliation> getReconciliationWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getReconciliationValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getReconciliationAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Reconciliation> _callback) throws ApiException {

        HttpRequest localVarCall = getReconciliationValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getReconciliationAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Reconciliation> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getReconciliationValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetReconciliationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Reconciliation> _callback) throws ApiException {
            getReconciliationAsync(scope, code, effectiveAt, asAt, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Reconciliation> _callback, ConfigurationOptions opts) throws ApiException {
            getReconciliationAsync(scope, code, effectiveAt, asAt, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getReconciliationMappingCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return getReconciliationMappingCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getReconciliationMapping. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the mapping. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the mapping. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest getReconciliationMappingCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getReconciliationMappingValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Mapping> getReconciliationMappingWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = getReconciliationMappingValidateBeforeCall(scope, code, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Mapping>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetReconciliationMapping: Get a mapping
     * Gets a mapping identified by the given scope and codeUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the mapping. (required)
     * @param code The code of the mapping. (required)
     * @return ApiResponse&lt;Mapping&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<Mapping> getReconciliationMappingWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getReconciliationMappingValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<Mapping>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getReconciliationMappingAsync(String scope, String code, final ApiCallback<Mapping> _callback) throws ApiException {

        HttpRequest localVarCall = getReconciliationMappingValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Mapping>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getReconciliationMappingAsync(String scope, String code, final ApiCallback<Mapping> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getReconciliationMappingValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<Mapping>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetReconciliationMappingRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Mapping> _callback) throws ApiException {
            getReconciliationMappingAsync(scope, code, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Mapping> _callback, ConfigurationOptions opts) throws ApiException {
            getReconciliationMappingAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listReconciliationMappingsCall(String reconciliationType, final ApiCallback _callback) throws ApiException {
        return listReconciliationMappingsCall(reconciliationType,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listReconciliationMappings. Use any specified configuration options to override any other configuration for this request only.
     * @param reconciliationType Optional parameter to specify which type of mappings should be returned.  Default value: Transaction. Available values: Transaction, Holding, Valuation, Cash, CashHolding. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listReconciliationMappingsCall(String reconciliationType, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/mapping";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listReconciliationMappingsValidateBeforeCall(String reconciliationType, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfMapping> listReconciliationMappingsWithHttpInfo(String reconciliationType) throws ApiException {
        HttpRequest localVarCall = listReconciliationMappingsValidateBeforeCall(reconciliationType, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfMapping>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListReconciliationMappings: List the reconciliation mappings
     * Lists all mappings this user is entitled to seeUse any specified configuration options to override any other configuration for this request only
     * @param reconciliationType Optional parameter to specify which type of mappings should be returned.  Default value: Transaction. Available values: Transaction, Holding, Valuation, Cash, CashHolding. (optional)
     * @return ApiResponse&lt;ResourceListOfMapping&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfMapping> listReconciliationMappingsWithHttpInfo(String reconciliationType, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listReconciliationMappingsValidateBeforeCall(reconciliationType, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfMapping>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listReconciliationMappingsAsync(String reconciliationType, final ApiCallback<ResourceListOfMapping> _callback) throws ApiException {

        HttpRequest localVarCall = listReconciliationMappingsValidateBeforeCall(reconciliationType, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfMapping>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listReconciliationMappingsAsync(String reconciliationType, final ApiCallback<ResourceListOfMapping> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listReconciliationMappingsValidateBeforeCall(reconciliationType, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfMapping>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistReconciliationMappingsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfMapping> _callback) throws ApiException {
            listReconciliationMappingsAsync(reconciliationType, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfMapping> _callback, ConfigurationOptions opts) throws ApiException {
            listReconciliationMappingsAsync(reconciliationType, _callback, opts);
        }
    }
     ...
     * @param filter Expression to filter the results.              For example, to filter on the reconciliation type, specify \&quot;id.Code eq &#39;001&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid. (optional)
     ...
     */
    private HttpRequest listReconciliationsCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return listReconciliationsCall(effectiveAt, asAt, page, limit, filter, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listReconciliations. Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the TimeVariant properties for the reconciliation. Defaults to the current LUSID              system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the reconciliation. Defaults to returning the latest version              of each reconciliation if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing reconciliations; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param filter Expression to filter the results.              For example, to filter on the reconciliation type, specify \&quot;id.Code eq &#39;001&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;Reconciliation&#39; domain to decorate onto each reconciliation.              These must take the format {domain}/{scope}/{code}, for example &#39;Reconciliation/Broker/Id&#39;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listReconciliationsCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/$scheduledReconciliations";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listReconciliationsValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfReconciliation> listReconciliationsWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = listReconciliationsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfReconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListReconciliations: List scheduled reconciliations
     * List all the scheduled reconciliations matching particular criteriaUse any specified configuration options to override any other configuration for this request only
     * @param effectiveAt The effective datetime or cut label at which to list the TimeVariant properties for the reconciliation. Defaults to the current LUSID              system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the reconciliation. Defaults to returning the latest version              of each reconciliation if not specified. (optional)
     * @param page The pagination token to use to continue listing reconciliations; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional)
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional)
    ...
    private ApiResponse<PagedResourceListOfReconciliation> listReconciliationsWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listReconciliationsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfReconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listReconciliationsAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfReconciliation> _callback) throws ApiException {

        HttpRequest localVarCall = listReconciliationsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfReconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listReconciliationsAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfReconciliation> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listReconciliationsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfReconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistReconciliationsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfReconciliation> _callback) throws ApiException {
            listReconciliationsAsync(effectiveAt, asAt, page, limit, filter, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfReconciliation> _callback, ConfigurationOptions opts) throws ApiException {
            listReconciliationsAsync(effectiveAt, asAt, page, limit, filter, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest reconcileGenericCall(ReconciliationRequest reconciliationRequest, final ApiCallback _callback) throws ApiException {
        return reconcileGenericCall(reconciliationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for reconcileGeneric. Use any specified configuration options to override any other configuration for this request only.
     * @param reconciliationRequest The specifications of the inputs to the reconciliation (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest reconcileGenericCall(ReconciliationRequest reconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/$reconcileGeneric";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest reconcileGenericValidateBeforeCall(ReconciliationRequest reconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ReconciliationResponse> reconcileGenericWithHttpInfo(ReconciliationRequest reconciliationRequest) throws ApiException {
        HttpRequest localVarCall = reconcileGenericValidateBeforeCall(reconciliationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ReconciliationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ReconcileGeneric: Reconcile either holdings or valuations performed on one or two sets of holdings using one or two configuration recipes.                The output is configurable for various types of comparisons, to allow tolerances on numerical and date-time data or case-insensitivity on strings,  and elision of resulting differences where they are &#39;empty&#39; or null or zero.
     * Perform evaluation of one or two set of holdings (a portfolio of instruments) using one or two (potentially different) configuration recipes.  Produce a breakdown of the resulting differences in evaluation that can be iterated through.Use any specified configuration options to override any other configuration for this request only
     * @param reconciliationRequest The specifications of the inputs to the reconciliation (optional)
     * @return ApiResponse&lt;ReconciliationResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ReconciliationResponse> reconcileGenericWithHttpInfo(ReconciliationRequest reconciliationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = reconcileGenericValidateBeforeCall(reconciliationRequest, null, opts);
        Type localVarReturnType = new TypeReference<ReconciliationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void reconcileGenericAsync(ReconciliationRequest reconciliationRequest, final ApiCallback<ReconciliationResponse> _callback) throws ApiException {

        HttpRequest localVarCall = reconcileGenericValidateBeforeCall(reconciliationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ReconciliationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void reconcileGenericAsync(ReconciliationRequest reconciliationRequest, final ApiCallback<ReconciliationResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = reconcileGenericValidateBeforeCall(reconciliationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ReconciliationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIreconcileGenericRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ReconciliationResponse> _callback) throws ApiException {
            reconcileGenericAsync(reconciliationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ReconciliationResponse> _callback, ConfigurationOptions opts) throws ApiException {
            reconcileGenericAsync(reconciliationRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest reconcileHoldingsCall(List<String> sortBy, Integer limit, String filter, PortfoliosReconciliationRequest portfoliosReconciliationRequest, final ApiCallback _callback) throws ApiException {
        return reconcileHoldingsCall(sortBy, limit, filter, portfoliosReconciliationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for reconcileHoldings. Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param filter Optional. Expression to filter the result set.              For example, to filter on the left portfolio Code, use \&quot;left.portfolioId.code eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param portfoliosReconciliationRequest The specifications of the inputs to the reconciliation (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest reconcileHoldingsCall(List<String> sortBy, Integer limit, String filter, PortfoliosReconciliationRequest portfoliosReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/$reconcileholdings";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest reconcileHoldingsValidateBeforeCall(List<String> sortBy, Integer limit, String filter, PortfoliosReconciliationRequest portfoliosReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfReconciliationBreak> reconcileHoldingsWithHttpInfo(List<String> sortBy, Integer limit, String filter, PortfoliosReconciliationRequest portfoliosReconciliationRequest) throws ApiException {
        HttpRequest localVarCall = reconcileHoldingsValidateBeforeCall(sortBy, limit, filter, portfoliosReconciliationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfReconciliationBreak>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ReconcileHoldings: Reconcile portfolio holdings
     * Reconcile the holdings of two portfolios.Use any specified configuration options to override any other configuration for this request only
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @param filter Optional. Expression to filter the result set.              For example, to filter on the left portfolio Code, use \&quot;left.portfolioId.code eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @param portfoliosReconciliationRequest The specifications of the inputs to the reconciliation (optional)
    ...
    private ApiResponse<ResourceListOfReconciliationBreak> reconcileHoldingsWithHttpInfo(List<String> sortBy, Integer limit, String filter, PortfoliosReconciliationRequest portfoliosReconciliationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = reconcileHoldingsValidateBeforeCall(sortBy, limit, filter, portfoliosReconciliationRequest, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfReconciliationBreak>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void reconcileHoldingsAsync(List<String> sortBy, Integer limit, String filter, PortfoliosReconciliationRequest portfoliosReconciliationRequest, final ApiCallback<ResourceListOfReconciliationBreak> _callback) throws ApiException {

        HttpRequest localVarCall = reconcileHoldingsValidateBeforeCall(sortBy, limit, filter, portfoliosReconciliationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfReconciliationBreak>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void reconcileHoldingsAsync(List<String> sortBy, Integer limit, String filter, PortfoliosReconciliationRequest portfoliosReconciliationRequest, final ApiCallback<ResourceListOfReconciliationBreak> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = reconcileHoldingsValidateBeforeCall(sortBy, limit, filter, portfoliosReconciliationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfReconciliationBreak>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIreconcileHoldingsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfReconciliationBreak> _callback) throws ApiException {
            reconcileHoldingsAsync(sortBy, limit, filter, portfoliosReconciliationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfReconciliationBreak> _callback, ConfigurationOptions opts) throws ApiException {
            reconcileHoldingsAsync(sortBy, limit, filter, portfoliosReconciliationRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest reconcileInlineCall(InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, final ApiCallback _callback) throws ApiException {
        return reconcileInlineCall(inlineValuationsReconciliationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for reconcileInline. Use any specified configuration options to override any other configuration for this request only.
     * @param inlineValuationsReconciliationRequest The specifications of the inputs to the reconciliation (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest reconcileInlineCall(InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/$reconcileInline";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest reconcileInlineValidateBeforeCall(InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ListAggregationReconciliation> reconcileInlineWithHttpInfo(InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest) throws ApiException {
        HttpRequest localVarCall = reconcileInlineValidateBeforeCall(inlineValuationsReconciliationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ListAggregationReconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ReconcileInline: Reconcile valuations performed on one or two sets of inline instruments using one or two configuration recipes.
     * Perform valuation of one or two set of inline instruments using different one or two configuration recipes. Produce a breakdown of the resulting differences in valuation.Use any specified configuration options to override any other configuration for this request only
     * @param inlineValuationsReconciliationRequest The specifications of the inputs to the reconciliation (optional)
     * @return ApiResponse&lt;ListAggregationReconciliation&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ListAggregationReconciliation> reconcileInlineWithHttpInfo(InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = reconcileInlineValidateBeforeCall(inlineValuationsReconciliationRequest, null, opts);
        Type localVarReturnType = new TypeReference<ListAggregationReconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void reconcileInlineAsync(InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, final ApiCallback<ListAggregationReconciliation> _callback) throws ApiException {

        HttpRequest localVarCall = reconcileInlineValidateBeforeCall(inlineValuationsReconciliationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ListAggregationReconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void reconcileInlineAsync(InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, final ApiCallback<ListAggregationReconciliation> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = reconcileInlineValidateBeforeCall(inlineValuationsReconciliationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ListAggregationReconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIreconcileInlineRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ListAggregationReconciliation> _callback) throws ApiException {
            reconcileInlineAsync(inlineValuationsReconciliationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ListAggregationReconciliation> _callback, ConfigurationOptions opts) throws ApiException {
            reconcileInlineAsync(inlineValuationsReconciliationRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest reconcileTransactionsCall(TransactionReconciliationRequest transactionReconciliationRequest, final ApiCallback _callback) throws ApiException {
        return reconcileTransactionsCall(transactionReconciliationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for reconcileTransactions. Use any specified configuration options to override any other configuration for this request only.
     * @param transactionReconciliationRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest reconcileTransactionsCall(TransactionReconciliationRequest transactionReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/$reconcileTransactions";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest reconcileTransactionsValidateBeforeCall(TransactionReconciliationRequest transactionReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TransactionsReconciliationsResponse> reconcileTransactionsWithHttpInfo(TransactionReconciliationRequest transactionReconciliationRequest) throws ApiException {
        HttpRequest localVarCall = reconcileTransactionsValidateBeforeCall(transactionReconciliationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionsReconciliationsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ReconcileTransactions: Perform a Transactions Reconciliation.
     * Evaluates two sets of transactions to determine which transactions from each set likely match  using the rules of a specified mapping.Use any specified configuration options to override any other configuration for this request only
     * @param transactionReconciliationRequest  (optional)
     * @return ApiResponse&lt;TransactionsReconciliationsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<TransactionsReconciliationsResponse> reconcileTransactionsWithHttpInfo(TransactionReconciliationRequest transactionReconciliationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = reconcileTransactionsValidateBeforeCall(transactionReconciliationRequest, null, opts);
        Type localVarReturnType = new TypeReference<TransactionsReconciliationsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void reconcileTransactionsAsync(TransactionReconciliationRequest transactionReconciliationRequest, final ApiCallback<TransactionsReconciliationsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = reconcileTransactionsValidateBeforeCall(transactionReconciliationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionsReconciliationsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void reconcileTransactionsAsync(TransactionReconciliationRequest transactionReconciliationRequest, final ApiCallback<TransactionsReconciliationsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = reconcileTransactionsValidateBeforeCall(transactionReconciliationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TransactionsReconciliationsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIreconcileTransactionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransactionsReconciliationsResponse> _callback) throws ApiException {
            reconcileTransactionsAsync(transactionReconciliationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransactionsReconciliationsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            reconcileTransactionsAsync(transactionReconciliationRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest reconcileTransactionsV2Call(TransactionReconciliationRequestV2 transactionReconciliationRequestV2, final ApiCallback _callback) throws ApiException {
        return reconcileTransactionsV2Call(transactionReconciliationRequestV2,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for reconcileTransactionsV2. Use any specified configuration options to override any other configuration for this request only.
     * @param transactionReconciliationRequestV2  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest reconcileTransactionsV2Call(TransactionReconciliationRequestV2 transactionReconciliationRequestV2, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/$reconcileTransactionsV2";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest reconcileTransactionsV2ValidateBeforeCall(TransactionReconciliationRequestV2 transactionReconciliationRequestV2, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ReconciliationResponse> reconcileTransactionsV2WithHttpInfo(TransactionReconciliationRequestV2 transactionReconciliationRequestV2) throws ApiException {
        HttpRequest localVarCall = reconcileTransactionsV2ValidateBeforeCall(transactionReconciliationRequestV2, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ReconciliationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ReconciliationResponse> reconcileTransactionsV2WithHttpInfo(TransactionReconciliationRequestV2 transactionReconciliationRequestV2, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = reconcileTransactionsV2ValidateBeforeCall(transactionReconciliationRequestV2, null, opts);
        Type localVarReturnType = new TypeReference<ReconciliationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void reconcileTransactionsV2Async(TransactionReconciliationRequestV2 transactionReconciliationRequestV2, final ApiCallback<ReconciliationResponse> _callback) throws ApiException {

        HttpRequest localVarCall = reconcileTransactionsV2ValidateBeforeCall(transactionReconciliationRequestV2, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ReconciliationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void reconcileTransactionsV2Async(TransactionReconciliationRequestV2 transactionReconciliationRequestV2, final ApiCallback<ReconciliationResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = reconcileTransactionsV2ValidateBeforeCall(transactionReconciliationRequestV2, _callback, opts);
        Type localVarReturnType = new TypeReference<ReconciliationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIreconcileTransactionsV2Request {
         ...
         */
        public void executeAsync(final ApiCallback<ReconciliationResponse> _callback) throws ApiException {
            reconcileTransactionsV2Async(transactionReconciliationRequestV2, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ReconciliationResponse> _callback, ConfigurationOptions opts) throws ApiException {
            reconcileTransactionsV2Async(transactionReconciliationRequestV2, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest reconcileValuationCall(ValuationsReconciliationRequest valuationsReconciliationRequest, final ApiCallback _callback) throws ApiException {
        return reconcileValuationCall(valuationsReconciliationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for reconcileValuation. Use any specified configuration options to override any other configuration for this request only.
     * @param valuationsReconciliationRequest The specifications of the inputs to the reconciliation (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest reconcileValuationCall(ValuationsReconciliationRequest valuationsReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/portfolios/$reconcileValuation";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest reconcileValuationValidateBeforeCall(ValuationsReconciliationRequest valuationsReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ListAggregationReconciliation> reconcileValuationWithHttpInfo(ValuationsReconciliationRequest valuationsReconciliationRequest) throws ApiException {
        HttpRequest localVarCall = reconcileValuationValidateBeforeCall(valuationsReconciliationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ListAggregationReconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * ReconcileValuation: Reconcile valuations performed on one or two sets of holdings using one or two configuration recipes.
     * Perform valuation of one or two set of holdings using different one or two configuration recipes. Produce a breakdown of the resulting differences in valuation.Use any specified configuration options to override any other configuration for this request only
     * @param valuationsReconciliationRequest The specifications of the inputs to the reconciliation (optional)
     * @return ApiResponse&lt;ListAggregationReconciliation&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ListAggregationReconciliation> reconcileValuationWithHttpInfo(ValuationsReconciliationRequest valuationsReconciliationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = reconcileValuationValidateBeforeCall(valuationsReconciliationRequest, null, opts);
        Type localVarReturnType = new TypeReference<ListAggregationReconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void reconcileValuationAsync(ValuationsReconciliationRequest valuationsReconciliationRequest, final ApiCallback<ListAggregationReconciliation> _callback) throws ApiException {

        HttpRequest localVarCall = reconcileValuationValidateBeforeCall(valuationsReconciliationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ListAggregationReconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void reconcileValuationAsync(ValuationsReconciliationRequest valuationsReconciliationRequest, final ApiCallback<ListAggregationReconciliation> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = reconcileValuationValidateBeforeCall(valuationsReconciliationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ListAggregationReconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIreconcileValuationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ListAggregationReconciliation> _callback) throws ApiException {
            reconcileValuationAsync(valuationsReconciliationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ListAggregationReconciliation> _callback, ConfigurationOptions opts) throws ApiException {
            reconcileValuationAsync(valuationsReconciliationRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateReconciliationCall(String scope, String code, UpdateReconciliationRequest updateReconciliationRequest, final ApiCallback _callback) throws ApiException {
        return updateReconciliationCall(scope, code, updateReconciliationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateReconciliation. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the reconciliation to be updated (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the reconciliation to be updated (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateReconciliationRequest The updated definition of the reconciliation (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updateReconciliationCall(String scope, String code, UpdateReconciliationRequest updateReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateReconciliationValidateBeforeCall(String scope, String code, UpdateReconciliationRequest updateReconciliationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Reconciliation> updateReconciliationWithHttpInfo(String scope, String code, UpdateReconciliationRequest updateReconciliationRequest) throws ApiException {
        HttpRequest localVarCall = updateReconciliationValidateBeforeCall(scope, code, updateReconciliationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EXPERIMENTAL] UpdateReconciliation: Update scheduled reconciliation
     * Update a given scheduled reconciliationUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the reconciliation to be updated (required)
     * @param code The code of the reconciliation to be updated (required)
     * @param updateReconciliationRequest The updated definition of the reconciliation (optional)
     * @return ApiResponse&lt;Reconciliation&gt;
    ...
    private ApiResponse<Reconciliation> updateReconciliationWithHttpInfo(String scope, String code, UpdateReconciliationRequest updateReconciliationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateReconciliationValidateBeforeCall(scope, code, updateReconciliationRequest, null, opts);
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void updateReconciliationAsync(String scope, String code, UpdateReconciliationRequest updateReconciliationRequest, final ApiCallback<Reconciliation> _callback) throws ApiException {

        HttpRequest localVarCall = updateReconciliationValidateBeforeCall(scope, code, updateReconciliationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateReconciliationAsync(String scope, String code, UpdateReconciliationRequest updateReconciliationRequest, final ApiCallback<Reconciliation> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateReconciliationValidateBeforeCall(scope, code, updateReconciliationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<Reconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateReconciliationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Reconciliation> _callback) throws ApiException {
            updateReconciliationAsync(scope, code, updateReconciliationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Reconciliation> _callback, ConfigurationOptions opts) throws ApiException {
            updateReconciliationAsync(scope, code, updateReconciliationRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertReconciliationMappingCall(Mapping mapping, final ApiCallback _callback) throws ApiException {
        return upsertReconciliationMappingCall(mapping,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertReconciliationMapping. Use any specified configuration options to override any other configuration for this request only.
     * @param mapping The mapping to be created / updated. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertReconciliationMappingCall(Mapping mapping, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertReconciliationMappingValidateBeforeCall(Mapping mapping, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<Mapping> upsertReconciliationMappingWithHttpInfo(Mapping mapping) throws ApiException {
        HttpRequest localVarCall = upsertReconciliationMappingValidateBeforeCall(mapping, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Mapping>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpsertReconciliationMapping: Create or update a mapping
     * If no mapping exists with the specified scope and code will create a new one.  Else will update the existing mappingUse any specified configuration options to override any other configuration for this request only
     * @param mapping The mapping to be created / updated. (optional)
     * @return ApiResponse&lt;Mapping&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<Mapping> upsertReconciliationMappingWithHttpInfo(Mapping mapping, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertReconciliationMappingValidateBeforeCall(mapping, null, opts);
        Type localVarReturnType = new TypeReference<Mapping>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertReconciliationMappingAsync(Mapping mapping, final ApiCallback<Mapping> _callback) throws ApiException {

        HttpRequest localVarCall = upsertReconciliationMappingValidateBeforeCall(mapping, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Mapping>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertReconciliationMappingAsync(Mapping mapping, final ApiCallback<Mapping> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertReconciliationMappingValidateBeforeCall(mapping, _callback, opts);
        Type localVarReturnType = new TypeReference<Mapping>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertReconciliationMappingRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Mapping> _callback) throws ApiException {
            upsertReconciliationMappingAsync(mapping, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Mapping> _callback, ConfigurationOptions opts) throws ApiException {
            upsertReconciliationMappingAsync(mapping, _callback, opts);
        }
    }
