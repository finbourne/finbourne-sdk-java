 ...
 */
@JsonPropertyOrder({
  UpsertQuotesResponse.JSON_PROPERTY_HREF,
  UpsertQuotesResponse.JSON_PROPERTY_VALUES,
  UpsertQuotesResponse.JSON_PROPERTY_FAILED,
  UpsertQuotesResponse.JSON_PROPERTY_LINKS
})
...
public class UpsertQuotesResponse {
  ...
  public boolean equals(Object o) {
    ...
    UpsertQuotesResponse upsertQuotesResponse = (UpsertQuotesResponse) o;
    return Objects.equals(this.href, upsertQuotesResponse.href) &&
        Objects.equals(this.values, upsertQuotesResponse.values) &&
        Objects.equals(this.failed, upsertQuotesResponse.failed) &&
        Objects.equals(this.links, upsertQuotesResponse.links);
  }
 ...
 public int hashCode() {
  ...
  /**
   * Create an instance of UpsertQuotesResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpsertQuotesResponse
   * @throws java.io.IOException if the JSON string is invalid with respect to UpsertQuotesResponse
   */
  public static UpsertQuotesResponse fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, UpsertQuotesResponse.class);
  }

  /**
   * Convert an instance of UpsertQuotesResponse to an JSON string
   *
   * @return JSON string
   */
