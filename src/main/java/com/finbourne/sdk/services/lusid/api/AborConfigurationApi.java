...
public class AborConfigurationApi {
     ...
     */
    private HttpRequest createAborConfigurationCall(String scope, AborConfigurationRequest aborConfigurationRequest, final ApiCallback _callback) throws ApiException {
        return createAborConfigurationCall(scope, aborConfigurationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createAborConfiguration. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the AborConfiguration. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param aborConfigurationRequest The definition of the AborConfiguration. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createAborConfigurationCall(String scope, AborConfigurationRequest aborConfigurationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/aborconfiguration/{scope}"
    ...
    private HttpRequest createAborConfigurationValidateBeforeCall(String scope, AborConfigurationRequest aborConfigurationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<AborConfiguration> createAborConfigurationWithHttpInfo(String scope, AborConfigurationRequest aborConfigurationRequest) throws ApiException {
        HttpRequest localVarCall = createAborConfigurationValidateBeforeCall(scope, aborConfigurationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
    ...
    private ApiResponse<AborConfiguration> createAborConfigurationWithHttpInfo(String scope, AborConfigurationRequest aborConfigurationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createAborConfigurationValidateBeforeCall(scope, aborConfigurationRequest, null, opts);
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createAborConfigurationAsync(String scope, AborConfigurationRequest aborConfigurationRequest, final ApiCallback<AborConfiguration> _callback) throws ApiException {

        HttpRequest localVarCall = createAborConfigurationValidateBeforeCall(scope, aborConfigurationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
     ...
     */
    private void createAborConfigurationAsync(String scope, AborConfigurationRequest aborConfigurationRequest, final ApiCallback<AborConfiguration> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createAborConfigurationValidateBeforeCall(scope, aborConfigurationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateAborConfigurationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AborConfiguration> _callback) throws ApiException {
            createAborConfigurationAsync(scope, aborConfigurationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AborConfiguration> _callback, ConfigurationOptions opts) throws ApiException {
            createAborConfigurationAsync(scope, aborConfigurationRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteAborConfigurationCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteAborConfigurationCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteAborConfiguration. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the AborConfiguration to be deleted. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the AborConfiguration to be deleted. Together with the scope this uniquely identifies the AborConfiguration. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteAborConfigurationCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/aborconfiguration/{scope}/{code}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteAborConfigurationValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteAborConfigurationWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteAborConfigurationValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    private ApiResponse<DeletedEntityResponse> deleteAborConfigurationWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteAborConfigurationValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteAborConfigurationAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteAborConfigurationValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteAborConfigurationAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteAborConfigurationValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteAborConfigurationRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteAborConfigurationAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteAborConfigurationAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getAborConfigurationCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return getAborConfigurationCall(scope, code, effectiveAt, asAt, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getAborConfiguration. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the AborConfiguration. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the AborConfiguration. Together with the scope this uniquely identifies the AborConfiguration. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the AborConfiguration properties. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the AborConfiguration definition. Defaults to returning the latest version of the AborConfiguration definition if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;AborConfiguration&#39; domain to decorate onto the AborConfiguration.              These must take the format {domain}/{scope}/{code}, for example &#39;AborConfiguration/Manager/Id&#39;. If no properties are specified, then no properties will be returned. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getAborConfigurationCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getAborConfigurationValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AborConfiguration> getAborConfigurationWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = getAborConfigurationValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<AborConfiguration> getAborConfigurationWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getAborConfigurationValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getAborConfigurationAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<AborConfiguration> _callback) throws ApiException {

        HttpRequest localVarCall = getAborConfigurationValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getAborConfigurationAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<AborConfiguration> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getAborConfigurationValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetAborConfigurationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AborConfiguration> _callback) throws ApiException {
            getAborConfigurationAsync(scope, code, effectiveAt, asAt, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AborConfiguration> _callback, ConfigurationOptions opts) throws ApiException {
            getAborConfigurationAsync(scope, code, effectiveAt, asAt, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getAborConfigurationPropertiesCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getAborConfigurationPropertiesCall(scope, code, effectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getAborConfigurationProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Abor Configuration to list the properties for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Abor Configuration to list the properties for. Together with the scope this uniquely identifies the Abor Configuration. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the Abor Configuration&#39;s properties. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the Abor Configuration&#39;s properties. Defaults to return the latest version of each property if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getAborConfigurationPropertiesCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/aborconfiguration/{scope}/{code}/properties"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getAborConfigurationPropertiesValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AborConfigurationProperties> getAborConfigurationPropertiesWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getAborConfigurationPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AborConfigurationProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<AborConfigurationProperties> getAborConfigurationPropertiesWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getAborConfigurationPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<AborConfigurationProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getAborConfigurationPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<AborConfigurationProperties> _callback) throws ApiException {

        HttpRequest localVarCall = getAborConfigurationPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AborConfigurationProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getAborConfigurationPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<AborConfigurationProperties> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getAborConfigurationPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<AborConfigurationProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetAborConfigurationPropertiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AborConfigurationProperties> _callback) throws ApiException {
            getAborConfigurationPropertiesAsync(scope, code, effectiveAt, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AborConfigurationProperties> _callback, ConfigurationOptions opts) throws ApiException {
            getAborConfigurationPropertiesAsync(scope, code, effectiveAt, asAt, _callback, opts);
        }
    }
     ...
     * @param filter Expression to filter the results.              For example, to filter on the AborConfiguration type, specify \&quot;id.Code eq &#39;AborConfiguration1&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid. (optional)
     ...
     */
    private HttpRequest listAborConfigurationsCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for listAborConfigurations. Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the TimeVariant properties for the AborConfiguration. Defaults to the current LUSID              system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the AborConfiguration. Defaults to returning the latest version of each AborConfiguration if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing AborConfiguration; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param filter Expression to filter the results.              For example, to filter on the AborConfiguration type, specify \&quot;id.Code eq &#39;AborConfiguration1&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listAborConfigurationsCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/aborconfiguration";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listAborConfigurationsValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfAborConfiguration> listAborConfigurationsWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = listAborConfigurationsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfAborConfiguration>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PagedResourceListOfAborConfiguration> listAborConfigurationsWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listAborConfigurationsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfAborConfiguration>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listAborConfigurationsAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback<PagedResourceListOfAborConfiguration> _callback) throws ApiException {

        HttpRequest localVarCall = listAborConfigurationsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfAborConfiguration>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listAborConfigurationsAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback<PagedResourceListOfAborConfiguration> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listAborConfigurationsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfAborConfiguration>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistAborConfigurationsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfAborConfiguration> _callback) throws ApiException {
            listAborConfigurationsAsync(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfAborConfiguration> _callback, ConfigurationOptions opts) throws ApiException {
            listAborConfigurationsAsync(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest patchAborConfigurationCall(String scope, String code, List<Operation> operation, final ApiCallback _callback) throws ApiException {
        return patchAborConfigurationCall(scope, code, operation,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for patchAborConfiguration. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the AborConfiguration. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the AborConfiguration.              Together with the scope this uniquely identifies the AborConfiguration. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902. (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest patchAborConfigurationCall(String scope, String code, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest patchAborConfigurationValidateBeforeCall(String scope, String code, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AborConfiguration> patchAborConfigurationWithHttpInfo(String scope, String code, List<Operation> operation) throws ApiException {
        HttpRequest localVarCall = patchAborConfigurationValidateBeforeCall(scope, code, operation, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<AborConfiguration> patchAborConfigurationWithHttpInfo(String scope, String code, List<Operation> operation, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = patchAborConfigurationValidateBeforeCall(scope, code, operation, null, opts);
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void patchAborConfigurationAsync(String scope, String code, List<Operation> operation, final ApiCallback<AborConfiguration> _callback) throws ApiException {

        HttpRequest localVarCall = patchAborConfigurationValidateBeforeCall(scope, code, operation, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void patchAborConfigurationAsync(String scope, String code, List<Operation> operation, final ApiCallback<AborConfiguration> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = patchAborConfigurationValidateBeforeCall(scope, code, operation, _callback, opts);
        Type localVarReturnType = new TypeReference<AborConfiguration>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIpatchAborConfigurationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AborConfiguration> _callback) throws ApiException {
            patchAborConfigurationAsync(scope, code, operation, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AborConfiguration> _callback, ConfigurationOptions opts) throws ApiException {
            patchAborConfigurationAsync(scope, code, operation, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertAborConfigurationPropertiesCall(String scope, String code, Map<String, Property> requestBody, final ApiCallback _callback) throws ApiException {
        return upsertAborConfigurationPropertiesCall(scope, code, requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertAborConfigurationProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the AborConfiguration to update or insert the properties onto. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the AborConfiguration to update or insert the properties onto. Together with the scope this uniquely identifies the AborConfiguration. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The properties to be updated or inserted onto the chart of account. Each property in               the request must be keyed by its unique property key. This has the format {domain}/{scope}/{code} e.g. \&quot;AborConfiguration/Manager/Id\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertAborConfigurationPropertiesCall(String scope, String code, Map<String, Property> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/aborconfiguration/{scope}/{code}/properties/$upsert"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertAborConfigurationPropertiesValidateBeforeCall(String scope, String code, Map<String, Property> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AborConfigurationProperties> upsertAborConfigurationPropertiesWithHttpInfo(String scope, String code, Map<String, Property> requestBody) throws ApiException {
        HttpRequest localVarCall = upsertAborConfigurationPropertiesValidateBeforeCall(scope, code, requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AborConfigurationProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<AborConfigurationProperties> upsertAborConfigurationPropertiesWithHttpInfo(String scope, String code, Map<String, Property> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertAborConfigurationPropertiesValidateBeforeCall(scope, code, requestBody, null, opts);
        Type localVarReturnType = new TypeReference<AborConfigurationProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertAborConfigurationPropertiesAsync(String scope, String code, Map<String, Property> requestBody, final ApiCallback<AborConfigurationProperties> _callback) throws ApiException {

        HttpRequest localVarCall = upsertAborConfigurationPropertiesValidateBeforeCall(scope, code, requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AborConfigurationProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertAborConfigurationPropertiesAsync(String scope, String code, Map<String, Property> requestBody, final ApiCallback<AborConfigurationProperties> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertAborConfigurationPropertiesValidateBeforeCall(scope, code, requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<AborConfigurationProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertAborConfigurationPropertiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AborConfigurationProperties> _callback) throws ApiException {
            upsertAborConfigurationPropertiesAsync(scope, code, requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AborConfigurationProperties> _callback, ConfigurationOptions opts) throws ApiException {
            upsertAborConfigurationPropertiesAsync(scope, code, requestBody, _callback, opts);
        }
    }
