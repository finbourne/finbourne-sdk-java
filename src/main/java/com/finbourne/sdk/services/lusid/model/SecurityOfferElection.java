 ...
 */
@JsonPropertyOrder({
  SecurityOfferElection.JSON_PROPERTY_ELECTION_KEY,
  SecurityOfferElection.JSON_PROPERTY_IS_CHOSEN,
  SecurityOfferElection.JSON_PROPERTY_IS_DEFAULT,
  SecurityOfferElection.JSON_PROPERTY_UNITS_RATIO
})
...
public class SecurityOfferElection {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to SecurityOfferElection
   */
  public static SecurityOfferElection fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, SecurityOfferElection.class);
  }
