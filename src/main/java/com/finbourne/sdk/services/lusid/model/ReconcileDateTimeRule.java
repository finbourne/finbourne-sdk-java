 ...
 */
@JsonPropertyOrder({
  ReconcileDateTimeRule.JSON_PROPERTY_COMPARISON_TYPE,
  ReconcileDateTimeRule.JSON_PROPERTY_TOLERANCE,
  ReconcileDateTimeRule.JSON_PROPERTY_APPLIES_TO
})
...
public class ReconcileDateTimeRule extends ReconciliationRule {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ReconcileDateTimeRule
   */
  public static ReconcileDateTimeRule fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ReconcileDateTimeRule.class);
  }
