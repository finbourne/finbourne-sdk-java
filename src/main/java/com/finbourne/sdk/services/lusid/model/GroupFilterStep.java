 ...
 */
@JsonPropertyOrder({
  GroupFilterStep.JSON_PROPERTY_LABEL,
  GroupFilterStep.JSON_PROPERTY_LIMIT_CHECK_PARAMETERS
})
...
public class GroupFilterStep extends ComplianceStep {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to GroupFilterStep
   */
  public static GroupFilterStep fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, GroupFilterStep.class);
  }
