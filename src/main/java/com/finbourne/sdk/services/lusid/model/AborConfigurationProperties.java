 ...
 */
@JsonPropertyOrder({
  AborConfigurationProperties.JSON_PROPERTY_HREF,
  AborConfigurationProperties.JSON_PROPERTY_PROPERTIES,
  AborConfigurationProperties.JSON_PROPERTY_VERSION,
  AborConfigurationProperties.JSON_PROPERTY_LINKS
})
...
public class AborConfigurationProperties {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to AborConfigurationProperties
   */
  public static AborConfigurationProperties fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, AborConfigurationProperties.class);
  }
