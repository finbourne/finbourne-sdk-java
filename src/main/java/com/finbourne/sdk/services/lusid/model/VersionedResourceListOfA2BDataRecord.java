 ...
 */
@JsonPropertyOrder({
  VersionedResourceListOfA2BDataRecord.JSON_PROPERTY_VERSION,
  VersionedResourceListOfA2BDataRecord.JSON_PROPERTY_VALUES,
  VersionedResourceListOfA2BDataRecord.JSON_PROPERTY_HREF,
  VersionedResourceListOfA2BDataRecord.JSON_PROPERTY_NEXT_PAGE,
  VersionedResourceListOfA2BDataRecord.JSON_PROPERTY_PREVIOUS_PAGE,
  VersionedResourceListOfA2BDataRecord.JSON_PROPERTY_LINKS
})
...
public class VersionedResourceListOfA2BDataRecord {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to VersionedResourceListOfA2BDataRecord
   */
  public static VersionedResourceListOfA2BDataRecord fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, VersionedResourceListOfA2BDataRecord.class);
  }
