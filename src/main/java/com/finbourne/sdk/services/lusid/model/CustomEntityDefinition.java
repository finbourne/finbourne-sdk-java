 ...
 */
@JsonPropertyOrder({
  CustomEntityDefinition.JSON_PROPERTY_HREF,
  CustomEntityDefinition.JSON_PROPERTY_ENTITY_TYPE_NAME,
  CustomEntityDefinition.JSON_PROPERTY_DISPLAY_NAME,
  CustomEntityDefinition.JSON_PROPERTY_DESCRIPTION,
  CustomEntityDefinition.JSON_PROPERTY_ENTITY_TYPE,
  CustomEntityDefinition.JSON_PROPERTY_FIELD_SCHEMA,
  CustomEntityDefinition.JSON_PROPERTY_VERSION,
  CustomEntityDefinition.JSON_PROPERTY_LINKS
})
...
public class CustomEntityDefinition {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to CustomEntityDefinition
   */
  public static CustomEntityDefinition fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, CustomEntityDefinition.class);
  }
