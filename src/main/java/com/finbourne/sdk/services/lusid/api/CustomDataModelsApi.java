...
public class CustomDataModelsApi {
     ...
     */
    private HttpRequest batchAmendCall(String successMode, Map<String, MembershipAmendmentRequest> requestBody, final ApiCallback _callback) throws ApiException {
        return batchAmendCall(successMode, requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for batchAmend. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest batchAmendCall(String successMode, Map<String, MembershipAmendmentRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/datamodel/$batchamend";
    ...
    private HttpRequest batchAmendValidateBeforeCall(String successMode, Map<String, MembershipAmendmentRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<BatchAmendCustomDataModelMembershipResponse> batchAmendWithHttpInfo(String successMode, Map<String, MembershipAmendmentRequest> requestBody) throws ApiException {
        HttpRequest localVarCall = batchAmendValidateBeforeCall(successMode, requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BatchAmendCustomDataModelMembershipResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] BatchAmend: Batch amend entities Custom Data Model membership.
     * Add/Remove entities to/from a Custom Data Model in a single operation.                Each amendment request must be keyed by a unique correlation ID.  This id is ephemeral and is not stored by LUSID.  It serves only as a way to easily identify each amendment in the response.                Note: If using partial failure modes, then it is important to check the response body for failures as any  failures will still return a 200 status code.Use any specified configuration options to override any other configuration for this request only
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial. (required)
     * @param requestBody The payload describing the amendments to make for the given Custom Data Model. (required)
     * @return ApiResponse&lt;BatchAmendCustomDataModelMembershipResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<BatchAmendCustomDataModelMembershipResponse> batchAmendWithHttpInfo(String successMode, Map<String, MembershipAmendmentRequest> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = batchAmendValidateBeforeCall(successMode, requestBody, null, opts);
        Type localVarReturnType = new TypeReference<BatchAmendCustomDataModelMembershipResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] BatchAmend: Batch amend entities Custom Data Model membership. (asynchronously)
     * Add/Remove entities to/from a Custom Data Model in a single operation.                Each amendment request must be keyed by a unique correlation ID.  This id is ephemeral and is not stored by LUSID.  It serves only as a way to easily identify each amendment in the response.                Note: If using partial failure modes, then it is important to check the response body for failures as any  failures will still return a 200 status code.
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial. (required)
     * @param requestBody The payload describing the amendments to make for the given Custom Data Model. (required)
     ...
     */
    private void batchAmendAsync(String successMode, Map<String, MembershipAmendmentRequest> requestBody, final ApiCallback<BatchAmendCustomDataModelMembershipResponse> _callback) throws ApiException {

        HttpRequest localVarCall = batchAmendValidateBeforeCall(successMode, requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BatchAmendCustomDataModelMembershipResponse>(){}.getType();
     ...
     */
    private void batchAmendAsync(String successMode, Map<String, MembershipAmendmentRequest> requestBody, final ApiCallback<BatchAmendCustomDataModelMembershipResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = batchAmendValidateBeforeCall(successMode, requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<BatchAmendCustomDataModelMembershipResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIbatchAmendRequest {
         ...
         */
        public void executeAsync(final ApiCallback<BatchAmendCustomDataModelMembershipResponse> _callback) throws ApiException {
            batchAmendAsync(successMode, requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<BatchAmendCustomDataModelMembershipResponse> _callback, ConfigurationOptions opts) throws ApiException {
            batchAmendAsync(successMode, requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest createCustomDataModelCall(String entityType, CreateCustomDataModelRequest createCustomDataModelRequest, final ApiCallback _callback) throws ApiException {
        return createCustomDataModelCall(entityType, createCustomDataModelRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createCustomDataModel. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The entity type of the Data Model. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param createCustomDataModelRequest The request containing the details of the Data Model. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createCustomDataModelCall(String entityType, CreateCustomDataModelRequest createCustomDataModelRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/datamodel/{entityType}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest createCustomDataModelValidateBeforeCall(String entityType, CreateCustomDataModelRequest createCustomDataModelRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<CustomDataModel> createCustomDataModelWithHttpInfo(String entityType, CreateCustomDataModelRequest createCustomDataModelRequest) throws ApiException {
        HttpRequest localVarCall = createCustomDataModelValidateBeforeCall(entityType, createCustomDataModelRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] CreateCustomDataModel: Create a Custom Data Model
     * Creates a Custom Data Model.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The entity type of the Data Model. (required)
     * @param createCustomDataModelRequest The request containing the details of the Data Model. (optional)
     * @return ApiResponse&lt;CustomDataModel&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<CustomDataModel> createCustomDataModelWithHttpInfo(String entityType, CreateCustomDataModelRequest createCustomDataModelRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createCustomDataModelValidateBeforeCall(entityType, createCustomDataModelRequest, null, opts);
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] CreateCustomDataModel: Create a Custom Data Model (asynchronously)
     * Creates a Custom Data Model.
     * @param entityType The entity type of the Data Model. (required)
     * @param createCustomDataModelRequest The request containing the details of the Data Model. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void createCustomDataModelAsync(String entityType, CreateCustomDataModelRequest createCustomDataModelRequest, final ApiCallback<CustomDataModel> _callback) throws ApiException {

        HttpRequest localVarCall = createCustomDataModelValidateBeforeCall(entityType, createCustomDataModelRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void createCustomDataModelAsync(String entityType, CreateCustomDataModelRequest createCustomDataModelRequest, final ApiCallback<CustomDataModel> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createCustomDataModelValidateBeforeCall(entityType, createCustomDataModelRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateCustomDataModelRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CustomDataModel> _callback) throws ApiException {
            createCustomDataModelAsync(entityType, createCustomDataModelRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CustomDataModel> _callback, ConfigurationOptions opts) throws ApiException {
            createCustomDataModelAsync(entityType, createCustomDataModelRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteCustomDataModelCall(String entityType, String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteCustomDataModelCall(entityType, scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteCustomDataModel. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The entity type of the Data Model. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the specified Data Model. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified Data Model. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteCustomDataModelCall(String entityType, String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/datamodel/{entityType}/{scope}/{code}"
            .replace("{" + "entityType" + "}", localVarApiClient.escapeString(entityType.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteCustomDataModelValidateBeforeCall(String entityType, String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteCustomDataModelWithHttpInfo(String entityType, String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteCustomDataModelValidateBeforeCall(entityType, scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EXPERIMENTAL] DeleteCustomDataModel: Delete a Custom Data Model
     * Delete a Custom Data Model. The data model will remain viewable at previous as at times, but will no longer  be part of any hierarchies.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The entity type of the Data Model. (required)
     * @param scope The scope of the specified Data Model. (required)
     * @param code The code of the specified Data Model. (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
    ...
    private ApiResponse<DeletedEntityResponse> deleteCustomDataModelWithHttpInfo(String entityType, String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCustomDataModelValidateBeforeCall(entityType, scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] DeleteCustomDataModel: Delete a Custom Data Model (asynchronously)
     * Delete a Custom Data Model. The data model will remain viewable at previous as at times, but will no longer  be part of any hierarchies.
     * @param entityType The entity type of the Data Model. (required)
     * @param scope The scope of the specified Data Model. (required)
     * @param code The code of the specified Data Model. (required)
     ...
     */
    private void deleteCustomDataModelAsync(String entityType, String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCustomDataModelValidateBeforeCall(entityType, scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteCustomDataModelAsync(String entityType, String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCustomDataModelValidateBeforeCall(entityType, scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCustomDataModelRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteCustomDataModelAsync(entityType, scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCustomDataModelAsync(entityType, scope, code, _callback, opts);
        }
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The requested Data Model </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    private HttpRequest getCustomDataModelCall(String entityType, String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getCustomDataModelCall(entityType, scope, code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getCustomDataModel. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The entity type of the Data Model. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the specified Data Model. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified Data Model. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Data Model. Defaults to return              the latest version of the Data Model if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getCustomDataModelCall(String entityType, String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCustomDataModelValidateBeforeCall(String entityType, String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<CustomDataModel> getCustomDataModelWithHttpInfo(String entityType, String scope, String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getCustomDataModelValidateBeforeCall(entityType, scope, code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EXPERIMENTAL] GetCustomDataModel: Get a Custom Data Model
     * Retrieves a Custom Data Model at a given as at time.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The entity type of the Data Model. (required)
     * @param scope The scope of the specified Data Model. (required)
     * @param code The code of the specified Data Model. (required)
     * @param asAt The asAt datetime at which to retrieve the Data Model. Defaults to return              the latest version of the Data Model if not specified. (optional)
    ...
    private ApiResponse<CustomDataModel> getCustomDataModelWithHttpInfo(String entityType, String scope, String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCustomDataModelValidateBeforeCall(entityType, scope, code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetCustomDataModel: Get a Custom Data Model (asynchronously)
     * Retrieves a Custom Data Model at a given as at time.
     * @param entityType The entity type of the Data Model. (required)
     * @param scope The scope of the specified Data Model. (required)
     * @param code The code of the specified Data Model. (required)
     ...
     */
    private void getCustomDataModelAsync(String entityType, String scope, String code, OffsetDateTime asAt, final ApiCallback<CustomDataModel> _callback) throws ApiException {

        HttpRequest localVarCall = getCustomDataModelValidateBeforeCall(entityType, scope, code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCustomDataModelAsync(String entityType, String scope, String code, OffsetDateTime asAt, final ApiCallback<CustomDataModel> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCustomDataModelValidateBeforeCall(entityType, scope, code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCustomDataModelRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CustomDataModel> _callback) throws ApiException {
            getCustomDataModelAsync(entityType, scope, code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CustomDataModel> _callback, ConfigurationOptions opts) throws ApiException {
            getCustomDataModelAsync(entityType, scope, code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listDataModelHierarchiesCall(OffsetDateTime asAt, String filter, List<String> sortBy, final ApiCallback _callback) throws ApiException {
        return listDataModelHierarchiesCall(asAt, filter, sortBy,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listDataModelHierarchies. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Data Model. Defaults to return              the latest version of the Data Model if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the results. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listDataModelHierarchiesCall(OffsetDateTime asAt, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/datamodel/hierarchies";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listDataModelHierarchiesValidateBeforeCall(OffsetDateTime asAt, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfDataModelSummary> listDataModelHierarchiesWithHttpInfo(OffsetDateTime asAt, String filter, List<String> sortBy) throws ApiException {
        HttpRequest localVarCall = listDataModelHierarchiesValidateBeforeCall(asAt, filter, sortBy, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfDataModelSummary>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListDataModelHierarchies: List Custom Data Model hierarchies.
     * Lists the data model summaries within their hierarchical structure.Use any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to retrieve the Data Model. Defaults to return              the latest version of the Data Model if not specified. (optional)
     * @param filter Expression to filter the results. (optional)
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;. (optional)
     * @return ApiResponse&lt;ResourceListOfDataModelSummary&gt;
    ...
    private ApiResponse<ResourceListOfDataModelSummary> listDataModelHierarchiesWithHttpInfo(OffsetDateTime asAt, String filter, List<String> sortBy, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listDataModelHierarchiesValidateBeforeCall(asAt, filter, sortBy, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfDataModelSummary>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListDataModelHierarchies: List Custom Data Model hierarchies. (asynchronously)
     * Lists the data model summaries within their hierarchical structure.
     * @param asAt The asAt datetime at which to retrieve the Data Model. Defaults to return              the latest version of the Data Model if not specified. (optional)
     * @param filter Expression to filter the results. (optional)
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;. (optional)
     ...
     */
    private void listDataModelHierarchiesAsync(OffsetDateTime asAt, String filter, List<String> sortBy, final ApiCallback<ResourceListOfDataModelSummary> _callback) throws ApiException {

        HttpRequest localVarCall = listDataModelHierarchiesValidateBeforeCall(asAt, filter, sortBy, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfDataModelSummary>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listDataModelHierarchiesAsync(OffsetDateTime asAt, String filter, List<String> sortBy, final ApiCallback<ResourceListOfDataModelSummary> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listDataModelHierarchiesValidateBeforeCall(asAt, filter, sortBy, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfDataModelSummary>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistDataModelHierarchiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfDataModelSummary> _callback) throws ApiException {
            listDataModelHierarchiesAsync(asAt, filter, sortBy, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfDataModelSummary> _callback, ConfigurationOptions opts) throws ApiException {
            listDataModelHierarchiesAsync(asAt, filter, sortBy, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listSupportedEntityTypesCall(final ApiCallback _callback) throws ApiException {
     ...
     */
    private HttpRequest listSupportedEntityTypesCall(final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listSupportedEntityTypesValidateBeforeCall(final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfString> listSupportedEntityTypesWithHttpInfo() throws ApiException {
        HttpRequest localVarCall = listSupportedEntityTypesValidateBeforeCall(null, new ConfigurationOptions());
    ...
    /**
     * [EXPERIMENTAL] ListSupportedEntityTypes: List the currently supported entity types for use in Custom Data Models.
     * Lists the currently supported entity types available to bind with Custom Data Models.Use any specified configuration options to override any other configuration for this request only
     * @return ApiResponse&lt;ResourceListOfString&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
    ...
    private ApiResponse<ResourceListOfString> listSupportedEntityTypesWithHttpInfo(ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listSupportedEntityTypesValidateBeforeCall(null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfString>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListSupportedEntityTypes: List the currently supported entity types for use in Custom Data Models. (asynchronously)
     * Lists the currently supported entity types available to bind with Custom Data Models.
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     * @http.response.details
     ...
     */
    private void listSupportedEntityTypesAsync(final ApiCallback<ResourceListOfString> _callback) throws ApiException {

        HttpRequest localVarCall = listSupportedEntityTypesValidateBeforeCall(_callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfString>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listSupportedEntityTypesAsync(final ApiCallback<ResourceListOfString> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listSupportedEntityTypesValidateBeforeCall(_callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfString>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistSupportedEntityTypesRequest {
        ...
        public void executeAsync(final ApiCallback<ResourceListOfString> _callback) throws ApiException {
            listSupportedEntityTypesAsync(_callback);
        }
        ...
        public void executeAsync(final ApiCallback<ResourceListOfString> _callback, ConfigurationOptions opts) throws ApiException {
            listSupportedEntityTypesAsync(_callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateCustomDataModelCall(String entityType, String scope, String code, UpdateCustomDataModelRequest updateCustomDataModelRequest, final ApiCallback _callback) throws ApiException {
        return updateCustomDataModelCall(entityType, scope, code, updateCustomDataModelRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateCustomDataModel. Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The entity type of the Data Model. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the specified Data Model. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified Data Model. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateCustomDataModelRequest The request containing the details of the Data Model. (optional)
     ...
     */
    private HttpRequest updateCustomDataModelCall(String entityType, String scope, String code, UpdateCustomDataModelRequest updateCustomDataModelRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateCustomDataModelValidateBeforeCall(String entityType, String scope, String code, UpdateCustomDataModelRequest updateCustomDataModelRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'entityType' is set
        if (entityType == null) {
    ...
    private ApiResponse<CustomDataModel> updateCustomDataModelWithHttpInfo(String entityType, String scope, String code, UpdateCustomDataModelRequest updateCustomDataModelRequest) throws ApiException {
        HttpRequest localVarCall = updateCustomDataModelValidateBeforeCall(entityType, scope, code, updateCustomDataModelRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EXPERIMENTAL] UpdateCustomDataModel: Update a Custom Data Model
     * Updates a Custom Data Model.Use any specified configuration options to override any other configuration for this request only
     * @param entityType The entity type of the Data Model. (required)
     * @param scope The scope of the specified Data Model. (required)
     * @param code The code of the specified Data Model. (required)
     * @param updateCustomDataModelRequest The request containing the details of the Data Model. (optional)
    ...
    private ApiResponse<CustomDataModel> updateCustomDataModelWithHttpInfo(String entityType, String scope, String code, UpdateCustomDataModelRequest updateCustomDataModelRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateCustomDataModelValidateBeforeCall(entityType, scope, code, updateCustomDataModelRequest, null, opts);
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] UpdateCustomDataModel: Update a Custom Data Model (asynchronously)
     * Updates a Custom Data Model.
     * @param entityType The entity type of the Data Model. (required)
     * @param scope The scope of the specified Data Model. (required)
     * @param code The code of the specified Data Model. (required)
     ...
     */
    private void updateCustomDataModelAsync(String entityType, String scope, String code, UpdateCustomDataModelRequest updateCustomDataModelRequest, final ApiCallback<CustomDataModel> _callback) throws ApiException {

        HttpRequest localVarCall = updateCustomDataModelValidateBeforeCall(entityType, scope, code, updateCustomDataModelRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateCustomDataModelAsync(String entityType, String scope, String code, UpdateCustomDataModelRequest updateCustomDataModelRequest, final ApiCallback<CustomDataModel> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateCustomDataModelValidateBeforeCall(entityType, scope, code, updateCustomDataModelRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<CustomDataModel>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateCustomDataModelRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CustomDataModel> _callback) throws ApiException {
            updateCustomDataModelAsync(entityType, scope, code, updateCustomDataModelRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CustomDataModel> _callback, ConfigurationOptions opts) throws ApiException {
            updateCustomDataModelAsync(entityType, scope, code, updateCustomDataModelRequest, _callback, opts);
        }
    }
