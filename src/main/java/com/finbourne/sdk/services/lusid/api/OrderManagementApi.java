...
public class OrderManagementApi {
     ...
     */
    private HttpRequest bookTransactionsCall(BookTransactionsRequest bookTransactionsRequest, Boolean applyFeesAndCommission, Boolean markOrdersAndAllocationsAsBooked, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for bookTransactions. Use any specified configuration options to override any other configuration for this request only.
     * @param bookTransactionsRequest The allocations to create transactions for (required). Use any specified configuration options to override any other configuration for this request only.
     * @param applyFeesAndCommission Whether to apply fees and commissions to transactions (default: true) (optional, default to true). Use any specified configuration options to override any other configuration for this request only.
     * @param markOrdersAndAllocationsAsBooked Whether to mark allocations and fully-booked orders with state Booked (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest bookTransactionsCall(BookTransactionsRequest bookTransactionsRequest, Boolean applyFeesAndCommission, Boolean markOrdersAndAllocationsAsBooked, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/ordermanagement/booktransactions";
    ...
    private HttpRequest bookTransactionsValidateBeforeCall(BookTransactionsRequest bookTransactionsRequest, Boolean applyFeesAndCommission, Boolean markOrdersAndAllocationsAsBooked, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<BookTransactionsResponse> bookTransactionsWithHttpInfo(BookTransactionsRequest bookTransactionsRequest, Boolean applyFeesAndCommission, Boolean markOrdersAndAllocationsAsBooked) throws ApiException {
        HttpRequest localVarCall = bookTransactionsValidateBeforeCall(bookTransactionsRequest, applyFeesAndCommission, markOrdersAndAllocationsAsBooked, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BookTransactionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * BookTransactions: Books transactions using specific allocations as a source.
     * Takes a collection of allocation IDs, and maps fields from those allocations and related orders onto new transactions.Use any specified configuration options to override any other configuration for this request only
     * @param bookTransactionsRequest The allocations to create transactions for (required)
     * @param applyFeesAndCommission Whether to apply fees and commissions to transactions (default: true) (optional, default to true)
     * @param markOrdersAndAllocationsAsBooked Whether to mark allocations and fully-booked orders with state Booked (optional, default to false)
     * @return ApiResponse&lt;BookTransactionsResponse&gt;
    ...
    private ApiResponse<BookTransactionsResponse> bookTransactionsWithHttpInfo(BookTransactionsRequest bookTransactionsRequest, Boolean applyFeesAndCommission, Boolean markOrdersAndAllocationsAsBooked, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = bookTransactionsValidateBeforeCall(bookTransactionsRequest, applyFeesAndCommission, markOrdersAndAllocationsAsBooked, null, opts);
        Type localVarReturnType = new TypeReference<BookTransactionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * BookTransactions: Books transactions using specific allocations as a source. (asynchronously)
     * Takes a collection of allocation IDs, and maps fields from those allocations and related orders onto new transactions.
     * @param bookTransactionsRequest The allocations to create transactions for (required)
     * @param applyFeesAndCommission Whether to apply fees and commissions to transactions (default: true) (optional, default to true)
     * @param markOrdersAndAllocationsAsBooked Whether to mark allocations and fully-booked orders with state Booked (optional, default to false)
     ...
     */
    private void bookTransactionsAsync(BookTransactionsRequest bookTransactionsRequest, Boolean applyFeesAndCommission, Boolean markOrdersAndAllocationsAsBooked, final ApiCallback<BookTransactionsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = bookTransactionsValidateBeforeCall(bookTransactionsRequest, applyFeesAndCommission, markOrdersAndAllocationsAsBooked, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BookTransactionsResponse>(){}.getType();
     ...
     */
    private void bookTransactionsAsync(BookTransactionsRequest bookTransactionsRequest, Boolean applyFeesAndCommission, Boolean markOrdersAndAllocationsAsBooked, final ApiCallback<BookTransactionsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = bookTransactionsValidateBeforeCall(bookTransactionsRequest, applyFeesAndCommission, markOrdersAndAllocationsAsBooked, _callback, opts);
        Type localVarReturnType = new TypeReference<BookTransactionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIbookTransactionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<BookTransactionsResponse> _callback) throws ApiException {
            bookTransactionsAsync(bookTransactionsRequest, applyFeesAndCommission, markOrdersAndAllocationsAsBooked, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<BookTransactionsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            bookTransactionsAsync(bookTransactionsRequest, applyFeesAndCommission, markOrdersAndAllocationsAsBooked, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest cancelOrdersCall(Map<String, ResourceId> requestBody, final ApiCallback _callback) throws ApiException {
        return cancelOrdersCall(requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for cancelOrders. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The request containing the ids of the orders to be cancelled. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest cancelOrdersCall(Map<String, ResourceId> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/cancelorders";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest cancelOrdersValidateBeforeCall(Map<String, ResourceId> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<CancelOrdersResponse> cancelOrdersWithHttpInfo(Map<String, ResourceId> requestBody) throws ApiException {
        HttpRequest localVarCall = cancelOrdersValidateBeforeCall(requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CancelOrdersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CancelOrders: Cancel existing orders
     * The response returns both the collection of successfully canceled orders, as well as those  that failed. For each failure, a reason is provided. It is important to check the failed set for  unsuccessful results.Use any specified configuration options to override any other configuration for this request only
     * @param requestBody The request containing the ids of the orders to be cancelled. (required)
     * @return ApiResponse&lt;CancelOrdersResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<CancelOrdersResponse> cancelOrdersWithHttpInfo(Map<String, ResourceId> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = cancelOrdersValidateBeforeCall(requestBody, null, opts);
        Type localVarReturnType = new TypeReference<CancelOrdersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CancelOrders: Cancel existing orders (asynchronously)
     * The response returns both the collection of successfully canceled orders, as well as those  that failed. For each failure, a reason is provided. It is important to check the failed set for  unsuccessful results.
     * @param requestBody The request containing the ids of the orders to be cancelled. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void cancelOrdersAsync(Map<String, ResourceId> requestBody, final ApiCallback<CancelOrdersResponse> _callback) throws ApiException {

        HttpRequest localVarCall = cancelOrdersValidateBeforeCall(requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CancelOrdersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void cancelOrdersAsync(Map<String, ResourceId> requestBody, final ApiCallback<CancelOrdersResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = cancelOrdersValidateBeforeCall(requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<CancelOrdersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcancelOrdersRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CancelOrdersResponse> _callback) throws ApiException {
            cancelOrdersAsync(requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CancelOrdersResponse> _callback, ConfigurationOptions opts) throws ApiException {
            cancelOrdersAsync(requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest cancelOrdersAndMoveRemainingCall(Map<String, CancelOrdersAndMoveRemainingRequest> requestBody, final ApiCallback _callback) throws ApiException {
        return cancelOrdersAndMoveRemainingCall(requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for cancelOrdersAndMoveRemaining. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The request containing the orders to be cancelled, and the destinations of remaining quantities. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest cancelOrdersAndMoveRemainingCall(Map<String, CancelOrdersAndMoveRemainingRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/cancelordersandmoveremaining";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest cancelOrdersAndMoveRemainingValidateBeforeCall(Map<String, CancelOrdersAndMoveRemainingRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
    ...
    private ApiResponse<CancelOrdersAndMoveRemainingResponse> cancelOrdersAndMoveRemainingWithHttpInfo(Map<String, CancelOrdersAndMoveRemainingRequest> requestBody) throws ApiException {
        HttpRequest localVarCall = cancelOrdersAndMoveRemainingValidateBeforeCall(requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CancelOrdersAndMoveRemainingResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CancelOrdersAndMoveRemaining: Cancel existing orders and move any unplaced quantities to new orders in new blocks
     * Cancels existing orders, reducing their quantities to those aleady placed. Any remaining quantities are moved  to new orders in new blocks. The placed quantities are distributed to the cancelled orders on a pro-rata basis.Use any specified configuration options to override any other configuration for this request only
     * @param requestBody The request containing the orders to be cancelled, and the destinations of remaining quantities. (required)
     * @return ApiResponse&lt;CancelOrdersAndMoveRemainingResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<CancelOrdersAndMoveRemainingResponse> cancelOrdersAndMoveRemainingWithHttpInfo(Map<String, CancelOrdersAndMoveRemainingRequest> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = cancelOrdersAndMoveRemainingValidateBeforeCall(requestBody, null, opts);
        Type localVarReturnType = new TypeReference<CancelOrdersAndMoveRemainingResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CancelOrdersAndMoveRemaining: Cancel existing orders and move any unplaced quantities to new orders in new blocks (asynchronously)
     * Cancels existing orders, reducing their quantities to those aleady placed. Any remaining quantities are moved  to new orders in new blocks. The placed quantities are distributed to the cancelled orders on a pro-rata basis.
     * @param requestBody The request containing the orders to be cancelled, and the destinations of remaining quantities. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void cancelOrdersAndMoveRemainingAsync(Map<String, CancelOrdersAndMoveRemainingRequest> requestBody, final ApiCallback<CancelOrdersAndMoveRemainingResponse> _callback) throws ApiException {

        HttpRequest localVarCall = cancelOrdersAndMoveRemainingValidateBeforeCall(requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CancelOrdersAndMoveRemainingResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void cancelOrdersAndMoveRemainingAsync(Map<String, CancelOrdersAndMoveRemainingRequest> requestBody, final ApiCallback<CancelOrdersAndMoveRemainingResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = cancelOrdersAndMoveRemainingValidateBeforeCall(requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<CancelOrdersAndMoveRemainingResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcancelOrdersAndMoveRemainingRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CancelOrdersAndMoveRemainingResponse> _callback) throws ApiException {
            cancelOrdersAndMoveRemainingAsync(requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CancelOrdersAndMoveRemainingResponse> _callback, ConfigurationOptions opts) throws ApiException {
            cancelOrdersAndMoveRemainingAsync(requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest cancelPlacementsCall(Map<String, ResourceId> requestBody, final ApiCallback _callback) throws ApiException {
        return cancelPlacementsCall(requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for cancelPlacements. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The request containing the ids of the placements to be cancelled. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest cancelPlacementsCall(Map<String, ResourceId> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/$cancelplacements";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest cancelPlacementsValidateBeforeCall(Map<String, ResourceId> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
    ...
    private ApiResponse<CancelPlacementsResponse> cancelPlacementsWithHttpInfo(Map<String, ResourceId> requestBody) throws ApiException {
        HttpRequest localVarCall = cancelPlacementsValidateBeforeCall(requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CancelPlacementsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<CancelPlacementsResponse> cancelPlacementsWithHttpInfo(Map<String, ResourceId> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = cancelPlacementsValidateBeforeCall(requestBody, null, opts);
        Type localVarReturnType = new TypeReference<CancelPlacementsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CancelPlacements: Cancel existing placements (asynchronously)
     * The response returns both the collection of successfully canceled placements, as well as those  that failed. For each failure, a reason is provided. It is important to check the failed set for  unsuccessful results.
     * @param requestBody The request containing the ids of the placements to be cancelled. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void cancelPlacementsAsync(Map<String, ResourceId> requestBody, final ApiCallback<CancelPlacementsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = cancelPlacementsValidateBeforeCall(requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CancelPlacementsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void cancelPlacementsAsync(Map<String, ResourceId> requestBody, final ApiCallback<CancelPlacementsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = cancelPlacementsValidateBeforeCall(requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<CancelPlacementsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcancelPlacementsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CancelPlacementsResponse> _callback) throws ApiException {
            cancelPlacementsAsync(requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CancelPlacementsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            cancelPlacementsAsync(requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest createOrdersCall(BlockAndOrdersCreateRequest blockAndOrdersCreateRequest, final ApiCallback _callback) throws ApiException {
        return createOrdersCall(blockAndOrdersCreateRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createOrders. Use any specified configuration options to override any other configuration for this request only.
     * @param blockAndOrdersCreateRequest The collection of block and orders requests. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createOrdersCall(BlockAndOrdersCreateRequest blockAndOrdersCreateRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/createorders";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest createOrdersValidateBeforeCall(BlockAndOrdersCreateRequest blockAndOrdersCreateRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfBlockAndOrders> createOrdersWithHttpInfo(BlockAndOrdersCreateRequest blockAndOrdersCreateRequest) throws ApiException {
        HttpRequest localVarCall = createOrdersValidateBeforeCall(blockAndOrdersCreateRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfBlockAndOrders>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListOfBlockAndOrders> createOrdersWithHttpInfo(BlockAndOrdersCreateRequest blockAndOrdersCreateRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createOrdersValidateBeforeCall(blockAndOrdersCreateRequest, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfBlockAndOrders>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createOrdersAsync(BlockAndOrdersCreateRequest blockAndOrdersCreateRequest, final ApiCallback<ResourceListOfBlockAndOrders> _callback) throws ApiException {

        HttpRequest localVarCall = createOrdersValidateBeforeCall(blockAndOrdersCreateRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfBlockAndOrders>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void createOrdersAsync(BlockAndOrdersCreateRequest blockAndOrdersCreateRequest, final ApiCallback<ResourceListOfBlockAndOrders> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createOrdersValidateBeforeCall(blockAndOrdersCreateRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfBlockAndOrders>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateOrdersRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfBlockAndOrders> _callback) throws ApiException {
            createOrdersAsync(blockAndOrdersCreateRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfBlockAndOrders> _callback, ConfigurationOptions opts) throws ApiException {
            createOrdersAsync(blockAndOrdersCreateRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getOrderHistoryCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getOrderHistoryCall(scope, code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getOrderHistory. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the order. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the order. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the history of the order and related entities. Defaults              to return the latest version if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getOrderHistoryCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/order/{scope}/{code}/$history"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getOrderHistoryValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfChangeIntervalWithOrderManagementDetail> getOrderHistoryWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getOrderHistoryValidateBeforeCall(scope, code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfChangeIntervalWithOrderManagementDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetOrderHistory: Get the history of an order and related entity changes
     * Get the changes that have happened to an order and related entities.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the order. (required)
     * @param code The code of the order. (required)
     * @param asAt The asAt datetime at which to retrieve the history of the order and related entities. Defaults              to return the latest version if not specified. (optional)
     * @return ApiResponse&lt;ResourceListOfChangeIntervalWithOrderManagementDetail&gt;
    ...
    private ApiResponse<ResourceListOfChangeIntervalWithOrderManagementDetail> getOrderHistoryWithHttpInfo(String scope, String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getOrderHistoryValidateBeforeCall(scope, code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfChangeIntervalWithOrderManagementDetail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetOrderHistory: Get the history of an order and related entity changes (asynchronously)
     * Get the changes that have happened to an order and related entities.
     * @param scope The scope of the order. (required)
     * @param code The code of the order. (required)
     * @param asAt The asAt datetime at which to retrieve the history of the order and related entities. Defaults              to return the latest version if not specified. (optional)
     ...
     */
    private void getOrderHistoryAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<ResourceListOfChangeIntervalWithOrderManagementDetail> _callback) throws ApiException {

        HttpRequest localVarCall = getOrderHistoryValidateBeforeCall(scope, code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfChangeIntervalWithOrderManagementDetail>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getOrderHistoryAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<ResourceListOfChangeIntervalWithOrderManagementDetail> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getOrderHistoryValidateBeforeCall(scope, code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfChangeIntervalWithOrderManagementDetail>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetOrderHistoryRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfChangeIntervalWithOrderManagementDetail> _callback) throws ApiException {
            getOrderHistoryAsync(scope, code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfChangeIntervalWithOrderManagementDetail> _callback, ConfigurationOptions opts) throws ApiException {
            getOrderHistoryAsync(scope, code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest moveOrdersCall(MoveOrdersToDifferentBlocksRequest moveOrdersToDifferentBlocksRequest, final ApiCallback _callback) throws ApiException {
        return moveOrdersCall(moveOrdersToDifferentBlocksRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for moveOrders. Use any specified configuration options to override any other configuration for this request only.
     * @param moveOrdersToDifferentBlocksRequest The collection of order and destination block ids. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest moveOrdersCall(MoveOrdersToDifferentBlocksRequest moveOrdersToDifferentBlocksRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/moveorders";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest moveOrdersValidateBeforeCall(MoveOrdersToDifferentBlocksRequest moveOrdersToDifferentBlocksRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfMovedOrderToDifferentBlockResponse> moveOrdersWithHttpInfo(MoveOrdersToDifferentBlocksRequest moveOrdersToDifferentBlocksRequest) throws ApiException {
        HttpRequest localVarCall = moveOrdersValidateBeforeCall(moveOrdersToDifferentBlocksRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfMovedOrderToDifferentBlockResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] MoveOrders: Move orders to new or existing block
     * Move an order to a block, creating the block if it does not already exist.   This will fail if the block exists and already references orders with differing fields to the upsert request.Use any specified configuration options to override any other configuration for this request only
     * @param moveOrdersToDifferentBlocksRequest The collection of order and destination block ids. (required)
     * @return ApiResponse&lt;ResourceListOfMovedOrderToDifferentBlockResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfMovedOrderToDifferentBlockResponse> moveOrdersWithHttpInfo(MoveOrdersToDifferentBlocksRequest moveOrdersToDifferentBlocksRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = moveOrdersValidateBeforeCall(moveOrdersToDifferentBlocksRequest, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfMovedOrderToDifferentBlockResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] MoveOrders: Move orders to new or existing block (asynchronously)
     * Move an order to a block, creating the block if it does not already exist.   This will fail if the block exists and already references orders with differing fields to the upsert request.
     * @param moveOrdersToDifferentBlocksRequest The collection of order and destination block ids. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void moveOrdersAsync(MoveOrdersToDifferentBlocksRequest moveOrdersToDifferentBlocksRequest, final ApiCallback<ResourceListOfMovedOrderToDifferentBlockResponse> _callback) throws ApiException {

        HttpRequest localVarCall = moveOrdersValidateBeforeCall(moveOrdersToDifferentBlocksRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfMovedOrderToDifferentBlockResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void moveOrdersAsync(MoveOrdersToDifferentBlocksRequest moveOrdersToDifferentBlocksRequest, final ApiCallback<ResourceListOfMovedOrderToDifferentBlockResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = moveOrdersValidateBeforeCall(moveOrdersToDifferentBlocksRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfMovedOrderToDifferentBlockResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APImoveOrdersRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfMovedOrderToDifferentBlockResponse> _callback) throws ApiException {
            moveOrdersAsync(moveOrdersToDifferentBlocksRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfMovedOrderToDifferentBlockResponse> _callback, ConfigurationOptions opts) throws ApiException {
            moveOrdersAsync(moveOrdersToDifferentBlocksRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest placeBlocksCall(PlaceBlocksRequest placeBlocksRequest, final ApiCallback _callback) throws ApiException {
        return placeBlocksCall(placeBlocksRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for placeBlocks. Use any specified configuration options to override any other configuration for this request only.
     * @param placeBlocksRequest The request containing the blocks to the placed. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest placeBlocksCall(PlaceBlocksRequest placeBlocksRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/placeblocks";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest placeBlocksValidateBeforeCall(PlaceBlocksRequest placeBlocksRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfPlacement> placeBlocksWithHttpInfo(PlaceBlocksRequest placeBlocksRequest) throws ApiException {
        HttpRequest localVarCall = placeBlocksValidateBeforeCall(placeBlocksRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPlacement>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] PlaceBlocks: Places blocks for a given list of placement requests.
     * The referenced block&#39;s existence will be verified.Use any specified configuration options to override any other configuration for this request only
     * @param placeBlocksRequest The request containing the blocks to the placed. (optional)
     * @return ApiResponse&lt;ResourceListOfPlacement&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfPlacement> placeBlocksWithHttpInfo(PlaceBlocksRequest placeBlocksRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = placeBlocksValidateBeforeCall(placeBlocksRequest, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPlacement>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] PlaceBlocks: Places blocks for a given list of placement requests. (asynchronously)
     * The referenced block&#39;s existence will be verified.
     * @param placeBlocksRequest The request containing the blocks to the placed. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void placeBlocksAsync(PlaceBlocksRequest placeBlocksRequest, final ApiCallback<ResourceListOfPlacement> _callback) throws ApiException {

        HttpRequest localVarCall = placeBlocksValidateBeforeCall(placeBlocksRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfPlacement>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void placeBlocksAsync(PlaceBlocksRequest placeBlocksRequest, final ApiCallback<ResourceListOfPlacement> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = placeBlocksValidateBeforeCall(placeBlocksRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfPlacement>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIplaceBlocksRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPlacement> _callback) throws ApiException {
            placeBlocksAsync(placeBlocksRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfPlacement> _callback, ConfigurationOptions opts) throws ApiException {
            placeBlocksAsync(placeBlocksRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest runAllocationServiceCall(List<ResourceId> resourceId, String allocationAlgorithm, final ApiCallback _callback) throws ApiException {
        return runAllocationServiceCall(resourceId, allocationAlgorithm,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for runAllocationService. Use any specified configuration options to override any other configuration for this request only.
     * @param resourceId The List of Placement IDs for which you wish to allocate Executions. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param allocationAlgorithm A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-FIFO\&quot;.  This defaults to \&quot;PR-FIFO\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest runAllocationServiceCall(List<ResourceId> resourceId, String allocationAlgorithm, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/allocate";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest runAllocationServiceValidateBeforeCall(List<ResourceId> resourceId, String allocationAlgorithm, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<AllocationServiceRunResponse> runAllocationServiceWithHttpInfo(List<ResourceId> resourceId, String allocationAlgorithm) throws ApiException {
        HttpRequest localVarCall = runAllocationServiceValidateBeforeCall(resourceId, allocationAlgorithm, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AllocationServiceRunResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * RunAllocationService: Runs the Allocation Service
     * Allocates Executions for a given list of placements back to their originating orders using one of the LUSID algorithms, creating Allocations to record the results.Use any specified configuration options to override any other configuration for this request only
     * @param resourceId The List of Placement IDs for which you wish to allocate Executions. (required)
     * @param allocationAlgorithm A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-FIFO\&quot;.  This defaults to \&quot;PR-FIFO\&quot;. (optional)
     * @return ApiResponse&lt;AllocationServiceRunResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<AllocationServiceRunResponse> runAllocationServiceWithHttpInfo(List<ResourceId> resourceId, String allocationAlgorithm, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = runAllocationServiceValidateBeforeCall(resourceId, allocationAlgorithm, null, opts);
        Type localVarReturnType = new TypeReference<AllocationServiceRunResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * RunAllocationService: Runs the Allocation Service (asynchronously)
     * Allocates Executions for a given list of placements back to their originating orders using one of the LUSID algorithms, creating Allocations to record the results.
     * @param resourceId The List of Placement IDs for which you wish to allocate Executions. (required)
     * @param allocationAlgorithm A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-FIFO\&quot;.  This defaults to \&quot;PR-FIFO\&quot;. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void runAllocationServiceAsync(List<ResourceId> resourceId, String allocationAlgorithm, final ApiCallback<AllocationServiceRunResponse> _callback) throws ApiException {

        HttpRequest localVarCall = runAllocationServiceValidateBeforeCall(resourceId, allocationAlgorithm, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AllocationServiceRunResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void runAllocationServiceAsync(List<ResourceId> resourceId, String allocationAlgorithm, final ApiCallback<AllocationServiceRunResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = runAllocationServiceValidateBeforeCall(resourceId, allocationAlgorithm, _callback, opts);
        Type localVarReturnType = new TypeReference<AllocationServiceRunResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIrunAllocationServiceRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AllocationServiceRunResponse> _callback) throws ApiException {
            runAllocationServiceAsync(resourceId, allocationAlgorithm, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AllocationServiceRunResponse> _callback, ConfigurationOptions opts) throws ApiException {
            runAllocationServiceAsync(resourceId, allocationAlgorithm, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest runAllocationServiceWithWeightsCall(WeightedAllocationServiceRunRequest weightedAllocationServiceRunRequest, String allocationAlgorithm, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for runAllocationServiceWithWeights. Use any specified configuration options to override any other configuration for this request only.
     * @param weightedAllocationServiceRunRequest The placement IDs to allocate against, and the portfolio weights to use for the allocation split. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param allocationAlgorithm A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-LF\&quot;.  Allocating with weights means the base algorithm is always pro-rata, and the orphan allocation algorithm is either Largest First or Smallest First.  This defaults to \&quot;PR-LF\&quot;. Valid values are \&quot;PR-LF\&quot;, \&quot;PR-SF\&quot;, \&quot;LF\&quot;, \&quot;SF\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest runAllocationServiceWithWeightsCall(WeightedAllocationServiceRunRequest weightedAllocationServiceRunRequest, String allocationAlgorithm, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/allocate/weighted";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest runAllocationServiceWithWeightsValidateBeforeCall(WeightedAllocationServiceRunRequest weightedAllocationServiceRunRequest, String allocationAlgorithm, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<AllocationServiceRunResponse> runAllocationServiceWithWeightsWithHttpInfo(WeightedAllocationServiceRunRequest weightedAllocationServiceRunRequest, String allocationAlgorithm) throws ApiException {
        HttpRequest localVarCall = runAllocationServiceWithWeightsValidateBeforeCall(weightedAllocationServiceRunRequest, allocationAlgorithm, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AllocationServiceRunResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EXPERIMENTAL] RunAllocationServiceWithWeights: Runs the Allocation Service with portfolio weights
     * Allocates Executions for a given list of placements to a specified set of portfolios by weight,  creating Allocations to record the results. Used for the unsolicited Block and Block Trade booking flows where no Orders exist against the Block.  Weights are relative to each other and are not required to sum to 1 or 100.Use any specified configuration options to override any other configuration for this request only
     * @param weightedAllocationServiceRunRequest The placement IDs to allocate against, and the portfolio weights to use for the allocation split. (required)
     * @param allocationAlgorithm A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-LF\&quot;.  Allocating with weights means the base algorithm is always pro-rata, and the orphan allocation algorithm is either Largest First or Smallest First.  This defaults to \&quot;PR-LF\&quot;. Valid values are \&quot;PR-LF\&quot;, \&quot;PR-SF\&quot;, \&quot;LF\&quot;, \&quot;SF\&quot;. (optional)
     * @return ApiResponse&lt;AllocationServiceRunResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<AllocationServiceRunResponse> runAllocationServiceWithWeightsWithHttpInfo(WeightedAllocationServiceRunRequest weightedAllocationServiceRunRequest, String allocationAlgorithm, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = runAllocationServiceWithWeightsValidateBeforeCall(weightedAllocationServiceRunRequest, allocationAlgorithm, null, opts);
        Type localVarReturnType = new TypeReference<AllocationServiceRunResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] RunAllocationServiceWithWeights: Runs the Allocation Service with portfolio weights (asynchronously)
     * Allocates Executions for a given list of placements to a specified set of portfolios by weight,  creating Allocations to record the results. Used for the unsolicited Block and Block Trade booking flows where no Orders exist against the Block.  Weights are relative to each other and are not required to sum to 1 or 100.
     * @param weightedAllocationServiceRunRequest The placement IDs to allocate against, and the portfolio weights to use for the allocation split. (required)
     * @param allocationAlgorithm A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-LF\&quot;.  Allocating with weights means the base algorithm is always pro-rata, and the orphan allocation algorithm is either Largest First or Smallest First.  This defaults to \&quot;PR-LF\&quot;. Valid values are \&quot;PR-LF\&quot;, \&quot;PR-SF\&quot;, \&quot;LF\&quot;, \&quot;SF\&quot;. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void runAllocationServiceWithWeightsAsync(WeightedAllocationServiceRunRequest weightedAllocationServiceRunRequest, String allocationAlgorithm, final ApiCallback<AllocationServiceRunResponse> _callback) throws ApiException {

        HttpRequest localVarCall = runAllocationServiceWithWeightsValidateBeforeCall(weightedAllocationServiceRunRequest, allocationAlgorithm, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AllocationServiceRunResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void runAllocationServiceWithWeightsAsync(WeightedAllocationServiceRunRequest weightedAllocationServiceRunRequest, String allocationAlgorithm, final ApiCallback<AllocationServiceRunResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = runAllocationServiceWithWeightsValidateBeforeCall(weightedAllocationServiceRunRequest, allocationAlgorithm, _callback, opts);
        Type localVarReturnType = new TypeReference<AllocationServiceRunResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIrunAllocationServiceWithWeightsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AllocationServiceRunResponse> _callback) throws ApiException {
            runAllocationServiceWithWeightsAsync(weightedAllocationServiceRunRequest, allocationAlgorithm, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AllocationServiceRunResponse> _callback, ConfigurationOptions opts) throws ApiException {
            runAllocationServiceWithWeightsAsync(weightedAllocationServiceRunRequest, allocationAlgorithm, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest sweepBlocksCall(SweepBlocksRequest sweepBlocksRequest, final ApiCallback _callback) throws ApiException {
        return sweepBlocksCall(sweepBlocksRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for sweepBlocks. Use any specified configuration options to override any other configuration for this request only.
     * @param sweepBlocksRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest sweepBlocksCall(SweepBlocksRequest sweepBlocksRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/SweepBlocks";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest sweepBlocksValidateBeforeCall(SweepBlocksRequest sweepBlocksRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<SweepBlocksResponse> sweepBlocksWithHttpInfo(SweepBlocksRequest sweepBlocksRequest) throws ApiException {
        HttpRequest localVarCall = sweepBlocksValidateBeforeCall(sweepBlocksRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<SweepBlocksResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] SweepBlocks: Sweeps specified blocks, for each block that meets the requirements. The request may be partially successful.
     * The requirements are:  &lt;list type&#x3D;\&quot;bullet\&quot;&gt;&lt;term&gt;The block exists.&lt;/term&gt;&lt;term&gt;All orders have state \&quot;Closed\&quot;, \&quot;Cancelled\&quot;, \&quot;Canceled\&quot; or \&quot;Booked\&quot;.&lt;/term&gt;&lt;term&gt;All placements have state \&quot;Allocated\&quot; or \&quot;Over-allocated\&quot;.&lt;/term&gt;&lt;term&gt;All allocations have state \&quot;Closed\&quot;, \&quot;Cancelled\&quot;, \&quot;Canceled\&quot; or \&quot;Booked\&quot;.&lt;/term&gt;&lt;term&gt;No execution or allocation has been modified since the passed LatestAllowableModificationTime.&lt;/term&gt;&lt;/list&gt;Use any specified configuration options to override any other configuration for this request only
     * @param sweepBlocksRequest  (required)
     * @return ApiResponse&lt;SweepBlocksResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<SweepBlocksResponse> sweepBlocksWithHttpInfo(SweepBlocksRequest sweepBlocksRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = sweepBlocksValidateBeforeCall(sweepBlocksRequest, null, opts);
        Type localVarReturnType = new TypeReference<SweepBlocksResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] SweepBlocks: Sweeps specified blocks, for each block that meets the requirements. The request may be partially successful. (asynchronously)
     * The requirements are:  &lt;list type&#x3D;\&quot;bullet\&quot;&gt;&lt;term&gt;The block exists.&lt;/term&gt;&lt;term&gt;All orders have state \&quot;Closed\&quot;, \&quot;Cancelled\&quot;, \&quot;Canceled\&quot; or \&quot;Booked\&quot;.&lt;/term&gt;&lt;term&gt;All placements have state \&quot;Allocated\&quot; or \&quot;Over-allocated\&quot;.&lt;/term&gt;&lt;term&gt;All allocations have state \&quot;Closed\&quot;, \&quot;Cancelled\&quot;, \&quot;Canceled\&quot; or \&quot;Booked\&quot;.&lt;/term&gt;&lt;term&gt;No execution or allocation has been modified since the passed LatestAllowableModificationTime.&lt;/term&gt;&lt;/list&gt;
     * @param sweepBlocksRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void sweepBlocksAsync(SweepBlocksRequest sweepBlocksRequest, final ApiCallback<SweepBlocksResponse> _callback) throws ApiException {

        HttpRequest localVarCall = sweepBlocksValidateBeforeCall(sweepBlocksRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<SweepBlocksResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void sweepBlocksAsync(SweepBlocksRequest sweepBlocksRequest, final ApiCallback<SweepBlocksResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = sweepBlocksValidateBeforeCall(sweepBlocksRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<SweepBlocksResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIsweepBlocksRequest {
         ...
         */
        public void executeAsync(final ApiCallback<SweepBlocksResponse> _callback) throws ApiException {
            sweepBlocksAsync(sweepBlocksRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<SweepBlocksResponse> _callback, ConfigurationOptions opts) throws ApiException {
            sweepBlocksAsync(sweepBlocksRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateOrdersCall(Map<String, OrderUpdateRequest> requestBody, final ApiCallback _callback) throws ApiException {
        return updateOrdersCall(requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateOrders. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The request containing the orders to be updated. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updateOrdersCall(Map<String, OrderUpdateRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/updateorders";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateOrdersValidateBeforeCall(Map<String, OrderUpdateRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
    ...
    private ApiResponse<UpdateOrdersResponse> updateOrdersWithHttpInfo(Map<String, OrderUpdateRequest> requestBody) throws ApiException {
        HttpRequest localVarCall = updateOrdersValidateBeforeCall(requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpdateOrdersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<UpdateOrdersResponse> updateOrdersWithHttpInfo(Map<String, OrderUpdateRequest> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateOrdersValidateBeforeCall(requestBody, null, opts);
        Type localVarReturnType = new TypeReference<UpdateOrdersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpdateOrders: Update existing orders (asynchronously)
     * The response returns both the collection of successfully updated orders, as well as those  that failed. For each failure, a reason is provided. It is important to check the failed set for  unsuccessful results.
     * @param requestBody The request containing the orders to be updated. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void updateOrdersAsync(Map<String, OrderUpdateRequest> requestBody, final ApiCallback<UpdateOrdersResponse> _callback) throws ApiException {

        HttpRequest localVarCall = updateOrdersValidateBeforeCall(requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpdateOrdersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateOrdersAsync(Map<String, OrderUpdateRequest> requestBody, final ApiCallback<UpdateOrdersResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateOrdersValidateBeforeCall(requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<UpdateOrdersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateOrdersRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UpdateOrdersResponse> _callback) throws ApiException {
            updateOrdersAsync(requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UpdateOrdersResponse> _callback, ConfigurationOptions opts) throws ApiException {
            updateOrdersAsync(requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updatePlacementsCall(Map<String, PlacementUpdateRequest> requestBody, final ApiCallback _callback) throws ApiException {
        return updatePlacementsCall(requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updatePlacements. Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The request containing the placements to be updated. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updatePlacementsCall(Map<String, PlacementUpdateRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/ordermanagement/$updateplacements";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updatePlacementsValidateBeforeCall(Map<String, PlacementUpdateRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
    ...
    private ApiResponse<UpdatePlacementsResponse> updatePlacementsWithHttpInfo(Map<String, PlacementUpdateRequest> requestBody) throws ApiException {
        HttpRequest localVarCall = updatePlacementsValidateBeforeCall(requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpdatePlacementsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<UpdatePlacementsResponse> updatePlacementsWithHttpInfo(Map<String, PlacementUpdateRequest> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updatePlacementsValidateBeforeCall(requestBody, null, opts);
        Type localVarReturnType = new TypeReference<UpdatePlacementsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpdatePlacements: Update existing placements (asynchronously)
     * The response returns both the collection of successfully updated placements, as well as those  that failed. For each failure, a reason is provided. It is important to check the failed set for  unsuccessful results.
     * @param requestBody The request containing the placements to be updated. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void updatePlacementsAsync(Map<String, PlacementUpdateRequest> requestBody, final ApiCallback<UpdatePlacementsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = updatePlacementsValidateBeforeCall(requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpdatePlacementsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updatePlacementsAsync(Map<String, PlacementUpdateRequest> requestBody, final ApiCallback<UpdatePlacementsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updatePlacementsValidateBeforeCall(requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<UpdatePlacementsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdatePlacementsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UpdatePlacementsResponse> _callback) throws ApiException {
            updatePlacementsAsync(requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UpdatePlacementsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            updatePlacementsAsync(requestBody, _callback, opts);
        }
    }
