 ...
 */
@JsonPropertyOrder({
  StockDividendEvent.JSON_PROPERTY_ANNOUNCEMENT_DATE,
  StockDividendEvent.JSON_PROPERTY_EX_DATE,
  StockDividendEvent.JSON_PROPERTY_PAYMENT_DATE,
  StockDividendEvent.JSON_PROPERTY_RECORD_DATE,
  StockDividendEvent.JSON_PROPERTY_FRACTIONAL_UNITS_CASH_PRICE,
  StockDividendEvent.JSON_PROPERTY_FRACTIONAL_UNITS_CASH_CURRENCY,
  StockDividendEvent.JSON_PROPERTY_FRACTIONAL_UNITS_ROUNDING_CONVENTION,
  StockDividendEvent.JSON_PROPERTY_FRACTIONAL_UNITS_DECIMAL_PLACES,
  StockDividendEvent.JSON_PROPERTY_UNITS_RATIO
})
...
public class StockDividendEvent extends InstrumentEvent {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to StockDividendEvent
   */
  public static StockDividendEvent fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, StockDividendEvent.class);
  }
