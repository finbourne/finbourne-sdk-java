 ...
 */
@JsonPropertyOrder({
  RoundingConvention.JSON_PROPERTY_FACE_VALUE,
  RoundingConvention.JSON_PROPERTY_PRECISION,
  RoundingConvention.JSON_PROPERTY_ROUNDING_TARGET,
  RoundingConvention.JSON_PROPERTY_ROUNDING_TYPE
})
...
public class RoundingConvention {
  ...
  public static final String JSON_PROPERTY_ROUNDING_TARGET = "roundingTarget";
  @JsonProperty(JSON_PROPERTY_ROUNDING_TARGET)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to RoundingConvention
   */
  public static RoundingConvention fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, RoundingConvention.class);
  }
