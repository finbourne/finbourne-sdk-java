...
public class TranslationApi {
     ...
     */
    private HttpRequest translateInstrumentDefinitionsCall(TranslateInstrumentDefinitionsRequest translateInstrumentDefinitionsRequest, final ApiCallback _callback) throws ApiException {
        return translateInstrumentDefinitionsCall(translateInstrumentDefinitionsRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for translateInstrumentDefinitions. Use any specified configuration options to override any other configuration for this request only.
     * @param translateInstrumentDefinitionsRequest The definitions of the instruments to translate along with the target dialect. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest translateInstrumentDefinitionsCall(TranslateInstrumentDefinitionsRequest translateInstrumentDefinitionsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/translation/instrumentdefinitions";
    ...
    private HttpRequest translateInstrumentDefinitionsValidateBeforeCall(TranslateInstrumentDefinitionsRequest translateInstrumentDefinitionsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TranslateInstrumentDefinitionsResponse> translateInstrumentDefinitionsWithHttpInfo(TranslateInstrumentDefinitionsRequest translateInstrumentDefinitionsRequest) throws ApiException {
        HttpRequest localVarCall = translateInstrumentDefinitionsValidateBeforeCall(translateInstrumentDefinitionsRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslateInstrumentDefinitionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] TranslateInstrumentDefinitions: Translate instruments
     * Translates one or more instruments into the given target dialect.                In the request each instrument definition should be keyed by a unique correlation id. This id is ephemeral  and is not stored by LUSID. It serves only as a way to easily identify each instrument in the response.                Any instrument that is not already in the LUSID dialect should be given as an ExoticInstrument.                The response will return both the collection of successfully translated instruments in the target dialect,  as well as those that failed.  For the failures a reason will be provided explaining why the instrument could not be updated or inserted.Use any specified configuration options to override any other configuration for this request only
     * @param translateInstrumentDefinitionsRequest The definitions of the instruments to translate along with the target dialect. (required)
     * @return ApiResponse&lt;TranslateInstrumentDefinitionsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<TranslateInstrumentDefinitionsResponse> translateInstrumentDefinitionsWithHttpInfo(TranslateInstrumentDefinitionsRequest translateInstrumentDefinitionsRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = translateInstrumentDefinitionsValidateBeforeCall(translateInstrumentDefinitionsRequest, null, opts);
        Type localVarReturnType = new TypeReference<TranslateInstrumentDefinitionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void translateInstrumentDefinitionsAsync(TranslateInstrumentDefinitionsRequest translateInstrumentDefinitionsRequest, final ApiCallback<TranslateInstrumentDefinitionsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = translateInstrumentDefinitionsValidateBeforeCall(translateInstrumentDefinitionsRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslateInstrumentDefinitionsResponse>(){}.getType();
     ...
     */
    private void translateInstrumentDefinitionsAsync(TranslateInstrumentDefinitionsRequest translateInstrumentDefinitionsRequest, final ApiCallback<TranslateInstrumentDefinitionsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = translateInstrumentDefinitionsValidateBeforeCall(translateInstrumentDefinitionsRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TranslateInstrumentDefinitionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APItranslateInstrumentDefinitionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TranslateInstrumentDefinitionsResponse> _callback) throws ApiException {
            translateInstrumentDefinitionsAsync(translateInstrumentDefinitionsRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TranslateInstrumentDefinitionsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            translateInstrumentDefinitionsAsync(translateInstrumentDefinitionsRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest translateTradeTicketsCall(TranslateTradeTicketRequest translateTradeTicketRequest, final ApiCallback _callback) throws ApiException {
        return translateTradeTicketsCall(translateTradeTicketRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for translateTradeTickets. Use any specified configuration options to override any other configuration for this request only.
     * @param translateTradeTicketRequest The definitions of the trade ticket to translate along with the target dialect. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest translateTradeTicketsCall(TranslateTradeTicketRequest translateTradeTicketRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/translation/tradetickets";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest translateTradeTicketsValidateBeforeCall(TranslateTradeTicketRequest translateTradeTicketRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TranslateTradeTicketsResponse> translateTradeTicketsWithHttpInfo(TranslateTradeTicketRequest translateTradeTicketRequest) throws ApiException {
        HttpRequest localVarCall = translateTradeTicketsValidateBeforeCall(translateTradeTicketRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslateTradeTicketsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] TranslateTradeTickets: Translate trade ticket
     * Translates one or more trade tickets into the given target dialect.                In the request each trade ticket definition should be keyed by a unique correlation id. This id is ephemeral  and is not stored by LUSID. It serves only as a way to easily identify each trade ticket in the response.                The response will return both the collection of successfully translated trade tickets in the target dialect,  as well as those that failed.  For the failures a reason will be provided explaining why the trade ticket could not be updated or inserted.Use any specified configuration options to override any other configuration for this request only
     * @param translateTradeTicketRequest The definitions of the trade ticket to translate along with the target dialect. (required)
     * @return ApiResponse&lt;TranslateTradeTicketsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<TranslateTradeTicketsResponse> translateTradeTicketsWithHttpInfo(TranslateTradeTicketRequest translateTradeTicketRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = translateTradeTicketsValidateBeforeCall(translateTradeTicketRequest, null, opts);
        Type localVarReturnType = new TypeReference<TranslateTradeTicketsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void translateTradeTicketsAsync(TranslateTradeTicketRequest translateTradeTicketRequest, final ApiCallback<TranslateTradeTicketsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = translateTradeTicketsValidateBeforeCall(translateTradeTicketRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslateTradeTicketsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void translateTradeTicketsAsync(TranslateTradeTicketRequest translateTradeTicketRequest, final ApiCallback<TranslateTradeTicketsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = translateTradeTicketsValidateBeforeCall(translateTradeTicketRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TranslateTradeTicketsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APItranslateTradeTicketsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TranslateTradeTicketsResponse> _callback) throws ApiException {
            translateTradeTicketsAsync(translateTradeTicketRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TranslateTradeTicketsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            translateTradeTicketsAsync(translateTradeTicketRequest, _callback, opts);
        }
    }
