 ...
 */
@JsonPropertyOrder({
  PortfolioReconciliationRequest.JSON_PROPERTY_PORTFOLIO_ID,
  PortfolioReconciliationRequest.JSON_PROPERTY_EFFECTIVE_AT,
  PortfolioReconciliationRequest.JSON_PROPERTY_AS_AT
})
...
public class PortfolioReconciliationRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to PortfolioReconciliationRequest
   */
  public static PortfolioReconciliationRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, PortfolioReconciliationRequest.class);
  }
