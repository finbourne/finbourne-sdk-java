 ...
 */
@JsonPropertyOrder({
  ComplianceRuleUpsertResponse.JSON_PROPERTY_VALUES
})
...
public class ComplianceRuleUpsertResponse {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ComplianceRuleUpsertResponse
   */
  public static ComplianceRuleUpsertResponse fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ComplianceRuleUpsertResponse.class);
  }
