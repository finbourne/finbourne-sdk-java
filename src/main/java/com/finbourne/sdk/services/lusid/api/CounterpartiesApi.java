...
public class CounterpartiesApi {
     ...
     */
    private HttpRequest deleteCounterpartyAgreementCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteCounterpartyAgreementCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteCounterpartyAgreement. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Counterparty Agreement to delete. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The Counterparty Agreement to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteCounterpartyAgreementCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/counterparties/counterpartyagreements/{scope}/{code}"
    ...
    private HttpRequest deleteCounterpartyAgreementValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<AnnulSingleStructuredDataResponse> deleteCounterpartyAgreementWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteCounterpartyAgreementValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] DeleteCounterpartyAgreement: Delete the Counterparty Agreement of given scope and code
     * Delete the specified Counterparty Agreement from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.                It is important to always check for any unsuccessful response.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Counterparty Agreement to delete. (required)
     * @param code The Counterparty Agreement to delete. (required)
     * @return ApiResponse&lt;AnnulSingleStructuredDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<AnnulSingleStructuredDataResponse> deleteCounterpartyAgreementWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCounterpartyAgreementValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteCounterpartyAgreementAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCounterpartyAgreementValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
     ...
     */
    private void deleteCounterpartyAgreementAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCounterpartyAgreementValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCounterpartyAgreementRequest {
        ...
        public void executeAsync(final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {
            deleteCounterpartyAgreementAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<AnnulSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCounterpartyAgreementAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteCreditSupportAnnexCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteCreditSupportAnnexCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteCreditSupportAnnex. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Credit Support Annex to delete. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The Credit Support Annex to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteCreditSupportAnnexCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/counterparties/creditsupportannexes/{scope}/{code}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteCreditSupportAnnexValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AnnulSingleStructuredDataResponse> deleteCreditSupportAnnexWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteCreditSupportAnnexValidateBeforeCall(scope, code, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] DeleteCreditSupportAnnex: Delete the Credit Support Annex of given scope and code
     * Delete the specified Credit Support Annex from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.                It is important to always check for any unsuccessful response.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Credit Support Annex to delete. (required)
     * @param code The Credit Support Annex to delete. (required)
     * @return ApiResponse&lt;AnnulSingleStructuredDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<AnnulSingleStructuredDataResponse> deleteCreditSupportAnnexWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCreditSupportAnnexValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteCreditSupportAnnexAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCreditSupportAnnexValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteCreditSupportAnnexAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCreditSupportAnnexValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCreditSupportAnnexRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {
            deleteCreditSupportAnnexAsync(scope, code, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AnnulSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCreditSupportAnnexAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getCounterpartyAgreementCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getCounterpartyAgreementCall(scope, code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getCounterpartyAgreement. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Counterparty Agreement to retrieve. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The name of the Counterparty Agreement to retrieve the data for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Counterparty Agreement. Defaults to return the latest version if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getCounterpartyAgreementCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCounterpartyAgreementValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<GetCounterpartyAgreementResponse> getCounterpartyAgreementWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getCounterpartyAgreementValidateBeforeCall(scope, code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetCounterpartyAgreementResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<GetCounterpartyAgreementResponse> getCounterpartyAgreementWithHttpInfo(String scope, String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCounterpartyAgreementValidateBeforeCall(scope, code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<GetCounterpartyAgreementResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getCounterpartyAgreementAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetCounterpartyAgreementResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getCounterpartyAgreementValidateBeforeCall(scope, code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetCounterpartyAgreementResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCounterpartyAgreementAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetCounterpartyAgreementResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCounterpartyAgreementValidateBeforeCall(scope, code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<GetCounterpartyAgreementResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCounterpartyAgreementRequest {
         ...
         */
        public void executeAsync(final ApiCallback<GetCounterpartyAgreementResponse> _callback) throws ApiException {
            getCounterpartyAgreementAsync(scope, code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<GetCounterpartyAgreementResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getCounterpartyAgreementAsync(scope, code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getCreditSupportAnnexCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getCreditSupportAnnexCall(scope, code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getCreditSupportAnnex. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Credit Support Annex to retrieve. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The name of the Credit Support Annex to retrieve the data for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Credit Support Annex . Defaults to return the latest version if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getCreditSupportAnnexCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCreditSupportAnnexValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<GetCreditSupportAnnexResponse> getCreditSupportAnnexWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getCreditSupportAnnexValidateBeforeCall(scope, code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetCreditSupportAnnexResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<GetCreditSupportAnnexResponse> getCreditSupportAnnexWithHttpInfo(String scope, String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCreditSupportAnnexValidateBeforeCall(scope, code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<GetCreditSupportAnnexResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getCreditSupportAnnexAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetCreditSupportAnnexResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getCreditSupportAnnexValidateBeforeCall(scope, code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetCreditSupportAnnexResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCreditSupportAnnexAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetCreditSupportAnnexResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCreditSupportAnnexValidateBeforeCall(scope, code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<GetCreditSupportAnnexResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCreditSupportAnnexRequest {
         ...
         */
        public void executeAsync(final ApiCallback<GetCreditSupportAnnexResponse> _callback) throws ApiException {
            getCreditSupportAnnexAsync(scope, code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<GetCreditSupportAnnexResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getCreditSupportAnnexAsync(scope, code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listCounterpartyAgreementsCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return listCounterpartyAgreementsCall(asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listCounterpartyAgreements. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the Counterparty Agreements. Defaults to latest if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listCounterpartyAgreementsCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/counterparties/counterpartyagreements";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listCounterpartyAgreementsValidateBeforeCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfGetCounterpartyAgreementResponse> listCounterpartyAgreementsWithHttpInfo(OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = listCounterpartyAgreementsValidateBeforeCall(asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfGetCounterpartyAgreementResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListCounterpartyAgreements: List the set of Counterparty Agreements
     * List the set of Counterparty Agreements at the specified AsAt date/timeUse any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to list the Counterparty Agreements. Defaults to latest if not specified. (optional)
     * @return ApiResponse&lt;ResourceListOfGetCounterpartyAgreementResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfGetCounterpartyAgreementResponse> listCounterpartyAgreementsWithHttpInfo(OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listCounterpartyAgreementsValidateBeforeCall(asAt, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfGetCounterpartyAgreementResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listCounterpartyAgreementsAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetCounterpartyAgreementResponse> _callback) throws ApiException {

        HttpRequest localVarCall = listCounterpartyAgreementsValidateBeforeCall(asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfGetCounterpartyAgreementResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listCounterpartyAgreementsAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetCounterpartyAgreementResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listCounterpartyAgreementsValidateBeforeCall(asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfGetCounterpartyAgreementResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistCounterpartyAgreementsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfGetCounterpartyAgreementResponse> _callback) throws ApiException {
            listCounterpartyAgreementsAsync(asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfGetCounterpartyAgreementResponse> _callback, ConfigurationOptions opts) throws ApiException {
            listCounterpartyAgreementsAsync(asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listCreditSupportAnnexesCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return listCreditSupportAnnexesCall(asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listCreditSupportAnnexes. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the Credit Support Annexes. Defaults to latest if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listCreditSupportAnnexesCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/counterparties/creditsupportannexes";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listCreditSupportAnnexesValidateBeforeCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfGetCreditSupportAnnexResponse> listCreditSupportAnnexesWithHttpInfo(OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = listCreditSupportAnnexesValidateBeforeCall(asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfGetCreditSupportAnnexResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListCreditSupportAnnexes: List the set of Credit Support Annexes
     * List the set of Credit Support Annexes at the specified AsAt date/timeUse any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to list the Credit Support Annexes. Defaults to latest if not specified. (optional)
     * @return ApiResponse&lt;ResourceListOfGetCreditSupportAnnexResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfGetCreditSupportAnnexResponse> listCreditSupportAnnexesWithHttpInfo(OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listCreditSupportAnnexesValidateBeforeCall(asAt, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfGetCreditSupportAnnexResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listCreditSupportAnnexesAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetCreditSupportAnnexResponse> _callback) throws ApiException {

        HttpRequest localVarCall = listCreditSupportAnnexesValidateBeforeCall(asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfGetCreditSupportAnnexResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listCreditSupportAnnexesAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetCreditSupportAnnexResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listCreditSupportAnnexesValidateBeforeCall(asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfGetCreditSupportAnnexResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistCreditSupportAnnexesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfGetCreditSupportAnnexResponse> _callback) throws ApiException {
            listCreditSupportAnnexesAsync(asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfGetCreditSupportAnnexResponse> _callback, ConfigurationOptions opts) throws ApiException {
            listCreditSupportAnnexesAsync(asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertCounterpartyAgreementCall(UpsertCounterpartyAgreementRequest upsertCounterpartyAgreementRequest, final ApiCallback _callback) throws ApiException {
        return upsertCounterpartyAgreementCall(upsertCounterpartyAgreementRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertCounterpartyAgreement. Use any specified configuration options to override any other configuration for this request only.
     * @param upsertCounterpartyAgreementRequest The Counterparty Agreement to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertCounterpartyAgreementCall(UpsertCounterpartyAgreementRequest upsertCounterpartyAgreementRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertCounterpartyAgreementValidateBeforeCall(UpsertCounterpartyAgreementRequest upsertCounterpartyAgreementRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertCounterpartyAgreementWithHttpInfo(UpsertCounterpartyAgreementRequest upsertCounterpartyAgreementRequest) throws ApiException {
        HttpRequest localVarCall = upsertCounterpartyAgreementValidateBeforeCall(upsertCounterpartyAgreementRequest, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] UpsertCounterpartyAgreement: Upsert Counterparty Agreement
     * Update or insert Counterparty Agreement in a single scope. An item will be updated if it already exists and inserted if it does not.                The response will return the successfully updated or inserted Counterparty Agreement or failure message if unsuccessful                It is important to always check to verify success (or failure).Use any specified configuration options to override any other configuration for this request only
     * @param upsertCounterpartyAgreementRequest The Counterparty Agreement to update or insert (required)
     * @return ApiResponse&lt;UpsertSingleStructuredDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertCounterpartyAgreementWithHttpInfo(UpsertCounterpartyAgreementRequest upsertCounterpartyAgreementRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertCounterpartyAgreementValidateBeforeCall(upsertCounterpartyAgreementRequest, null, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertCounterpartyAgreementAsync(UpsertCounterpartyAgreementRequest upsertCounterpartyAgreementRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertCounterpartyAgreementValidateBeforeCall(upsertCounterpartyAgreementRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertCounterpartyAgreementAsync(UpsertCounterpartyAgreementRequest upsertCounterpartyAgreementRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertCounterpartyAgreementValidateBeforeCall(upsertCounterpartyAgreementRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertCounterpartyAgreementRequest {
        ...
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {
            upsertCounterpartyAgreementAsync(upsertCounterpartyAgreementRequest, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertCounterpartyAgreementAsync(upsertCounterpartyAgreementRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertCreditSupportAnnexCall(UpsertCreditSupportAnnexRequest upsertCreditSupportAnnexRequest, final ApiCallback _callback) throws ApiException {
        return upsertCreditSupportAnnexCall(upsertCreditSupportAnnexRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertCreditSupportAnnex. Use any specified configuration options to override any other configuration for this request only.
     * @param upsertCreditSupportAnnexRequest The Credit Support Annex to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertCreditSupportAnnexCall(UpsertCreditSupportAnnexRequest upsertCreditSupportAnnexRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertCreditSupportAnnexValidateBeforeCall(UpsertCreditSupportAnnexRequest upsertCreditSupportAnnexRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertCreditSupportAnnexWithHttpInfo(UpsertCreditSupportAnnexRequest upsertCreditSupportAnnexRequest) throws ApiException {
        HttpRequest localVarCall = upsertCreditSupportAnnexValidateBeforeCall(upsertCreditSupportAnnexRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpsertCreditSupportAnnex: Upsert Credit Support Annex
     * Update or insert Credit Support Annex in a single scope. An item will be updated if it already exists and inserted if it does not.                The response will return the successfully updated or inserted Credit Support Annex or failure message if unsuccessful                It is important to always check to verify success (or failure).Use any specified configuration options to override any other configuration for this request only
     * @param upsertCreditSupportAnnexRequest The Credit Support Annex to update or insert (required)
     * @return ApiResponse&lt;UpsertSingleStructuredDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertCreditSupportAnnexWithHttpInfo(UpsertCreditSupportAnnexRequest upsertCreditSupportAnnexRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertCreditSupportAnnexValidateBeforeCall(upsertCreditSupportAnnexRequest, null, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertCreditSupportAnnexAsync(UpsertCreditSupportAnnexRequest upsertCreditSupportAnnexRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertCreditSupportAnnexValidateBeforeCall(upsertCreditSupportAnnexRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertCreditSupportAnnexAsync(UpsertCreditSupportAnnexRequest upsertCreditSupportAnnexRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertCreditSupportAnnexValidateBeforeCall(upsertCreditSupportAnnexRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertCreditSupportAnnexRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {
            upsertCreditSupportAnnexAsync(upsertCreditSupportAnnexRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertCreditSupportAnnexAsync(upsertCreditSupportAnnexRequest, _callback, opts);
        }
    }
