...
public class OrdersApi {
     ...
     */
    private HttpRequest deleteOrderCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteOrderCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteOrder. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The order scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The order&#39;s code. This, together with the scope uniquely identifies the order to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteOrderCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/orders/{scope}/{code}"
    ...
    private HttpRequest deleteOrderValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteOrderWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteOrderValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] DeleteOrder: Delete order
     * Delete an order. Deletion will be valid from the order&#39;s creation datetime.  This means that the order will no longer exist at any effective datetime from the asAt datetime of deletion.Use any specified configuration options to override any other configuration for this request only
     * @param scope The order scope. (required)
     * @param code The order&#39;s code. This, together with the scope uniquely identifies the order to delete. (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deleteOrderWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteOrderValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteOrderAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteOrderValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
     ...
     */
    private void deleteOrderAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteOrderValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteOrderRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteOrderAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteOrderAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getOrderCall(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return getOrderCall(scope, code, asAt, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getOrder. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope to which the order belongs. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The order&#39;s unique identifier. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the order. Defaults to return the latest version of the order if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the \&quot;Orders\&quot; domain to decorate onto the order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getOrderCall(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getOrderValidateBeforeCall(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Order> getOrderWithHttpInfo(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = getOrderValidateBeforeCall(scope, code, asAt, propertyKeys, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] GetOrder: Get Order
     * Fetch an Order that matches the specified identifier.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope to which the order belongs. (required)
     * @param code The order&#39;s unique identifier. (required)
     * @param asAt The asAt datetime at which to retrieve the order. Defaults to return the latest version of the order if not specified. (optional)
     * @param propertyKeys A list of property keys from the \&quot;Orders\&quot; domain to decorate onto the order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)
    ...
    private ApiResponse<Order> getOrderWithHttpInfo(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getOrderValidateBeforeCall(scope, code, asAt, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<Order>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getOrderAsync(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Order> _callback) throws ApiException {

        HttpRequest localVarCall = getOrderValidateBeforeCall(scope, code, asAt, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Order>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getOrderAsync(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Order> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getOrderValidateBeforeCall(scope, code, asAt, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<Order>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetOrderRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Order> _callback) throws ApiException {
            getOrderAsync(scope, code, asAt, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Order> _callback, ConfigurationOptions opts) throws ApiException {
            getOrderAsync(scope, code, asAt, propertyKeys, _callback, opts);
        }
    }
    ...
    /**
     * Build call for listOrders. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the order. Defaults to return the latest version of the order if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
    ...
    private HttpRequest listOrdersCall(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, String dataModelScope, String dataModelCode, String membershipType, Boolean getDerivedComplianceStatuses, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/api/orders";
    ...
    /**
     * ListOrders: List Orders
     * Fetch the last pre-AsAt date version of each order with optional filtering (does not fetch the entire history).Use any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to retrieve the order. Defaults to return the latest version of the order if not specified. (optional)
     * @param page The pagination token to use to continue listing orders from a previous call to list orders.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request. (optional)
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
    ...
    /**
     * ListOrders: List Orders (asynchronously)
     * Fetch the last pre-AsAt date version of each order with optional filtering (does not fetch the entire history).
     * @param asAt The asAt datetime at which to retrieve the order. Defaults to return the latest version of the order if not specified. (optional)
     * @param page The pagination token to use to continue listing orders from a previous call to list orders.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request. (optional)
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;. (optional)
     ...
     */
    private HttpRequest upsertOrdersCall(OrderSetRequest orderSetRequest, String dataModelScope, String dataModelCode, final ApiCallback _callback) throws ApiException {
        return upsertOrdersCall(orderSetRequest, dataModelScope, dataModelCode,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertOrders. Use any specified configuration options to override any other configuration for this request only.
     * @param orderSetRequest The collection of order requests. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param dataModelScope The optional scope of a Custom Data Model to use (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param dataModelCode The optional code of a Custom Data Model to use (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest upsertOrdersCall(OrderSetRequest orderSetRequest, String dataModelScope, String dataModelCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertOrdersValidateBeforeCall(OrderSetRequest orderSetRequest, String dataModelScope, String dataModelCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfOrder> upsertOrdersWithHttpInfo(OrderSetRequest orderSetRequest, String dataModelScope, String dataModelCode) throws ApiException {
        HttpRequest localVarCall = upsertOrdersValidateBeforeCall(orderSetRequest, dataModelScope, dataModelCode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfOrder>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpsertOrders: Upsert Order
     * Upsert; update existing orders with given ids, or create new orders otherwise.Use any specified configuration options to override any other configuration for this request only
     * @param orderSetRequest The collection of order requests. (required)
     * @param dataModelScope The optional scope of a Custom Data Model to use (optional)
     * @param dataModelCode The optional code of a Custom Data Model to use (optional)
     * @return ApiResponse&lt;ResourceListOfOrder&gt;
    ...
    private ApiResponse<ResourceListOfOrder> upsertOrdersWithHttpInfo(OrderSetRequest orderSetRequest, String dataModelScope, String dataModelCode, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertOrdersValidateBeforeCall(orderSetRequest, dataModelScope, dataModelCode, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfOrder>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpsertOrders: Upsert Order (asynchronously)
     * Upsert; update existing orders with given ids, or create new orders otherwise.
     * @param orderSetRequest The collection of order requests. (required)
     * @param dataModelScope The optional scope of a Custom Data Model to use (optional)
     * @param dataModelCode The optional code of a Custom Data Model to use (optional)
     ...
     */
    private void upsertOrdersAsync(OrderSetRequest orderSetRequest, String dataModelScope, String dataModelCode, final ApiCallback<ResourceListOfOrder> _callback) throws ApiException {

        HttpRequest localVarCall = upsertOrdersValidateBeforeCall(orderSetRequest, dataModelScope, dataModelCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfOrder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertOrdersAsync(OrderSetRequest orderSetRequest, String dataModelScope, String dataModelCode, final ApiCallback<ResourceListOfOrder> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertOrdersValidateBeforeCall(orderSetRequest, dataModelScope, dataModelCode, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfOrder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertOrdersRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfOrder> _callback) throws ApiException {
            upsertOrdersAsync(orderSetRequest, dataModelScope, dataModelCode, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfOrder> _callback, ConfigurationOptions opts) throws ApiException {
            upsertOrdersAsync(orderSetRequest, dataModelScope, dataModelCode, _callback, opts);
        }
    }
