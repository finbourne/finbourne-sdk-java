 ...
 */
@JsonPropertyOrder({
  PropertySchema.JSON_PROPERTY_HREF,
  PropertySchema.JSON_PROPERTY_VALUES,
  PropertySchema.JSON_PROPERTY_LINKS
})
...
public class PropertySchema {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to PropertySchema
   */
  public static PropertySchema fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, PropertySchema.class);
  }
