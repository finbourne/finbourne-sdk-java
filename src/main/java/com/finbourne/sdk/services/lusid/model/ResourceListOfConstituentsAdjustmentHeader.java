 ...
 */
@JsonPropertyOrder({
  ResourceListOfConstituentsAdjustmentHeader.JSON_PROPERTY_VALUES,
  ResourceListOfConstituentsAdjustmentHeader.JSON_PROPERTY_HREF,
  ResourceListOfConstituentsAdjustmentHeader.JSON_PROPERTY_LINKS,
  ResourceListOfConstituentsAdjustmentHeader.JSON_PROPERTY_NEXT_PAGE,
  ResourceListOfConstituentsAdjustmentHeader.JSON_PROPERTY_PREVIOUS_PAGE
})
...
public class ResourceListOfConstituentsAdjustmentHeader {
  ...
  public ResourceListOfConstituentsAdjustmentHeader href(URI href) {
    this.href = href;
    return this;
  }
  ...
  public ResourceListOfConstituentsAdjustmentHeader nextPage(String nextPage) {
  ...
  public ResourceListOfConstituentsAdjustmentHeader previousPage(String previousPage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.values, resourceListOfConstituentsAdjustmentHeader.values) &&
        ...
        Objects.equals(this.nextPage, resourceListOfConstituentsAdjustmentHeader.nextPage) &&
        Objects.equals(this.previousPage, resourceListOfConstituentsAdjustmentHeader.previousPage);
  }
 ...
 public int hashCode() {
  ...
  /**
   * Create an instance of ResourceListOfConstituentsAdjustmentHeader given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceListOfConstituentsAdjustmentHeader
   * @throws java.io.IOException if the JSON string is invalid with respect to ResourceListOfConstituentsAdjustmentHeader
   */
  public static ResourceListOfConstituentsAdjustmentHeader fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ResourceListOfConstituentsAdjustmentHeader.class);
  }

  /**
   * Convert an instance of ResourceListOfConstituentsAdjustmentHeader to an JSON string
   *
   * @return JSON string
   */
