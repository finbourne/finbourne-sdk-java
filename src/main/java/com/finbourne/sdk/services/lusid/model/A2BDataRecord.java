 ...
 */
@JsonPropertyOrder({
  A2BDataRecord.JSON_PROPERTY_PORTFOLIO_ID,
  A2BDataRecord.JSON_PROPERTY_HOLDING_TYPE,
  A2BDataRecord.JSON_PROPERTY_INSTRUMENT_SCOPE,
  A2BDataRecord.JSON_PROPERTY_INSTRUMENT_UID,
  A2BDataRecord.JSON_PROPERTY_SUB_HOLDING_KEYS,
  A2BDataRecord.JSON_PROPERTY_CURRENCY,
  A2BDataRecord.JSON_PROPERTY_TRANSACTION_ID,
  A2BDataRecord.JSON_PROPERTY_START,
  A2BDataRecord.JSON_PROPERTY_FLOWS,
  A2BDataRecord.JSON_PROPERTY_GAINS,
  A2BDataRecord.JSON_PROPERTY_CARRY,
  A2BDataRecord.JSON_PROPERTY_END,
  A2BDataRecord.JSON_PROPERTY_PROPERTIES,
  A2BDataRecord.JSON_PROPERTY_GROUP_ID,
  A2BDataRecord.JSON_PROPERTY_ERRORS
})
...
public class A2BDataRecord {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to A2BDataRecord
   */
  public static A2BDataRecord fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, A2BDataRecord.class);
  }
