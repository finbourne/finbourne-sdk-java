 ...
 */
@JsonPropertyOrder({
  AdjustHoldingRequest.JSON_PROPERTY_INSTRUMENT_IDENTIFIERS,
  AdjustHoldingRequest.JSON_PROPERTY_SUB_HOLDING_KEYS,
  AdjustHoldingRequest.JSON_PROPERTY_PROPERTIES,
  AdjustHoldingRequest.JSON_PROPERTY_TAX_LOTS,
  AdjustHoldingRequest.JSON_PROPERTY_CURRENCY,
  AdjustHoldingRequest.JSON_PROPERTY_CUSTODIAN_ACCOUNT_ID
})
...
public class AdjustHoldingRequest {
  ...
  public AdjustHoldingRequest custodianAccountId(ResourceId custodianAccountId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instrumentIdentifiers, adjustHoldingRequest.instrumentIdentifiers) &&
        ...
        Objects.equals(this.custodianAccountId, adjustHoldingRequest.custodianAccountId);
  }
  ...
  @Override
 public int hashCode() {
    return Objects.hash(instrumentIdentifiers, subHoldingKeys, properties, taxLots, currency, custodianAccountId);
  }
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to AdjustHoldingRequest
   */
  public static AdjustHoldingRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, AdjustHoldingRequest.class);
  }
