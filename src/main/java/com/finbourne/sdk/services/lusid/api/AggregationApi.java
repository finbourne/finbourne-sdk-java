...
public class AggregationApi {
     ...
     */
    private HttpRequest generateConfigurationRecipeCall(String scope, String code, CreateRecipeRequest createRecipeRequest, final ApiCallback _callback) throws ApiException {
        return generateConfigurationRecipeCall(scope, code, createRecipeRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for generateConfigurationRecipe. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest generateConfigurationRecipeCall(String scope, String code, CreateRecipeRequest createRecipeRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/aggregation/{scope}/{code}/$generateconfigurationrecipe"
    ...
    private HttpRequest generateConfigurationRecipeValidateBeforeCall(String scope, String code, CreateRecipeRequest createRecipeRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ConfigurationRecipe> generateConfigurationRecipeWithHttpInfo(String scope, String code, CreateRecipeRequest createRecipeRequest) throws ApiException {
        HttpRequest localVarCall = generateConfigurationRecipeValidateBeforeCall(scope, code, createRecipeRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ConfigurationRecipe>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GenerateConfigurationRecipe: Generates a recipe sufficient to perform valuations for the given portfolio.
     * Given a set of scopes, a portfolio Id and a basic recipe, this endpoint generates a configuration recipe with relevant rules that can value the instruments in the portfolio.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the portfolio (required)
     * @param code The code of the portfolio (required)
     * @param createRecipeRequest The request specifying the parameters to generating the recipe (optional)
     * @return ApiResponse&lt;ConfigurationRecipe&gt;
    ...
    private ApiResponse<ConfigurationRecipe> generateConfigurationRecipeWithHttpInfo(String scope, String code, CreateRecipeRequest createRecipeRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = generateConfigurationRecipeValidateBeforeCall(scope, code, createRecipeRequest, null, opts);
        Type localVarReturnType = new TypeReference<ConfigurationRecipe>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void generateConfigurationRecipeAsync(String scope, String code, CreateRecipeRequest createRecipeRequest, final ApiCallback<ConfigurationRecipe> _callback) throws ApiException {

        HttpRequest localVarCall = generateConfigurationRecipeValidateBeforeCall(scope, code, createRecipeRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ConfigurationRecipe>(){}.getType();
     ...
     */
    private void generateConfigurationRecipeAsync(String scope, String code, CreateRecipeRequest createRecipeRequest, final ApiCallback<ConfigurationRecipe> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = generateConfigurationRecipeValidateBeforeCall(scope, code, createRecipeRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ConfigurationRecipe>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgenerateConfigurationRecipeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ConfigurationRecipe> _callback) throws ApiException {
            generateConfigurationRecipeAsync(scope, code, createRecipeRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ConfigurationRecipe> _callback, ConfigurationOptions opts) throws ApiException {
            generateConfigurationRecipeAsync(scope, code, createRecipeRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getQueryableKeysCall(String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        return getQueryableKeysCall(page, limit, filter,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getQueryableKeys. Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing queryable keys from a previous call to list queryable keys.              This value is returned from the previous call. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getQueryableKeysCall(String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/results/queryable/keys";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getQueryableKeysValidateBeforeCall(String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfAggregationQuery> getQueryableKeysWithHttpInfo(String page, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = getQueryableKeysValidateBeforeCall(page, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfAggregationQuery>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetQueryableKeys: Query the set of supported \&quot;addresses\&quot; that can be queried from the aggregation endpoint.
     * When a request is made for aggregation, the user needs to know what keys can be passed to it for queryable data. This endpoint allows to queries to provide the set of keys,  what they are and what they return.Use any specified configuration options to override any other configuration for this request only
     * @param page The pagination token to use to continue listing queryable keys from a previous call to list queryable keys.              This value is returned from the previous call. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set.              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @return ApiResponse&lt;ResourceListOfAggregationQuery&gt;
    ...
    private ApiResponse<ResourceListOfAggregationQuery> getQueryableKeysWithHttpInfo(String page, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getQueryableKeysValidateBeforeCall(page, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfAggregationQuery>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetQueryableKeys: Query the set of supported \&quot;addresses\&quot; that can be queried from the aggregation endpoint. (asynchronously)
     * When a request is made for aggregation, the user needs to know what keys can be passed to it for queryable data. This endpoint allows to queries to provide the set of keys,  what they are and what they return.
     * @param page The pagination token to use to continue listing queryable keys from a previous call to list queryable keys.              This value is returned from the previous call. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set.              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     ...
     */
    private void getQueryableKeysAsync(String page, Integer limit, String filter, final ApiCallback<ResourceListOfAggregationQuery> _callback) throws ApiException {

        HttpRequest localVarCall = getQueryableKeysValidateBeforeCall(page, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfAggregationQuery>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getQueryableKeysAsync(String page, Integer limit, String filter, final ApiCallback<ResourceListOfAggregationQuery> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getQueryableKeysValidateBeforeCall(page, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfAggregationQuery>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetQueryableKeysRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfAggregationQuery> _callback) throws ApiException {
            getQueryableKeysAsync(page, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfAggregationQuery> _callback, ConfigurationOptions opts) throws ApiException {
            getQueryableKeysAsync(page, limit, filter, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getValuationCall(ValuationRequest valuationRequest, final ApiCallback _callback) throws ApiException {
        return getValuationCall(valuationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getValuation. Use any specified configuration options to override any other configuration for this request only.
     * @param valuationRequest The request specifying the set of portfolios and dates on which to calculate a set of valuation metrics (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getValuationCall(ValuationRequest valuationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/aggregation/$valuation";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getValuationValidateBeforeCall(ValuationRequest valuationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ListAggregationResponse> getValuationWithHttpInfo(ValuationRequest valuationRequest) throws ApiException {
        HttpRequest localVarCall = getValuationValidateBeforeCall(valuationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ListAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetValuation: Perform valuation for a list of portfolios and/or portfolio groups
     * Perform valuation on specified list of portfolio and/or portfolio groups for a set of dates.Use any specified configuration options to override any other configuration for this request only
     * @param valuationRequest The request specifying the set of portfolios and dates on which to calculate a set of valuation metrics (optional)
     * @return ApiResponse&lt;ListAggregationResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ListAggregationResponse> getValuationWithHttpInfo(ValuationRequest valuationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getValuationValidateBeforeCall(valuationRequest, null, opts);
        Type localVarReturnType = new TypeReference<ListAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getValuationAsync(ValuationRequest valuationRequest, final ApiCallback<ListAggregationResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getValuationValidateBeforeCall(valuationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ListAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getValuationAsync(ValuationRequest valuationRequest, final ApiCallback<ListAggregationResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getValuationValidateBeforeCall(valuationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ListAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetValuationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ListAggregationResponse> _callback) throws ApiException {
            getValuationAsync(valuationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ListAggregationResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getValuationAsync(valuationRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getValuationOfWeightedInstrumentsCall(InlineValuationRequest inlineValuationRequest, final ApiCallback _callback) throws ApiException {
        return getValuationOfWeightedInstrumentsCall(inlineValuationRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getValuationOfWeightedInstruments. Use any specified configuration options to override any other configuration for this request only.
     * @param inlineValuationRequest The request specifying the set of portfolios and dates on which to calculate a set of valuation metrics (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getValuationOfWeightedInstrumentsCall(InlineValuationRequest inlineValuationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/aggregation/$valuationinlined";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getValuationOfWeightedInstrumentsValidateBeforeCall(InlineValuationRequest inlineValuationRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ListAggregationResponse> getValuationOfWeightedInstrumentsWithHttpInfo(InlineValuationRequest inlineValuationRequest) throws ApiException {
        HttpRequest localVarCall = getValuationOfWeightedInstrumentsValidateBeforeCall(inlineValuationRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ListAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * GetValuationOfWeightedInstruments: Perform valuation for an inlined portfolio
     * Perform valuation on the portfolio that is defined by the weighted set of instruments passed to the request.Use any specified configuration options to override any other configuration for this request only
     * @param inlineValuationRequest The request specifying the set of portfolios and dates on which to calculate a set of valuation metrics (optional)
     * @return ApiResponse&lt;ListAggregationResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ListAggregationResponse> getValuationOfWeightedInstrumentsWithHttpInfo(InlineValuationRequest inlineValuationRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getValuationOfWeightedInstrumentsValidateBeforeCall(inlineValuationRequest, null, opts);
        Type localVarReturnType = new TypeReference<ListAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getValuationOfWeightedInstrumentsAsync(InlineValuationRequest inlineValuationRequest, final ApiCallback<ListAggregationResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getValuationOfWeightedInstrumentsValidateBeforeCall(inlineValuationRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ListAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getValuationOfWeightedInstrumentsAsync(InlineValuationRequest inlineValuationRequest, final ApiCallback<ListAggregationResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getValuationOfWeightedInstrumentsValidateBeforeCall(inlineValuationRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ListAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetValuationOfWeightedInstrumentsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ListAggregationResponse> _callback) throws ApiException {
            getValuationOfWeightedInstrumentsAsync(inlineValuationRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ListAggregationResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getValuationOfWeightedInstrumentsAsync(inlineValuationRequest, _callback, opts);
        }
    }
