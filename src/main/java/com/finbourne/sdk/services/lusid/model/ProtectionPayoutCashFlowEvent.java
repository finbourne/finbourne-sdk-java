 ...
 */
@JsonPropertyOrder({
  ProtectionPayoutCashFlowEvent.JSON_PROPERTY_EX_DATE,
  ProtectionPayoutCashFlowEvent.JSON_PROPERTY_PAYMENT_DATE,
  ProtectionPayoutCashFlowEvent.JSON_PROPERTY_CURRENCY,
  ProtectionPayoutCashFlowEvent.JSON_PROPERTY_CASH_FLOW_PER_UNIT
})
...
public class ProtectionPayoutCashFlowEvent extends InstrumentEvent {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ProtectionPayoutCashFlowEvent
   */
  public static ProtectionPayoutCashFlowEvent fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ProtectionPayoutCashFlowEvent.class);
  }
