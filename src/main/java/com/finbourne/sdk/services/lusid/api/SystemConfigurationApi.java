...
public class SystemConfigurationApi {
     ...
     */
    private HttpRequest createConfigurationTransactionTypeCall(TransactionConfigurationDataRequest transactionConfigurationDataRequest, final ApiCallback _callback) throws ApiException {
        return createConfigurationTransactionTypeCall(transactionConfigurationDataRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createConfigurationTransactionType. Use any specified configuration options to override any other configuration for this request only.
     * @param transactionConfigurationDataRequest A transaction type definition. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createConfigurationTransactionTypeCall(TransactionConfigurationDataRequest transactionConfigurationDataRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/systemconfiguration/transactions/type";
    ...
    private HttpRequest createConfigurationTransactionTypeValidateBeforeCall(TransactionConfigurationDataRequest transactionConfigurationDataRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TransactionSetConfigurationData> createConfigurationTransactionTypeWithHttpInfo(TransactionConfigurationDataRequest transactionConfigurationDataRequest) throws ApiException {
        HttpRequest localVarCall = createConfigurationTransactionTypeValidateBeforeCall(transactionConfigurationDataRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CreateConfigurationTransactionType: Create transaction type
     * Create a new transaction type by specifying a definition and mappings to movements.Use any specified configuration options to override any other configuration for this request only
     * @param transactionConfigurationDataRequest A transaction type definition. (optional)
     * @return ApiResponse&lt;TransactionSetConfigurationData&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<TransactionSetConfigurationData> createConfigurationTransactionTypeWithHttpInfo(TransactionConfigurationDataRequest transactionConfigurationDataRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createConfigurationTransactionTypeValidateBeforeCall(transactionConfigurationDataRequest, null, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createConfigurationTransactionTypeAsync(TransactionConfigurationDataRequest transactionConfigurationDataRequest, final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {

        HttpRequest localVarCall = createConfigurationTransactionTypeValidateBeforeCall(transactionConfigurationDataRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
     ...
     */
    private void createConfigurationTransactionTypeAsync(TransactionConfigurationDataRequest transactionConfigurationDataRequest, final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createConfigurationTransactionTypeValidateBeforeCall(transactionConfigurationDataRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateConfigurationTransactionTypeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {
            createConfigurationTransactionTypeAsync(transactionConfigurationDataRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {
            createConfigurationTransactionTypeAsync(transactionConfigurationDataRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest createSideDefinitionCall(SideConfigurationDataRequest sideConfigurationDataRequest, final ApiCallback _callback) throws ApiException {
        return createSideDefinitionCall(sideConfigurationDataRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createSideDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param sideConfigurationDataRequest The definition of the side. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createSideDefinitionCall(SideConfigurationDataRequest sideConfigurationDataRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/systemconfiguration/transactions/side";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest createSideDefinitionValidateBeforeCall(SideConfigurationDataRequest sideConfigurationDataRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TransactionSetConfigurationData> createSideDefinitionWithHttpInfo(SideConfigurationDataRequest sideConfigurationDataRequest) throws ApiException {
        HttpRequest localVarCall = createSideDefinitionValidateBeforeCall(sideConfigurationDataRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<TransactionSetConfigurationData> createSideDefinitionWithHttpInfo(SideConfigurationDataRequest sideConfigurationDataRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createSideDefinitionValidateBeforeCall(sideConfigurationDataRequest, null, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createSideDefinitionAsync(SideConfigurationDataRequest sideConfigurationDataRequest, final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {

        HttpRequest localVarCall = createSideDefinitionValidateBeforeCall(sideConfigurationDataRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void createSideDefinitionAsync(SideConfigurationDataRequest sideConfigurationDataRequest, final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createSideDefinitionValidateBeforeCall(sideConfigurationDataRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateSideDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {
            createSideDefinitionAsync(sideConfigurationDataRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {
            createSideDefinitionAsync(sideConfigurationDataRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteTransactionConfigurationSourceCall(String source, final ApiCallback _callback) throws ApiException {
        return deleteTransactionConfigurationSourceCall(source,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteTransactionConfigurationSource. Use any specified configuration options to override any other configuration for this request only.
     * @param source The source to delete transaction configurations for (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteTransactionConfigurationSourceCall(String source, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/systemconfiguration/transactions/type/{source}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteTransactionConfigurationSourceValidateBeforeCall(String source, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteTransactionConfigurationSourceWithHttpInfo(String source) throws ApiException {
        HttpRequest localVarCall = deleteTransactionConfigurationSourceValidateBeforeCall(source, null, new ConfigurationOptions());
    ...
    private ApiResponse<DeletedEntityResponse> deleteTransactionConfigurationSourceWithHttpInfo(String source, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteTransactionConfigurationSourceValidateBeforeCall(source, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteTransactionConfigurationSourceAsync(String source, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteTransactionConfigurationSourceValidateBeforeCall(source, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteTransactionConfigurationSourceAsync(String source, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteTransactionConfigurationSourceValidateBeforeCall(source, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteTransactionConfigurationSourceRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteTransactionConfigurationSourceAsync(source, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteTransactionConfigurationSourceAsync(source, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getTransactionConfigurationSourceCall(String source, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getTransactionConfigurationSourceCall(source, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getTransactionConfigurationSource. Use any specified configuration options to override any other configuration for this request only.
     * @param source The source for which to retrieve transaction configurations (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the transaction configurations.              Defaults to returning the latest version of the transaction configurations if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getTransactionConfigurationSourceCall(String source, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getTransactionConfigurationSourceValidateBeforeCall(String source, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'source' is set
        if (source == null) {
    ...
    private ApiResponse<TransactionSetConfigurationData> getTransactionConfigurationSourceWithHttpInfo(String source, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getTransactionConfigurationSourceValidateBeforeCall(source, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EXPERIMENTAL] GetTransactionConfigurationSource: Get all transaction configurations for a source
     * Returns failure if requested source is not foundUse any specified configuration options to override any other configuration for this request only
     * @param source The source for which to retrieve transaction configurations (required)
     * @param asAt The asAt datetime at which to retrieve the transaction configurations.              Defaults to returning the latest version of the transaction configurations if not specified. (optional)
     * @return ApiResponse&lt;TransactionSetConfigurationData&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<TransactionSetConfigurationData> getTransactionConfigurationSourceWithHttpInfo(String source, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getTransactionConfigurationSourceValidateBeforeCall(source, asAt, null, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getTransactionConfigurationSourceAsync(String source, OffsetDateTime asAt, final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {

        HttpRequest localVarCall = getTransactionConfigurationSourceValidateBeforeCall(source, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getTransactionConfigurationSourceAsync(String source, OffsetDateTime asAt, final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getTransactionConfigurationSourceValidateBeforeCall(source, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetTransactionConfigurationSourceRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {
            getTransactionConfigurationSourceAsync(source, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {
            getTransactionConfigurationSourceAsync(source, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listConfigurationTransactionTypesCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return listConfigurationTransactionTypesCall(asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listConfigurationTransactionTypes. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the transaction types. Defaults              to returning the latest versions if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listConfigurationTransactionTypesCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/systemconfiguration/transactions";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listConfigurationTransactionTypesValidateBeforeCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TransactionSetConfigurationData> listConfigurationTransactionTypesWithHttpInfo(OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = listConfigurationTransactionTypesValidateBeforeCall(asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<TransactionSetConfigurationData> listConfigurationTransactionTypesWithHttpInfo(OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listConfigurationTransactionTypesValidateBeforeCall(asAt, null, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listConfigurationTransactionTypesAsync(OffsetDateTime asAt, final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {

        HttpRequest localVarCall = listConfigurationTransactionTypesValidateBeforeCall(asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listConfigurationTransactionTypesAsync(OffsetDateTime asAt, final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listConfigurationTransactionTypesValidateBeforeCall(asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistConfigurationTransactionTypesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {
            listConfigurationTransactionTypesAsync(asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {
            listConfigurationTransactionTypesAsync(asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest setConfigurationTransactionTypesCall(TransactionSetConfigurationDataRequest transactionSetConfigurationDataRequest, final ApiCallback _callback) throws ApiException {
        return setConfigurationTransactionTypesCall(transactionSetConfigurationDataRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for setConfigurationTransactionTypes. Use any specified configuration options to override any other configuration for this request only.
     * @param transactionSetConfigurationDataRequest The complete set of transaction type definitions. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest setConfigurationTransactionTypesCall(TransactionSetConfigurationDataRequest transactionSetConfigurationDataRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest setConfigurationTransactionTypesValidateBeforeCall(TransactionSetConfigurationDataRequest transactionSetConfigurationDataRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TransactionSetConfigurationData> setConfigurationTransactionTypesWithHttpInfo(TransactionSetConfigurationDataRequest transactionSetConfigurationDataRequest) throws ApiException {
        HttpRequest localVarCall = setConfigurationTransactionTypesValidateBeforeCall(transactionSetConfigurationDataRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<TransactionSetConfigurationData> setConfigurationTransactionTypesWithHttpInfo(TransactionSetConfigurationDataRequest transactionSetConfigurationDataRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = setConfigurationTransactionTypesValidateBeforeCall(transactionSetConfigurationDataRequest, null, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void setConfigurationTransactionTypesAsync(TransactionSetConfigurationDataRequest transactionSetConfigurationDataRequest, final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {

        HttpRequest localVarCall = setConfigurationTransactionTypesValidateBeforeCall(transactionSetConfigurationDataRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void setConfigurationTransactionTypesAsync(TransactionSetConfigurationDataRequest transactionSetConfigurationDataRequest, final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = setConfigurationTransactionTypesValidateBeforeCall(transactionSetConfigurationDataRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIsetConfigurationTransactionTypesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {
            setConfigurationTransactionTypesAsync(transactionSetConfigurationDataRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {
            setConfigurationTransactionTypesAsync(transactionSetConfigurationDataRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest setTransactionConfigurationSourceCall(String source, List<SetTransactionConfigurationSourceRequest> setTransactionConfigurationSourceRequest, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for setTransactionConfigurationSource. Use any specified configuration options to override any other configuration for this request only.
     * @param source The source to set the transaction configurations for (required). Use any specified configuration options to override any other configuration for this request only.
     * @param setTransactionConfigurationSourceRequest The set of transaction configurations (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest setTransactionConfigurationSourceCall(String source, List<SetTransactionConfigurationSourceRequest> setTransactionConfigurationSourceRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest setTransactionConfigurationSourceValidateBeforeCall(String source, List<SetTransactionConfigurationSourceRequest> setTransactionConfigurationSourceRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'source' is set
        if (source == null) {
    ...
    private ApiResponse<TransactionSetConfigurationData> setTransactionConfigurationSourceWithHttpInfo(String source, List<SetTransactionConfigurationSourceRequest> setTransactionConfigurationSourceRequest) throws ApiException {
        HttpRequest localVarCall = setTransactionConfigurationSourceValidateBeforeCall(source, setTransactionConfigurationSourceRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<TransactionSetConfigurationData> setTransactionConfigurationSourceWithHttpInfo(String source, List<SetTransactionConfigurationSourceRequest> setTransactionConfigurationSourceRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = setTransactionConfigurationSourceValidateBeforeCall(source, setTransactionConfigurationSourceRequest, null, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void setTransactionConfigurationSourceAsync(String source, List<SetTransactionConfigurationSourceRequest> setTransactionConfigurationSourceRequest, final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {

        HttpRequest localVarCall = setTransactionConfigurationSourceValidateBeforeCall(source, setTransactionConfigurationSourceRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void setTransactionConfigurationSourceAsync(String source, List<SetTransactionConfigurationSourceRequest> setTransactionConfigurationSourceRequest, final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = setTransactionConfigurationSourceValidateBeforeCall(source, setTransactionConfigurationSourceRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIsetTransactionConfigurationSourceRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {
            setTransactionConfigurationSourceAsync(source, setTransactionConfigurationSourceRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransactionSetConfigurationData> _callback, ConfigurationOptions opts) throws ApiException {
            setTransactionConfigurationSourceAsync(source, setTransactionConfigurationSourceRequest, _callback, opts);
        }
    }
