...
public class TransactionFeeTypesApi {
     ...
     */
    private HttpRequest createTransactionFeeTypeCall(String scope, String code, CreateTransactionFeeTypeRequest createTransactionFeeTypeRequest, final ApiCallback _callback) throws ApiException {
        return createTransactionFeeTypeCall(scope, code, createTransactionFeeTypeRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createTransactionFeeType. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the transaction fee type. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param createTransactionFeeTypeRequest The contents of the transaction fee type. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createTransactionFeeTypeCall(String scope, String code, CreateTransactionFeeTypeRequest createTransactionFeeTypeRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/transactions/transactionfeetypes/{scope}/{code}"
    ...
    private HttpRequest createTransactionFeeTypeValidateBeforeCall(String scope, String code, CreateTransactionFeeTypeRequest createTransactionFeeTypeRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TransactionFeeType> createTransactionFeeTypeWithHttpInfo(String scope, String code, CreateTransactionFeeTypeRequest createTransactionFeeTypeRequest) throws ApiException {
        HttpRequest localVarCall = createTransactionFeeTypeValidateBeforeCall(scope, code, createTransactionFeeTypeRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CreateTransactionFeeType: Create a transaction fee type
     * Create a transaction fee type for the specified scope and code.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the transaction fee type. (required)
     * @param code The code of the transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required)
     * @param createTransactionFeeTypeRequest The contents of the transaction fee type. (required)
     * @return ApiResponse&lt;TransactionFeeType&gt;
    ...
    private ApiResponse<TransactionFeeType> createTransactionFeeTypeWithHttpInfo(String scope, String code, CreateTransactionFeeTypeRequest createTransactionFeeTypeRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createTransactionFeeTypeValidateBeforeCall(scope, code, createTransactionFeeTypeRequest, null, opts);
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CreateTransactionFeeType: Create a transaction fee type (asynchronously)
     * Create a transaction fee type for the specified scope and code.
     * @param scope The scope of the transaction fee type. (required)
     * @param code The code of the transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required)
     * @param createTransactionFeeTypeRequest The contents of the transaction fee type. (required)
     ...
     */
    private void createTransactionFeeTypeAsync(String scope, String code, CreateTransactionFeeTypeRequest createTransactionFeeTypeRequest, final ApiCallback<TransactionFeeType> _callback) throws ApiException {

        HttpRequest localVarCall = createTransactionFeeTypeValidateBeforeCall(scope, code, createTransactionFeeTypeRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
     ...
     */
    private void createTransactionFeeTypeAsync(String scope, String code, CreateTransactionFeeTypeRequest createTransactionFeeTypeRequest, final ApiCallback<TransactionFeeType> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createTransactionFeeTypeValidateBeforeCall(scope, code, createTransactionFeeTypeRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateTransactionFeeTypeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransactionFeeType> _callback) throws ApiException {
            createTransactionFeeTypeAsync(scope, code, createTransactionFeeTypeRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransactionFeeType> _callback, ConfigurationOptions opts) throws ApiException {
            createTransactionFeeTypeAsync(scope, code, createTransactionFeeTypeRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteTransactionFeeTypeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteTransactionFeeTypeCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteTransactionFeeType. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the transaction fee type. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest deleteTransactionFeeTypeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteTransactionFeeTypeValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteTransactionFeeTypeWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteTransactionFeeTypeValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    private ApiResponse<DeletedEntityResponse> deleteTransactionFeeTypeWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteTransactionFeeTypeValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] DeleteTransactionFeeType: Delete a transaction fee type (asynchronously)
     * Delete a transaction fee type for the specified scope and code. To note, this will be a monotemporal delete, meaning that  the transaction fee type will be deleted for all effective time (including past and future versions of the transaction fee type).
     * @param scope The scope of the transaction fee type. (required)
     * @param code The code of the specified transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void deleteTransactionFeeTypeAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteTransactionFeeTypeValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteTransactionFeeTypeAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteTransactionFeeTypeValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteTransactionFeeTypeRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteTransactionFeeTypeAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteTransactionFeeTypeAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getTransactionFeeTypeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return getTransactionFeeTypeCall(scope, code, effectiveAt, asAt, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getTransactionFeeType. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the transaction fee type. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime at which to retrieve the transaction fee type properties.              Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the transaction fee types.              Defaults to latest if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys The collection of &#x60;PropertyKey&#x60;s that we want to decorate on the transaction fee type. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getTransactionFeeTypeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getTransactionFeeTypeValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<TransactionFeeType> getTransactionFeeTypeWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = getTransactionFeeTypeValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] GetTransactionFeeType: Get a transaction fee type
     * Get the transaction fee type for the specified scope and code.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the transaction fee type. (required)
     * @param code The code of the transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required)
     * @param effectiveAt The effective datetime at which to retrieve the transaction fee type properties.              Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve the transaction fee types.              Defaults to latest if not specified. (optional)
    ...
    private ApiResponse<TransactionFeeType> getTransactionFeeTypeWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getTransactionFeeTypeValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetTransactionFeeType: Get a transaction fee type (asynchronously)
     * Get the transaction fee type for the specified scope and code.
     * @param scope The scope of the transaction fee type. (required)
     * @param code The code of the transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required)
     * @param effectiveAt The effective datetime at which to retrieve the transaction fee type properties.              Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     */
    private void getTransactionFeeTypeAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<TransactionFeeType> _callback) throws ApiException {

        HttpRequest localVarCall = getTransactionFeeTypeValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getTransactionFeeTypeAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<TransactionFeeType> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getTransactionFeeTypeValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetTransactionFeeTypeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransactionFeeType> _callback) throws ApiException {
            getTransactionFeeTypeAsync(scope, code, effectiveAt, asAt, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransactionFeeType> _callback, ConfigurationOptions opts) throws ApiException {
            getTransactionFeeTypeAsync(scope, code, effectiveAt, asAt, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listTransactionFeeTypesCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for listTransactionFeeTypes. Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime at which to retrieve transaction fee type properties.              Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the transaction fee types.              Defaults to latest if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listTransactionFeeTypesCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/transactions/transactionfeetypes";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listTransactionFeeTypesValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfTransactionFeeType> listTransactionFeeTypesWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = listTransactionFeeTypesValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfTransactionFeeType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListTransactionFeeTypes: List transaction fee types
     * List transaction fee types that match the specified criteria.Use any specified configuration options to override any other configuration for this request only
     * @param effectiveAt The effective datetime at which to retrieve transaction fee type properties.              Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve the transaction fee types.              Defaults to latest if not specified. (optional)
     * @param page The pagination token to use to continue listing transaction fee types from a previous call to list transaction fee types.  This value is returned from the previous call. If a pagination token is provided the filter,  sortBy, effectiveAt and asAt field must not have changed since the original request. (optional)
     * @param limit When paginating, limit the number of returned results to this many. Defaults to 100 if not specified. (optional)
    ...
    private ApiResponse<ResourceListOfTransactionFeeType> listTransactionFeeTypesWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listTransactionFeeTypesValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfTransactionFeeType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListTransactionFeeTypes: List transaction fee types (asynchronously)
     * List transaction fee types that match the specified criteria.
     * @param effectiveAt The effective datetime at which to retrieve transaction fee type properties.              Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve the transaction fee types.              Defaults to latest if not specified. (optional)
     * @param page The pagination token to use to continue listing transaction fee types from a previous call to list transaction fee types.  This value is returned from the previous call. If a pagination token is provided the filter,  sortBy, effectiveAt and asAt field must not have changed since the original request. (optional)
     ...
     */
    private void listTransactionFeeTypesAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback<ResourceListOfTransactionFeeType> _callback) throws ApiException {

        HttpRequest localVarCall = listTransactionFeeTypesValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfTransactionFeeType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listTransactionFeeTypesAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback<ResourceListOfTransactionFeeType> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listTransactionFeeTypesValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfTransactionFeeType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistTransactionFeeTypesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfTransactionFeeType> _callback) throws ApiException {
            listTransactionFeeTypesAsync(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfTransactionFeeType> _callback, ConfigurationOptions opts) throws ApiException {
            listTransactionFeeTypesAsync(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateTransactionFeeTypeCall(String scope, String code, UpdateTransactionFeeTypeRequest updateTransactionFeeTypeRequest, final ApiCallback _callback) throws ApiException {
        return updateTransactionFeeTypeCall(scope, code, updateTransactionFeeTypeRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateTransactionFeeType. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the transaction fee type. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateTransactionFeeTypeRequest The updated contents of the transaction fee type. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updateTransactionFeeTypeCall(String scope, String code, UpdateTransactionFeeTypeRequest updateTransactionFeeTypeRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateTransactionFeeTypeValidateBeforeCall(String scope, String code, UpdateTransactionFeeTypeRequest updateTransactionFeeTypeRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<TransactionFeeType> updateTransactionFeeTypeWithHttpInfo(String scope, String code, UpdateTransactionFeeTypeRequest updateTransactionFeeTypeRequest) throws ApiException {
        HttpRequest localVarCall = updateTransactionFeeTypeValidateBeforeCall(scope, code, updateTransactionFeeTypeRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpdateTransactionFeeType: Update a transaction fee type
     * Update a transaction fee type by providing the new contents of the transaction fee type.  The displayName field cannot be updated.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the transaction fee type. (required)
     * @param code The code of the specified transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required)
     * @param updateTransactionFeeTypeRequest The updated contents of the transaction fee type. (required)
     * @return ApiResponse&lt;TransactionFeeType&gt;
    ...
    private ApiResponse<TransactionFeeType> updateTransactionFeeTypeWithHttpInfo(String scope, String code, UpdateTransactionFeeTypeRequest updateTransactionFeeTypeRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateTransactionFeeTypeValidateBeforeCall(scope, code, updateTransactionFeeTypeRequest, null, opts);
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpdateTransactionFeeType: Update a transaction fee type (asynchronously)
     * Update a transaction fee type by providing the new contents of the transaction fee type.  The displayName field cannot be updated.
     * @param scope The scope of the transaction fee type. (required)
     * @param code The code of the specified transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required)
     * @param updateTransactionFeeTypeRequest The updated contents of the transaction fee type. (required)
     ...
     */
    private void updateTransactionFeeTypeAsync(String scope, String code, UpdateTransactionFeeTypeRequest updateTransactionFeeTypeRequest, final ApiCallback<TransactionFeeType> _callback) throws ApiException {

        HttpRequest localVarCall = updateTransactionFeeTypeValidateBeforeCall(scope, code, updateTransactionFeeTypeRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateTransactionFeeTypeAsync(String scope, String code, UpdateTransactionFeeTypeRequest updateTransactionFeeTypeRequest, final ApiCallback<TransactionFeeType> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateTransactionFeeTypeValidateBeforeCall(scope, code, updateTransactionFeeTypeRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TransactionFeeType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateTransactionFeeTypeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TransactionFeeType> _callback) throws ApiException {
            updateTransactionFeeTypeAsync(scope, code, updateTransactionFeeTypeRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TransactionFeeType> _callback, ConfigurationOptions opts) throws ApiException {
            updateTransactionFeeTypeAsync(scope, code, updateTransactionFeeTypeRequest, _callback, opts);
        }
    }
