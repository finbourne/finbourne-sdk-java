 ...
 */
@JsonPropertyOrder({
  GetCounterpartyAgreementResponse.JSON_PROPERTY_HREF,
  GetCounterpartyAgreementResponse.JSON_PROPERTY_VALUE,
  GetCounterpartyAgreementResponse.JSON_PROPERTY_FAILED,
  GetCounterpartyAgreementResponse.JSON_PROPERTY_LINKS
})
...
public class GetCounterpartyAgreementResponse {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to GetCounterpartyAgreementResponse
   */
  public static GetCounterpartyAgreementResponse fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, GetCounterpartyAgreementResponse.class);
  }
