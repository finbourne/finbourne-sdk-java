 ...
 */
@JsonPropertyOrder({
  UpsertInstrumentEventsResponse.JSON_PROPERTY_HREF,
  UpsertInstrumentEventsResponse.JSON_PROPERTY_VALUES,
  UpsertInstrumentEventsResponse.JSON_PROPERTY_FAILED,
  UpsertInstrumentEventsResponse.JSON_PROPERTY_LINKS
})
...
public class UpsertInstrumentEventsResponse {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to UpsertInstrumentEventsResponse
   */
  public static UpsertInstrumentEventsResponse fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, UpsertInstrumentEventsResponse.class);
  }
