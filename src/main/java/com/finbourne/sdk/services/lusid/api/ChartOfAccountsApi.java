...
public class ChartOfAccountsApi {
     ...
     */
    private HttpRequest createChartOfAccountsCall(String scope, ChartOfAccountsRequest chartOfAccountsRequest, final ApiCallback _callback) throws ApiException {
        return createChartOfAccountsCall(scope, chartOfAccountsRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createChartOfAccounts. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param chartOfAccountsRequest The definition of the Chart of Accounts. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createChartOfAccountsCall(String scope, ChartOfAccountsRequest chartOfAccountsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/chartofaccounts/{scope}"
    ...
    private HttpRequest createChartOfAccountsValidateBeforeCall(String scope, ChartOfAccountsRequest chartOfAccountsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ChartOfAccounts> createChartOfAccountsWithHttpInfo(String scope, ChartOfAccountsRequest chartOfAccountsRequest) throws ApiException {
        HttpRequest localVarCall = createChartOfAccountsValidateBeforeCall(scope, chartOfAccountsRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
    ...
    private ApiResponse<ChartOfAccounts> createChartOfAccountsWithHttpInfo(String scope, ChartOfAccountsRequest chartOfAccountsRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createChartOfAccountsValidateBeforeCall(scope, chartOfAccountsRequest, null, opts);
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createChartOfAccountsAsync(String scope, ChartOfAccountsRequest chartOfAccountsRequest, final ApiCallback<ChartOfAccounts> _callback) throws ApiException {

        HttpRequest localVarCall = createChartOfAccountsValidateBeforeCall(scope, chartOfAccountsRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
     ...
     */
    private void createChartOfAccountsAsync(String scope, ChartOfAccountsRequest chartOfAccountsRequest, final ApiCallback<ChartOfAccounts> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createChartOfAccountsValidateBeforeCall(scope, chartOfAccountsRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateChartOfAccountsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ChartOfAccounts> _callback) throws ApiException {
            createChartOfAccountsAsync(scope, chartOfAccountsRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ChartOfAccounts> _callback, ConfigurationOptions opts) throws ApiException {
            createChartOfAccountsAsync(scope, chartOfAccountsRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest createCleardownModuleCall(String scope, String code, CleardownModuleRequest cleardownModuleRequest, final ApiCallback _callback) throws ApiException {
        return createCleardownModuleCall(scope, code, cleardownModuleRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createCleardownModule. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param cleardownModuleRequest The definition of the Cleardown Module. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createCleardownModuleCall(String scope, String code, CleardownModuleRequest cleardownModuleRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/cleardownmodules"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest createCleardownModuleValidateBeforeCall(String scope, String code, CleardownModuleRequest cleardownModuleRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CleardownModuleResponse> createCleardownModuleWithHttpInfo(String scope, String code, CleardownModuleRequest cleardownModuleRequest) throws ApiException {
        HttpRequest localVarCall = createCleardownModuleValidateBeforeCall(scope, code, cleardownModuleRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<CleardownModuleResponse> createCleardownModuleWithHttpInfo(String scope, String code, CleardownModuleRequest cleardownModuleRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createCleardownModuleValidateBeforeCall(scope, code, cleardownModuleRequest, null, opts);
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createCleardownModuleAsync(String scope, String code, CleardownModuleRequest cleardownModuleRequest, final ApiCallback<CleardownModuleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = createCleardownModuleValidateBeforeCall(scope, code, cleardownModuleRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void createCleardownModuleAsync(String scope, String code, CleardownModuleRequest cleardownModuleRequest, final ApiCallback<CleardownModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createCleardownModuleValidateBeforeCall(scope, code, cleardownModuleRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateCleardownModuleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CleardownModuleResponse> _callback) throws ApiException {
            createCleardownModuleAsync(scope, code, cleardownModuleRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CleardownModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            createCleardownModuleAsync(scope, code, cleardownModuleRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest createGeneralLedgerProfileCall(String scope, String code, GeneralLedgerProfileRequest generalLedgerProfileRequest, final ApiCallback _callback) throws ApiException {
        return createGeneralLedgerProfileCall(scope, code, generalLedgerProfileRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createGeneralLedgerProfile. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param generalLedgerProfileRequest The definition of the General Ledger Profile. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createGeneralLedgerProfileCall(String scope, String code, GeneralLedgerProfileRequest generalLedgerProfileRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/generalledgerprofile"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest createGeneralLedgerProfileValidateBeforeCall(String scope, String code, GeneralLedgerProfileRequest generalLedgerProfileRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<GeneralLedgerProfileResponse> createGeneralLedgerProfileWithHttpInfo(String scope, String code, GeneralLedgerProfileRequest generalLedgerProfileRequest) throws ApiException {
        HttpRequest localVarCall = createGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<GeneralLedgerProfileResponse> createGeneralLedgerProfileWithHttpInfo(String scope, String code, GeneralLedgerProfileRequest generalLedgerProfileRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileRequest, null, opts);
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createGeneralLedgerProfileAsync(String scope, String code, GeneralLedgerProfileRequest generalLedgerProfileRequest, final ApiCallback<GeneralLedgerProfileResponse> _callback) throws ApiException {

        HttpRequest localVarCall = createGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void createGeneralLedgerProfileAsync(String scope, String code, GeneralLedgerProfileRequest generalLedgerProfileRequest, final ApiCallback<GeneralLedgerProfileResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateGeneralLedgerProfileRequest {
         ...
         */
        public void executeAsync(final ApiCallback<GeneralLedgerProfileResponse> _callback) throws ApiException {
            createGeneralLedgerProfileAsync(scope, code, generalLedgerProfileRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<GeneralLedgerProfileResponse> _callback, ConfigurationOptions opts) throws ApiException {
            createGeneralLedgerProfileAsync(scope, code, generalLedgerProfileRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest createPostingModuleCall(String scope, String code, PostingModuleRequest postingModuleRequest, final ApiCallback _callback) throws ApiException {
        return createPostingModuleCall(scope, code, postingModuleRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createPostingModule. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param postingModuleRequest The definition of the Posting Module. (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest createPostingModuleCall(String scope, String code, PostingModuleRequest postingModuleRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/postingmodules"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest createPostingModuleValidateBeforeCall(String scope, String code, PostingModuleRequest postingModuleRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PostingModuleResponse> createPostingModuleWithHttpInfo(String scope, String code, PostingModuleRequest postingModuleRequest) throws ApiException {
        HttpRequest localVarCall = createPostingModuleValidateBeforeCall(scope, code, postingModuleRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PostingModuleResponse> createPostingModuleWithHttpInfo(String scope, String code, PostingModuleRequest postingModuleRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createPostingModuleValidateBeforeCall(scope, code, postingModuleRequest, null, opts);
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createPostingModuleAsync(String scope, String code, PostingModuleRequest postingModuleRequest, final ApiCallback<PostingModuleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = createPostingModuleValidateBeforeCall(scope, code, postingModuleRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void createPostingModuleAsync(String scope, String code, PostingModuleRequest postingModuleRequest, final ApiCallback<PostingModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createPostingModuleValidateBeforeCall(scope, code, postingModuleRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreatePostingModuleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PostingModuleResponse> _callback) throws ApiException {
            createPostingModuleAsync(scope, code, postingModuleRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PostingModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            createPostingModuleAsync(scope, code, postingModuleRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteAccountsCall(String scope, String code, List<String> requestBody, String deleteMode, final ApiCallback _callback) throws ApiException {
        return deleteAccountsCall(scope, code, requestBody, deleteMode,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteAccounts. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies              the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The codes of the accounts to delete. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param deleteMode The delete mode to use. Default value: Soft. Available values: Soft, Hard. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteAccountsCall(String scope, String code, List<String> requestBody, String deleteMode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/accounts/$delete"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteAccountsValidateBeforeCall(String scope, String code, List<String> requestBody, String deleteMode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeleteAccountsResponse> deleteAccountsWithHttpInfo(String scope, String code, List<String> requestBody, String deleteMode) throws ApiException {
        HttpRequest localVarCall = deleteAccountsValidateBeforeCall(scope, code, requestBody, deleteMode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeleteAccountsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<DeleteAccountsResponse> deleteAccountsWithHttpInfo(String scope, String code, List<String> requestBody, String deleteMode, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteAccountsValidateBeforeCall(scope, code, requestBody, deleteMode, null, opts);
        Type localVarReturnType = new TypeReference<DeleteAccountsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteAccountsAsync(String scope, String code, List<String> requestBody, String deleteMode, final ApiCallback<DeleteAccountsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteAccountsValidateBeforeCall(scope, code, requestBody, deleteMode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeleteAccountsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteAccountsAsync(String scope, String code, List<String> requestBody, String deleteMode, final ApiCallback<DeleteAccountsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteAccountsValidateBeforeCall(scope, code, requestBody, deleteMode, _callback, opts);
        Type localVarReturnType = new TypeReference<DeleteAccountsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteAccountsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeleteAccountsResponse> _callback) throws ApiException {
            deleteAccountsAsync(scope, code, requestBody, deleteMode, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeleteAccountsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteAccountsAsync(scope, code, requestBody, deleteMode, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteChartOfAccountsCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteChartOfAccountsCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteChartOfAccounts. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts to be deleted. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts to be deleted. Together with the scope this uniquely identifies the Chart of Accounts. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteChartOfAccountsCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteChartOfAccountsValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteChartOfAccountsWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteChartOfAccountsValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    private ApiResponse<DeletedEntityResponse> deleteChartOfAccountsWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteChartOfAccountsValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteChartOfAccountsAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteChartOfAccountsValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteChartOfAccountsAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteChartOfAccountsValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteChartOfAccountsRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteChartOfAccountsAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteChartOfAccountsAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteCleardownModuleCall(String scope, String code, String cleardownModuleCode, final ApiCallback _callback) throws ApiException {
        return deleteCleardownModuleCall(scope, code, cleardownModuleCode,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteCleardownModule. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param cleardownModuleCode The code of the Cleardown Module to be deleted. (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest deleteCleardownModuleCall(String scope, String code, String cleardownModuleCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/cleardownmodules/{cleardownModuleCode}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteCleardownModuleValidateBeforeCall(String scope, String code, String cleardownModuleCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteCleardownModuleWithHttpInfo(String scope, String code, String cleardownModuleCode) throws ApiException {
        HttpRequest localVarCall = deleteCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<DeletedEntityResponse> deleteCleardownModuleWithHttpInfo(String scope, String code, String cleardownModuleCode, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteCleardownModuleAsync(String scope, String code, String cleardownModuleCode, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteCleardownModuleAsync(String scope, String code, String cleardownModuleCode, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCleardownModuleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteCleardownModuleAsync(scope, code, cleardownModuleCode, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCleardownModuleAsync(scope, code, cleardownModuleCode, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteGeneralLedgerProfileCall(String scope, String code, String generalLedgerProfileCode, final ApiCallback _callback) throws ApiException {
        return deleteGeneralLedgerProfileCall(scope, code, generalLedgerProfileCode,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteGeneralLedgerProfile. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts for the General Ledger Profile. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts for the General Ledger Profile. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param generalLedgerProfileCode The Code of the General Ledger Profile. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteGeneralLedgerProfileCall(String scope, String code, String generalLedgerProfileCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/generalledgerprofile/{generalLedgerProfileCode}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteGeneralLedgerProfileValidateBeforeCall(String scope, String code, String generalLedgerProfileCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deleteGeneralLedgerProfileWithHttpInfo(String scope, String code, String generalLedgerProfileCode) throws ApiException {
        HttpRequest localVarCall = deleteGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileCode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<DeletedEntityResponse> deleteGeneralLedgerProfileWithHttpInfo(String scope, String code, String generalLedgerProfileCode, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileCode, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteGeneralLedgerProfileAsync(String scope, String code, String generalLedgerProfileCode, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteGeneralLedgerProfileAsync(String scope, String code, String generalLedgerProfileCode, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileCode, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteGeneralLedgerProfileRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteGeneralLedgerProfileAsync(scope, code, generalLedgerProfileCode, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteGeneralLedgerProfileAsync(scope, code, generalLedgerProfileCode, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deletePostingModuleCall(String scope, String code, String postingModuleCode, final ApiCallback _callback) throws ApiException {
        return deletePostingModuleCall(scope, code, postingModuleCode,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deletePostingModule. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param postingModuleCode The code of the Posting Module to be deleted. (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest deletePostingModuleCall(String scope, String code, String postingModuleCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/postingmodules/{postingModuleCode}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deletePostingModuleValidateBeforeCall(String scope, String code, String postingModuleCode, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DeletedEntityResponse> deletePostingModuleWithHttpInfo(String scope, String code, String postingModuleCode) throws ApiException {
        HttpRequest localVarCall = deletePostingModuleValidateBeforeCall(scope, code, postingModuleCode, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<DeletedEntityResponse> deletePostingModuleWithHttpInfo(String scope, String code, String postingModuleCode, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deletePostingModuleValidateBeforeCall(scope, code, postingModuleCode, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deletePostingModuleAsync(String scope, String code, String postingModuleCode, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deletePostingModuleValidateBeforeCall(scope, code, postingModuleCode, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deletePostingModuleAsync(String scope, String code, String postingModuleCode, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deletePostingModuleValidateBeforeCall(scope, code, postingModuleCode, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeletePostingModuleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deletePostingModuleAsync(scope, code, postingModuleCode, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deletePostingModuleAsync(scope, code, postingModuleCode, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getAccountCall(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return getAccountCall(scope, code, accountCode, effectiveAt, asAt, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getAccount. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param accountCode The code of the Account. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the Account properties. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Account definition. Defaults to returning the latest version of the Account definition if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;Account&#39; domain to decorate onto the Account.              These must take the format {domain}/{scope}/{code}, for example &#39;Account/Manager/Id&#39;. If no properties are specified, then no properties will be returned. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getAccountCall(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/accounts/{accountCode}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getAccountValidateBeforeCall(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Account> getAccountWithHttpInfo(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = getAccountValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Account>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<Account> getAccountWithHttpInfo(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getAccountValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<Account>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getAccountAsync(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Account> _callback) throws ApiException {

        HttpRequest localVarCall = getAccountValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Account>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getAccountAsync(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Account> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getAccountValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<Account>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetAccountRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Account> _callback) throws ApiException {
            getAccountAsync(scope, code, accountCode, effectiveAt, asAt, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Account> _callback, ConfigurationOptions opts) throws ApiException {
            getAccountAsync(scope, code, accountCode, effectiveAt, asAt, propertyKeys, _callback, opts);
        }
    }
     ...
     * @param accountCode The unique ID of the account to get properties for. (required)
     * @param effectiveAt The effective datetime or cut label at which to list the Account&#39;s properties. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the Account&#39;s properties. Defaults to return the latest version of each property if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The properties of the specified account </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    private HttpRequest getAccountPropertiesCall(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getAccountPropertiesCall(scope, code, accountCode, effectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getAccountProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts to update or insert the properties onto. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts to update or insert the properties onto. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param accountCode The unique ID of the account to get properties for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the Account&#39;s properties. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the Account&#39;s properties. Defaults to return the latest version of each property if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getAccountPropertiesCall(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/accounts/{accountCode}/properties"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
            .replace("{" + "accountCode" + "}", localVarApiClient.escapeString(accountCode.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getAccountPropertiesValidateBeforeCall(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getAccountProperties(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getAccountProperties(Async)");
        }

        // verify the required parameter 'accountCode' is set
        if (accountCode == null) {
            throw new ApiException("Missing the required parameter 'accountCode' when calling getAccountProperties(Async)");
        }

        return getAccountPropertiesCall(scope, code, accountCode, effectiveAt, asAt, _callback, opts);
     ...
     */
    private ApiResponse<AccountProperties> getAccountPropertiesWithHttpInfo(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getAccountPropertiesValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AccountProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private ApiResponse<AccountProperties> getAccountPropertiesWithHttpInfo(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getAccountPropertiesValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<AccountProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getAccountPropertiesAsync(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, final ApiCallback<AccountProperties> _callback) throws ApiException {

        HttpRequest localVarCall = getAccountPropertiesValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AccountProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getAccountPropertiesAsync(String scope, String code, String accountCode, String effectiveAt, OffsetDateTime asAt, final ApiCallback<AccountProperties> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getAccountPropertiesValidateBeforeCall(scope, code, accountCode, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<AccountProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }

    public class APIgetAccountPropertiesRequest {
        private final String scope;
        private final String code;
        private final String accountCode;
        private String effectiveAt;
        ...
        private APIgetAccountPropertiesRequest(String scope, String code, String accountCode) {
            this.scope = scope;
            this.code = code;
            this.accountCode = accountCode;
        }
         ...
         * Set effectiveAt
         * @param effectiveAt The effective datetime or cut label at which to list the Account&#39;s properties. Defaults to the current LUSID system datetime if not specified. (optional)
         * @return APIgetAccountPropertiesRequest
         */
        public APIgetAccountPropertiesRequest effectiveAt(String effectiveAt) {
            this.effectiveAt = effectiveAt;
            return this;
        }
         ...
         * @return APIgetAccountPropertiesRequest
         */
        public APIgetAccountPropertiesRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }
         ...
         */
        public HttpRequest buildCall(final ApiCallback _callback) throws ApiException {
            return getAccountPropertiesCall(scope, code, accountCode, effectiveAt, asAt, _callback);
        }

        /**
         * Execute getAccountProperties request
        ...
        public AccountProperties execute() throws ApiException {
            ApiResponse<AccountProperties> localVarResp = getAccountPropertiesWithHttpInfo(scope, code, accountCode, effectiveAt, asAt);
            return localVarResp.getData();
        }

        /**
         * Execute getAccountProperties request. Use any specified configuration options to override any other configuration for this request only.
         * @return AccountProperties
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public AccountProperties execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<AccountProperties> localVarResp = getAccountPropertiesWithHttpInfo(scope, code, accountCode, effectiveAt, asAt, opts);
            return localVarResp.getData();
        }

        /**
         * Execute getAccountProperties request with HTTP info returned
         * @return ApiResponse&lt;AccountProperties&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<AccountProperties> executeWithHttpInfo() throws ApiException {
            return getAccountPropertiesWithHttpInfo(scope, code, accountCode, effectiveAt, asAt);
        }

        /**
         * Execute getAccountProperties request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;AccountProperties&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<AccountProperties> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return getAccountPropertiesWithHttpInfo(scope, code, accountCode, effectiveAt, asAt, opts);
        }

        /**
         * Execute getAccountProperties request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public void executeAsync(final ApiCallback<AccountProperties> _callback) throws ApiException {
            getAccountPropertiesAsync(scope, code, accountCode, effectiveAt, asAt, _callback);
        }

        /**
         * Execute getAccountProperties request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public void executeAsync(final ApiCallback<AccountProperties> _callback, ConfigurationOptions opts) throws ApiException {
            getAccountPropertiesAsync(scope, code, accountCode, effectiveAt, asAt, _callback, opts);
        }
    }
     ...
     */
    public APIgetAccountPropertiesRequest getAccountProperties(String scope, String code, String accountCode) {
        return new APIgetAccountPropertiesRequest(scope, code, accountCode);
    }
    /**
     ...
     */
    private HttpRequest getChartOfAccountsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return getChartOfAccountsCall(scope, code, effectiveAt, asAt, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getChartOfAccounts. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the Chart of Accounts properties. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Chart of Accounts definition. Defaults to returning the latest version of the Chart of Accounts definition if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;ChartOfAccounts&#39; domain to decorate onto the Chart of Accounts.              These must take the format {domain}/{scope}/{code}, for example &#39;ChartOfAccounts/Manager/Id&#39;. If no properties are specified, then no properties will be returned. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getChartOfAccountsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getChartOfAccountsValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ChartOfAccounts> getChartOfAccountsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = getChartOfAccountsValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ChartOfAccounts> getChartOfAccountsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getChartOfAccountsValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getChartOfAccountsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<ChartOfAccounts> _callback) throws ApiException {

        HttpRequest localVarCall = getChartOfAccountsValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getChartOfAccountsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<ChartOfAccounts> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getChartOfAccountsValidateBeforeCall(scope, code, effectiveAt, asAt, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetChartOfAccountsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ChartOfAccounts> _callback) throws ApiException {
            getChartOfAccountsAsync(scope, code, effectiveAt, asAt, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ChartOfAccounts> _callback, ConfigurationOptions opts) throws ApiException {
            getChartOfAccountsAsync(scope, code, effectiveAt, asAt, propertyKeys, _callback, opts);
        }
    }
    ...
    /**
     * Build call for getChartOfAccountsProperties
     ...
     * @param effectiveAt The effective datetime or cut label at which to list the chart of accounts&#39; properties. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the chart of accounts&#39; properties. Defaults to return the latest version of each property if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The properties of the specified chartOfAccounts </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    private HttpRequest getChartOfAccountsPropertiesCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getChartOfAccountsPropertiesCall(scope, code, effectiveAt, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getChartOfAccountsProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the chart of accounts to list the properties for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the chart of accounts to list the properties for. Together with the scope this uniquely identifies the chart of accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the chart of accounts&#39; properties. Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the chart of accounts&#39; properties. Defaults to return the latest version of each property if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getChartOfAccountsPropertiesCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/properties"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getChartOfAccountsPropertiesValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getChartOfAccountsProperties(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getChartOfAccountsProperties(Async)");
        }

        return getChartOfAccountsPropertiesCall(scope, code, effectiveAt, asAt, _callback, opts);
     ...
     */
    private ApiResponse<ChartOfAccountsProperties> getChartOfAccountsPropertiesWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getChartOfAccountsPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ChartOfAccountsProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private ApiResponse<ChartOfAccountsProperties> getChartOfAccountsPropertiesWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getChartOfAccountsPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, null, opts);
        Type localVarReturnType = new TypeReference<ChartOfAccountsProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getChartOfAccountsPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<ChartOfAccountsProperties> _callback) throws ApiException {

        HttpRequest localVarCall = getChartOfAccountsPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ChartOfAccountsProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getChartOfAccountsPropertiesAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback<ChartOfAccountsProperties> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getChartOfAccountsPropertiesValidateBeforeCall(scope, code, effectiveAt, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ChartOfAccountsProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }

    public class APIgetChartOfAccountsPropertiesRequest {
        private final String scope;
        private final String code;
        private String effectiveAt;
        private OffsetDateTime asAt;

        private APIgetChartOfAccountsPropertiesRequest(String scope, String code) {
            this.scope = scope;
            this.code = code;
        }
         ...
         * Set effectiveAt
         * @param effectiveAt The effective datetime or cut label at which to list the chart of accounts&#39; properties. Defaults to the current LUSID system datetime if not specified. (optional)
         * @return APIgetChartOfAccountsPropertiesRequest
         */
        public APIgetChartOfAccountsPropertiesRequest effectiveAt(String effectiveAt) {
            this.effectiveAt = effectiveAt;
            return this;
        }
         ...
         * @return APIgetChartOfAccountsPropertiesRequest
         */
        public APIgetChartOfAccountsPropertiesRequest asAt(OffsetDateTime asAt) {
            this.asAt = asAt;
            return this;
        }
         ...
         */
        public HttpRequest buildCall(final ApiCallback _callback) throws ApiException {
            return getChartOfAccountsPropertiesCall(scope, code, effectiveAt, asAt, _callback);
        }

        /**
         * Execute getChartOfAccountsProperties request
        ...
        public ChartOfAccountsProperties execute() throws ApiException {
            ApiResponse<ChartOfAccountsProperties> localVarResp = getChartOfAccountsPropertiesWithHttpInfo(scope, code, effectiveAt, asAt);
            return localVarResp.getData();
        }

        /**
         * Execute getChartOfAccountsProperties request. Use any specified configuration options to override any other configuration for this request only.
         * @return ChartOfAccountsProperties
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ChartOfAccountsProperties execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<ChartOfAccountsProperties> localVarResp = getChartOfAccountsPropertiesWithHttpInfo(scope, code, effectiveAt, asAt, opts);
            return localVarResp.getData();
        }

        /**
         * Execute getChartOfAccountsProperties request with HTTP info returned
         * @return ApiResponse&lt;ChartOfAccountsProperties&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<ChartOfAccountsProperties> executeWithHttpInfo() throws ApiException {
            return getChartOfAccountsPropertiesWithHttpInfo(scope, code, effectiveAt, asAt);
        }

        /**
         * Execute getChartOfAccountsProperties request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;ChartOfAccountsProperties&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<ChartOfAccountsProperties> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return getChartOfAccountsPropertiesWithHttpInfo(scope, code, effectiveAt, asAt, opts);
        }

        /**
         * Execute getChartOfAccountsProperties request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public void executeAsync(final ApiCallback<ChartOfAccountsProperties> _callback) throws ApiException {
            getChartOfAccountsPropertiesAsync(scope, code, effectiveAt, asAt, _callback);
        }

        /**
         * Execute getChartOfAccountsProperties request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public void executeAsync(final ApiCallback<ChartOfAccountsProperties> _callback, ConfigurationOptions opts) throws ApiException {
            getChartOfAccountsPropertiesAsync(scope, code, effectiveAt, asAt, _callback, opts);
        }
    }
     ...
     */
    public APIgetChartOfAccountsPropertiesRequest getChartOfAccountsProperties(String scope, String code) {
        return new APIgetChartOfAccountsPropertiesRequest(scope, code);
    }
    /**
     ...
     */
    private HttpRequest getCleardownModuleCall(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getCleardownModuleCall(scope, code, cleardownModuleCode, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getCleardownModule. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param cleardownModuleCode The code of the Cleardown Module. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Cleardown Module. Defaults to return the latest version of the Cleardown Module if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getCleardownModuleCall(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCleardownModuleValidateBeforeCall(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CleardownModuleResponse> getCleardownModuleWithHttpInfo(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<CleardownModuleResponse> getCleardownModuleWithHttpInfo(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, asAt, null, opts);
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getCleardownModuleAsync(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, final ApiCallback<CleardownModuleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCleardownModuleAsync(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, final ApiCallback<CleardownModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCleardownModuleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CleardownModuleResponse> _callback) throws ApiException {
            getCleardownModuleAsync(scope, code, cleardownModuleCode, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CleardownModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getCleardownModuleAsync(scope, code, cleardownModuleCode, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getGeneralLedgerProfileCall(String scope, String code, String generalLedgerProfileCode, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getGeneralLedgerProfileCall(scope, code, generalLedgerProfileCode, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getGeneralLedgerProfile. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts for the General Ledger Profile. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts for the General Ledger Profile. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param generalLedgerProfileCode The General Ledger Profile Code of the General Ledger Profile. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the General Ledger Profile. Defaults to return the latest version of the General Ledger Profile if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getGeneralLedgerProfileCall(String scope, String code, String generalLedgerProfileCode, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getGeneralLedgerProfileValidateBeforeCall(String scope, String code, String generalLedgerProfileCode, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<GeneralLedgerProfileResponse> getGeneralLedgerProfileWithHttpInfo(String scope, String code, String generalLedgerProfileCode, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileCode, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<GeneralLedgerProfileResponse> getGeneralLedgerProfileWithHttpInfo(String scope, String code, String generalLedgerProfileCode, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileCode, asAt, null, opts);
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getGeneralLedgerProfileAsync(String scope, String code, String generalLedgerProfileCode, OffsetDateTime asAt, final ApiCallback<GeneralLedgerProfileResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileCode, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getGeneralLedgerProfileAsync(String scope, String code, String generalLedgerProfileCode, OffsetDateTime asAt, final ApiCallback<GeneralLedgerProfileResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getGeneralLedgerProfileValidateBeforeCall(scope, code, generalLedgerProfileCode, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetGeneralLedgerProfileRequest {
         ...
         */
        public void executeAsync(final ApiCallback<GeneralLedgerProfileResponse> _callback) throws ApiException {
            getGeneralLedgerProfileAsync(scope, code, generalLedgerProfileCode, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<GeneralLedgerProfileResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getGeneralLedgerProfileAsync(scope, code, generalLedgerProfileCode, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getPostingModuleCall(String scope, String code, String postingModuleCode, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getPostingModuleCall(scope, code, postingModuleCode, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getPostingModule. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param postingModuleCode The code of the Posting Module. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Posting Module. Defaults to return the latest version of the Posting Module if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getPostingModuleCall(String scope, String code, String postingModuleCode, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getPostingModuleValidateBeforeCall(String scope, String code, String postingModuleCode, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PostingModuleResponse> getPostingModuleWithHttpInfo(String scope, String code, String postingModuleCode, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getPostingModuleValidateBeforeCall(scope, code, postingModuleCode, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PostingModuleResponse> getPostingModuleWithHttpInfo(String scope, String code, String postingModuleCode, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getPostingModuleValidateBeforeCall(scope, code, postingModuleCode, asAt, null, opts);
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getPostingModuleAsync(String scope, String code, String postingModuleCode, OffsetDateTime asAt, final ApiCallback<PostingModuleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getPostingModuleValidateBeforeCall(scope, code, postingModuleCode, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getPostingModuleAsync(String scope, String code, String postingModuleCode, OffsetDateTime asAt, final ApiCallback<PostingModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getPostingModuleValidateBeforeCall(scope, code, postingModuleCode, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetPostingModuleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PostingModuleResponse> _callback) throws ApiException {
            getPostingModuleAsync(scope, code, postingModuleCode, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PostingModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getPostingModuleAsync(scope, code, postingModuleCode, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listAccountsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return listAccountsCall(scope, code, effectiveAt, asAt, page, limit, filter, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listAccounts. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies              the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the TimeVariant properties decorated on Accounts. Defaults to the current LUSID              system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Accounts. Defaults to              returning the latest version if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing charts of accounts; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param filter Expression to filter the results.              For example, to filter on the Account type, specify \&quot;code eq &#39;001&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;Account&#39; domain to decorate onto the Account.              These must have the format {domain}/{scope}/{code}, for example &#39;Account/system/Name&#39;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listAccountsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/accounts"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listAccountsValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PagedResourceListOfAccount> listAccountsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = listAccountsValidateBeforeCall(scope, code, effectiveAt, asAt, page, limit, filter, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfAccount>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PagedResourceListOfAccount> listAccountsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listAccountsValidateBeforeCall(scope, code, effectiveAt, asAt, page, limit, filter, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfAccount>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listAccountsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfAccount> _callback) throws ApiException {

        HttpRequest localVarCall = listAccountsValidateBeforeCall(scope, code, effectiveAt, asAt, page, limit, filter, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfAccount>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listAccountsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfAccount> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listAccountsValidateBeforeCall(scope, code, effectiveAt, asAt, page, limit, filter, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfAccount>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistAccountsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfAccount> _callback) throws ApiException {
            listAccountsAsync(scope, code, effectiveAt, asAt, page, limit, filter, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfAccount> _callback, ConfigurationOptions opts) throws ApiException {
            listAccountsAsync(scope, code, effectiveAt, asAt, page, limit, filter, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listChartsOfAccountsCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for listChartsOfAccounts. Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the TimeVariant properties for the Chart Of Accounts. Defaults to the current LUSID              system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the charts of accounts. Defaults to returning the latest version              of each Chart of Accounts if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing charts of accounts; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the results.              For example, to filter on the Chart of Accounts type, specify \&quot;id.Code eq &#39;001&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listChartsOfAccountsCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listChartsOfAccountsValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfChartOfAccounts> listChartsOfAccountsWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = listChartsOfAccountsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfChartOfAccounts>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PagedResourceListOfChartOfAccounts> listChartsOfAccountsWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listChartsOfAccountsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfChartOfAccounts>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listChartsOfAccountsAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback<PagedResourceListOfChartOfAccounts> _callback) throws ApiException {

        HttpRequest localVarCall = listChartsOfAccountsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfChartOfAccounts>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listChartsOfAccountsAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback<PagedResourceListOfChartOfAccounts> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listChartsOfAccountsValidateBeforeCall(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfChartOfAccounts>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistChartsOfAccountsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfChartOfAccounts> _callback) throws ApiException {
            listChartsOfAccountsAsync(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfChartOfAccounts> _callback, ConfigurationOptions opts) throws ApiException {
            listChartsOfAccountsAsync(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listCleardownModuleRulesCall(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for listCleardownModuleRules. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param cleardownModuleCode The code of the cleardown module. (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listCleardownModuleRulesCall(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/cleardownmodules/{cleardownModuleCode}/cleardownrules"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
            .replace("{" + "cleardownModuleCode" + "}", localVarApiClient.escapeString(cleardownModuleCode.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listCleardownModuleRulesValidateBeforeCall(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PagedResourceListOfCleardownModuleRule> listCleardownModuleRulesWithHttpInfo(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = listCleardownModuleRulesValidateBeforeCall(scope, code, cleardownModuleCode, asAt, page, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCleardownModuleRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PagedResourceListOfCleardownModuleRule> listCleardownModuleRulesWithHttpInfo(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listCleardownModuleRulesValidateBeforeCall(scope, code, cleardownModuleCode, asAt, page, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCleardownModuleRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listCleardownModuleRulesAsync(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfCleardownModuleRule> _callback) throws ApiException {

        HttpRequest localVarCall = listCleardownModuleRulesValidateBeforeCall(scope, code, cleardownModuleCode, asAt, page, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCleardownModuleRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listCleardownModuleRulesAsync(String scope, String code, String cleardownModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfCleardownModuleRule> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listCleardownModuleRulesValidateBeforeCall(scope, code, cleardownModuleCode, asAt, page, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCleardownModuleRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistCleardownModuleRulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCleardownModuleRule> _callback) throws ApiException {
            listCleardownModuleRulesAsync(scope, code, cleardownModuleCode, asAt, page, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCleardownModuleRule> _callback, ConfigurationOptions opts) throws ApiException {
            listCleardownModuleRulesAsync(scope, code, cleardownModuleCode, asAt, page, limit, filter, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listCleardownModulesCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback) throws ApiException {
        return listCleardownModulesCall(scope, code, asAt, page, limit, filter, sortBy,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listCleardownModules. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the Cleardown Module. Defaults to returning the latest version              of each Cleardown Module if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing Cleardown Modules; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the results.              For example, to filter on the Cleardown Module status, specify \&quot;status eq &#39;Active&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listCleardownModulesCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listCleardownModulesValidateBeforeCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PagedResourceListOfCleardownModuleResponse> listCleardownModulesWithHttpInfo(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy) throws ApiException {
        HttpRequest localVarCall = listCleardownModulesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCleardownModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PagedResourceListOfCleardownModuleResponse> listCleardownModulesWithHttpInfo(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listCleardownModulesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCleardownModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listCleardownModulesAsync(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfCleardownModuleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = listCleardownModulesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCleardownModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listCleardownModulesAsync(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfCleardownModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listCleardownModulesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCleardownModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistCleardownModulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCleardownModuleResponse> _callback) throws ApiException {
            listCleardownModulesAsync(scope, code, asAt, page, limit, filter, sortBy, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCleardownModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            listCleardownModulesAsync(scope, code, asAt, page, limit, filter, sortBy, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listGeneralLedgerProfilesCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback) throws ApiException {
        return listGeneralLedgerProfilesCall(scope, code, asAt, page, limit, filter, sortBy,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listGeneralLedgerProfiles. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the General Ledger Profiles. Defaults to returning the latest version of each General Ledger Profile if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the results.              For example, to filter on the General Ledger profiles type, specify \&quot;type eq &#39;PeriodBoundary&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listGeneralLedgerProfilesCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listGeneralLedgerProfilesValidateBeforeCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PagedResourceListOfGeneralLedgerProfileResponse> listGeneralLedgerProfilesWithHttpInfo(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy) throws ApiException {
        HttpRequest localVarCall = listGeneralLedgerProfilesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfGeneralLedgerProfileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PagedResourceListOfGeneralLedgerProfileResponse> listGeneralLedgerProfilesWithHttpInfo(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listGeneralLedgerProfilesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfGeneralLedgerProfileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listGeneralLedgerProfilesAsync(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfGeneralLedgerProfileResponse> _callback) throws ApiException {

        HttpRequest localVarCall = listGeneralLedgerProfilesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfGeneralLedgerProfileResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listGeneralLedgerProfilesAsync(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfGeneralLedgerProfileResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listGeneralLedgerProfilesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfGeneralLedgerProfileResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistGeneralLedgerProfilesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfGeneralLedgerProfileResponse> _callback) throws ApiException {
            listGeneralLedgerProfilesAsync(scope, code, asAt, page, limit, filter, sortBy, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfGeneralLedgerProfileResponse> _callback, ConfigurationOptions opts) throws ApiException {
            listGeneralLedgerProfilesAsync(scope, code, asAt, page, limit, filter, sortBy, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listPostingModuleRulesCall(String scope, String code, String postingModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        return listPostingModuleRulesCall(scope, code, postingModuleCode, asAt, page, limit, filter,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listPostingModuleRules. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param postingModuleCode The code of the posting module. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the instrument. Defaults to              returning the latest version if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing posting module rules; this              value is returned from the previous call. If a pagination token is provided, the filter              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the results.              For example, to filter on the rule id, specify \&quot;ruleId eq &#39;rule 1&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest listPostingModuleRulesCall(String scope, String code, String postingModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/postingmodules/{postingModuleCode}/postingrules"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
            .replace("{" + "postingModuleCode" + "}", localVarApiClient.escapeString(postingModuleCode.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listPostingModuleRulesValidateBeforeCall(String scope, String code, String postingModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PagedResourceListOfPostingModuleRule> listPostingModuleRulesWithHttpInfo(String scope, String code, String postingModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = listPostingModuleRulesValidateBeforeCall(scope, code, postingModuleCode, asAt, page, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfPostingModuleRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PagedResourceListOfPostingModuleRule> listPostingModuleRulesWithHttpInfo(String scope, String code, String postingModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listPostingModuleRulesValidateBeforeCall(scope, code, postingModuleCode, asAt, page, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfPostingModuleRule>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listPostingModuleRulesAsync(String scope, String code, String postingModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfPostingModuleRule> _callback) throws ApiException {

        HttpRequest localVarCall = listPostingModuleRulesValidateBeforeCall(scope, code, postingModuleCode, asAt, page, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfPostingModuleRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listPostingModuleRulesAsync(String scope, String code, String postingModuleCode, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfPostingModuleRule> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listPostingModuleRulesValidateBeforeCall(scope, code, postingModuleCode, asAt, page, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfPostingModuleRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistPostingModuleRulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfPostingModuleRule> _callback) throws ApiException {
            listPostingModuleRulesAsync(scope, code, postingModuleCode, asAt, page, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfPostingModuleRule> _callback, ConfigurationOptions opts) throws ApiException {
            listPostingModuleRulesAsync(scope, code, postingModuleCode, asAt, page, limit, filter, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listPostingModulesCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback) throws ApiException {
        return listPostingModulesCall(scope, code, asAt, page, limit, filter, sortBy,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listPostingModules. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the Posting Module. Defaults to returning the latest version              of each Posting Module if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing Posting Modules; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the results.              For example, to filter on the Posting Module status, specify \&quot;status eq &#39;Active&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listPostingModulesCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listPostingModulesValidateBeforeCall(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PagedResourceListOfPostingModuleResponse> listPostingModulesWithHttpInfo(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy) throws ApiException {
        HttpRequest localVarCall = listPostingModulesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfPostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PagedResourceListOfPostingModuleResponse> listPostingModulesWithHttpInfo(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listPostingModulesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfPostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listPostingModulesAsync(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfPostingModuleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = listPostingModulesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfPostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listPostingModulesAsync(String scope, String code, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfPostingModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listPostingModulesValidateBeforeCall(scope, code, asAt, page, limit, filter, sortBy, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfPostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistPostingModulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfPostingModuleResponse> _callback) throws ApiException {
            listPostingModulesAsync(scope, code, asAt, page, limit, filter, sortBy, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfPostingModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            listPostingModulesAsync(scope, code, asAt, page, limit, filter, sortBy, _callback, opts);
        }
    }
    ...
    /**
     * Build call for patchChartOfAccounts
     * @param scope The scope of the Chart of Accounts. (required)
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The updated Chart of Accounts. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    private HttpRequest patchChartOfAccountsCall(String scope, String code, List<Operation> operation, final ApiCallback _callback) throws ApiException {
        return patchChartOfAccountsCall(scope, code, operation,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for patchChartOfAccounts. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902. (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest patchChartOfAccountsCall(String scope, String code, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest patchChartOfAccountsValidateBeforeCall(String scope, String code, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling patchChartOfAccounts(Async)");
        }

        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling patchChartOfAccounts(Async)");
        }

        // verify the required parameter 'operation' is set
        if (operation == null) {
            throw new ApiException("Missing the required parameter 'operation' when calling patchChartOfAccounts(Async)");
        }

        return patchChartOfAccountsCall(scope, code, operation, _callback, opts);
     ...
     */
    private ApiResponse<ChartOfAccounts> patchChartOfAccountsWithHttpInfo(String scope, String code, List<Operation> operation) throws ApiException {
        HttpRequest localVarCall = patchChartOfAccountsValidateBeforeCall(scope, code, operation, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private ApiResponse<ChartOfAccounts> patchChartOfAccountsWithHttpInfo(String scope, String code, List<Operation> operation, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = patchChartOfAccountsValidateBeforeCall(scope, code, operation, null, opts);
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void patchChartOfAccountsAsync(String scope, String code, List<Operation> operation, final ApiCallback<ChartOfAccounts> _callback) throws ApiException {

        HttpRequest localVarCall = patchChartOfAccountsValidateBeforeCall(scope, code, operation, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void patchChartOfAccountsAsync(String scope, String code, List<Operation> operation, final ApiCallback<ChartOfAccounts> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = patchChartOfAccountsValidateBeforeCall(scope, code, operation, _callback, opts);
        Type localVarReturnType = new TypeReference<ChartOfAccounts>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }

    public class APIpatchChartOfAccountsRequest {
        private final String scope;
        private final String code;
        private final List<Operation> operation;

        private APIpatchChartOfAccountsRequest(String scope, String code, List<Operation> operation) {
            this.scope = scope;
            this.code = code;
         ...
         */
        public HttpRequest buildCall(final ApiCallback _callback) throws ApiException {
            return patchChartOfAccountsCall(scope, code, operation, _callback);
        }

        /**
         * Execute patchChartOfAccounts request
         * @return ChartOfAccounts
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ChartOfAccounts execute() throws ApiException {
            ApiResponse<ChartOfAccounts> localVarResp = patchChartOfAccountsWithHttpInfo(scope, code, operation);
            return localVarResp.getData();
        }

        /**
         * Execute patchChartOfAccounts request. Use any specified configuration options to override any other configuration for this request only.
         * @return ChartOfAccounts
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ChartOfAccounts execute(ConfigurationOptions opts) throws ApiException {
            ApiResponse<ChartOfAccounts> localVarResp = patchChartOfAccountsWithHttpInfo(scope, code, operation, opts);
            return localVarResp.getData();
        }

        /**
         * Execute patchChartOfAccounts request with HTTP info returned
         * @return ApiResponse&lt;ChartOfAccounts&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ChartOfAccounts> executeWithHttpInfo() throws ApiException {
            return patchChartOfAccountsWithHttpInfo(scope, code, operation);
        }

        /**
         * Execute patchChartOfAccounts request with HTTP info returned. Use any specified configuration options to override any other configuration for this request only.
         * @return ApiResponse&lt;ChartOfAccounts&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<ChartOfAccounts> executeWithHttpInfo(ConfigurationOptions opts) throws ApiException {
            return patchChartOfAccountsWithHttpInfo(scope, code, operation, opts);
        }

        /**
         * Execute patchChartOfAccounts request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public void executeAsync(final ApiCallback<ChartOfAccounts> _callback) throws ApiException {
            patchChartOfAccountsAsync(scope, code, operation, _callback);
        }

        /**
         * Execute patchChartOfAccounts request (asynchronously). Use any specified configuration options to override any other configuration for this request only.
         * @param _callback The callback to be executed when the API call finishes
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public void executeAsync(final ApiCallback<ChartOfAccounts> _callback, ConfigurationOptions opts) throws ApiException {
            patchChartOfAccountsAsync(scope, code, operation, _callback, opts);
        }
    }
     ...
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required)
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902. (required)
     * @return APIpatchChartOfAccountsRequest
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The updated Chart of Accounts. </td><td>  -  </td></tr>
     ...
     */
    public APIpatchChartOfAccountsRequest patchChartOfAccounts(String scope, String code, List<Operation> operation) {
        return new APIpatchChartOfAccountsRequest(scope, code, operation);
    }
    /**
     ...
     */
    private HttpRequest patchCleardownModuleCall(String scope, String code, String cleardownModuleCode, List<Operation> operation, final ApiCallback _callback) throws ApiException {
        return patchCleardownModuleCall(scope, code, cleardownModuleCode, operation,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for patchCleardownModule. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param cleardownModuleCode The code of the Cleardown Module to be updated. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest patchCleardownModuleCall(String scope, String code, String cleardownModuleCode, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest patchCleardownModuleValidateBeforeCall(String scope, String code, String cleardownModuleCode, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CleardownModuleResponse> patchCleardownModuleWithHttpInfo(String scope, String code, String cleardownModuleCode, List<Operation> operation) throws ApiException {
        HttpRequest localVarCall = patchCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, operation, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<CleardownModuleResponse> patchCleardownModuleWithHttpInfo(String scope, String code, String cleardownModuleCode, List<Operation> operation, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = patchCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, operation, null, opts);
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void patchCleardownModuleAsync(String scope, String code, String cleardownModuleCode, List<Operation> operation, final ApiCallback<CleardownModuleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = patchCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, operation, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void patchCleardownModuleAsync(String scope, String code, String cleardownModuleCode, List<Operation> operation, final ApiCallback<CleardownModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = patchCleardownModuleValidateBeforeCall(scope, code, cleardownModuleCode, operation, _callback, opts);
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIpatchCleardownModuleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CleardownModuleResponse> _callback) throws ApiException {
            patchCleardownModuleAsync(scope, code, cleardownModuleCode, operation, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CleardownModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            patchCleardownModuleAsync(scope, code, cleardownModuleCode, operation, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest patchPostingModuleCall(String scope, String code, String postingModuleCode, List<Operation> operation, final ApiCallback _callback) throws ApiException {
        return patchPostingModuleCall(scope, code, postingModuleCode, operation,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for patchPostingModule. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param postingModuleCode The code of the Posting Module to be updated. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest patchPostingModuleCall(String scope, String code, String postingModuleCode, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest patchPostingModuleValidateBeforeCall(String scope, String code, String postingModuleCode, List<Operation> operation, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PostingModuleResponse> patchPostingModuleWithHttpInfo(String scope, String code, String postingModuleCode, List<Operation> operation) throws ApiException {
        HttpRequest localVarCall = patchPostingModuleValidateBeforeCall(scope, code, postingModuleCode, operation, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PostingModuleResponse> patchPostingModuleWithHttpInfo(String scope, String code, String postingModuleCode, List<Operation> operation, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = patchPostingModuleValidateBeforeCall(scope, code, postingModuleCode, operation, null, opts);
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void patchPostingModuleAsync(String scope, String code, String postingModuleCode, List<Operation> operation, final ApiCallback<PostingModuleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = patchPostingModuleValidateBeforeCall(scope, code, postingModuleCode, operation, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void patchPostingModuleAsync(String scope, String code, String postingModuleCode, List<Operation> operation, final ApiCallback<PostingModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = patchPostingModuleValidateBeforeCall(scope, code, postingModuleCode, operation, _callback, opts);
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIpatchPostingModuleRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PostingModuleResponse> _callback) throws ApiException {
            patchPostingModuleAsync(scope, code, postingModuleCode, operation, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PostingModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            patchPostingModuleAsync(scope, code, postingModuleCode, operation, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest setCleardownModuleDetailsCall(String scope, String code, String cleardownModuleCode, CleardownModuleDetails cleardownModuleDetails, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for setCleardownModuleDetails. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param cleardownModuleCode The code of the Cleardown Module to be updated. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param cleardownModuleDetails The new details for the Cleardown Module. (required)
     ...
     */
    private HttpRequest setCleardownModuleDetailsCall(String scope, String code, String cleardownModuleCode, CleardownModuleDetails cleardownModuleDetails, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest setCleardownModuleDetailsValidateBeforeCall(String scope, String code, String cleardownModuleCode, CleardownModuleDetails cleardownModuleDetails, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CleardownModuleResponse> setCleardownModuleDetailsWithHttpInfo(String scope, String code, String cleardownModuleCode, CleardownModuleDetails cleardownModuleDetails) throws ApiException {
        HttpRequest localVarCall = setCleardownModuleDetailsValidateBeforeCall(scope, code, cleardownModuleCode, cleardownModuleDetails, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<CleardownModuleResponse> setCleardownModuleDetailsWithHttpInfo(String scope, String code, String cleardownModuleCode, CleardownModuleDetails cleardownModuleDetails, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = setCleardownModuleDetailsValidateBeforeCall(scope, code, cleardownModuleCode, cleardownModuleDetails, null, opts);
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void setCleardownModuleDetailsAsync(String scope, String code, String cleardownModuleCode, CleardownModuleDetails cleardownModuleDetails, final ApiCallback<CleardownModuleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = setCleardownModuleDetailsValidateBeforeCall(scope, code, cleardownModuleCode, cleardownModuleDetails, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void setCleardownModuleDetailsAsync(String scope, String code, String cleardownModuleCode, CleardownModuleDetails cleardownModuleDetails, final ApiCallback<CleardownModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = setCleardownModuleDetailsValidateBeforeCall(scope, code, cleardownModuleCode, cleardownModuleDetails, _callback, opts);
        Type localVarReturnType = new TypeReference<CleardownModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIsetCleardownModuleDetailsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CleardownModuleResponse> _callback) throws ApiException {
            setCleardownModuleDetailsAsync(scope, code, cleardownModuleCode, cleardownModuleDetails, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CleardownModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            setCleardownModuleDetailsAsync(scope, code, cleardownModuleCode, cleardownModuleDetails, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest setCleardownModuleRulesCall(String scope, String code, String cleardownModuleCode, List<CleardownModuleRule> cleardownModuleRule, final ApiCallback _callback) throws ApiException {
        return setCleardownModuleRulesCall(scope, code, cleardownModuleCode, cleardownModuleRule,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for setCleardownModuleRules. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param cleardownModuleCode The code of the Cleardown Module to be updated. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param cleardownModuleRule The new rule set for the Cleardown Module. (required)
     ...
     */
    private HttpRequest setCleardownModuleRulesCall(String scope, String code, String cleardownModuleCode, List<CleardownModuleRule> cleardownModuleRule, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest setCleardownModuleRulesValidateBeforeCall(String scope, String code, String cleardownModuleCode, List<CleardownModuleRule> cleardownModuleRule, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CleardownModuleRulesUpdatedResponse> setCleardownModuleRulesWithHttpInfo(String scope, String code, String cleardownModuleCode, List<CleardownModuleRule> cleardownModuleRule) throws ApiException {
        HttpRequest localVarCall = setCleardownModuleRulesValidateBeforeCall(scope, code, cleardownModuleCode, cleardownModuleRule, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CleardownModuleRulesUpdatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<CleardownModuleRulesUpdatedResponse> setCleardownModuleRulesWithHttpInfo(String scope, String code, String cleardownModuleCode, List<CleardownModuleRule> cleardownModuleRule, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = setCleardownModuleRulesValidateBeforeCall(scope, code, cleardownModuleCode, cleardownModuleRule, null, opts);
        Type localVarReturnType = new TypeReference<CleardownModuleRulesUpdatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void setCleardownModuleRulesAsync(String scope, String code, String cleardownModuleCode, List<CleardownModuleRule> cleardownModuleRule, final ApiCallback<CleardownModuleRulesUpdatedResponse> _callback) throws ApiException {

        HttpRequest localVarCall = setCleardownModuleRulesValidateBeforeCall(scope, code, cleardownModuleCode, cleardownModuleRule, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CleardownModuleRulesUpdatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void setCleardownModuleRulesAsync(String scope, String code, String cleardownModuleCode, List<CleardownModuleRule> cleardownModuleRule, final ApiCallback<CleardownModuleRulesUpdatedResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = setCleardownModuleRulesValidateBeforeCall(scope, code, cleardownModuleCode, cleardownModuleRule, _callback, opts);
        Type localVarReturnType = new TypeReference<CleardownModuleRulesUpdatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIsetCleardownModuleRulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CleardownModuleRulesUpdatedResponse> _callback) throws ApiException {
            setCleardownModuleRulesAsync(scope, code, cleardownModuleCode, cleardownModuleRule, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CleardownModuleRulesUpdatedResponse> _callback, ConfigurationOptions opts) throws ApiException {
            setCleardownModuleRulesAsync(scope, code, cleardownModuleCode, cleardownModuleRule, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest setGeneralLedgerProfileMappingsCall(String scope, String code, String generalLedgerProfileCode, List<GeneralLedgerProfileMapping> generalLedgerProfileMapping, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for setGeneralLedgerProfileMappings. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param generalLedgerProfileCode The code of the General Ledger Profile (required). Use any specified configuration options to override any other configuration for this request only.
     * @param generalLedgerProfileMapping The updated General Ledger Profile Mappings, the previous mappings will be wholly replaced with this data. Mappings will be evaluated in the order they are provided. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest setGeneralLedgerProfileMappingsCall(String scope, String code, String generalLedgerProfileCode, List<GeneralLedgerProfileMapping> generalLedgerProfileMapping, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/generalledgerprofile/{generalLedgerProfileCode}/mappings"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
            .replace("{" + "generalLedgerProfileCode" + "}", localVarApiClient.escapeString(generalLedgerProfileCode.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest setGeneralLedgerProfileMappingsValidateBeforeCall(String scope, String code, String generalLedgerProfileCode, List<GeneralLedgerProfileMapping> generalLedgerProfileMapping, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<GeneralLedgerProfileResponse> setGeneralLedgerProfileMappingsWithHttpInfo(String scope, String code, String generalLedgerProfileCode, List<GeneralLedgerProfileMapping> generalLedgerProfileMapping) throws ApiException {
        HttpRequest localVarCall = setGeneralLedgerProfileMappingsValidateBeforeCall(scope, code, generalLedgerProfileCode, generalLedgerProfileMapping, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<GeneralLedgerProfileResponse> setGeneralLedgerProfileMappingsWithHttpInfo(String scope, String code, String generalLedgerProfileCode, List<GeneralLedgerProfileMapping> generalLedgerProfileMapping, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = setGeneralLedgerProfileMappingsValidateBeforeCall(scope, code, generalLedgerProfileCode, generalLedgerProfileMapping, null, opts);
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void setGeneralLedgerProfileMappingsAsync(String scope, String code, String generalLedgerProfileCode, List<GeneralLedgerProfileMapping> generalLedgerProfileMapping, final ApiCallback<GeneralLedgerProfileResponse> _callback) throws ApiException {

        HttpRequest localVarCall = setGeneralLedgerProfileMappingsValidateBeforeCall(scope, code, generalLedgerProfileCode, generalLedgerProfileMapping, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void setGeneralLedgerProfileMappingsAsync(String scope, String code, String generalLedgerProfileCode, List<GeneralLedgerProfileMapping> generalLedgerProfileMapping, final ApiCallback<GeneralLedgerProfileResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = setGeneralLedgerProfileMappingsValidateBeforeCall(scope, code, generalLedgerProfileCode, generalLedgerProfileMapping, _callback, opts);
        Type localVarReturnType = new TypeReference<GeneralLedgerProfileResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIsetGeneralLedgerProfileMappingsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<GeneralLedgerProfileResponse> _callback) throws ApiException {
            setGeneralLedgerProfileMappingsAsync(scope, code, generalLedgerProfileCode, generalLedgerProfileMapping, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<GeneralLedgerProfileResponse> _callback, ConfigurationOptions opts) throws ApiException {
            setGeneralLedgerProfileMappingsAsync(scope, code, generalLedgerProfileCode, generalLedgerProfileMapping, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest setPostingModuleDetailsCall(String scope, String code, String postingModuleCode, PostingModuleDetails postingModuleDetails, final ApiCallback _callback) throws ApiException {
        return setPostingModuleDetailsCall(scope, code, postingModuleCode, postingModuleDetails,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for setPostingModuleDetails. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param postingModuleCode The code of the Posting Module to be updated. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param postingModuleDetails The new details for the Posting Module. (required)
     ...
     */
    private HttpRequest setPostingModuleDetailsCall(String scope, String code, String postingModuleCode, PostingModuleDetails postingModuleDetails, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest setPostingModuleDetailsValidateBeforeCall(String scope, String code, String postingModuleCode, PostingModuleDetails postingModuleDetails, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PostingModuleResponse> setPostingModuleDetailsWithHttpInfo(String scope, String code, String postingModuleCode, PostingModuleDetails postingModuleDetails) throws ApiException {
        HttpRequest localVarCall = setPostingModuleDetailsValidateBeforeCall(scope, code, postingModuleCode, postingModuleDetails, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PostingModuleResponse> setPostingModuleDetailsWithHttpInfo(String scope, String code, String postingModuleCode, PostingModuleDetails postingModuleDetails, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = setPostingModuleDetailsValidateBeforeCall(scope, code, postingModuleCode, postingModuleDetails, null, opts);
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void setPostingModuleDetailsAsync(String scope, String code, String postingModuleCode, PostingModuleDetails postingModuleDetails, final ApiCallback<PostingModuleResponse> _callback) throws ApiException {

        HttpRequest localVarCall = setPostingModuleDetailsValidateBeforeCall(scope, code, postingModuleCode, postingModuleDetails, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void setPostingModuleDetailsAsync(String scope, String code, String postingModuleCode, PostingModuleDetails postingModuleDetails, final ApiCallback<PostingModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = setPostingModuleDetailsValidateBeforeCall(scope, code, postingModuleCode, postingModuleDetails, _callback, opts);
        Type localVarReturnType = new TypeReference<PostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIsetPostingModuleDetailsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PostingModuleResponse> _callback) throws ApiException {
            setPostingModuleDetailsAsync(scope, code, postingModuleCode, postingModuleDetails, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PostingModuleResponse> _callback, ConfigurationOptions opts) throws ApiException {
            setPostingModuleDetailsAsync(scope, code, postingModuleCode, postingModuleDetails, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest setPostingModuleRulesCall(String scope, String code, String postingModuleCode, List<PostingModuleRule> postingModuleRule, final ApiCallback _callback) throws ApiException {
        return setPostingModuleRulesCall(scope, code, postingModuleCode, postingModuleRule,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for setPostingModuleRules. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param postingModuleCode The code of the Posting Module to be updated. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param postingModuleRule The new rule set for the Posting Module. (required)
     ...
     */
    private HttpRequest setPostingModuleRulesCall(String scope, String code, String postingModuleCode, List<PostingModuleRule> postingModuleRule, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest setPostingModuleRulesValidateBeforeCall(String scope, String code, String postingModuleCode, List<PostingModuleRule> postingModuleRule, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<PostingModuleRulesUpdatedResponse> setPostingModuleRulesWithHttpInfo(String scope, String code, String postingModuleCode, List<PostingModuleRule> postingModuleRule) throws ApiException {
        HttpRequest localVarCall = setPostingModuleRulesValidateBeforeCall(scope, code, postingModuleCode, postingModuleRule, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PostingModuleRulesUpdatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PostingModuleRulesUpdatedResponse> setPostingModuleRulesWithHttpInfo(String scope, String code, String postingModuleCode, List<PostingModuleRule> postingModuleRule, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = setPostingModuleRulesValidateBeforeCall(scope, code, postingModuleCode, postingModuleRule, null, opts);
        Type localVarReturnType = new TypeReference<PostingModuleRulesUpdatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void setPostingModuleRulesAsync(String scope, String code, String postingModuleCode, List<PostingModuleRule> postingModuleRule, final ApiCallback<PostingModuleRulesUpdatedResponse> _callback) throws ApiException {

        HttpRequest localVarCall = setPostingModuleRulesValidateBeforeCall(scope, code, postingModuleCode, postingModuleRule, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PostingModuleRulesUpdatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void setPostingModuleRulesAsync(String scope, String code, String postingModuleCode, List<PostingModuleRule> postingModuleRule, final ApiCallback<PostingModuleRulesUpdatedResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = setPostingModuleRulesValidateBeforeCall(scope, code, postingModuleCode, postingModuleRule, _callback, opts);
        Type localVarReturnType = new TypeReference<PostingModuleRulesUpdatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIsetPostingModuleRulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PostingModuleRulesUpdatedResponse> _callback) throws ApiException {
            setPostingModuleRulesAsync(scope, code, postingModuleCode, postingModuleRule, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PostingModuleRulesUpdatedResponse> _callback, ConfigurationOptions opts) throws ApiException {
            setPostingModuleRulesAsync(scope, code, postingModuleCode, postingModuleRule, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertAccountPropertiesCall(String scope, String code, String accountCode, Map<String, Property> requestBody, final ApiCallback _callback) throws ApiException {
        return upsertAccountPropertiesCall(scope, code, accountCode, requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertAccountProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts to update or insert the properties onto. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts to update or insert the properties onto. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param accountCode The unique ID of the account to create or update properties for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The properties to be updated or inserted onto the chart of account. Each property in               the request must be keyed by its unique property key. This has the format {domain}/{scope}/{code} e.g. \&quot;Account/Manager/Id\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertAccountPropertiesCall(String scope, String code, String accountCode, Map<String, Property> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/accounts/{accountCode}/properties/$upsert"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()))
            .replace("{" + "accountCode" + "}", localVarApiClient.escapeString(accountCode.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertAccountPropertiesValidateBeforeCall(String scope, String code, String accountCode, Map<String, Property> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AccountProperties> upsertAccountPropertiesWithHttpInfo(String scope, String code, String accountCode, Map<String, Property> requestBody) throws ApiException {
        HttpRequest localVarCall = upsertAccountPropertiesValidateBeforeCall(scope, code, accountCode, requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AccountProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<AccountProperties> upsertAccountPropertiesWithHttpInfo(String scope, String code, String accountCode, Map<String, Property> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertAccountPropertiesValidateBeforeCall(scope, code, accountCode, requestBody, null, opts);
        Type localVarReturnType = new TypeReference<AccountProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertAccountPropertiesAsync(String scope, String code, String accountCode, Map<String, Property> requestBody, final ApiCallback<AccountProperties> _callback) throws ApiException {

        HttpRequest localVarCall = upsertAccountPropertiesValidateBeforeCall(scope, code, accountCode, requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AccountProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertAccountPropertiesAsync(String scope, String code, String accountCode, Map<String, Property> requestBody, final ApiCallback<AccountProperties> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertAccountPropertiesValidateBeforeCall(scope, code, accountCode, requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<AccountProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertAccountPropertiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AccountProperties> _callback) throws ApiException {
            upsertAccountPropertiesAsync(scope, code, accountCode, requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AccountProperties> _callback, ConfigurationOptions opts) throws ApiException {
            upsertAccountPropertiesAsync(scope, code, accountCode, requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertAccountsCall(String scope, String code, List<Account> account, final ApiCallback _callback) throws ApiException {
        return upsertAccountsCall(scope, code, account,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertAccounts. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies              the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param account A list of accounts to be created or updated. (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest upsertAccountsCall(String scope, String code, List<Account> account, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertAccountsValidateBeforeCall(String scope, String code, List<Account> account, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AccountsUpsertResponse> upsertAccountsWithHttpInfo(String scope, String code, List<Account> account) throws ApiException {
        HttpRequest localVarCall = upsertAccountsValidateBeforeCall(scope, code, account, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AccountsUpsertResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<AccountsUpsertResponse> upsertAccountsWithHttpInfo(String scope, String code, List<Account> account, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertAccountsValidateBeforeCall(scope, code, account, null, opts);
        Type localVarReturnType = new TypeReference<AccountsUpsertResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertAccountsAsync(String scope, String code, List<Account> account, final ApiCallback<AccountsUpsertResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertAccountsValidateBeforeCall(scope, code, account, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AccountsUpsertResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertAccountsAsync(String scope, String code, List<Account> account, final ApiCallback<AccountsUpsertResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertAccountsValidateBeforeCall(scope, code, account, _callback, opts);
        Type localVarReturnType = new TypeReference<AccountsUpsertResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertAccountsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AccountsUpsertResponse> _callback) throws ApiException {
            upsertAccountsAsync(scope, code, account, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AccountsUpsertResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertAccountsAsync(scope, code, account, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertChartOfAccountsPropertiesCall(String scope, String code, Map<String, Property> requestBody, final ApiCallback _callback) throws ApiException {
        return upsertChartOfAccountsPropertiesCall(scope, code, requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertChartOfAccountsProperties. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Chart of Accounts to update or insert the properties onto. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the Chart of Accounts to update or insert the properties onto. Together with the scope this uniquely identifies the Chart of Accounts. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The properties to be updated or inserted onto the chart of account. Each property in               the request must be keyed by its unique property key. This has the format {domain}/{scope}/{code} e.g. \&quot;ChartOfAccounts/Manager/Id\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest upsertChartOfAccountsPropertiesCall(String scope, String code, Map<String, Property> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/chartofaccounts/{scope}/{code}/properties/$upsert"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertChartOfAccountsPropertiesValidateBeforeCall(String scope, String code, Map<String, Property> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ChartOfAccountsProperties> upsertChartOfAccountsPropertiesWithHttpInfo(String scope, String code, Map<String, Property> requestBody) throws ApiException {
        HttpRequest localVarCall = upsertChartOfAccountsPropertiesValidateBeforeCall(scope, code, requestBody, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ChartOfAccountsProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ChartOfAccountsProperties> upsertChartOfAccountsPropertiesWithHttpInfo(String scope, String code, Map<String, Property> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertChartOfAccountsPropertiesValidateBeforeCall(scope, code, requestBody, null, opts);
        Type localVarReturnType = new TypeReference<ChartOfAccountsProperties>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertChartOfAccountsPropertiesAsync(String scope, String code, Map<String, Property> requestBody, final ApiCallback<ChartOfAccountsProperties> _callback) throws ApiException {

        HttpRequest localVarCall = upsertChartOfAccountsPropertiesValidateBeforeCall(scope, code, requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ChartOfAccountsProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertChartOfAccountsPropertiesAsync(String scope, String code, Map<String, Property> requestBody, final ApiCallback<ChartOfAccountsProperties> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertChartOfAccountsPropertiesValidateBeforeCall(scope, code, requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<ChartOfAccountsProperties>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertChartOfAccountsPropertiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ChartOfAccountsProperties> _callback) throws ApiException {
            upsertChartOfAccountsPropertiesAsync(scope, code, requestBody, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ChartOfAccountsProperties> _callback, ConfigurationOptions opts) throws ApiException {
            upsertChartOfAccountsPropertiesAsync(scope, code, requestBody, _callback, opts);
        }
    }
