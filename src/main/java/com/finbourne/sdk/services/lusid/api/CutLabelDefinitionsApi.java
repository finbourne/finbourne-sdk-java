...
public class CutLabelDefinitionsApi {
     ...
     */
    private HttpRequest createCutLabelDefinitionCall(CreateCutLabelDefinitionRequest createCutLabelDefinitionRequest, final ApiCallback _callback) throws ApiException {
        return createCutLabelDefinitionCall(createCutLabelDefinitionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createCutLabelDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param createCutLabelDefinitionRequest The cut label definition (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createCutLabelDefinitionCall(CreateCutLabelDefinitionRequest createCutLabelDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/systemconfiguration/cutlabels";
    ...
    private HttpRequest createCutLabelDefinitionValidateBeforeCall(CreateCutLabelDefinitionRequest createCutLabelDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<CutLabelDefinition> createCutLabelDefinitionWithHttpInfo(CreateCutLabelDefinitionRequest createCutLabelDefinitionRequest) throws ApiException {
        HttpRequest localVarCall = createCutLabelDefinitionValidateBeforeCall(createCutLabelDefinitionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CreateCutLabelDefinition: Create a Cut Label
     * Create a Cut Label valid in all scopesUse any specified configuration options to override any other configuration for this request only
     * @param createCutLabelDefinitionRequest The cut label definition (optional)
     * @return ApiResponse&lt;CutLabelDefinition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<CutLabelDefinition> createCutLabelDefinitionWithHttpInfo(CreateCutLabelDefinitionRequest createCutLabelDefinitionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createCutLabelDefinitionValidateBeforeCall(createCutLabelDefinitionRequest, null, opts);
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createCutLabelDefinitionAsync(CreateCutLabelDefinitionRequest createCutLabelDefinitionRequest, final ApiCallback<CutLabelDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = createCutLabelDefinitionValidateBeforeCall(createCutLabelDefinitionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
     ...
     */
    private void createCutLabelDefinitionAsync(CreateCutLabelDefinitionRequest createCutLabelDefinitionRequest, final ApiCallback<CutLabelDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createCutLabelDefinitionValidateBeforeCall(createCutLabelDefinitionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateCutLabelDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CutLabelDefinition> _callback) throws ApiException {
            createCutLabelDefinitionAsync(createCutLabelDefinitionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CutLabelDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            createCutLabelDefinitionAsync(createCutLabelDefinitionRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteCutLabelDefinitionCall(String code, final ApiCallback _callback) throws ApiException {
        return deleteCutLabelDefinitionCall(code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteCutLabelDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param code The Code of the Cut Label that is being Deleted (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteCutLabelDefinitionCall(String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/systemconfiguration/cutlabels/{code}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteCutLabelDefinitionValidateBeforeCall(String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<OffsetDateTime> deleteCutLabelDefinitionWithHttpInfo(String code) throws ApiException {
        HttpRequest localVarCall = deleteCutLabelDefinitionValidateBeforeCall(code, null, new ConfigurationOptions());
    ...
    /**
     * DeleteCutLabelDefinition: Delete a Cut Label
     * Delete a specified cut labelUse any specified configuration options to override any other configuration for this request only
     * @param code The Code of the Cut Label that is being Deleted (required)
     * @return ApiResponse&lt;OffsetDateTime&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<OffsetDateTime> deleteCutLabelDefinitionWithHttpInfo(String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCutLabelDefinitionValidateBeforeCall(code, null, opts);
        Type localVarReturnType = new TypeReference<OffsetDateTime>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteCutLabelDefinitionAsync(String code, final ApiCallback<OffsetDateTime> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCutLabelDefinitionValidateBeforeCall(code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<OffsetDateTime>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteCutLabelDefinitionAsync(String code, final ApiCallback<OffsetDateTime> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCutLabelDefinitionValidateBeforeCall(code, _callback, opts);
        Type localVarReturnType = new TypeReference<OffsetDateTime>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCutLabelDefinitionRequest {
        ...
        public void executeAsync(final ApiCallback<OffsetDateTime> _callback) throws ApiException {
            deleteCutLabelDefinitionAsync(code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<OffsetDateTime> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCutLabelDefinitionAsync(code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getCutLabelDefinitionCall(String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getCutLabelDefinitionCall(code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getCutLabelDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param code The Code of the Cut Label that is being queried (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The time at which to get the Cut Label (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getCutLabelDefinitionCall(String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCutLabelDefinitionValidateBeforeCall(String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'code' is set
        if (code == null) {
    ...
    private ApiResponse<CutLabelDefinition> getCutLabelDefinitionWithHttpInfo(String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getCutLabelDefinitionValidateBeforeCall(code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * GetCutLabelDefinition: Get a Cut Label
     * Get a specified cut label at a given timeUse any specified configuration options to override any other configuration for this request only
     * @param code The Code of the Cut Label that is being queried (required)
     * @param asAt The time at which to get the Cut Label (optional)
     * @return ApiResponse&lt;CutLabelDefinition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<CutLabelDefinition> getCutLabelDefinitionWithHttpInfo(String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCutLabelDefinitionValidateBeforeCall(code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getCutLabelDefinitionAsync(String code, OffsetDateTime asAt, final ApiCallback<CutLabelDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = getCutLabelDefinitionValidateBeforeCall(code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCutLabelDefinitionAsync(String code, OffsetDateTime asAt, final ApiCallback<CutLabelDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCutLabelDefinitionValidateBeforeCall(code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCutLabelDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CutLabelDefinition> _callback) throws ApiException {
            getCutLabelDefinitionAsync(code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CutLabelDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            getCutLabelDefinitionAsync(code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listCutLabelDefinitionsCall(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback _callback) throws ApiException {
        return listCutLabelDefinitionsCall(asAt, sortBy, limit, filter, page,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listCutLabelDefinitions. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt Optional. The As At time at which listed Cut Labels are valid (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listCutLabelDefinitionsCall(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listCutLabelDefinitionsValidateBeforeCall(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfCutLabelDefinition> listCutLabelDefinitionsWithHttpInfo(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page) throws ApiException {
        HttpRequest localVarCall = listCutLabelDefinitionsValidateBeforeCall(asAt, sortBy, limit, filter, page, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCutLabelDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListCutLabelDefinitions: List Existing Cut Labels
     * List all the Cut Label Definitions that are valid at the given AsAt timeUse any specified configuration options to override any other configuration for this request only
     * @param asAt Optional. The As At time at which listed Cut Labels are valid (optional)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @param filter Optional. Expression to filter the result set.              For example, to filter on code, use \&quot;code eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    private ApiResponse<PagedResourceListOfCutLabelDefinition> listCutLabelDefinitionsWithHttpInfo(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listCutLabelDefinitionsValidateBeforeCall(asAt, sortBy, limit, filter, page, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCutLabelDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listCutLabelDefinitionsAsync(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback<PagedResourceListOfCutLabelDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = listCutLabelDefinitionsValidateBeforeCall(asAt, sortBy, limit, filter, page, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCutLabelDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listCutLabelDefinitionsAsync(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback<PagedResourceListOfCutLabelDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listCutLabelDefinitionsValidateBeforeCall(asAt, sortBy, limit, filter, page, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCutLabelDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistCutLabelDefinitionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCutLabelDefinition> _callback) throws ApiException {
            listCutLabelDefinitionsAsync(asAt, sortBy, limit, filter, page, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCutLabelDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            listCutLabelDefinitionsAsync(asAt, sortBy, limit, filter, page, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateCutLabelDefinitionCall(String code, UpdateCutLabelDefinitionRequest updateCutLabelDefinitionRequest, final ApiCallback _callback) throws ApiException {
        return updateCutLabelDefinitionCall(code, updateCutLabelDefinitionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateCutLabelDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param code The Code of the Cut Label that is being updated (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateCutLabelDefinitionRequest The cut label update definition (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updateCutLabelDefinitionCall(String code, UpdateCutLabelDefinitionRequest updateCutLabelDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateCutLabelDefinitionValidateBeforeCall(String code, UpdateCutLabelDefinitionRequest updateCutLabelDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'code' is set
        if (code == null) {
    ...
    private ApiResponse<CutLabelDefinition> updateCutLabelDefinitionWithHttpInfo(String code, UpdateCutLabelDefinitionRequest updateCutLabelDefinitionRequest) throws ApiException {
        HttpRequest localVarCall = updateCutLabelDefinitionValidateBeforeCall(code, updateCutLabelDefinitionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * UpdateCutLabelDefinition: Update a Cut Label
     * Update a specified cut labelUse any specified configuration options to override any other configuration for this request only
     * @param code The Code of the Cut Label that is being updated (required)
     * @param updateCutLabelDefinitionRequest The cut label update definition (optional)
     * @return ApiResponse&lt;CutLabelDefinition&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<CutLabelDefinition> updateCutLabelDefinitionWithHttpInfo(String code, UpdateCutLabelDefinitionRequest updateCutLabelDefinitionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateCutLabelDefinitionValidateBeforeCall(code, updateCutLabelDefinitionRequest, null, opts);
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void updateCutLabelDefinitionAsync(String code, UpdateCutLabelDefinitionRequest updateCutLabelDefinitionRequest, final ApiCallback<CutLabelDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = updateCutLabelDefinitionValidateBeforeCall(code, updateCutLabelDefinitionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateCutLabelDefinitionAsync(String code, UpdateCutLabelDefinitionRequest updateCutLabelDefinitionRequest, final ApiCallback<CutLabelDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateCutLabelDefinitionValidateBeforeCall(code, updateCutLabelDefinitionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<CutLabelDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateCutLabelDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CutLabelDefinition> _callback) throws ApiException {
            updateCutLabelDefinitionAsync(code, updateCutLabelDefinitionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CutLabelDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            updateCutLabelDefinitionAsync(code, updateCutLabelDefinitionRequest, _callback, opts);
        }
    }
