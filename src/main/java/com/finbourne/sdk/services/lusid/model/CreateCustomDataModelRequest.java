 ...
 */
@JsonPropertyOrder({
  CreateCustomDataModelRequest.JSON_PROPERTY_ID,
  CreateCustomDataModelRequest.JSON_PROPERTY_DISPLAY_NAME,
  CreateCustomDataModelRequest.JSON_PROPERTY_DESCRIPTION,
  CreateCustomDataModelRequest.JSON_PROPERTY_PARENT_DATA_MODEL,
  CreateCustomDataModelRequest.JSON_PROPERTY_CONDITIONS,
  CreateCustomDataModelRequest.JSON_PROPERTY_PROPERTIES,
  CreateCustomDataModelRequest.JSON_PROPERTY_IDENTIFIER_TYPES,
  CreateCustomDataModelRequest.JSON_PROPERTY_ATTRIBUTE_ALIASES,
  CreateCustomDataModelRequest.JSON_PROPERTY_RECOMMENDED_SORT_BY,
  CreateCustomDataModelRequest.JSON_PROPERTY_SUPPLEMENTAL_PROPERTY_KEYS
})
...
public class CreateCustomDataModelRequest {
  ...
  public CreateCustomDataModelRequest properties(List<CustomDataModelPropertySpecification> properties) {
  ...
  public CreateCustomDataModelRequest identifierTypes(List<CustomDataModelIdentifierTypeSpecification> identifierTypes) {
  ...
  public CreateCustomDataModelRequest attributeAliases(List<Alias> attributeAliases) {
  ...
  public CreateCustomDataModelRequest recommendedSortBy(List<RecommendedSortBy> recommendedSortBy) {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to CreateCustomDataModelRequest
   */
  public static CreateCustomDataModelRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, CreateCustomDataModelRequest.class);
  }
