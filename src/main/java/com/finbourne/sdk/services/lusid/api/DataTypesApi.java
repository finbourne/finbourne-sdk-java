...
public class DataTypesApi {
     ...
     */
    private HttpRequest createDataTypeCall(CreateDataTypeRequest createDataTypeRequest, final ApiCallback _callback) throws ApiException {
        return createDataTypeCall(createDataTypeRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createDataType. Use any specified configuration options to override any other configuration for this request only.
     * @param createDataTypeRequest The definition of the new data type (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createDataTypeCall(CreateDataTypeRequest createDataTypeRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/datatypes";
    ...
    private HttpRequest createDataTypeValidateBeforeCall(CreateDataTypeRequest createDataTypeRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DataType> createDataTypeWithHttpInfo(CreateDataTypeRequest createDataTypeRequest) throws ApiException {
        HttpRequest localVarCall = createDataTypeValidateBeforeCall(createDataTypeRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] CreateDataType: Create data type definition
     * Create a new data type definition    Data types cannot be created in either the \&quot;default\&quot; or \&quot;system\&quot; scopes.Use any specified configuration options to override any other configuration for this request only
     * @param createDataTypeRequest The definition of the new data type (optional)
     * @return ApiResponse&lt;DataType&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<DataType> createDataTypeWithHttpInfo(CreateDataTypeRequest createDataTypeRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createDataTypeValidateBeforeCall(createDataTypeRequest, null, opts);
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void createDataTypeAsync(CreateDataTypeRequest createDataTypeRequest, final ApiCallback<DataType> _callback) throws ApiException {

        HttpRequest localVarCall = createDataTypeValidateBeforeCall(createDataTypeRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
     ...
     */
    private void createDataTypeAsync(CreateDataTypeRequest createDataTypeRequest, final ApiCallback<DataType> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createDataTypeValidateBeforeCall(createDataTypeRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateDataTypeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DataType> _callback) throws ApiException {
            createDataTypeAsync(createDataTypeRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DataType> _callback, ConfigurationOptions opts) throws ApiException {
            createDataTypeAsync(createDataTypeRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteDataTypeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteDataTypeCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteDataType. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the data type (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteDataTypeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/datatypes/{scope}/{code}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteDataTypeValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteDataTypeWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteDataTypeValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * DeleteDataType: Delete a data type definition.
     * Delete an existing data type definition.    Data types cannot be deleted in either the \&quot;default\&quot; or \&quot;system\&quot; scopes, scopes beginning with \&quot;LUSID-\&quot;,  or data types that are in use on a property definition.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the data type (required)
     * @param code The code of the data type (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deleteDataTypeWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteDataTypeValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * DeleteDataType: Delete a data type definition. (asynchronously)
     * Delete an existing data type definition.    Data types cannot be deleted in either the \&quot;default\&quot; or \&quot;system\&quot; scopes, scopes beginning with \&quot;LUSID-\&quot;,  or data types that are in use on a property definition.
     * @param scope The scope of the data type (required)
     * @param code The code of the data type (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void deleteDataTypeAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteDataTypeValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteDataTypeAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteDataTypeValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteDataTypeRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteDataTypeAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteDataTypeAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getDataTypeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getDataTypeCall(scope, code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getDataType. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the data type definition. Defaults to              return the latest version of the instrument definition if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getDataTypeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getDataTypeValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DataType> getDataTypeWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getDataTypeValidateBeforeCall(scope, code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * GetDataType: Get data type definition
     * Get the definition of a specified data typeUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the data type (required)
     * @param code The code of the data type (required)
     * @param asAt The asAt datetime at which to retrieve the data type definition. Defaults to              return the latest version of the instrument definition if not specified. (optional)
     * @return ApiResponse&lt;DataType&gt;
    ...
    private ApiResponse<DataType> getDataTypeWithHttpInfo(String scope, String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getDataTypeValidateBeforeCall(scope, code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getDataTypeAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<DataType> _callback) throws ApiException {

        HttpRequest localVarCall = getDataTypeValidateBeforeCall(scope, code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getDataTypeAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<DataType> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getDataTypeValidateBeforeCall(scope, code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetDataTypeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DataType> _callback) throws ApiException {
            getDataTypeAsync(scope, code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DataType> _callback, ConfigurationOptions opts) throws ApiException {
            getDataTypeAsync(scope, code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getUnitsFromDataTypeCall(String scope, String code, List<String> units, String filter, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getUnitsFromDataTypeCall(scope, code, units, filter, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getUnitsFromDataType. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param units One or more unit identifiers for which the definition is being requested (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Optional. Expression to filter the result set.               For example, to filter on the Schema, use \&quot;schema eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt Optional. The as at of the requested data type (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getUnitsFromDataTypeCall(String scope, String code, List<String> units, String filter, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/datatypes/{scope}/{code}/units"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getUnitsFromDataTypeValidateBeforeCall(String scope, String code, List<String> units, String filter, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfIUnitDefinitionDto> getUnitsFromDataTypeWithHttpInfo(String scope, String code, List<String> units, String filter, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getUnitsFromDataTypeValidateBeforeCall(scope, code, units, filter, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfIUnitDefinitionDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetUnitsFromDataType: Get units from data type
     * Get the definitions of the specified units associated bound to a specific data typeUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the data type (required)
     * @param code The code of the data type (required)
     * @param units One or more unit identifiers for which the definition is being requested (optional)
     * @param filter Optional. Expression to filter the result set.               For example, to filter on the Schema, use \&quot;schema eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    private ApiResponse<ResourceListOfIUnitDefinitionDto> getUnitsFromDataTypeWithHttpInfo(String scope, String code, List<String> units, String filter, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getUnitsFromDataTypeValidateBeforeCall(scope, code, units, filter, asAt, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfIUnitDefinitionDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getUnitsFromDataTypeAsync(String scope, String code, List<String> units, String filter, OffsetDateTime asAt, final ApiCallback<ResourceListOfIUnitDefinitionDto> _callback) throws ApiException {

        HttpRequest localVarCall = getUnitsFromDataTypeValidateBeforeCall(scope, code, units, filter, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfIUnitDefinitionDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getUnitsFromDataTypeAsync(String scope, String code, List<String> units, String filter, OffsetDateTime asAt, final ApiCallback<ResourceListOfIUnitDefinitionDto> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getUnitsFromDataTypeValidateBeforeCall(scope, code, units, filter, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfIUnitDefinitionDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetUnitsFromDataTypeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfIUnitDefinitionDto> _callback) throws ApiException {
            getUnitsFromDataTypeAsync(scope, code, units, filter, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfIUnitDefinitionDto> _callback, ConfigurationOptions opts) throws ApiException {
            getUnitsFromDataTypeAsync(scope, code, units, filter, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listDataTypeSummariesCall(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback) throws ApiException {
        return listDataTypeSummariesCall(asAt, page, limit, filter, sortBy,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listDataTypeSummaries. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the data type summaries. Defaults to returning the latest version               of each summary if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing data type summaries. This  value is returned from the previous call. If a pagination token is provided, the filter, sortBy  and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listDataTypeSummariesCall(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listDataTypeSummariesValidateBeforeCall(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfDataTypeSummary> listDataTypeSummariesWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy) throws ApiException {
        HttpRequest localVarCall = listDataTypeSummariesValidateBeforeCall(asAt, page, limit, filter, sortBy, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfDataTypeSummary>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListDataTypeSummaries: List all data type summaries, without the reference data
     * List all data type summariesUse any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to list the data type summaries. Defaults to returning the latest version               of each summary if not specified. (optional)
     * @param page The pagination token to use to continue listing data type summaries. This  value is returned from the previous call. If a pagination token is provided, the filter, sortBy  and asAt fields must not have changed since the original request. (optional)
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional)
     * @param filter Optional. Expression to filter the result set.                For example, to filter on the Scope, use \&quot;id.scope eq &#39;myscope&#39;\&quot;, to filter on Schema, use \&quot;schema eq &#39;string&#39;\&quot;,               to filter on AcceptableValues use \&quot;acceptableValues any (~ eq &#39;value&#39;)\&quot;               Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    private ApiResponse<PagedResourceListOfDataTypeSummary> listDataTypeSummariesWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listDataTypeSummariesValidateBeforeCall(asAt, page, limit, filter, sortBy, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfDataTypeSummary>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listDataTypeSummariesAsync(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfDataTypeSummary> _callback) throws ApiException {

        HttpRequest localVarCall = listDataTypeSummariesValidateBeforeCall(asAt, page, limit, filter, sortBy, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfDataTypeSummary>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listDataTypeSummariesAsync(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, final ApiCallback<PagedResourceListOfDataTypeSummary> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listDataTypeSummariesValidateBeforeCall(asAt, page, limit, filter, sortBy, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfDataTypeSummary>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistDataTypeSummariesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfDataTypeSummary> _callback) throws ApiException {
            listDataTypeSummariesAsync(asAt, page, limit, filter, sortBy, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfDataTypeSummary> _callback, ConfigurationOptions opts) throws ApiException {
            listDataTypeSummariesAsync(asAt, page, limit, filter, sortBy, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listDataTypesCall(String scope, OffsetDateTime asAt, Boolean includeSystem, List<String> sortBy, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        return listDataTypesCall(scope, asAt, includeSystem, sortBy, limit, filter,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listDataTypes. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The requested scope of the data types (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The as at of the requested data types (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param includeSystem Whether to additionally include those data types in the \&quot;system\&quot; scope (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listDataTypesCall(String scope, OffsetDateTime asAt, Boolean includeSystem, List<String> sortBy, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/datatypes/{scope}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listDataTypesValidateBeforeCall(String scope, OffsetDateTime asAt, Boolean includeSystem, List<String> sortBy, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfDataType> listDataTypesWithHttpInfo(String scope, OffsetDateTime asAt, Boolean includeSystem, List<String> sortBy, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = listDataTypesValidateBeforeCall(scope, asAt, includeSystem, sortBy, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfDataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListDataTypes: List data types
     * List all data types in a specified scopeUse any specified configuration options to override any other configuration for this request only
     * @param scope The requested scope of the data types (required)
     * @param asAt The as at of the requested data types (optional)
     * @param includeSystem Whether to additionally include those data types in the \&quot;system\&quot; scope (optional)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
    ...
    private ApiResponse<ResourceListOfDataType> listDataTypesWithHttpInfo(String scope, OffsetDateTime asAt, Boolean includeSystem, List<String> sortBy, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listDataTypesValidateBeforeCall(scope, asAt, includeSystem, sortBy, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfDataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listDataTypesAsync(String scope, OffsetDateTime asAt, Boolean includeSystem, List<String> sortBy, Integer limit, String filter, final ApiCallback<ResourceListOfDataType> _callback) throws ApiException {

        HttpRequest localVarCall = listDataTypesValidateBeforeCall(scope, asAt, includeSystem, sortBy, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfDataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listDataTypesAsync(String scope, OffsetDateTime asAt, Boolean includeSystem, List<String> sortBy, Integer limit, String filter, final ApiCallback<ResourceListOfDataType> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listDataTypesValidateBeforeCall(scope, asAt, includeSystem, sortBy, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfDataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistDataTypesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfDataType> _callback) throws ApiException {
            listDataTypesAsync(scope, asAt, includeSystem, sortBy, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfDataType> _callback, ConfigurationOptions opts) throws ApiException {
            listDataTypesAsync(scope, asAt, includeSystem, sortBy, limit, filter, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateDataTypeCall(String scope, String code, UpdateDataTypeRequest updateDataTypeRequest, final ApiCallback _callback) throws ApiException {
        return updateDataTypeCall(scope, code, updateDataTypeRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateDataType. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateDataTypeRequest The updated definition of the data type (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest updateDataTypeCall(String scope, String code, UpdateDataTypeRequest updateDataTypeRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateDataTypeValidateBeforeCall(String scope, String code, UpdateDataTypeRequest updateDataTypeRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DataType> updateDataTypeWithHttpInfo(String scope, String code, UpdateDataTypeRequest updateDataTypeRequest) throws ApiException {
        HttpRequest localVarCall = updateDataTypeValidateBeforeCall(scope, code, updateDataTypeRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpdateDataType: Update data type definition
     * Update the definition of the specified existing data type    Not all elements within a data type definition are modifiable due to the potential implications for data  already stored against the typesUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the data type (required)
     * @param code The code of the data type (required)
     * @param updateDataTypeRequest The updated definition of the data type (required)
     * @return ApiResponse&lt;DataType&gt;
    ...
    private ApiResponse<DataType> updateDataTypeWithHttpInfo(String scope, String code, UpdateDataTypeRequest updateDataTypeRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateDataTypeValidateBeforeCall(scope, code, updateDataTypeRequest, null, opts);
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void updateDataTypeAsync(String scope, String code, UpdateDataTypeRequest updateDataTypeRequest, final ApiCallback<DataType> _callback) throws ApiException {

        HttpRequest localVarCall = updateDataTypeValidateBeforeCall(scope, code, updateDataTypeRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateDataTypeAsync(String scope, String code, UpdateDataTypeRequest updateDataTypeRequest, final ApiCallback<DataType> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateDataTypeValidateBeforeCall(scope, code, updateDataTypeRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateDataTypeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DataType> _callback) throws ApiException {
            updateDataTypeAsync(scope, code, updateDataTypeRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DataType> _callback, ConfigurationOptions opts) throws ApiException {
            updateDataTypeAsync(scope, code, updateDataTypeRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateReferenceDataCall(String scope, String code, UpdateReferenceDataRequest updateReferenceDataRequest, final ApiCallback _callback) throws ApiException {
        return updateReferenceDataCall(scope, code, updateReferenceDataRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateReferenceData. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateReferenceDataRequest The updated reference data (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest updateReferenceDataCall(String scope, String code, UpdateReferenceDataRequest updateReferenceDataRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/datatypes/{scope}/{code}/referencedata"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateReferenceDataValidateBeforeCall(String scope, String code, UpdateReferenceDataRequest updateReferenceDataRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DataType> updateReferenceDataWithHttpInfo(String scope, String code, UpdateReferenceDataRequest updateReferenceDataRequest) throws ApiException {
        HttpRequest localVarCall = updateReferenceDataValidateBeforeCall(scope, code, updateReferenceDataRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpdateReferenceData: Update all reference data on a data type, includes the reference values, the field definitions, field values
     * Replaces the whole set of reference dataUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the data type (required)
     * @param code The code of the data type (required)
     * @param updateReferenceDataRequest The updated reference data (required)
     * @return ApiResponse&lt;DataType&gt;
    ...
    private ApiResponse<DataType> updateReferenceDataWithHttpInfo(String scope, String code, UpdateReferenceDataRequest updateReferenceDataRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateReferenceDataValidateBeforeCall(scope, code, updateReferenceDataRequest, null, opts);
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpdateReferenceData: Update all reference data on a data type, includes the reference values, the field definitions, field values (asynchronously)
     * Replaces the whole set of reference data
     * @param scope The scope of the data type (required)
     * @param code The code of the data type (required)
     * @param updateReferenceDataRequest The updated reference data (required)
     ...
     */
    private void updateReferenceDataAsync(String scope, String code, UpdateReferenceDataRequest updateReferenceDataRequest, final ApiCallback<DataType> _callback) throws ApiException {

        HttpRequest localVarCall = updateReferenceDataValidateBeforeCall(scope, code, updateReferenceDataRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateReferenceDataAsync(String scope, String code, UpdateReferenceDataRequest updateReferenceDataRequest, final ApiCallback<DataType> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateReferenceDataValidateBeforeCall(scope, code, updateReferenceDataRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateReferenceDataRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DataType> _callback) throws ApiException {
            updateReferenceDataAsync(scope, code, updateReferenceDataRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DataType> _callback, ConfigurationOptions opts) throws ApiException {
            updateReferenceDataAsync(scope, code, updateReferenceDataRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateReferenceValuesCall(String scope, String code, List<FieldValue> fieldValue, final ApiCallback _callback) throws ApiException {
        return updateReferenceValuesCall(scope, code, fieldValue,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateReferenceValues. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the data type (required). Use any specified configuration options to override any other configuration for this request only.
     * @param fieldValue The updated reference values (required)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest updateReferenceValuesCall(String scope, String code, List<FieldValue> fieldValue, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/datatypes/{scope}/{code}/referencedatavalues"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateReferenceValuesValidateBeforeCall(String scope, String code, List<FieldValue> fieldValue, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<DataType> updateReferenceValuesWithHttpInfo(String scope, String code, List<FieldValue> fieldValue) throws ApiException {
        HttpRequest localVarCall = updateReferenceValuesValidateBeforeCall(scope, code, fieldValue, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpdateReferenceValues: Update reference data on a data type
     * Replaces the whole set of reference valuesUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the data type (required)
     * @param code The code of the data type (required)
     * @param fieldValue The updated reference values (required)
     * @return ApiResponse&lt;DataType&gt;
    ...
    private ApiResponse<DataType> updateReferenceValuesWithHttpInfo(String scope, String code, List<FieldValue> fieldValue, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateReferenceValuesValidateBeforeCall(scope, code, fieldValue, null, opts);
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void updateReferenceValuesAsync(String scope, String code, List<FieldValue> fieldValue, final ApiCallback<DataType> _callback) throws ApiException {

        HttpRequest localVarCall = updateReferenceValuesValidateBeforeCall(scope, code, fieldValue, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateReferenceValuesAsync(String scope, String code, List<FieldValue> fieldValue, final ApiCallback<DataType> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateReferenceValuesValidateBeforeCall(scope, code, fieldValue, _callback, opts);
        Type localVarReturnType = new TypeReference<DataType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateReferenceValuesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<DataType> _callback) throws ApiException {
            updateReferenceValuesAsync(scope, code, fieldValue, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<DataType> _callback, ConfigurationOptions opts) throws ApiException {
            updateReferenceValuesAsync(scope, code, fieldValue, _callback, opts);
        }
    }
