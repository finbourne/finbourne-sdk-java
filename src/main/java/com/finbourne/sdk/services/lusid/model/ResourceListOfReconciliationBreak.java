 ...
 */
@JsonPropertyOrder({
  ResourceListOfReconciliationBreak.JSON_PROPERTY_VALUES,
  ResourceListOfReconciliationBreak.JSON_PROPERTY_HREF,
  ResourceListOfReconciliationBreak.JSON_PROPERTY_LINKS,
  ResourceListOfReconciliationBreak.JSON_PROPERTY_NEXT_PAGE,
  ResourceListOfReconciliationBreak.JSON_PROPERTY_PREVIOUS_PAGE
})
...
public class ResourceListOfReconciliationBreak {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ResourceListOfReconciliationBreak
   */
  public static ResourceListOfReconciliationBreak fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ResourceListOfReconciliationBreak.class);
  }
