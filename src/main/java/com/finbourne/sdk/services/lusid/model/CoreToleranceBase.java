 ...
 */
@JsonPropertyOrder({
  CoreToleranceBase.JSON_PROPERTY_TOLERANCE_TYPE,
  CoreToleranceBase.JSON_PROPERTY_RULE_NAME
})
...
public class CoreToleranceBase {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to CoreToleranceBase
   */
  public static CoreToleranceBase fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, CoreToleranceBase.class);
  }
