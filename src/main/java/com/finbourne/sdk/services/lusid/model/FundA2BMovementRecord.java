 ...
 */
@JsonPropertyOrder({
  FundA2BMovementRecord.JSON_PROPERTY_PORTFOLIO_ID,
  FundA2BMovementRecord.JSON_PROPERTY_HOLDING_TYPE,
  FundA2BMovementRecord.JSON_PROPERTY_INSTRUMENT_SCOPE,
  FundA2BMovementRecord.JSON_PROPERTY_INSTRUMENT_UID,
  FundA2BMovementRecord.JSON_PROPERTY_SUB_HOLDING_KEYS,
  FundA2BMovementRecord.JSON_PROPERTY_CURRENCY,
  FundA2BMovementRecord.JSON_PROPERTY_TRANSACTION_ID,
  FundA2BMovementRecord.JSON_PROPERTY_MOVEMENT_NAME,
  FundA2BMovementRecord.JSON_PROPERTY_EFFECTIVE_DATE,
  FundA2BMovementRecord.JSON_PROPERTY_UNITS,
  FundA2BMovementRecord.JSON_PROPERTY_START,
  FundA2BMovementRecord.JSON_PROPERTY_FLOWS,
  FundA2BMovementRecord.JSON_PROPERTY_GAINS,
  FundA2BMovementRecord.JSON_PROPERTY_CARRY,
  FundA2BMovementRecord.JSON_PROPERTY_END,
  FundA2BMovementRecord.JSON_PROPERTY_RUNNING_UNITS,
  FundA2BMovementRecord.JSON_PROPERTY_RUNNING_BALANCE,
  FundA2BMovementRecord.JSON_PROPERTY_RUNNING_COST,
  FundA2BMovementRecord.JSON_PROPERTY_PROPERTIES,
  FundA2BMovementRecord.JSON_PROPERTY_GROUP_ID,
  FundA2BMovementRecord.JSON_PROPERTY_ERRORS
})

public class FundA2BMovementRecord {
  ...
  public FundA2BMovementRecord() {
  }

  public FundA2BMovementRecord portfolioId(ResourceId portfolioId) {
  ...
  public FundA2BMovementRecord holdingType(String holdingType) {
  ...
  public FundA2BMovementRecord instrumentScope(String instrumentScope) {
  ...
  public FundA2BMovementRecord instrumentUid(String instrumentUid) {
  ...
  public FundA2BMovementRecord subHoldingKeys(Map<String, PerpetualProperty> subHoldingKeys) {
    this.subHoldingKeys = subHoldingKeys;
    return this;
  }

  public FundA2BMovementRecord putSubHoldingKeysItem(String key, PerpetualProperty subHoldingKeysItem) {
  ...
  public FundA2BMovementRecord currency(String currency) {
  ...
  public FundA2BMovementRecord transactionId(String transactionId) {
  ...
  public FundA2BMovementRecord movementName(String movementName) {
  ...
  public FundA2BMovementRecord effectiveDate(OffsetDateTime effectiveDate) {
  ...
  public FundA2BMovementRecord units(java.math.BigDecimal units) {
    this.units = units;
    return this;
  }
  ...
  public FundA2BMovementRecord start(A2BCategory start) {
    this.start = start;
    return this;
  }
  ...
  public FundA2BMovementRecord flows(A2BCategory flows) {
    this.flows = flows;
    return this;
  }
  ...
  public FundA2BMovementRecord gains(A2BCategory gains) {
    this.gains = gains;
    return this;
  }
  ...
  public FundA2BMovementRecord carry(A2BCategory carry) {
    this.carry = carry;
    return this;
  }
  ...
  public FundA2BMovementRecord end(A2BCategory end) {
    this.end = end;
    return this;
  }
  ...
  public FundA2BMovementRecord runningUnits(java.math.BigDecimal runningUnits) {
  ...
  public FundA2BMovementRecord runningBalance(A2BCategory runningBalance) {
  ...
  public FundA2BMovementRecord runningCost(java.math.BigDecimal runningCost) {
  ...
  public FundA2BMovementRecord properties(Map<String, Property> properties) {
    this.properties = properties;
    return this;
  }

  public FundA2BMovementRecord putPropertiesItem(String key, Property propertiesItem) {
  ...
  public FundA2BMovementRecord groupId(String groupId) {
  ...
  public FundA2BMovementRecord errors(List<ResponseMetaData> errors) {
    this.errors = errors;
    return this;
  }

  public FundA2BMovementRecord addErrorsItem(ResponseMetaData errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    FundA2BMovementRecord fundA2BMovementRecord = (FundA2BMovementRecord) o;
    return Objects.equals(this.portfolioId, fundA2BMovementRecord.portfolioId) &&
        Objects.equals(this.holdingType, fundA2BMovementRecord.holdingType) &&
        Objects.equals(this.instrumentScope, fundA2BMovementRecord.instrumentScope) &&
        Objects.equals(this.instrumentUid, fundA2BMovementRecord.instrumentUid) &&
        Objects.equals(this.subHoldingKeys, fundA2BMovementRecord.subHoldingKeys) &&
        Objects.equals(this.currency, fundA2BMovementRecord.currency) &&
  ...
  @Override
 public int hashCode() {
    return Objects.hash(portfolioId, holdingType, instrumentScope, instrumentUid, subHoldingKeys, currency, transactionId, movementName, effectiveDate, units, start, flows, gains, carry, end, runningUnits, runningBalance, runningCost, properties, groupId, errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class FundA2BMovementRecord {\n");
  ...
  /**
   * Create an instance of FundA2BMovementRecord given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FundA2BMovementRecord
   * @throws java.io.IOException if the JSON string is invalid with respect to FundA2BMovementRecord
   */
  public static FundA2BMovementRecord fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, FundA2BMovementRecord.class);
  }

  /**
   * Convert an instance of FundA2BMovementRecord to an JSON string
   *
   * @return JSON string
   */
