...
public class ScriptedTranslationApi {
     ...
     */
    private HttpRequest getTranslationDialectCall(String scope, String vendor, String sourceSystem, String entityType, String serialisationFormat, String version, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getTranslationDialect. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the dialect. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param vendor The vendor of the dialect, the entity that created it. e.g. ISDA, FINBOURNE. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param sourceSystem The source system of the dialect, the system that understands it. e.g. LUSID, QuantLib. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param entityType The type of entity this dialect describes e.g. Instrument. Available values: Instrument. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param serialisationFormat The serialisation format of a document in this dialect. Available values: Json, Xml. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param version The semantic version of the dialect: MAJOR.MINOR.PATCH. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the dialect. Defaults to return the latest version of the dialect if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getTranslationDialectCall(String scope, String vendor, String sourceSystem, String entityType, String serialisationFormat, String version, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/scriptedtranslation/dialects/{scope}/{vendor}/{sourceSystem}/{entityType}/{serialisationFormat}/{version}"
    ...
    private HttpRequest getTranslationDialectValidateBeforeCall(String scope, String vendor, String sourceSystem, String entityType, String serialisationFormat, String version, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<Dialect> getTranslationDialectWithHttpInfo(String scope, String vendor, String sourceSystem, String entityType, String serialisationFormat, String version, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getTranslationDialectValidateBeforeCall(scope, vendor, sourceSystem, entityType, serialisationFormat, version, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Dialect>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetTranslationDialect: Get a dialect.
     * Get the dialect with the given identifier at the specific asAt time.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the dialect. (required)
     * @param vendor The vendor of the dialect, the entity that created it. e.g. ISDA, FINBOURNE. (required)
     * @param sourceSystem The source system of the dialect, the system that understands it. e.g. LUSID, QuantLib. (required)
     * @param entityType The type of entity this dialect describes e.g. Instrument. Available values: Instrument. (required)
    ...
    private ApiResponse<Dialect> getTranslationDialectWithHttpInfo(String scope, String vendor, String sourceSystem, String entityType, String serialisationFormat, String version, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getTranslationDialectValidateBeforeCall(scope, vendor, sourceSystem, entityType, serialisationFormat, version, asAt, null, opts);
        Type localVarReturnType = new TypeReference<Dialect>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getTranslationDialectAsync(String scope, String vendor, String sourceSystem, String entityType, String serialisationFormat, String version, OffsetDateTime asAt, final ApiCallback<Dialect> _callback) throws ApiException {

        HttpRequest localVarCall = getTranslationDialectValidateBeforeCall(scope, vendor, sourceSystem, entityType, serialisationFormat, version, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Dialect>(){}.getType();
     ...
     */
    private void getTranslationDialectAsync(String scope, String vendor, String sourceSystem, String entityType, String serialisationFormat, String version, OffsetDateTime asAt, final ApiCallback<Dialect> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getTranslationDialectValidateBeforeCall(scope, vendor, sourceSystem, entityType, serialisationFormat, version, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<Dialect>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetTranslationDialectRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Dialect> _callback) throws ApiException {
            getTranslationDialectAsync(scope, vendor, sourceSystem, entityType, serialisationFormat, version, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Dialect> _callback, ConfigurationOptions opts) throws ApiException {
            getTranslationDialectAsync(scope, vendor, sourceSystem, entityType, serialisationFormat, version, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getTranslationScriptCall(String scope, String code, String version, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getTranslationScriptCall(scope, code, version, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getTranslationScript. Use any specified configuration options to override any other configuration for this request only.
     * @param scope Scope of the translation script. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code Code of the translation script. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param version Semantic version of the translation script. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the translation script. Defaults to latest. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getTranslationScriptCall(String scope, String code, String version, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/scriptedtranslation/scripts/{scope}/{code}/{version}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getTranslationScriptValidateBeforeCall(String scope, String code, String version, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<TranslationScript> getTranslationScriptWithHttpInfo(String scope, String code, String version, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getTranslationScriptValidateBeforeCall(scope, code, version, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslationScript>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetTranslationScript: Retrieve a translation script by its identifier.
     * Retrieves a translation script to be used for translating financial entities.Use any specified configuration options to override any other configuration for this request only
     * @param scope Scope of the translation script. (required)
     * @param code Code of the translation script. (required)
     * @param version Semantic version of the translation script. (required)
     * @param asAt The asAt datetime at which to retrieve the translation script. Defaults to latest. (optional)
    ...
    private ApiResponse<TranslationScript> getTranslationScriptWithHttpInfo(String scope, String code, String version, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getTranslationScriptValidateBeforeCall(scope, code, version, asAt, null, opts);
        Type localVarReturnType = new TypeReference<TranslationScript>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getTranslationScriptAsync(String scope, String code, String version, OffsetDateTime asAt, final ApiCallback<TranslationScript> _callback) throws ApiException {

        HttpRequest localVarCall = getTranslationScriptValidateBeforeCall(scope, code, version, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslationScript>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getTranslationScriptAsync(String scope, String code, String version, OffsetDateTime asAt, final ApiCallback<TranslationScript> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getTranslationScriptValidateBeforeCall(scope, code, version, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<TranslationScript>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetTranslationScriptRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TranslationScript> _callback) throws ApiException {
            getTranslationScriptAsync(scope, code, version, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TranslationScript> _callback, ConfigurationOptions opts) throws ApiException {
            getTranslationScriptAsync(scope, code, version, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listDialectIdsCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        return listDialectIdsCall(asAt, page, limit, filter,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listDialectIds. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the dialects.              Defaults to return the latest version of the dialect if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing dialect IDs from a previous call to list dialect IDs.              This value is returned from the previous call. If a pagination token is provided the filter and asAt fields              must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listDialectIdsCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/scriptedtranslation/dialects/ids";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listDialectIdsValidateBeforeCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfDialectId> listDialectIdsWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = listDialectIdsValidateBeforeCall(asAt, page, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfDialectId>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListDialectIds: List dialect identifiers matching an optional filter.
     * List the stored dialects&#39; identifiers with pagination and filtering at the specified asAt time.Use any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to retrieve the dialects.              Defaults to return the latest version of the dialect if not specified. (optional)
     * @param page The pagination token to use to continue listing dialect IDs from a previous call to list dialect IDs.              This value is returned from the previous call. If a pagination token is provided the filter and asAt fields              must not have changed since the original request. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    private ApiResponse<PagedResourceListOfDialectId> listDialectIdsWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listDialectIdsValidateBeforeCall(asAt, page, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfDialectId>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listDialectIdsAsync(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfDialectId> _callback) throws ApiException {

        HttpRequest localVarCall = listDialectIdsValidateBeforeCall(asAt, page, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfDialectId>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listDialectIdsAsync(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfDialectId> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listDialectIdsValidateBeforeCall(asAt, page, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfDialectId>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistDialectIdsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfDialectId> _callback) throws ApiException {
            listDialectIdsAsync(asAt, page, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfDialectId> _callback, ConfigurationOptions opts) throws ApiException {
            listDialectIdsAsync(asAt, page, limit, filter, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listTranslationScriptIdsCall(OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback _callback) throws ApiException {
        return listTranslationScriptIdsCall(asAt, limit, filter, page,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listTranslationScriptIds. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the script identifiers. Defaults to latest. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param filter Expression to filter the results. For example, Id.Version.Major eq 1 to list IDs with major version 1              or Id.Scope eq &#39;my-scripts&#39; to list result only for a particular scope. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing translation script IDs; this              value is returned from the previous call. If a pagination token is provided, the filter field              must not have changed since the original request. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listTranslationScriptIdsCall(OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/scriptedtranslation/scripts/ids";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listTranslationScriptIdsValidateBeforeCall(OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfTranslationScriptId> listTranslationScriptIdsWithHttpInfo(OffsetDateTime asAt, Integer limit, String filter, String page) throws ApiException {
        HttpRequest localVarCall = listTranslationScriptIdsValidateBeforeCall(asAt, limit, filter, page, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfTranslationScriptId>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListTranslationScriptIds: List translation script identifiers.
     * List translation script ids.Use any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to retrieve the script identifiers. Defaults to latest. (optional)
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional)
     * @param filter Expression to filter the results. For example, Id.Version.Major eq 1 to list IDs with major version 1              or Id.Scope eq &#39;my-scripts&#39; to list result only for a particular scope. (optional)
     * @param page The pagination token to use to continue listing translation script IDs; this              value is returned from the previous call. If a pagination token is provided, the filter field              must not have changed since the original request. (optional)
    ...
    private ApiResponse<PagedResourceListOfTranslationScriptId> listTranslationScriptIdsWithHttpInfo(OffsetDateTime asAt, Integer limit, String filter, String page, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listTranslationScriptIdsValidateBeforeCall(asAt, limit, filter, page, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfTranslationScriptId>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listTranslationScriptIdsAsync(OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback<PagedResourceListOfTranslationScriptId> _callback) throws ApiException {

        HttpRequest localVarCall = listTranslationScriptIdsValidateBeforeCall(asAt, limit, filter, page, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfTranslationScriptId>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listTranslationScriptIdsAsync(OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback<PagedResourceListOfTranslationScriptId> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listTranslationScriptIdsValidateBeforeCall(asAt, limit, filter, page, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfTranslationScriptId>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistTranslationScriptIdsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfTranslationScriptId> _callback) throws ApiException {
            listTranslationScriptIdsAsync(asAt, limit, filter, page, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfTranslationScriptId> _callback, ConfigurationOptions opts) throws ApiException {
            listTranslationScriptIdsAsync(asAt, limit, filter, page, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest translateEntitiesCall(TranslateEntitiesRequest translateEntitiesRequest, final ApiCallback _callback) throws ApiException {
        return translateEntitiesCall(translateEntitiesRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for translateEntities. Use any specified configuration options to override any other configuration for this request only.
     * @param translateEntitiesRequest The entities to translate, along with identifiers for the script and (optional) dialect to use. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest translateEntitiesCall(TranslateEntitiesRequest translateEntitiesRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/scriptedtranslation/translateentities";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest translateEntitiesValidateBeforeCall(TranslateEntitiesRequest translateEntitiesRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TranslateEntitiesResponse> translateEntitiesWithHttpInfo(TranslateEntitiesRequest translateEntitiesRequest) throws ApiException {
        HttpRequest localVarCall = translateEntitiesValidateBeforeCall(translateEntitiesRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslateEntitiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] TranslateEntities: Translate a collection of entities with a specified translation script.
     * Run the provided translation request. The entities to translate are specified in the request body as a  dictionary with (ephemeral) unique correlation IDs. The script to use and optional dialect to validate  results against are sourced from the database.Use any specified configuration options to override any other configuration for this request only
     * @param translateEntitiesRequest The entities to translate, along with identifiers for the script and (optional) dialect to use. (required)
     * @return ApiResponse&lt;TranslateEntitiesResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<TranslateEntitiesResponse> translateEntitiesWithHttpInfo(TranslateEntitiesRequest translateEntitiesRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = translateEntitiesValidateBeforeCall(translateEntitiesRequest, null, opts);
        Type localVarReturnType = new TypeReference<TranslateEntitiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void translateEntitiesAsync(TranslateEntitiesRequest translateEntitiesRequest, final ApiCallback<TranslateEntitiesResponse> _callback) throws ApiException {

        HttpRequest localVarCall = translateEntitiesValidateBeforeCall(translateEntitiesRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslateEntitiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void translateEntitiesAsync(TranslateEntitiesRequest translateEntitiesRequest, final ApiCallback<TranslateEntitiesResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = translateEntitiesValidateBeforeCall(translateEntitiesRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TranslateEntitiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APItranslateEntitiesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TranslateEntitiesResponse> _callback) throws ApiException {
            translateEntitiesAsync(translateEntitiesRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TranslateEntitiesResponse> _callback, ConfigurationOptions opts) throws ApiException {
            translateEntitiesAsync(translateEntitiesRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest translateEntitiesInlinedCall(TranslateEntitiesInlinedRequest translateEntitiesInlinedRequest, final ApiCallback _callback) throws ApiException {
        return translateEntitiesInlinedCall(translateEntitiesInlinedRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for translateEntitiesInlined. Use any specified configuration options to override any other configuration for this request only.
     * @param translateEntitiesInlinedRequest The entities to translate, along with the script to use and an optional schema for validation. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest translateEntitiesInlinedCall(TranslateEntitiesInlinedRequest translateEntitiesInlinedRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/scriptedtranslation/translateentitiesinlined";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest translateEntitiesInlinedValidateBeforeCall(TranslateEntitiesInlinedRequest translateEntitiesInlinedRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TranslateEntitiesResponse> translateEntitiesInlinedWithHttpInfo(TranslateEntitiesInlinedRequest translateEntitiesInlinedRequest) throws ApiException {
        HttpRequest localVarCall = translateEntitiesInlinedValidateBeforeCall(translateEntitiesInlinedRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslateEntitiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<TranslateEntitiesResponse> translateEntitiesInlinedWithHttpInfo(TranslateEntitiesInlinedRequest translateEntitiesInlinedRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = translateEntitiesInlinedValidateBeforeCall(translateEntitiesInlinedRequest, null, opts);
        Type localVarReturnType = new TypeReference<TranslateEntitiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void translateEntitiesInlinedAsync(TranslateEntitiesInlinedRequest translateEntitiesInlinedRequest, final ApiCallback<TranslateEntitiesResponse> _callback) throws ApiException {

        HttpRequest localVarCall = translateEntitiesInlinedValidateBeforeCall(translateEntitiesInlinedRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslateEntitiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void translateEntitiesInlinedAsync(TranslateEntitiesInlinedRequest translateEntitiesInlinedRequest, final ApiCallback<TranslateEntitiesResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = translateEntitiesInlinedValidateBeforeCall(translateEntitiesInlinedRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TranslateEntitiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APItranslateEntitiesInlinedRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TranslateEntitiesResponse> _callback) throws ApiException {
            translateEntitiesInlinedAsync(translateEntitiesInlinedRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TranslateEntitiesResponse> _callback, ConfigurationOptions opts) throws ApiException {
            translateEntitiesInlinedAsync(translateEntitiesInlinedRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertTranslationDialectCall(UpsertDialectRequest upsertDialectRequest, final ApiCallback _callback) throws ApiException {
        return upsertTranslationDialectCall(upsertDialectRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertTranslationDialect. Use any specified configuration options to override any other configuration for this request only.
     * @param upsertDialectRequest The dialect to upsert. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertTranslationDialectCall(UpsertDialectRequest upsertDialectRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/scriptedtranslation/dialects";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertTranslationDialectValidateBeforeCall(UpsertDialectRequest upsertDialectRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<Dialect> upsertTranslationDialectWithHttpInfo(UpsertDialectRequest upsertDialectRequest) throws ApiException {
        HttpRequest localVarCall = upsertTranslationDialectValidateBeforeCall(upsertDialectRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Dialect>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpsertTranslationDialect: Upsert a Dialect.
     * Upsert the given dialect.Use any specified configuration options to override any other configuration for this request only
     * @param upsertDialectRequest The dialect to upsert. (required)
     * @return ApiResponse&lt;Dialect&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<Dialect> upsertTranslationDialectWithHttpInfo(UpsertDialectRequest upsertDialectRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertTranslationDialectValidateBeforeCall(upsertDialectRequest, null, opts);
        Type localVarReturnType = new TypeReference<Dialect>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertTranslationDialectAsync(UpsertDialectRequest upsertDialectRequest, final ApiCallback<Dialect> _callback) throws ApiException {

        HttpRequest localVarCall = upsertTranslationDialectValidateBeforeCall(upsertDialectRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Dialect>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertTranslationDialectAsync(UpsertDialectRequest upsertDialectRequest, final ApiCallback<Dialect> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertTranslationDialectValidateBeforeCall(upsertDialectRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<Dialect>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertTranslationDialectRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Dialect> _callback) throws ApiException {
            upsertTranslationDialectAsync(upsertDialectRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Dialect> _callback, ConfigurationOptions opts) throws ApiException {
            upsertTranslationDialectAsync(upsertDialectRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertTranslationScriptCall(UpsertTranslationScriptRequest upsertTranslationScriptRequest, final ApiCallback _callback) throws ApiException {
        return upsertTranslationScriptCall(upsertTranslationScriptRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertTranslationScript. Use any specified configuration options to override any other configuration for this request only.
     * @param upsertTranslationScriptRequest The translation script to be upserted. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertTranslationScriptCall(UpsertTranslationScriptRequest upsertTranslationScriptRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/scriptedtranslation/scripts";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertTranslationScriptValidateBeforeCall(UpsertTranslationScriptRequest upsertTranslationScriptRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<TranslationScript> upsertTranslationScriptWithHttpInfo(UpsertTranslationScriptRequest upsertTranslationScriptRequest) throws ApiException {
        HttpRequest localVarCall = upsertTranslationScriptValidateBeforeCall(upsertTranslationScriptRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslationScript>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpsertTranslationScript: Upsert a translation script.
     * Upserts a translation script to be used for translating financial entities.Use any specified configuration options to override any other configuration for this request only
     * @param upsertTranslationScriptRequest The translation script to be upserted. (required)
     * @return ApiResponse&lt;TranslationScript&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<TranslationScript> upsertTranslationScriptWithHttpInfo(UpsertTranslationScriptRequest upsertTranslationScriptRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertTranslationScriptValidateBeforeCall(upsertTranslationScriptRequest, null, opts);
        Type localVarReturnType = new TypeReference<TranslationScript>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertTranslationScriptAsync(UpsertTranslationScriptRequest upsertTranslationScriptRequest, final ApiCallback<TranslationScript> _callback) throws ApiException {

        HttpRequest localVarCall = upsertTranslationScriptValidateBeforeCall(upsertTranslationScriptRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TranslationScript>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertTranslationScriptAsync(UpsertTranslationScriptRequest upsertTranslationScriptRequest, final ApiCallback<TranslationScript> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertTranslationScriptValidateBeforeCall(upsertTranslationScriptRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<TranslationScript>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertTranslationScriptRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TranslationScript> _callback) throws ApiException {
            upsertTranslationScriptAsync(upsertTranslationScriptRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TranslationScript> _callback, ConfigurationOptions opts) throws ApiException {
            upsertTranslationScriptAsync(upsertTranslationScriptRequest, _callback, opts);
        }
    }
