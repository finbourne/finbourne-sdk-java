 ...
 */
@JsonPropertyOrder({
  ResourceListOfDataType.JSON_PROPERTY_VALUES,
  ResourceListOfDataType.JSON_PROPERTY_HREF,
  ResourceListOfDataType.JSON_PROPERTY_LINKS,
  ResourceListOfDataType.JSON_PROPERTY_NEXT_PAGE,
  ResourceListOfDataType.JSON_PROPERTY_PREVIOUS_PAGE
})
...
public class ResourceListOfDataType {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ResourceListOfDataType
   */
  public static ResourceListOfDataType fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ResourceListOfDataType.class);
  }
