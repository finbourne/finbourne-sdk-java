 ...
 */
@JsonPropertyOrder({
  EquityShiftDefinition.JSON_PROPERTY_INSTRUMENT,
  EquityShiftDefinition.JSON_PROPERTY_AMOUNT,
  EquityShiftDefinition.JSON_PROPERTY_SHIFT_TYPE
})
...
public class EquityShiftDefinition extends ScenarioShiftDefinition {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instrument, equityShiftDefinition.instrument) &&
        (this.amount == null ? equityShiftDefinition.amount == null : (equityShiftDefinition.amount != null && this.amount.compareTo(equityShiftDefinition.getAmount()) == 0)) &&
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to EquityShiftDefinition
   */
  public static EquityShiftDefinition fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, EquityShiftDefinition.class);
  }
