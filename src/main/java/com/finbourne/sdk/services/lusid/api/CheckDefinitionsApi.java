...
public class CheckDefinitionsApi {
     ...
     */
    private HttpRequest createCheckDefinitionCall(CreateCheckDefinitionRequest createCheckDefinitionRequest, final ApiCallback _callback) throws ApiException {
        return createCheckDefinitionCall(createCheckDefinitionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createCheckDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param createCheckDefinitionRequest The request containing the details of the Check Definition (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createCheckDefinitionCall(CreateCheckDefinitionRequest createCheckDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/dataquality/checkdefinitions";
    ...
    private HttpRequest createCheckDefinitionValidateBeforeCall(CreateCheckDefinitionRequest createCheckDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<CheckDefinition> createCheckDefinitionWithHttpInfo(CreateCheckDefinitionRequest createCheckDefinitionRequest) throws ApiException {
        HttpRequest localVarCall = createCheckDefinitionValidateBeforeCall(createCheckDefinitionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
    ...
    private ApiResponse<CheckDefinition> createCheckDefinitionWithHttpInfo(CreateCheckDefinitionRequest createCheckDefinitionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createCheckDefinitionValidateBeforeCall(createCheckDefinitionRequest, null, opts);
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] CreateCheckDefinition: Create a Check Definition (asynchronously)
     * Creates a Check Definition. Returns the created Check Definition at the current effectiveAt.  Note that Check Definitions are mono-temporal, however they can have Time-Variant Properties.  Upserted Properties will be returned at the latest AsAt and EffectiveAt
     * @param createCheckDefinitionRequest The request containing the details of the Check Definition (optional)
     ...
     */
    private void createCheckDefinitionAsync(CreateCheckDefinitionRequest createCheckDefinitionRequest, final ApiCallback<CheckDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = createCheckDefinitionValidateBeforeCall(createCheckDefinitionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
     ...
     */
    private void createCheckDefinitionAsync(CreateCheckDefinitionRequest createCheckDefinitionRequest, final ApiCallback<CheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createCheckDefinitionValidateBeforeCall(createCheckDefinitionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateCheckDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CheckDefinition> _callback) throws ApiException {
            createCheckDefinitionAsync(createCheckDefinitionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            createCheckDefinitionAsync(createCheckDefinitionRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteCheckDefinitionCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteCheckDefinitionCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteCheckDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the specified Check Definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteCheckDefinitionCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/dataquality/checkdefinitions/{scope}/{code}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteCheckDefinitionValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteCheckDefinitionWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteCheckDefinitionValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EXPERIMENTAL] DeleteCheckDefinition: Deletes a particular Check Definition
     * The deletion will take effect from the Check Definition deletion datetime.  i.e. will no longer exist at any asAt datetime after the asAt datetime of deletion.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the specified Check Definition. (required)
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition. (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deleteCheckDefinitionWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCheckDefinitionValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] DeleteCheckDefinition: Deletes a particular Check Definition (asynchronously)
     * The deletion will take effect from the Check Definition deletion datetime.  i.e. will no longer exist at any asAt datetime after the asAt datetime of deletion.
     * @param scope The scope of the specified Check Definition. (required)
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void deleteCheckDefinitionAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCheckDefinitionValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteCheckDefinitionAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCheckDefinitionValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCheckDefinitionRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteCheckDefinitionAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCheckDefinitionAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteRulesCall(String scope, String code, List<DeleteDataQualityRule> deleteDataQualityRule, final ApiCallback _callback) throws ApiException {
        return deleteRulesCall(scope, code, deleteDataQualityRule,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteRules. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the specified Check Definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param deleteDataQualityRule The request containing the rules to be deleted (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteRulesCall(String scope, String code, List<DeleteDataQualityRule> deleteDataQualityRule, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/dataquality/checkdefinitions/{scope}/{code}/$deleteRules"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteRulesValidateBeforeCall(String scope, String code, List<DeleteDataQualityRule> deleteDataQualityRule, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CheckDefinition> deleteRulesWithHttpInfo(String scope, String code, List<DeleteDataQualityRule> deleteDataQualityRule) throws ApiException {
        HttpRequest localVarCall = deleteRulesValidateBeforeCall(scope, code, deleteDataQualityRule, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EXPERIMENTAL] DeleteRules: Delete rules on a particular Check Definition
     * Delete rules for a given check definition. This will not affect any other rules that are not included in the request.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the specified Check Definition. (required)
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition. (required)
     * @param deleteDataQualityRule The request containing the rules to be deleted (optional)
     * @return ApiResponse&lt;CheckDefinition&gt;
    ...
    private ApiResponse<CheckDefinition> deleteRulesWithHttpInfo(String scope, String code, List<DeleteDataQualityRule> deleteDataQualityRule, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteRulesValidateBeforeCall(scope, code, deleteDataQualityRule, null, opts);
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] DeleteRules: Delete rules on a particular Check Definition (asynchronously)
     * Delete rules for a given check definition. This will not affect any other rules that are not included in the request.
     * @param scope The scope of the specified Check Definition. (required)
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition. (required)
     * @param deleteDataQualityRule The request containing the rules to be deleted (optional)
     ...
     */
    private void deleteRulesAsync(String scope, String code, List<DeleteDataQualityRule> deleteDataQualityRule, final ApiCallback<CheckDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = deleteRulesValidateBeforeCall(scope, code, deleteDataQualityRule, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteRulesAsync(String scope, String code, List<DeleteDataQualityRule> deleteDataQualityRule, final ApiCallback<CheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteRulesValidateBeforeCall(scope, code, deleteDataQualityRule, _callback, opts);
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteRulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CheckDefinition> _callback) throws ApiException {
            deleteRulesAsync(scope, code, deleteDataQualityRule, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            deleteRulesAsync(scope, code, deleteDataQualityRule, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getCheckDefinitionCall(String scope, String code, OffsetDateTime asAt, String effectiveAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return getCheckDefinitionCall(scope, code, asAt, effectiveAt, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getCheckDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the specified Check Definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified Check Definition. Together with the scope this uniquely              identifies the Check Definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Check Definition definition. Defaults to return              the latest version of the definition if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the check definition properties.              Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the &#39;CheckDefinition&#39; domain to decorate onto              the Check Definition.              These must have the format {domain}/{scope}/{code}, for example &#39;CheckDefinition/system/Name&#39;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getCheckDefinitionCall(String scope, String code, OffsetDateTime asAt, String effectiveAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCheckDefinitionValidateBeforeCall(String scope, String code, OffsetDateTime asAt, String effectiveAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CheckDefinition> getCheckDefinitionWithHttpInfo(String scope, String code, OffsetDateTime asAt, String effectiveAt, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = getCheckDefinitionValidateBeforeCall(scope, code, asAt, effectiveAt, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EXPERIMENTAL] GetCheckDefinition: Get a single Check Definition by scope and code.
     * Retrieves one Check Definition by scope and code.  Check Definitions are mono-temporal. The EffectiveAt is only applied to Time-Variant Properties.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the specified Check Definition. (required)
     * @param code The code of the specified Check Definition. Together with the scope this uniquely              identifies the Check Definition. (required)
     * @param asAt The asAt datetime at which to retrieve the Check Definition definition. Defaults to return              the latest version of the definition if not specified. (optional)
     * @param effectiveAt The effective datetime or cut label at which to retrieve the check definition properties.              Defaults to the current LUSID system datetime if not specified. (optional)
    ...
    private ApiResponse<CheckDefinition> getCheckDefinitionWithHttpInfo(String scope, String code, OffsetDateTime asAt, String effectiveAt, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCheckDefinitionValidateBeforeCall(scope, code, asAt, effectiveAt, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetCheckDefinition: Get a single Check Definition by scope and code. (asynchronously)
     * Retrieves one Check Definition by scope and code.  Check Definitions are mono-temporal. The EffectiveAt is only applied to Time-Variant Properties.
     * @param scope The scope of the specified Check Definition. (required)
     * @param code The code of the specified Check Definition. Together with the scope this uniquely              identifies the Check Definition. (required)
     * @param asAt The asAt datetime at which to retrieve the Check Definition definition. Defaults to return              the latest version of the definition if not specified. (optional)
     ...
     */
    private void getCheckDefinitionAsync(String scope, String code, OffsetDateTime asAt, String effectiveAt, List<String> propertyKeys, final ApiCallback<CheckDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = getCheckDefinitionValidateBeforeCall(scope, code, asAt, effectiveAt, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCheckDefinitionAsync(String scope, String code, OffsetDateTime asAt, String effectiveAt, List<String> propertyKeys, final ApiCallback<CheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCheckDefinitionValidateBeforeCall(scope, code, asAt, effectiveAt, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCheckDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CheckDefinition> _callback) throws ApiException {
            getCheckDefinitionAsync(scope, code, asAt, effectiveAt, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            getCheckDefinitionAsync(scope, code, asAt, effectiveAt, propertyKeys, _callback, opts);
        }
    }
     ...
     * @param filter Expression to filter the results.              For example, to filter on the displayName, specify \&quot;displayName eq &#39;MyCheckDefinition&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid. (optional)
     ...
     */
    private HttpRequest listCheckDefinitionsCall(OffsetDateTime asAt, String effectiveAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for listCheckDefinitions. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the Check Definitions. Defaults to returning the latest version of each Check Definition if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime or cut label at which to list the Check Definitions.              Note that Check Definitions are monotemporal, the effectiveAt is for Timevariant Properties on the Check Definition only.              Defaults to the current LUSID system datetime if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing Check Definitions; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param filter Expression to filter the results.              For example, to filter on the displayName, specify \&quot;displayName eq &#39;MyCheckDefinition&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listCheckDefinitionsCall(OffsetDateTime asAt, String effectiveAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listCheckDefinitionsValidateBeforeCall(OffsetDateTime asAt, String effectiveAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfCheckDefinition> listCheckDefinitionsWithHttpInfo(OffsetDateTime asAt, String effectiveAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = listCheckDefinitionsValidateBeforeCall(asAt, effectiveAt, page, limit, filter, sortBy, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListCheckDefinitions: List Check Definitions
     * List all the Check Definitions matching a particular criteria.Use any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to list the Check Definitions. Defaults to returning the latest version of each Check Definition if not specified. (optional)
     * @param effectiveAt The effective datetime or cut label at which to list the Check Definitions.              Note that Check Definitions are monotemporal, the effectiveAt is for Timevariant Properties on the Check Definition only.              Defaults to the current LUSID system datetime if not specified. (optional)
     * @param page The pagination token to use to continue listing Check Definitions; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional)
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified. (optional)
    ...
    private ApiResponse<PagedResourceListOfCheckDefinition> listCheckDefinitionsWithHttpInfo(OffsetDateTime asAt, String effectiveAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listCheckDefinitionsValidateBeforeCall(asAt, effectiveAt, page, limit, filter, sortBy, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListCheckDefinitions: List Check Definitions (asynchronously)
     * List all the Check Definitions matching a particular criteria.
     * @param asAt The asAt datetime at which to list the Check Definitions. Defaults to returning the latest version of each Check Definition if not specified. (optional)
     * @param effectiveAt The effective datetime or cut label at which to list the Check Definitions.              Note that Check Definitions are monotemporal, the effectiveAt is for Timevariant Properties on the Check Definition only.              Defaults to the current LUSID system datetime if not specified. (optional)
     * @param page The pagination token to use to continue listing Check Definitions; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. (optional)
     ...
     */
    private void listCheckDefinitionsAsync(OffsetDateTime asAt, String effectiveAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback<PagedResourceListOfCheckDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = listCheckDefinitionsValidateBeforeCall(asAt, effectiveAt, page, limit, filter, sortBy, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfCheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listCheckDefinitionsAsync(OffsetDateTime asAt, String effectiveAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback<PagedResourceListOfCheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listCheckDefinitionsValidateBeforeCall(asAt, effectiveAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfCheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistCheckDefinitionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCheckDefinition> _callback) throws ApiException {
            listCheckDefinitionsAsync(asAt, effectiveAt, page, limit, filter, sortBy, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfCheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            listCheckDefinitionsAsync(asAt, effectiveAt, page, limit, filter, sortBy, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest runCheckDefinitionCall(String scope, String code, RunCheckRequest runCheckRequest, final ApiCallback _callback) throws ApiException {
        return runCheckDefinitionCall(scope, code, runCheckRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for runCheckDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param scope Scope of the CheckDefinition to run. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code Code of the CheckDefinition to run. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param runCheckRequest Run request defining what dataset to run against. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest runCheckDefinitionCall(String scope, String code, RunCheckRequest runCheckRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/dataquality/checkdefinitions/{scope}/{code}/$run"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest runCheckDefinitionValidateBeforeCall(String scope, String code, RunCheckRequest runCheckRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<RunCheckResponse> runCheckDefinitionWithHttpInfo(String scope, String code, RunCheckRequest runCheckRequest) throws ApiException {
        HttpRequest localVarCall = runCheckDefinitionValidateBeforeCall(scope, code, runCheckRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<RunCheckResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] RunCheckDefinition: Runs a Check Definition against given dataset.
     * Runs a Check Definition against given dataset.Use any specified configuration options to override any other configuration for this request only
     * @param scope Scope of the CheckDefinition to run. (required)
     * @param code Code of the CheckDefinition to run. (required)
     * @param runCheckRequest Run request defining what dataset to run against. (optional)
     * @return ApiResponse&lt;RunCheckResponse&gt;
    ...
    private ApiResponse<RunCheckResponse> runCheckDefinitionWithHttpInfo(String scope, String code, RunCheckRequest runCheckRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = runCheckDefinitionValidateBeforeCall(scope, code, runCheckRequest, null, opts);
        Type localVarReturnType = new TypeReference<RunCheckResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] RunCheckDefinition: Runs a Check Definition against given dataset. (asynchronously)
     * Runs a Check Definition against given dataset.
     * @param scope Scope of the CheckDefinition to run. (required)
     * @param code Code of the CheckDefinition to run. (required)
     * @param runCheckRequest Run request defining what dataset to run against. (optional)
     ...
     */
    private void runCheckDefinitionAsync(String scope, String code, RunCheckRequest runCheckRequest, final ApiCallback<RunCheckResponse> _callback) throws ApiException {

        HttpRequest localVarCall = runCheckDefinitionValidateBeforeCall(scope, code, runCheckRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<RunCheckResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void runCheckDefinitionAsync(String scope, String code, RunCheckRequest runCheckRequest, final ApiCallback<RunCheckResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = runCheckDefinitionValidateBeforeCall(scope, code, runCheckRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<RunCheckResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIrunCheckDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<RunCheckResponse> _callback) throws ApiException {
            runCheckDefinitionAsync(scope, code, runCheckRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<RunCheckResponse> _callback, ConfigurationOptions opts) throws ApiException {
            runCheckDefinitionAsync(scope, code, runCheckRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateCheckDefinitionCall(String scope, String code, UpdateCheckDefinitionRequest updateCheckDefinitionRequest, final ApiCallback _callback) throws ApiException {
        return updateCheckDefinitionCall(scope, code, updateCheckDefinitionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateCheckDefinition. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the specified Check Definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely identifies the Check Definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateCheckDefinitionRequest The request containing the updated details of the Check Definition (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest updateCheckDefinitionCall(String scope, String code, UpdateCheckDefinitionRequest updateCheckDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateCheckDefinitionValidateBeforeCall(String scope, String code, UpdateCheckDefinitionRequest updateCheckDefinitionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CheckDefinition> updateCheckDefinitionWithHttpInfo(String scope, String code, UpdateCheckDefinitionRequest updateCheckDefinitionRequest) throws ApiException {
        HttpRequest localVarCall = updateCheckDefinitionValidateBeforeCall(scope, code, updateCheckDefinitionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<CheckDefinition> updateCheckDefinitionWithHttpInfo(String scope, String code, UpdateCheckDefinitionRequest updateCheckDefinitionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateCheckDefinitionValidateBeforeCall(scope, code, updateCheckDefinitionRequest, null, opts);
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] UpdateCheckDefinition: Update Check Definition defined by scope and code (asynchronously)
     * Overwrites an existing Check Definition  Update request has the same required fields as Create apart from the id.  Returns the updated Check Definition at the current effectiveAt.  Note that Check Definitions are mono-temporal, however they can have Time-Variant Properties.  Updated Properties will be returned at the latest AsAt and EffectiveAt
     * @param scope The scope of the specified Check Definition. (required)
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely identifies the Check Definition. (required)
     * @param updateCheckDefinitionRequest The request containing the updated details of the Check Definition (optional)
     ...
     */
    private void updateCheckDefinitionAsync(String scope, String code, UpdateCheckDefinitionRequest updateCheckDefinitionRequest, final ApiCallback<CheckDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = updateCheckDefinitionValidateBeforeCall(scope, code, updateCheckDefinitionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateCheckDefinitionAsync(String scope, String code, UpdateCheckDefinitionRequest updateCheckDefinitionRequest, final ApiCallback<CheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateCheckDefinitionValidateBeforeCall(scope, code, updateCheckDefinitionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateCheckDefinitionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CheckDefinition> _callback) throws ApiException {
            updateCheckDefinitionAsync(scope, code, updateCheckDefinitionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            updateCheckDefinitionAsync(scope, code, updateCheckDefinitionRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertRulesCall(String scope, String code, List<UpsertDataQualityRule> upsertDataQualityRule, final ApiCallback _callback) throws ApiException {
        return upsertRulesCall(scope, code, upsertDataQualityRule,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertRules. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the specified Check Definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param upsertDataQualityRule The request containing the rules to be upserted (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    private HttpRequest upsertRulesCall(String scope, String code, List<UpsertDataQualityRule> upsertDataQualityRule, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/dataquality/checkdefinitions/{scope}/{code}/$upsertRules"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertRulesValidateBeforeCall(String scope, String code, List<UpsertDataQualityRule> upsertDataQualityRule, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<CheckDefinition> upsertRulesWithHttpInfo(String scope, String code, List<UpsertDataQualityRule> upsertDataQualityRule) throws ApiException {
        HttpRequest localVarCall = upsertRulesValidateBeforeCall(scope, code, upsertDataQualityRule, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EXPERIMENTAL] UpsertRules: Upsert rules to a particular Check Definition
     * Upsert rules for a given check definition. This will not affect any other rules that are not included in the request.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the specified Check Definition. (required)
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition. (required)
     * @param upsertDataQualityRule The request containing the rules to be upserted (optional)
     * @return ApiResponse&lt;CheckDefinition&gt;
    ...
    private ApiResponse<CheckDefinition> upsertRulesWithHttpInfo(String scope, String code, List<UpsertDataQualityRule> upsertDataQualityRule, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertRulesValidateBeforeCall(scope, code, upsertDataQualityRule, null, opts);
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] UpsertRules: Upsert rules to a particular Check Definition (asynchronously)
     * Upsert rules for a given check definition. This will not affect any other rules that are not included in the request.
     * @param scope The scope of the specified Check Definition. (required)
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition. (required)
     * @param upsertDataQualityRule The request containing the rules to be upserted (optional)
     ...
     */
    private void upsertRulesAsync(String scope, String code, List<UpsertDataQualityRule> upsertDataQualityRule, final ApiCallback<CheckDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = upsertRulesValidateBeforeCall(scope, code, upsertDataQualityRule, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertRulesAsync(String scope, String code, List<UpsertDataQualityRule> upsertDataQualityRule, final ApiCallback<CheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertRulesValidateBeforeCall(scope, code, upsertDataQualityRule, _callback, opts);
        Type localVarReturnType = new TypeReference<CheckDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertRulesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<CheckDefinition> _callback) throws ApiException {
            upsertRulesAsync(scope, code, upsertDataQualityRule, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<CheckDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            upsertRulesAsync(scope, code, upsertDataQualityRule, _callback, opts);
        }
    }
