 ...
 */
@JsonPropertyOrder({
  UpsertComplianceRunSummaryResult.JSON_PROPERTY_RUN_ID,
  UpsertComplianceRunSummaryResult.JSON_PROPERTY_INSTIGATED_AT,
  UpsertComplianceRunSummaryResult.JSON_PROPERTY_COMPLETED_AT,
  UpsertComplianceRunSummaryResult.JSON_PROPERTY_SCHEDULE,
  UpsertComplianceRunSummaryResult.JSON_PROPERTY_RESULTS
})
...
public class UpsertComplianceRunSummaryResult {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to UpsertComplianceRunSummaryResult
   */
  public static UpsertComplianceRunSummaryResult fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, UpsertComplianceRunSummaryResult.class);
  }
