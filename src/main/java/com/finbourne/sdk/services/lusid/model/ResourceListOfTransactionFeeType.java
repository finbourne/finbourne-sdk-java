 ...
 */
@JsonPropertyOrder({
  ResourceListOfTransactionFeeType.JSON_PROPERTY_VALUES,
  ResourceListOfTransactionFeeType.JSON_PROPERTY_HREF,
  ResourceListOfTransactionFeeType.JSON_PROPERTY_LINKS,
  ResourceListOfTransactionFeeType.JSON_PROPERTY_NEXT_PAGE,
  ResourceListOfTransactionFeeType.JSON_PROPERTY_PREVIOUS_PAGE
})
...
public class ResourceListOfTransactionFeeType {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ResourceListOfTransactionFeeType
   */
  public static ResourceListOfTransactionFeeType fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ResourceListOfTransactionFeeType.class);
  }
