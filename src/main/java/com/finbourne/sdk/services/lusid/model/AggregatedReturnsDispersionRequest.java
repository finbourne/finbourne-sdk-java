 ...
 */
@JsonPropertyOrder({
  AggregatedReturnsDispersionRequest.JSON_PROPERTY_TO_EFFECTIVE_AT,
  AggregatedReturnsDispersionRequest.JSON_PROPERTY_YEARS_COUNT,
  AggregatedReturnsDispersionRequest.JSON_PROPERTY_RETURN_IDS,
  AggregatedReturnsDispersionRequest.JSON_PROPERTY_RECIPE_ID,
  AggregatedReturnsDispersionRequest.JSON_PROPERTY_COMPOSITE_METHOD,
  AggregatedReturnsDispersionRequest.JSON_PROPERTY_ALTERNATIVE_INCEPTION_DATE
})
...
public class AggregatedReturnsDispersionRequest {
  ...
  public static final String JSON_PROPERTY_YEARS_COUNT = "yearsCount";
  @JsonProperty(JSON_PROPERTY_YEARS_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to AggregatedReturnsDispersionRequest
   */
  public static AggregatedReturnsDispersionRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, AggregatedReturnsDispersionRequest.class);
  }
