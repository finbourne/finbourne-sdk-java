 ...
 */
@JsonPropertyOrder({
  BlockRequest.JSON_PROPERTY_ID,
  BlockRequest.JSON_PROPERTY_ORDER_IDS,
  ...
  BlockRequest.JSON_PROPERTY_CREATED_DATE,
  BlockRequest.JSON_PROPERTY_LIMIT_PRICE,
  BlockRequest.JSON_PROPERTY_STOP_PRICE,
  BlockRequest.JSON_PROPERTY_IS_SWEPT
})
...
public class BlockRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to BlockRequest
   */
  public static BlockRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, BlockRequest.class);
  }
