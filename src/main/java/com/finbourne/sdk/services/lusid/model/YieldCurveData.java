 ...
 */
@JsonPropertyOrder({
  YieldCurveData.JSON_PROPERTY_BASE_DATE,
  YieldCurveData.JSON_PROPERTY_INSTRUMENTS,
...
public class YieldCurveData extends ComplexMarketData {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to YieldCurveData
   */
  public static YieldCurveData fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, YieldCurveData.class);
  }
