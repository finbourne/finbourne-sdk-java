 ...
 */
@JsonPropertyOrder({
  DeleteRelationshipRequest.JSON_PROPERTY_SOURCE_ENTITY_ID,
  DeleteRelationshipRequest.JSON_PROPERTY_TARGET_ENTITY_ID,
  DeleteRelationshipRequest.JSON_PROPERTY_EFFECTIVE_FROM,
  DeleteRelationshipRequest.JSON_PROPERTY_EFFECTIVE_UNTIL
})
...
public class DeleteRelationshipRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to DeleteRelationshipRequest
   */
  public static DeleteRelationshipRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, DeleteRelationshipRequest.class);
  }
