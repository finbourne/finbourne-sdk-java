...
@JsonPropertyOrder({
  ...
  FundShareClass.JSON_PROPERTY_DISTRIBUTION_TYPE,
  ...
  FundShareClass.JSON_PROPERTY_ROUNDING_CONVENTION_UNITS,
...
public class FundShareClass extends LusidInstrument {
  ...
  public static final String JSON_PROPERTY_ROUNDING_CONVENTION_UNITS = "roundingConventionUnits";
  @JsonProperty(JSON_PROPERTY_ROUNDING_CONVENTION_UNITS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
