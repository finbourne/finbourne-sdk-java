 ...
 */
@JsonPropertyOrder({
  UpdateFeeTypeRequest.JSON_PROPERTY_DISPLAY_NAME,
  UpdateFeeTypeRequest.JSON_PROPERTY_DESCRIPTION,
  UpdateFeeTypeRequest.JSON_PROPERTY_COMPONENT_TRANSACTIONS
})
...
public class UpdateFeeTypeRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to UpdateFeeTypeRequest
   */
  public static UpdateFeeTypeRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, UpdateFeeTypeRequest.class);
  }
