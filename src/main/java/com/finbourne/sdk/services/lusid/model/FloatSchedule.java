 ...
 */
@JsonPropertyOrder({
  FloatSchedule.JSON_PROPERTY_START_DATE,
  FloatSchedule.JSON_PROPERTY_MATURITY_DATE,
  FloatSchedule.JSON_PROPERTY_FLOW_CONVENTIONS,
  FloatSchedule.JSON_PROPERTY_CONVENTION_NAME,
  FloatSchedule.JSON_PROPERTY_EX_DIVIDEND_DAYS,
  FloatSchedule.JSON_PROPERTY_INDEX_CONVENTION_NAME,
  FloatSchedule.JSON_PROPERTY_INDEX_CONVENTIONS,
  FloatSchedule.JSON_PROPERTY_NOTIONAL,
  FloatSchedule.JSON_PROPERTY_PAYMENT_CURRENCY,
  FloatSchedule.JSON_PROPERTY_SPREAD,
  FloatSchedule.JSON_PROPERTY_STUB_TYPE,
  FloatSchedule.JSON_PROPERTY_EX_DIVIDEND_CONFIGURATION,
  FloatSchedule.JSON_PROPERTY_COMPOUNDING,
...
public class FloatSchedule extends Schedule {
  ...
  public static final String JSON_PROPERTY_INDEX_CONVENTIONS = "indexConventions";
  @JsonProperty(JSON_PROPERTY_INDEX_CONVENTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public static final String JSON_PROPERTY_USE_ANNUALISED_DIRECT_RATES = "useAnnualisedDirectRates";
  @JsonProperty(JSON_PROPERTY_USE_ANNUALISED_DIRECT_RATES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to FloatSchedule
   */
  public static FloatSchedule fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, FloatSchedule.class);
  }
