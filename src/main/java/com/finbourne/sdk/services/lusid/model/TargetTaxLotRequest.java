 ...
 */
@JsonPropertyOrder({
  TargetTaxLotRequest.JSON_PROPERTY_UNITS,
  TargetTaxLotRequest.JSON_PROPERTY_COST,
  TargetTaxLotRequest.JSON_PROPERTY_PORTFOLIO_COST,
  TargetTaxLotRequest.JSON_PROPERTY_PRICE,
  TargetTaxLotRequest.JSON_PROPERTY_PURCHASE_DATE,
...
public class TargetTaxLotRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to TargetTaxLotRequest
   */
  public static TargetTaxLotRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, TargetTaxLotRequest.class);
  }
