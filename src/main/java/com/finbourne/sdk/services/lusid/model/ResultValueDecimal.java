 ...
 */
@JsonPropertyOrder({
  ResultValueDecimal.JSON_PROPERTY_VALUE,
  ResultValueDecimal.JSON_PROPERTY_DIMENSION
})
...
public class ResultValueDecimal extends ResultValue {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ResultValueDecimal
   */
  public static ResultValueDecimal fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ResultValueDecimal.class);
  }
