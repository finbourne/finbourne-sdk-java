...
public class ParticipationsApi {
     ...
     */
    private HttpRequest deleteParticipationCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteParticipationCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteParticipation. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The participation scope. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The participation&#39;s code. This, together with the scope uniquely identifies the participation to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteParticipationCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/participations/{scope}/{code}"
    ...
    private HttpRequest deleteParticipationValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteParticipationWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteParticipationValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] DeleteParticipation: Delete participation
     * Delete an participation. Deletion will be valid from the participation&#39;s creation datetime.  This means that the participation will no longer exist at any effective datetime from the asAt datetime of deletion.Use any specified configuration options to override any other configuration for this request only
     * @param scope The participation scope. (required)
     * @param code The participation&#39;s code. This, together with the scope uniquely identifies the participation to delete. (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deleteParticipationWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteParticipationValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteParticipationAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteParticipationValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
     ...
     */
    private void deleteParticipationAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteParticipationValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteParticipationRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteParticipationAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteParticipationAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getParticipationCall(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return getParticipationCall(scope, code, asAt, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getParticipation. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope to which the participation belongs. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The participation&#39;s unique identifier. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the participation. Defaults to return the latest version of the participation if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param propertyKeys A list of property keys from the \&quot;Participation\&quot; domain to decorate onto the participation.              These take the format {domain}/{scope}/{code} e.g. \&quot;Participation/system/Name\&quot;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getParticipationCall(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getParticipationValidateBeforeCall(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<Participation> getParticipationWithHttpInfo(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = getParticipationValidateBeforeCall(scope, code, asAt, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Participation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetParticipation: Get Participation
     * Fetch a Participation that matches the specified identifierUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope to which the participation belongs. (required)
     * @param code The participation&#39;s unique identifier. (required)
     * @param asAt The asAt datetime at which to retrieve the participation. Defaults to return the latest version of the participation if not specified. (optional)
     * @param propertyKeys A list of property keys from the \&quot;Participation\&quot; domain to decorate onto the participation.              These take the format {domain}/{scope}/{code} e.g. \&quot;Participation/system/Name\&quot;. (optional)
    ...
    private ApiResponse<Participation> getParticipationWithHttpInfo(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getParticipationValidateBeforeCall(scope, code, asAt, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<Participation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getParticipationAsync(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Participation> _callback) throws ApiException {

        HttpRequest localVarCall = getParticipationValidateBeforeCall(scope, code, asAt, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<Participation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getParticipationAsync(String scope, String code, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Participation> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getParticipationValidateBeforeCall(scope, code, asAt, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<Participation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetParticipationRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Participation> _callback) throws ApiException {
            getParticipationAsync(scope, code, asAt, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Participation> _callback, ConfigurationOptions opts) throws ApiException {
            getParticipationAsync(scope, code, asAt, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listParticipationsCall(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        return listParticipationsCall(asAt, page, sortBy, limit, filter, propertyKeys,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listParticipations. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the participation. Defaults to return the latest version of the participation if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listParticipationsCall(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/participations";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listParticipationsValidateBeforeCall(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfParticipation> listParticipationsWithHttpInfo(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        HttpRequest localVarCall = listParticipationsValidateBeforeCall(asAt, page, sortBy, limit, filter, propertyKeys, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfParticipation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListParticipations: List Participations
     * Fetch the last pre-AsAt date version of each Participation in scope (does not fetch the entire history).Use any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to retrieve the participation. Defaults to return the latest version of the participation if not specified. (optional)
     * @param page The pagination token to use to continue listing participations from a previous call to list participations.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request. (optional)
     * @param sortBy A list of field names to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot; (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
    ...
    private ApiResponse<PagedResourceListOfParticipation> listParticipationsWithHttpInfo(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listParticipationsValidateBeforeCall(asAt, page, sortBy, limit, filter, propertyKeys, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfParticipation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listParticipationsAsync(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfParticipation> _callback) throws ApiException {

        HttpRequest localVarCall = listParticipationsValidateBeforeCall(asAt, page, sortBy, limit, filter, propertyKeys, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfParticipation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listParticipationsAsync(OffsetDateTime asAt, String page, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfParticipation> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listParticipationsValidateBeforeCall(asAt, page, sortBy, limit, filter, propertyKeys, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfParticipation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistParticipationsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfParticipation> _callback) throws ApiException {
            listParticipationsAsync(asAt, page, sortBy, limit, filter, propertyKeys, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfParticipation> _callback, ConfigurationOptions opts) throws ApiException {
            listParticipationsAsync(asAt, page, sortBy, limit, filter, propertyKeys, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertParticipationsCall(ParticipationSetRequest participationSetRequest, final ApiCallback _callback) throws ApiException {
        return upsertParticipationsCall(participationSetRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertParticipations. Use any specified configuration options to override any other configuration for this request only.
     * @param participationSetRequest The collection of participation requests. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertParticipationsCall(ParticipationSetRequest participationSetRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertParticipationsValidateBeforeCall(ParticipationSetRequest participationSetRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfParticipation> upsertParticipationsWithHttpInfo(ParticipationSetRequest participationSetRequest) throws ApiException {
        HttpRequest localVarCall = upsertParticipationsValidateBeforeCall(participationSetRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfParticipation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpsertParticipations: Upsert Participation
     * Upsert; update existing participations with given ids, or create new participations otherwise.Use any specified configuration options to override any other configuration for this request only
     * @param participationSetRequest The collection of participation requests. (optional)
     * @return ApiResponse&lt;ResourceListOfParticipation&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfParticipation> upsertParticipationsWithHttpInfo(ParticipationSetRequest participationSetRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertParticipationsValidateBeforeCall(participationSetRequest, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfParticipation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertParticipationsAsync(ParticipationSetRequest participationSetRequest, final ApiCallback<ResourceListOfParticipation> _callback) throws ApiException {

        HttpRequest localVarCall = upsertParticipationsValidateBeforeCall(participationSetRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfParticipation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertParticipationsAsync(ParticipationSetRequest participationSetRequest, final ApiCallback<ResourceListOfParticipation> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertParticipationsValidateBeforeCall(participationSetRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfParticipation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertParticipationsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfParticipation> _callback) throws ApiException {
            upsertParticipationsAsync(participationSetRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfParticipation> _callback, ConfigurationOptions opts) throws ApiException {
            upsertParticipationsAsync(participationSetRequest, _callback, opts);
        }
    }
