 ...
 */
@JsonPropertyOrder({
  ScripDividendEvent.JSON_PROPERTY_ANNOUNCEMENT_DATE,
  ScripDividendEvent.JSON_PROPERTY_EX_DATE,
  ScripDividendEvent.JSON_PROPERTY_RECORD_DATE,
...
public class ScripDividendEvent extends InstrumentEvent {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ScripDividendEvent
   */
  public static ScripDividendEvent fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ScripDividendEvent.class);
  }
