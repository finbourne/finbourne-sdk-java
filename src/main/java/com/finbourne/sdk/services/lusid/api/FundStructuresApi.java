...
public class FundStructuresApi {
     ...
     */
    private HttpRequest createFundStructureCall(String scope, FundStructureRequest fundStructureRequest, final ApiCallback _callback) throws ApiException {
        return createFundStructureCall(scope, fundStructureRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createFundStructure. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest createFundStructureCall(String scope, FundStructureRequest fundStructureRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/fundstructures/{scope}"
    ...
    private HttpRequest createFundStructureValidateBeforeCall(String scope, FundStructureRequest fundStructureRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<FundStructure> createFundStructureWithHttpInfo(String scope, FundStructureRequest fundStructureRequest) throws ApiException {
        HttpRequest localVarCall = createFundStructureValidateBeforeCall(scope, fundStructureRequest, null, new ConfigurationOptions());
    ...
    /**
     * [EXPERIMENTAL] CreateFundStructure: Create a Fund Structure.
     * Create a new Fund Structure Model. The scope and code of the Fund Structure are provided in the request body.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Fund Structure. (required)
     * @param fundStructureRequest The definition of the Fund Structure. (required)
     * @return ApiResponse&lt;FundStructure&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<FundStructure> createFundStructureWithHttpInfo(String scope, FundStructureRequest fundStructureRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createFundStructureValidateBeforeCall(scope, fundStructureRequest, null, opts);
        Type localVarReturnType = new TypeReference<FundStructure>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] CreateFundStructure: Create a Fund Structure. (asynchronously)
     * Create a new Fund Structure Model. The scope and code of the Fund Structure are provided in the request body.
     * @param scope The scope of the Fund Structure. (required)
     * @param fundStructureRequest The definition of the Fund Structure. (required)
     ...
     */
    private void createFundStructureAsync(String scope, FundStructureRequest fundStructureRequest, final ApiCallback<FundStructure> _callback) throws ApiException {

        HttpRequest localVarCall = createFundStructureValidateBeforeCall(scope, fundStructureRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<FundStructure>(){}.getType();
     ...
     */
    private void createFundStructureAsync(String scope, FundStructureRequest fundStructureRequest, final ApiCallback<FundStructure> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createFundStructureValidateBeforeCall(scope, fundStructureRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<FundStructure>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateFundStructureRequest {
        ...
        public void executeAsync(final ApiCallback<FundStructure> _callback) throws ApiException {
            createFundStructureAsync(scope, fundStructureRequest, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<FundStructure> _callback, ConfigurationOptions opts) throws ApiException {
            createFundStructureAsync(scope, fundStructureRequest, _callback, opts);
        }
    }
     ...
     * @param filter Expression to filter the results. For example, to filter on the Fund Structure code, specify \&quot;id.Code eq &#39;Structure1&#39;\&quot;. For more information about filtering results, see https://support.lusid.com/knowledgebase/article/KA-01914. (optional). Use any specified configuration options to override any other configuration for this request only.
    ...
    private HttpRequest listFundStructuresCall(OffsetDateTime asAt, String page, Integer limit, String filter, List<String> sortBy, List<String> propertyKeys, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/api/fundstructures";
