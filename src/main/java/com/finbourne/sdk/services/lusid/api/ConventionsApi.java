...
public class ConventionsApi {
     ...
     */
    private HttpRequest deleteCdsFlowConventionsCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteCdsFlowConventionsCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteCdsFlowConventions. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the CDS Flow Conventions to delete. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The CDS Flow Conventions to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteCdsFlowConventionsCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/conventions/credit/conventions/{scope}/{code}"
    ...
    private HttpRequest deleteCdsFlowConventionsValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<AnnulSingleStructuredDataResponse> deleteCdsFlowConventionsWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteCdsFlowConventionsValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * [BETA] DeleteCdsFlowConventions: Delete the CDS Flow Conventions of given scope and code, assuming that it is present.
     * Delete the specified CDS Flow Conventions from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.  It is important to always check for any unsuccessful response.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the CDS Flow Conventions to delete. (required)
     * @param code The CDS Flow Conventions to delete. (required)
     * @return ApiResponse&lt;AnnulSingleStructuredDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<AnnulSingleStructuredDataResponse> deleteCdsFlowConventionsWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteCdsFlowConventionsValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteCdsFlowConventionsAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteCdsFlowConventionsValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
     ...
     */
    private void deleteCdsFlowConventionsAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteCdsFlowConventionsValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteCdsFlowConventionsRequest {
        ...
        public void executeAsync(final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {
            deleteCdsFlowConventionsAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<AnnulSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteCdsFlowConventionsAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteFlowConventionsCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteFlowConventionsCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteFlowConventions. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Flow Conventions to delete. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The Flow Conventions to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteFlowConventionsCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/conventions/rates/flowconventions/{scope}/{code}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteFlowConventionsValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AnnulSingleStructuredDataResponse> deleteFlowConventionsWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteFlowConventionsValidateBeforeCall(scope, code, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [BETA] DeleteFlowConventions: Delete the Flow Conventions of given scope and code, assuming that it is present.
     * Delete the specified conventions from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.  It is important to always check for any unsuccessful response.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Flow Conventions to delete. (required)
     * @param code The Flow Conventions to delete. (required)
     * @return ApiResponse&lt;AnnulSingleStructuredDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<AnnulSingleStructuredDataResponse> deleteFlowConventionsWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteFlowConventionsValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteFlowConventionsAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteFlowConventionsValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteFlowConventionsAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteFlowConventionsValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteFlowConventionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {
            deleteFlowConventionsAsync(scope, code, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AnnulSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteFlowConventionsAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteIndexConventionCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteIndexConventionCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteIndexConvention. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Index Convention to delete. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The Index Convention to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteIndexConventionCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/conventions/rates/indexconventions/{scope}/{code}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteIndexConventionValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<AnnulSingleStructuredDataResponse> deleteIndexConventionWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteIndexConventionValidateBeforeCall(scope, code, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [BETA] DeleteIndexConvention: Delete the Index Convention of given scope and code, assuming that it is present.
     * Delete the specified Index Convention from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.  It is important to always check for any unsuccessful response.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the Index Convention to delete. (required)
     * @param code The Index Convention to delete. (required)
     * @return ApiResponse&lt;AnnulSingleStructuredDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<AnnulSingleStructuredDataResponse> deleteIndexConventionWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteIndexConventionValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteIndexConventionAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteIndexConventionValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteIndexConventionAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteIndexConventionValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<AnnulSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteIndexConventionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {
            deleteIndexConventionAsync(scope, code, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<AnnulSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteIndexConventionAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getCdsFlowConventionsCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getCdsFlowConventionsCall(scope, code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getCdsFlowConventions. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the CDS Flow Conventions to retrieve. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The name of the CDS Flow Conventions to retrieve the data for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the CDS Flow Conventions. Defaults to return the latest version if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getCdsFlowConventionsCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getCdsFlowConventionsValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<GetCdsFlowConventionsResponse> getCdsFlowConventionsWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getCdsFlowConventionsValidateBeforeCall(scope, code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetCdsFlowConventionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<GetCdsFlowConventionsResponse> getCdsFlowConventionsWithHttpInfo(String scope, String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getCdsFlowConventionsValidateBeforeCall(scope, code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<GetCdsFlowConventionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getCdsFlowConventionsAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetCdsFlowConventionsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getCdsFlowConventionsValidateBeforeCall(scope, code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetCdsFlowConventionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getCdsFlowConventionsAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetCdsFlowConventionsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getCdsFlowConventionsValidateBeforeCall(scope, code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<GetCdsFlowConventionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetCdsFlowConventionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<GetCdsFlowConventionsResponse> _callback) throws ApiException {
            getCdsFlowConventionsAsync(scope, code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<GetCdsFlowConventionsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getCdsFlowConventionsAsync(scope, code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getFlowConventionsCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getFlowConventionsCall(scope, code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getFlowConventions. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Flow Conventions to retrieve. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The name of the Flow Conventions to retrieve the data for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Flow Conventions. Defaults to return the latest version if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getFlowConventionsCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getFlowConventionsValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<GetFlowConventionsResponse> getFlowConventionsWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getFlowConventionsValidateBeforeCall(scope, code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetFlowConventionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<GetFlowConventionsResponse> getFlowConventionsWithHttpInfo(String scope, String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getFlowConventionsValidateBeforeCall(scope, code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<GetFlowConventionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getFlowConventionsAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetFlowConventionsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getFlowConventionsValidateBeforeCall(scope, code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetFlowConventionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getFlowConventionsAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetFlowConventionsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getFlowConventionsValidateBeforeCall(scope, code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<GetFlowConventionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetFlowConventionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<GetFlowConventionsResponse> _callback) throws ApiException {
            getFlowConventionsAsync(scope, code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<GetFlowConventionsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getFlowConventionsAsync(scope, code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getIndexConventionCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getIndexConventionCall(scope, code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getIndexConvention. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the Index Convention to retrieve. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The name of the Index Convention to retrieve the data for. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the Index Convention. Defaults to return the latest version if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getIndexConventionCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getIndexConventionValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<GetIndexConventionResponse> getIndexConventionWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getIndexConventionValidateBeforeCall(scope, code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetIndexConventionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<GetIndexConventionResponse> getIndexConventionWithHttpInfo(String scope, String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getIndexConventionValidateBeforeCall(scope, code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<GetIndexConventionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void getIndexConventionAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetIndexConventionResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getIndexConventionValidateBeforeCall(scope, code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetIndexConventionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getIndexConventionAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetIndexConventionResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getIndexConventionValidateBeforeCall(scope, code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<GetIndexConventionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetIndexConventionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<GetIndexConventionResponse> _callback) throws ApiException {
            getIndexConventionAsync(scope, code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<GetIndexConventionResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getIndexConventionAsync(scope, code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listCdsFlowConventionsCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return listCdsFlowConventionsCall(asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listCdsFlowConventions. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listCdsFlowConventionsCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/conventions/credit/conventions";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listCdsFlowConventionsValidateBeforeCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfGetCdsFlowConventionsResponse> listCdsFlowConventionsWithHttpInfo(OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = listCdsFlowConventionsValidateBeforeCall(asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfGetCdsFlowConventionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [BETA] ListCdsFlowConventions: List the set of CDS Flow Conventions
     * List the set of CDS Flow Conventions at the specified date/timeUse any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)
     * @return ApiResponse&lt;ResourceListOfGetCdsFlowConventionsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfGetCdsFlowConventionsResponse> listCdsFlowConventionsWithHttpInfo(OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listCdsFlowConventionsValidateBeforeCall(asAt, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfGetCdsFlowConventionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listCdsFlowConventionsAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetCdsFlowConventionsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = listCdsFlowConventionsValidateBeforeCall(asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfGetCdsFlowConventionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listCdsFlowConventionsAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetCdsFlowConventionsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listCdsFlowConventionsValidateBeforeCall(asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfGetCdsFlowConventionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistCdsFlowConventionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfGetCdsFlowConventionsResponse> _callback) throws ApiException {
            listCdsFlowConventionsAsync(asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfGetCdsFlowConventionsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            listCdsFlowConventionsAsync(asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listFlowConventionsCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return listFlowConventionsCall(asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listFlowConventions. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listFlowConventionsCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/conventions/rates/flowconventions";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listFlowConventionsValidateBeforeCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfGetFlowConventionsResponse> listFlowConventionsWithHttpInfo(OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = listFlowConventionsValidateBeforeCall(asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfGetFlowConventionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [BETA] ListFlowConventions: List the set of Flow Conventions
     * List the set of Flow Conventions at the specified date/timeUse any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)
     * @return ApiResponse&lt;ResourceListOfGetFlowConventionsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfGetFlowConventionsResponse> listFlowConventionsWithHttpInfo(OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listFlowConventionsValidateBeforeCall(asAt, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfGetFlowConventionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listFlowConventionsAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetFlowConventionsResponse> _callback) throws ApiException {

        HttpRequest localVarCall = listFlowConventionsValidateBeforeCall(asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfGetFlowConventionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listFlowConventionsAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetFlowConventionsResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listFlowConventionsValidateBeforeCall(asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfGetFlowConventionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistFlowConventionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfGetFlowConventionsResponse> _callback) throws ApiException {
            listFlowConventionsAsync(asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfGetFlowConventionsResponse> _callback, ConfigurationOptions opts) throws ApiException {
            listFlowConventionsAsync(asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listIndexConventionCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return listIndexConventionCall(asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listIndexConvention. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listIndexConventionCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/conventions/rates/indexconventions";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listIndexConventionValidateBeforeCall(OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfGetIndexConventionResponse> listIndexConventionWithHttpInfo(OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = listIndexConventionValidateBeforeCall(asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfGetIndexConventionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [BETA] ListIndexConvention: List the set of Index Conventions
     * List the set of Index Conventions at the specified date/timeUse any specified configuration options to override any other configuration for this request only
     * @param asAt The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)
     * @return ApiResponse&lt;ResourceListOfGetIndexConventionResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ResourceListOfGetIndexConventionResponse> listIndexConventionWithHttpInfo(OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listIndexConventionValidateBeforeCall(asAt, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfGetIndexConventionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void listIndexConventionAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetIndexConventionResponse> _callback) throws ApiException {

        HttpRequest localVarCall = listIndexConventionValidateBeforeCall(asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfGetIndexConventionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listIndexConventionAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetIndexConventionResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listIndexConventionValidateBeforeCall(asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfGetIndexConventionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistIndexConventionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfGetIndexConventionResponse> _callback) throws ApiException {
            listIndexConventionAsync(asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfGetIndexConventionResponse> _callback, ConfigurationOptions opts) throws ApiException {
            listIndexConventionAsync(asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertCdsFlowConventionsCall(UpsertCdsFlowConventionsRequest upsertCdsFlowConventionsRequest, final ApiCallback _callback) throws ApiException {
        return upsertCdsFlowConventionsCall(upsertCdsFlowConventionsRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertCdsFlowConventions. Use any specified configuration options to override any other configuration for this request only.
     * @param upsertCdsFlowConventionsRequest The CDS Flow Conventions to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertCdsFlowConventionsCall(UpsertCdsFlowConventionsRequest upsertCdsFlowConventionsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertCdsFlowConventionsValidateBeforeCall(UpsertCdsFlowConventionsRequest upsertCdsFlowConventionsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertCdsFlowConventionsWithHttpInfo(UpsertCdsFlowConventionsRequest upsertCdsFlowConventionsRequest) throws ApiException {
        HttpRequest localVarCall = upsertCdsFlowConventionsValidateBeforeCall(upsertCdsFlowConventionsRequest, null, new ConfigurationOptions());
    ...
    /**
     * [BETA] UpsertCdsFlowConventions: Upsert a set of CDS Flow Conventions. This creates or updates the data in Lusid.
     * Update or insert CDS Flow Conventions in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted CDS Flow Conventions or failure message if unsuccessful                It is important to always check to verify success (or failure).Use any specified configuration options to override any other configuration for this request only
     * @param upsertCdsFlowConventionsRequest The CDS Flow Conventions to update or insert (required)
     * @return ApiResponse&lt;UpsertSingleStructuredDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertCdsFlowConventionsWithHttpInfo(UpsertCdsFlowConventionsRequest upsertCdsFlowConventionsRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertCdsFlowConventionsValidateBeforeCall(upsertCdsFlowConventionsRequest, null, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertCdsFlowConventionsAsync(UpsertCdsFlowConventionsRequest upsertCdsFlowConventionsRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertCdsFlowConventionsValidateBeforeCall(upsertCdsFlowConventionsRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertCdsFlowConventionsAsync(UpsertCdsFlowConventionsRequest upsertCdsFlowConventionsRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertCdsFlowConventionsValidateBeforeCall(upsertCdsFlowConventionsRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertCdsFlowConventionsRequest {
        ...
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {
            upsertCdsFlowConventionsAsync(upsertCdsFlowConventionsRequest, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertCdsFlowConventionsAsync(upsertCdsFlowConventionsRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertFlowConventionsCall(UpsertFlowConventionsRequest upsertFlowConventionsRequest, final ApiCallback _callback) throws ApiException {
        return upsertFlowConventionsCall(upsertFlowConventionsRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertFlowConventions. Use any specified configuration options to override any other configuration for this request only.
     * @param upsertFlowConventionsRequest The Flow Conventions to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertFlowConventionsCall(UpsertFlowConventionsRequest upsertFlowConventionsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertFlowConventionsValidateBeforeCall(UpsertFlowConventionsRequest upsertFlowConventionsRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertFlowConventionsWithHttpInfo(UpsertFlowConventionsRequest upsertFlowConventionsRequest) throws ApiException {
        HttpRequest localVarCall = upsertFlowConventionsValidateBeforeCall(upsertFlowConventionsRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertFlowConventionsWithHttpInfo(UpsertFlowConventionsRequest upsertFlowConventionsRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertFlowConventionsValidateBeforeCall(upsertFlowConventionsRequest, null, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertFlowConventionsAsync(UpsertFlowConventionsRequest upsertFlowConventionsRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertFlowConventionsValidateBeforeCall(upsertFlowConventionsRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertFlowConventionsAsync(UpsertFlowConventionsRequest upsertFlowConventionsRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertFlowConventionsValidateBeforeCall(upsertFlowConventionsRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertFlowConventionsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {
            upsertFlowConventionsAsync(upsertFlowConventionsRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertFlowConventionsAsync(upsertFlowConventionsRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertIndexConventionCall(UpsertIndexConventionRequest upsertIndexConventionRequest, final ApiCallback _callback) throws ApiException {
        return upsertIndexConventionCall(upsertIndexConventionRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertIndexConvention. Use any specified configuration options to override any other configuration for this request only.
     * @param upsertIndexConventionRequest The Index Conventions to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertIndexConventionCall(UpsertIndexConventionRequest upsertIndexConventionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertIndexConventionValidateBeforeCall(UpsertIndexConventionRequest upsertIndexConventionRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertIndexConventionWithHttpInfo(UpsertIndexConventionRequest upsertIndexConventionRequest) throws ApiException {
        HttpRequest localVarCall = upsertIndexConventionValidateBeforeCall(upsertIndexConventionRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [BETA] UpsertIndexConvention: Upsert a set of Index Convention. This creates or updates the data in Lusid.
     * Update or insert Index Convention in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted Index Convention or failure message if unsuccessful                It is important to always check to verify success (or failure).Use any specified configuration options to override any other configuration for this request only
     * @param upsertIndexConventionRequest The Index Conventions to update or insert (required)
     * @return ApiResponse&lt;UpsertSingleStructuredDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertIndexConventionWithHttpInfo(UpsertIndexConventionRequest upsertIndexConventionRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertIndexConventionValidateBeforeCall(upsertIndexConventionRequest, null, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void upsertIndexConventionAsync(UpsertIndexConventionRequest upsertIndexConventionRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertIndexConventionValidateBeforeCall(upsertIndexConventionRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertIndexConventionAsync(UpsertIndexConventionRequest upsertIndexConventionRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertIndexConventionValidateBeforeCall(upsertIndexConventionRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertIndexConventionRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {
            upsertIndexConventionAsync(upsertIndexConventionRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertIndexConventionAsync(upsertIndexConventionRequest, _callback, opts);
        }
    }
