 ...
 */
@JsonPropertyOrder({
  DeleteTransferAgencyOrdersResponse.JSON_PROPERTY_SUCCESSES,
  DeleteTransferAgencyOrdersResponse.JSON_PROPERTY_FAILED,
  DeleteTransferAgencyOrdersResponse.JSON_PROPERTY_LINKS
})
...
public class DeleteTransferAgencyOrdersResponse {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to DeleteTransferAgencyOrdersResponse
   */
  public static DeleteTransferAgencyOrdersResponse fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, DeleteTransferAgencyOrdersResponse.class);
  }
