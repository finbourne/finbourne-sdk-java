 ...
 */
@JsonPropertyOrder({
  MbsCouponEvent.JSON_PROPERTY_EX_DATE,
  MbsCouponEvent.JSON_PROPERTY_PAYMENT_DATE,
  MbsCouponEvent.JSON_PROPERTY_CURRENCY,
  MbsCouponEvent.JSON_PROPERTY_COUPON_PER_UNIT
})
...
public class MbsCouponEvent extends InstrumentEvent {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to MbsCouponEvent
   */
  public static MbsCouponEvent fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, MbsCouponEvent.class);
  }
