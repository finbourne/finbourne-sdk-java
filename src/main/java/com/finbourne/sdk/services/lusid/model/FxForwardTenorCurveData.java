 ...
 */
@JsonPropertyOrder({
  FxForwardTenorCurveData.JSON_PROPERTY_BASE_DATE,
  FxForwardTenorCurveData.JSON_PROPERTY_DOM_CCY,
  FxForwardTenorCurveData.JSON_PROPERTY_FGN_CCY,
  FxForwardTenorCurveData.JSON_PROPERTY_TENORS,
  FxForwardTenorCurveData.JSON_PROPERTY_RATES,
  FxForwardTenorCurveData.JSON_PROPERTY_LINEAGE,
  FxForwardTenorCurveData.JSON_PROPERTY_MARKET_DATA_OPTIONS,
  FxForwardTenorCurveData.JSON_PROPERTY_CALENDARS,
  FxForwardTenorCurveData.JSON_PROPERTY_SPOT_DAYS_CALCULATION_TYPE,
  FxForwardTenorCurveData.JSON_PROPERTY_VERSION
})
...
public class FxForwardTenorCurveData extends ComplexMarketData {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to FxForwardTenorCurveData
   */
  public static FxForwardTenorCurveData fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, FxForwardTenorCurveData.class);
  }
