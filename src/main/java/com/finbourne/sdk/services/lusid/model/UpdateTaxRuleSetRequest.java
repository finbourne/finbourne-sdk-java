 ...
 */
@JsonPropertyOrder({
  UpdateTaxRuleSetRequest.JSON_PROPERTY_DISPLAY_NAME,
  UpdateTaxRuleSetRequest.JSON_PROPERTY_DESCRIPTION,
  UpdateTaxRuleSetRequest.JSON_PROPERTY_RULES
})
...
public class UpdateTaxRuleSetRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to UpdateTaxRuleSetRequest
   */
  public static UpdateTaxRuleSetRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, UpdateTaxRuleSetRequest.class);
  }
