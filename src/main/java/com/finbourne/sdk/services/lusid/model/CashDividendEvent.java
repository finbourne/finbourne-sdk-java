 ...
 */
@JsonPropertyOrder({
  CashDividendEvent.JSON_PROPERTY_PAYMENT_DATE,
  CashDividendEvent.JSON_PROPERTY_EX_DATE,
  CashDividendEvent.JSON_PROPERTY_CASH_ELECTIONS,
  CashDividendEvent.JSON_PROPERTY_ANNOUNCEMENT_DATE,
  CashDividendEvent.JSON_PROPERTY_RECORD_DATE
})
...
public class CashDividendEvent extends InstrumentEvent {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to CashDividendEvent
   */
  public static CashDividendEvent fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, CashDividendEvent.class);
  }
