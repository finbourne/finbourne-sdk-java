...
public class ComplexMarketDataApi {
     ...
     */
    private HttpRequest deleteComplexMarketDataCall(String scope, Map<String, ComplexMarketDataId> requestBody, final ApiCallback _callback) throws ApiException {
        return deleteComplexMarketDataCall(scope, requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteComplexMarketData. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the complex market data to delete. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The complex market data Ids to delete, each keyed by a unique correlation id. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteComplexMarketDataCall(String scope, Map<String, ComplexMarketDataId> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/api/api/complexmarketdata/{scope}/$delete"
    ...
    private HttpRequest deleteComplexMarketDataValidateBeforeCall(String scope, Map<String, ComplexMarketDataId> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<AnnulStructuredDataResponse> deleteComplexMarketDataWithHttpInfo(String scope, Map<String, ComplexMarketDataId> requestBody) throws ApiException {
        HttpRequest localVarCall = deleteComplexMarketDataValidateBeforeCall(scope, requestBody, null, new ConfigurationOptions());
    ...
    private ApiResponse<AnnulStructuredDataResponse> deleteComplexMarketDataWithHttpInfo(String scope, Map<String, ComplexMarketDataId> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteComplexMarketDataValidateBeforeCall(scope, requestBody, null, opts);
        Type localVarReturnType = new TypeReference<AnnulStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * DeleteComplexMarketData: Delete one or more items of complex market data, assuming they are present. (asynchronously)
     * Delete one or more specified complex market data items from a single scope. Each item is identified by a unique id which includes  information about its type as well as the exact effective datetime (to the microsecond) at which it entered the system (became valid).                In the request each complex market data item must be keyed by a unique correlation id. This id is ephemeral and is not stored by LUSID.  It serves only as a way to easily identify each quote in the response.                The response will return both the collection of successfully deleted  complex market data items, as well as those that failed.  For the failures a reason will be provided explaining why the it could not be deleted.                It is important to always check the failed set for any unsuccessful results.
     * @param scope The scope of the complex market data to delete. (required)
     * @param requestBody The complex market data Ids to delete, each keyed by a unique correlation id. (required)
     ...
     */
    private void deleteComplexMarketDataAsync(String scope, Map<String, ComplexMarketDataId> requestBody, final ApiCallback<AnnulStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteComplexMarketDataValidateBeforeCall(scope, requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<AnnulStructuredDataResponse>(){}.getType();
     ...
     */
    private void deleteComplexMarketDataAsync(String scope, Map<String, ComplexMarketDataId> requestBody, final ApiCallback<AnnulStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteComplexMarketDataValidateBeforeCall(scope, requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<AnnulStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteComplexMarketDataRequest {
        ...
        public void executeAsync(final ApiCallback<AnnulStructuredDataResponse> _callback) throws ApiException {
            deleteComplexMarketDataAsync(scope, requestBody, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<AnnulStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteComplexMarketDataAsync(scope, requestBody, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getComplexMarketDataCall(String scope, Map<String, ComplexMarketDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for getComplexMarketData. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the complex market data to retrieve. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The time invariant set of complex data identifiers to retrieve the data for. These need to be               keyed by a unique correlation id allowing the retrieved item to be identified in the response. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The effective datetime at which to retrieve the complex market data.               Defaults to the current LUSID system datetime if not specified.               Must match the Effective at of each ComplexMarketDataId given in the request body. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the complex market data. Defaults to return the latest version if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param maxAge The duration of the look back window in an ISO8601 time interval format e.g. P1Y2M3DT4H30M (1 year, 2 months, 3 days, 4 hours and 30 minutes).               This is subtracted from the provided effectiveAt datetime to generate a effective datetime window inside which a complex market data item must exist to be retrieved. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest getComplexMarketDataCall(String scope, Map<String, ComplexMarketDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/complexmarketdata/{scope}/$get"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getComplexMarketDataValidateBeforeCall(String scope, Map<String, ComplexMarketDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<GetComplexMarketDataResponse> getComplexMarketDataWithHttpInfo(String scope, Map<String, ComplexMarketDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge, String timelineScope, String timelineCode, String closedPeriodId) throws ApiException {
        HttpRequest localVarCall = getComplexMarketDataValidateBeforeCall(scope, requestBody, effectiveAt, asAt, maxAge, timelineScope, timelineCode, closedPeriodId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetComplexMarketDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetComplexMarketData: Get complex market data
     * Get one or more items of complex market data from a single scope.                Each item can be identified by its time invariant complex market data identifier.                For each id LUSID will return the most recent matched item with respect to the provided (or default) effective datetime.                An optional maximum age range window can be specified which defines how far back to look back for data from the specified effective datetime.  LUSID will return the most recent item within this window.                In the request each complex market data id must be keyed by a unique correlation id. This id is ephemeral and is not stored by LUSID.  It serves only as a way to easily identify each item in the response.                The response will return three collections. One, the successfully retrieved complex market data. Two, those that had a  valid identifier but could not be found. Three, those that failed because LUSID could not construct a valid identifier from the request.                For the ids that failed to resolve or could not be found a reason will be provided explaining why that is the case.                It is important to always check the failed and not found sets for any unsuccessful results.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the complex market data to retrieve. (required)
     * @param requestBody The time invariant set of complex data identifiers to retrieve the data for. These need to be               keyed by a unique correlation id allowing the retrieved item to be identified in the response. (required)
     * @param effectiveAt The effective datetime at which to retrieve the complex market data.               Defaults to the current LUSID system datetime if not specified.               Must match the Effective at of each ComplexMarketDataId given in the request body. (optional)
     * @param asAt The asAt datetime at which to retrieve the complex market data. Defaults to return the latest version if not specified. (optional)
    ...
    private ApiResponse<GetComplexMarketDataResponse> getComplexMarketDataWithHttpInfo(String scope, Map<String, ComplexMarketDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge, String timelineScope, String timelineCode, String closedPeriodId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getComplexMarketDataValidateBeforeCall(scope, requestBody, effectiveAt, asAt, maxAge, timelineScope, timelineCode, closedPeriodId, null, opts);
        Type localVarReturnType = new TypeReference<GetComplexMarketDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetComplexMarketData: Get complex market data (asynchronously)
     * Get one or more items of complex market data from a single scope.                Each item can be identified by its time invariant complex market data identifier.                For each id LUSID will return the most recent matched item with respect to the provided (or default) effective datetime.                An optional maximum age range window can be specified which defines how far back to look back for data from the specified effective datetime.  LUSID will return the most recent item within this window.                In the request each complex market data id must be keyed by a unique correlation id. This id is ephemeral and is not stored by LUSID.  It serves only as a way to easily identify each item in the response.                The response will return three collections. One, the successfully retrieved complex market data. Two, those that had a  valid identifier but could not be found. Three, those that failed because LUSID could not construct a valid identifier from the request.                For the ids that failed to resolve or could not be found a reason will be provided explaining why that is the case.                It is important to always check the failed and not found sets for any unsuccessful results.
     * @param scope The scope of the complex market data to retrieve. (required)
     * @param requestBody The time invariant set of complex data identifiers to retrieve the data for. These need to be               keyed by a unique correlation id allowing the retrieved item to be identified in the response. (required)
     * @param effectiveAt The effective datetime at which to retrieve the complex market data.               Defaults to the current LUSID system datetime if not specified.               Must match the Effective at of each ComplexMarketDataId given in the request body. (optional)
     ...
     */
    private void getComplexMarketDataAsync(String scope, Map<String, ComplexMarketDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback<GetComplexMarketDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getComplexMarketDataValidateBeforeCall(scope, requestBody, effectiveAt, asAt, maxAge, timelineScope, timelineCode, closedPeriodId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<GetComplexMarketDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getComplexMarketDataAsync(String scope, Map<String, ComplexMarketDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback<GetComplexMarketDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getComplexMarketDataValidateBeforeCall(scope, requestBody, effectiveAt, asAt, maxAge, timelineScope, timelineCode, closedPeriodId, _callback, opts);
        Type localVarReturnType = new TypeReference<GetComplexMarketDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetComplexMarketDataRequest {
         ...
         */
        public void executeAsync(final ApiCallback<GetComplexMarketDataResponse> _callback) throws ApiException {
            getComplexMarketDataAsync(scope, requestBody, effectiveAt, asAt, maxAge, timelineScope, timelineCode, closedPeriodId, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<GetComplexMarketDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getComplexMarketDataAsync(scope, requestBody, effectiveAt, asAt, maxAge, timelineScope, timelineCode, closedPeriodId, _callback, opts);
        }
    }
    ...
    private HttpRequest listComplexMarketDataCall(OffsetDateTime asAt, String effectiveAt, String page, Integer limit, String timelineScope, String timelineCode, String closedPeriodId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/api/complexmarketdata";
     ...
     */
    private HttpRequest upsertAppendComplexMarketDataCall(String scope, AppendComplexMarketDataRequest appendComplexMarketDataRequest, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return upsertAppendComplexMarketDataCall(scope, appendComplexMarketDataRequest, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertAppendComplexMarketData. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the complex market data to append. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param appendComplexMarketDataRequest Request definition of the point to append. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the complex market data. Defaults to return the latest version if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertAppendComplexMarketDataCall(String scope, AppendComplexMarketDataRequest appendComplexMarketDataRequest, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/complexmarketdata/{scope}/$append"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertAppendComplexMarketDataValidateBeforeCall(String scope, AppendComplexMarketDataRequest appendComplexMarketDataRequest, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertAppendComplexMarketDataWithHttpInfo(String scope, AppendComplexMarketDataRequest appendComplexMarketDataRequest, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = upsertAppendComplexMarketDataValidateBeforeCall(scope, appendComplexMarketDataRequest, asAt, null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] UpsertAppendComplexMarketData: Appends a new point to the end of a ComplexMarketData definition.
     * Update a complex market data item in a single scope by appending a new point onto the end.                NOTE: This operation is only supported for FX curves with one of the following data types:  FxForwardCurveByQuoteReference, FxForwardCurveData, FxForwardPipsCurveData, FxForwardTenorCurveData, FxForwardTenorPipsCurveDataUse any specified configuration options to override any other configuration for this request only
     * @param scope The scope of the complex market data to append. (required)
     * @param appendComplexMarketDataRequest Request definition of the point to append. (required)
     * @param asAt The asAt datetime at which to retrieve the complex market data. Defaults to return the latest version if not specified. (optional)
     * @return ApiResponse&lt;UpsertSingleStructuredDataResponse&gt;
    ...
    private ApiResponse<UpsertSingleStructuredDataResponse> upsertAppendComplexMarketDataWithHttpInfo(String scope, AppendComplexMarketDataRequest appendComplexMarketDataRequest, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertAppendComplexMarketDataValidateBeforeCall(scope, appendComplexMarketDataRequest, asAt, null, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpsertAppendComplexMarketData: Appends a new point to the end of a ComplexMarketData definition. (asynchronously)
     * Update a complex market data item in a single scope by appending a new point onto the end.                NOTE: This operation is only supported for FX curves with one of the following data types:  FxForwardCurveByQuoteReference, FxForwardCurveData, FxForwardPipsCurveData, FxForwardTenorCurveData, FxForwardTenorPipsCurveData
     * @param scope The scope of the complex market data to append. (required)
     * @param appendComplexMarketDataRequest Request definition of the point to append. (required)
     * @param asAt The asAt datetime at which to retrieve the complex market data. Defaults to return the latest version if not specified. (optional)
     ...
     */
    private void upsertAppendComplexMarketDataAsync(String scope, AppendComplexMarketDataRequest appendComplexMarketDataRequest, OffsetDateTime asAt, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertAppendComplexMarketDataValidateBeforeCall(scope, appendComplexMarketDataRequest, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertAppendComplexMarketDataAsync(String scope, AppendComplexMarketDataRequest appendComplexMarketDataRequest, OffsetDateTime asAt, final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertAppendComplexMarketDataValidateBeforeCall(scope, appendComplexMarketDataRequest, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertAppendComplexMarketDataRequest {
        ...
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {
            upsertAppendComplexMarketDataAsync(scope, appendComplexMarketDataRequest, asAt, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<UpsertSingleStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertAppendComplexMarketDataAsync(scope, appendComplexMarketDataRequest, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest upsertComplexMarketDataCall(String scope, Map<String, UpsertComplexMarketDataRequest> requestBody, final ApiCallback _callback) throws ApiException {
        return upsertComplexMarketDataCall(scope, requestBody,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for upsertComplexMarketData. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope to use when updating or inserting the complex market data. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param requestBody The set of complex market data items to update or insert keyed by a unique correlation id. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest upsertComplexMarketDataCall(String scope, Map<String, UpsertComplexMarketDataRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/api/complexmarketdata/{scope}"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest upsertComplexMarketDataValidateBeforeCall(String scope, Map<String, UpsertComplexMarketDataRequest> requestBody, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<UpsertStructuredDataResponse> upsertComplexMarketDataWithHttpInfo(String scope, Map<String, UpsertComplexMarketDataRequest> requestBody) throws ApiException {
        HttpRequest localVarCall = upsertComplexMarketDataValidateBeforeCall(scope, requestBody, null, new ConfigurationOptions());
    ...
    /**
     * UpsertComplexMarketData: Upsert a set of complex market data items. This creates or updates the data in Lusid.
     * Update or insert one or more complex market data items in a single scope. An item will be updated if it already exists  and inserted if it does not.                In the request each complex market data item must be keyed by a unique correlation id. This id is ephemeral and is not stored by LUSID.  It serves only as a way to easily identify each complex market data in the response.                The response will return both the collection of successfully updated or inserted complex market data, as well as those that failed.  For the failures a reason will be provided explaining why the item could not be updated or inserted.                It is important to always check the failed set for any unsuccessful results.Use any specified configuration options to override any other configuration for this request only
     * @param scope The scope to use when updating or inserting the complex market data. (required)
     * @param requestBody The set of complex market data items to update or insert keyed by a unique correlation id. (required)
     * @return ApiResponse&lt;UpsertStructuredDataResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<UpsertStructuredDataResponse> upsertComplexMarketDataWithHttpInfo(String scope, Map<String, UpsertComplexMarketDataRequest> requestBody, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = upsertComplexMarketDataValidateBeforeCall(scope, requestBody, null, opts);
        Type localVarReturnType = new TypeReference<UpsertStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpsertComplexMarketData: Upsert a set of complex market data items. This creates or updates the data in Lusid. (asynchronously)
     * Update or insert one or more complex market data items in a single scope. An item will be updated if it already exists  and inserted if it does not.                In the request each complex market data item must be keyed by a unique correlation id. This id is ephemeral and is not stored by LUSID.  It serves only as a way to easily identify each complex market data in the response.                The response will return both the collection of successfully updated or inserted complex market data, as well as those that failed.  For the failures a reason will be provided explaining why the item could not be updated or inserted.                It is important to always check the failed set for any unsuccessful results.
     * @param scope The scope to use when updating or inserting the complex market data. (required)
     * @param requestBody The set of complex market data items to update or insert keyed by a unique correlation id. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void upsertComplexMarketDataAsync(String scope, Map<String, UpsertComplexMarketDataRequest> requestBody, final ApiCallback<UpsertStructuredDataResponse> _callback) throws ApiException {

        HttpRequest localVarCall = upsertComplexMarketDataValidateBeforeCall(scope, requestBody, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UpsertStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void upsertComplexMarketDataAsync(String scope, Map<String, UpsertComplexMarketDataRequest> requestBody, final ApiCallback<UpsertStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = upsertComplexMarketDataValidateBeforeCall(scope, requestBody, _callback, opts);
        Type localVarReturnType = new TypeReference<UpsertStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupsertComplexMarketDataRequest {
        ...
        public void executeAsync(final ApiCallback<UpsertStructuredDataResponse> _callback) throws ApiException {
            upsertComplexMarketDataAsync(scope, requestBody, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<UpsertStructuredDataResponse> _callback, ConfigurationOptions opts) throws ApiException {
            upsertComplexMarketDataAsync(scope, requestBody, _callback, opts);
        }
    }
