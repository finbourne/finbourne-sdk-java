...
@JsonPropertyOrder({
  ...
  ErrorDetail.JSON_PROPERTY_TYPE,
...
public class ErrorDetail {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ErrorDetail
   */
  public static ErrorDetail fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ErrorDetail.class);
  }
