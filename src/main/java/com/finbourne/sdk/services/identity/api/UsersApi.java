...
public class UsersApi {
     ...
     */
    private HttpRequest createUserCall(CreateUserRequest createUserRequest, Boolean waitForReindex, final ApiCallback _callback) throws ApiException {
        return createUserCall(createUserRequest, waitForReindex,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createUser. Use any specified configuration options to override any other configuration for this request only.
     * @param createUserRequest Details of the User to be created (required). Use any specified configuration options to override any other configuration for this request only.
     * @param waitForReindex Should the request wait until the newly created User is indexed (available in List) before returning (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createUserCall(CreateUserRequest createUserRequest, Boolean waitForReindex, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/identity/api/users";
    ...
    private HttpRequest createUserValidateBeforeCall(CreateUserRequest createUserRequest, Boolean waitForReindex, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UserResponse> createUserWithHttpInfo(CreateUserRequest createUserRequest, Boolean waitForReindex) throws ApiException {
        HttpRequest localVarCall = createUserValidateBeforeCall(createUserRequest, waitForReindex, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CreateUser: Create User
     * Create a new UserUse any specified configuration options to override any other configuration for this request only
     * @param createUserRequest Details of the User to be created (required)
     * @param waitForReindex Should the request wait until the newly created User is indexed (available in List) before returning (optional, default to false)
     * @return ApiResponse&lt;UserResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<UserResponse> createUserWithHttpInfo(CreateUserRequest createUserRequest, Boolean waitForReindex, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createUserValidateBeforeCall(createUserRequest, waitForReindex, null, opts);
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CreateUser: Create User (asynchronously)
     * Create a new User
     * @param createUserRequest Details of the User to be created (required)
     * @param waitForReindex Should the request wait until the newly created User is indexed (available in List) before returning (optional, default to false)
     ...
     */
    private void createUserAsync(CreateUserRequest createUserRequest, Boolean waitForReindex, final ApiCallback<UserResponse> _callback) throws ApiException {

        HttpRequest localVarCall = createUserValidateBeforeCall(createUserRequest, waitForReindex, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
     ...
     */
    private void createUserAsync(CreateUserRequest createUserRequest, Boolean waitForReindex, final ApiCallback<UserResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createUserValidateBeforeCall(createUserRequest, waitForReindex, _callback, opts);
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateUserRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserResponse> _callback) throws ApiException {
            createUserAsync(createUserRequest, waitForReindex, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserResponse> _callback, ConfigurationOptions opts) throws ApiException {
            createUserAsync(createUserRequest, waitForReindex, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteUserCall(String id, Boolean purge, final ApiCallback _callback) throws ApiException {
        return deleteUserCall(id, purge,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteUser. Use any specified configuration options to override any other configuration for this request only.
     * @param id The unique identifier for the user (required). Use any specified configuration options to override any other configuration for this request only.
     * @param purge Whether to purge any trace of the user from the identity provider (will affect audit) (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteUserCall(String id, Boolean purge, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/users/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteUserValidateBeforeCall(String id, Boolean purge, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<Void> deleteUserWithHttpInfo(String id, Boolean purge) throws ApiException {
        HttpRequest localVarCall = deleteUserValidateBeforeCall(id, purge, null, new ConfigurationOptions());
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * DeleteUser: Delete User
     * By default the user will be de-provisioned and inactive, however their record will remain in the identity provider for audit purposes. If this is not desirable and removal of all trace of the user is required, the purge parameter can be specified to indicate the details should be purged completely.Use any specified configuration options to override any other configuration for this request only
     * @param id The unique identifier for the user (required)
     * @param purge Whether to purge any trace of the user from the identity provider (will affect audit) (optional)
     * @return ApiResponse&lt;Void&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<Void> deleteUserWithHttpInfo(String id, Boolean purge, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteUserValidateBeforeCall(id, purge, null, opts);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * DeleteUser: Delete User (asynchronously)
     * By default the user will be de-provisioned and inactive, however their record will remain in the identity provider for audit purposes. If this is not desirable and removal of all trace of the user is required, the purge parameter can be specified to indicate the details should be purged completely.
     * @param id The unique identifier for the user (required)
     * @param purge Whether to purge any trace of the user from the identity provider (will affect audit) (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void deleteUserAsync(String id, Boolean purge, final ApiCallback<Void> _callback) throws ApiException {

        HttpRequest localVarCall = deleteUserValidateBeforeCall(id, purge, _callback, new ConfigurationOptions());
     ...
     */
    private void deleteUserAsync(String id, Boolean purge, final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteUserValidateBeforeCall(id, purge, _callback, opts);
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
    ...
    public class APIdeleteUserRequest {
        ...
        public void executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            deleteUserAsync(id, purge, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {
            deleteUserAsync(id, purge, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest expirePasswordCall(String id, final ApiCallback _callback) throws ApiException {
        return expirePasswordCall(id,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for expirePassword. Use any specified configuration options to override any other configuration for this request only.
     * @param id The unique identifier for the User having its password reset (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest expirePasswordCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/users/{id}/lifecycle/$expirepassword"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest expirePasswordValidateBeforeCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<TemporaryPassword> expirePasswordWithHttpInfo(String id) throws ApiException {
        HttpRequest localVarCall = expirePasswordValidateBeforeCall(id, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TemporaryPassword>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ExpirePassword: Reset the user&#39;s password to a temporary one
     * Resets the user&#39;s password to a temporary one which is then expiredUse any specified configuration options to override any other configuration for this request only
     * @param id The unique identifier for the User having its password reset (required)
     * @return ApiResponse&lt;TemporaryPassword&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<TemporaryPassword> expirePasswordWithHttpInfo(String id, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = expirePasswordValidateBeforeCall(id, null, opts);
        Type localVarReturnType = new TypeReference<TemporaryPassword>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ExpirePassword: Reset the user&#39;s password to a temporary one (asynchronously)
     * Resets the user&#39;s password to a temporary one which is then expired
     * @param id The unique identifier for the User having its password reset (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void expirePasswordAsync(String id, final ApiCallback<TemporaryPassword> _callback) throws ApiException {

        HttpRequest localVarCall = expirePasswordValidateBeforeCall(id, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<TemporaryPassword>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void expirePasswordAsync(String id, final ApiCallback<TemporaryPassword> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = expirePasswordValidateBeforeCall(id, _callback, opts);
        Type localVarReturnType = new TypeReference<TemporaryPassword>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIexpirePasswordRequest {
         ...
         */
        public void executeAsync(final ApiCallback<TemporaryPassword> _callback) throws ApiException {
            expirePasswordAsync(id, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<TemporaryPassword> _callback, ConfigurationOptions opts) throws ApiException {
            expirePasswordAsync(id, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest findUsersByIdCall(List<String> id, final ApiCallback _callback) throws ApiException {
        return findUsersByIdCall(id,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for findUsersById. Use any specified configuration options to override any other configuration for this request only.
     * @param id A list of unique identifiers for the users (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest findUsersByIdCall(List<String> id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/directory";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest findUsersByIdValidateBeforeCall(List<String> id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<ListUsersResponse> findUsersByIdWithHttpInfo(List<String> id) throws ApiException {
        HttpRequest localVarCall = findUsersByIdValidateBeforeCall(id, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ListUsersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * FindUsersById: Find users by id endpoint
     * Finds a maximum of 50 users by IDUse any specified configuration options to override any other configuration for this request only
     * @param id A list of unique identifiers for the users (required)
     * @return ApiResponse&lt;ListUsersResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<ListUsersResponse> findUsersByIdWithHttpInfo(List<String> id, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = findUsersByIdValidateBeforeCall(id, null, opts);
        Type localVarReturnType = new TypeReference<ListUsersResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * FindUsersById: Find users by id endpoint (asynchronously)
     * Finds a maximum of 50 users by ID
     * @param id A list of unique identifiers for the users (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void findUsersByIdAsync(List<String> id, final ApiCallback<ListUsersResponse> _callback) throws ApiException {

        HttpRequest localVarCall = findUsersByIdValidateBeforeCall(id, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ListUsersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void findUsersByIdAsync(List<String> id, final ApiCallback<ListUsersResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = findUsersByIdValidateBeforeCall(id, _callback, opts);
        Type localVarReturnType = new TypeReference<ListUsersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIfindUsersByIdRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ListUsersResponse> _callback) throws ApiException {
            findUsersByIdAsync(id, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ListUsersResponse> _callback, ConfigurationOptions opts) throws ApiException {
            findUsersByIdAsync(id, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getUserCall(String id, Boolean includeRoles, final ApiCallback _callback) throws ApiException {
        return getUserCall(id, includeRoles,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getUser. Use any specified configuration options to override any other configuration for this request only.
     * @param id The unique identifier for the User (required). Use any specified configuration options to override any other configuration for this request only.
     * @param includeRoles Flag indicating that the users roles should be included in the response (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest getUserCall(String id, Boolean includeRoles, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getUserValidateBeforeCall(String id, Boolean includeRoles, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<UserResponse> getUserWithHttpInfo(String id, Boolean includeRoles) throws ApiException {
        HttpRequest localVarCall = getUserValidateBeforeCall(id, includeRoles, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * GetUser: Get User
     * Get the specified UserUse any specified configuration options to override any other configuration for this request only
     * @param id The unique identifier for the User (required)
     * @param includeRoles Flag indicating that the users roles should be included in the response (optional)
     * @return ApiResponse&lt;UserResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<UserResponse> getUserWithHttpInfo(String id, Boolean includeRoles, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getUserValidateBeforeCall(id, includeRoles, null, opts);
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetUser: Get User (asynchronously)
     * Get the specified User
     * @param id The unique identifier for the User (required)
     * @param includeRoles Flag indicating that the users roles should be included in the response (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void getUserAsync(String id, Boolean includeRoles, final ApiCallback<UserResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getUserValidateBeforeCall(id, includeRoles, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getUserAsync(String id, Boolean includeRoles, final ApiCallback<UserResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getUserValidateBeforeCall(id, includeRoles, _callback, opts);
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetUserRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserResponse> _callback) throws ApiException {
            getUserAsync(id, includeRoles, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getUserAsync(id, includeRoles, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getUserFromLoginCall(String login, final ApiCallback _callback) throws ApiException {
        return getUserFromLoginCall(login,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getUserFromLogin. Use any specified configuration options to override any other configuration for this request only.
     * @param login The unique login for the User (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getUserFromLoginCall(String login, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/users/fromlogin/{login}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getUserFromLoginValidateBeforeCall(String login, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UserResponse> getUserFromLoginWithHttpInfo(String login) throws ApiException {
        HttpRequest localVarCall = getUserFromLoginValidateBeforeCall(login, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * GetUserFromLogin: Get User From Login
     * Get the userId of a specified UserUse any specified configuration options to override any other configuration for this request only
     * @param login The unique login for the User (required)
     * @return ApiResponse&lt;UserResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<UserResponse> getUserFromLoginWithHttpInfo(String login, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getUserFromLoginValidateBeforeCall(login, null, opts);
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetUserFromLogin: Get User From Login (asynchronously)
     * Get the userId of a specified User
     * @param login The unique login for the User (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void getUserFromLoginAsync(String login, final ApiCallback<UserResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getUserFromLoginValidateBeforeCall(login, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getUserFromLoginAsync(String login, final ApiCallback<UserResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getUserFromLoginValidateBeforeCall(login, _callback, opts);
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetUserFromLoginRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserResponse> _callback) throws ApiException {
            getUserFromLoginAsync(login, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getUserFromLoginAsync(login, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getUserSchemaCall(final ApiCallback _callback) throws ApiException {
     ...
     */
    private HttpRequest getUserSchemaCall(final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/users/schema";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getUserSchemaValidateBeforeCall(final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UserSchemaResponse> getUserSchemaWithHttpInfo() throws ApiException {
        HttpRequest localVarCall = getUserSchemaValidateBeforeCall(null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserSchemaResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetUserSchema: Get User Schema
     * Get the User SchemaUse any specified configuration options to override any other configuration for this request only
     * @return ApiResponse&lt;UserSchemaResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
    ...
    private ApiResponse<UserSchemaResponse> getUserSchemaWithHttpInfo(ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getUserSchemaValidateBeforeCall(null, opts);
        Type localVarReturnType = new TypeReference<UserSchemaResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] GetUserSchema: Get User Schema (asynchronously)
     * Get the User Schema
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     * @http.response.details
     ...
     */
    private void getUserSchemaAsync(final ApiCallback<UserSchemaResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getUserSchemaValidateBeforeCall(_callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserSchemaResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getUserSchemaAsync(final ApiCallback<UserSchemaResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getUserSchemaValidateBeforeCall(_callback, opts);
        Type localVarReturnType = new TypeReference<UserSchemaResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetUserSchemaRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserSchemaResponse> _callback) throws ApiException {
            getUserSchemaAsync(_callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserSchemaResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getUserSchemaAsync(_callback, opts);
        }
    }
     ...
     */
    private HttpRequest listRunnableUsersCall(final ApiCallback _callback) throws ApiException {
     ...
     */
    private HttpRequest listRunnableUsersCall(final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/users/$runnable";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listRunnableUsersValidateBeforeCall(final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<List<UserResponse>> listRunnableUsersWithHttpInfo() throws ApiException {
        HttpRequest localVarCall = listRunnableUsersValidateBeforeCall(null, new ConfigurationOptions());
    ...
    /**
     * [EARLY ACCESS] ListRunnableUsers: List Runable Users
     * List the available runnable UsersUse any specified configuration options to override any other configuration for this request only
     * @return ApiResponse&lt;List&lt;UserResponse&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
    ...
    private ApiResponse<List<UserResponse>> listRunnableUsersWithHttpInfo(ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listRunnableUsersValidateBeforeCall(null, opts);
        Type localVarReturnType = new TypeReference<List<UserResponse>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] ListRunnableUsers: List Runable Users (asynchronously)
     * List the available runnable Users
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     * @http.response.details
     ...
     */
    private void listRunnableUsersAsync(final ApiCallback<List<UserResponse>> _callback) throws ApiException {

        HttpRequest localVarCall = listRunnableUsersValidateBeforeCall(_callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<List<UserResponse>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listRunnableUsersAsync(final ApiCallback<List<UserResponse>> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listRunnableUsersValidateBeforeCall(_callback, opts);
        Type localVarReturnType = new TypeReference<List<UserResponse>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistRunnableUsersRequest {
        ...
        public void executeAsync(final ApiCallback<List<UserResponse>> _callback) throws ApiException {
            listRunnableUsersAsync(_callback);
        }
        ...
        public void executeAsync(final ApiCallback<List<UserResponse>> _callback, ConfigurationOptions opts) throws ApiException {
            listRunnableUsersAsync(_callback, opts);
        }
    }
     ...
     */
    private HttpRequest listUsersCall(Boolean includeDeactivated, final ApiCallback _callback) throws ApiException {
        return listUsersCall(includeDeactivated,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listUsers. Use any specified configuration options to override any other configuration for this request only.
     * @param includeDeactivated Include previously deleted (not purged) users (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest listUsersCall(Boolean includeDeactivated, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listUsersValidateBeforeCall(Boolean includeDeactivated, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<List<UserResponse>> listUsersWithHttpInfo(Boolean includeDeactivated) throws ApiException {
        HttpRequest localVarCall = listUsersValidateBeforeCall(includeDeactivated, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<List<UserResponse>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * ListUsers: List Users
     * List the available UsersUse any specified configuration options to override any other configuration for this request only
     * @param includeDeactivated Include previously deleted (not purged) users (optional, default to false)
     * @return ApiResponse&lt;List&lt;UserResponse&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<List<UserResponse>> listUsersWithHttpInfo(Boolean includeDeactivated, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listUsersValidateBeforeCall(includeDeactivated, null, opts);
        Type localVarReturnType = new TypeReference<List<UserResponse>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListUsers: List Users (asynchronously)
     * List the available Users
     * @param includeDeactivated Include previously deleted (not purged) users (optional, default to false)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void listUsersAsync(Boolean includeDeactivated, final ApiCallback<List<UserResponse>> _callback) throws ApiException {

        HttpRequest localVarCall = listUsersValidateBeforeCall(includeDeactivated, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<List<UserResponse>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listUsersAsync(Boolean includeDeactivated, final ApiCallback<List<UserResponse>> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listUsersValidateBeforeCall(includeDeactivated, _callback, opts);
        Type localVarReturnType = new TypeReference<List<UserResponse>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistUsersRequest {
         ...
         */
        public void executeAsync(final ApiCallback<List<UserResponse>> _callback) throws ApiException {
            listUsersAsync(includeDeactivated, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<List<UserResponse>> _callback, ConfigurationOptions opts) throws ApiException {
            listUsersAsync(includeDeactivated, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest resetFactorsCall(String id, final ApiCallback _callback) throws ApiException {
        return resetFactorsCall(id,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for resetFactors. Use any specified configuration options to override any other configuration for this request only.
     * @param id The unique identifier for the User having their MFA factors reset (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest resetFactorsCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/users/{id}/lifecycle/$resetfactors"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest resetFactorsValidateBeforeCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<Void> resetFactorsWithHttpInfo(String id) throws ApiException {
        HttpRequest localVarCall = resetFactorsValidateBeforeCall(id, null, new ConfigurationOptions());
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * ResetFactors: Reset MFA factors
     * Resets the MFA factors of the specified UserUse any specified configuration options to override any other configuration for this request only
     * @param id The unique identifier for the User having their MFA factors reset (required)
     * @return ApiResponse&lt;Void&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<Void> resetFactorsWithHttpInfo(String id, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = resetFactorsValidateBeforeCall(id, null, opts);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * ResetFactors: Reset MFA factors (asynchronously)
     * Resets the MFA factors of the specified User
     * @param id The unique identifier for the User having their MFA factors reset (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void resetFactorsAsync(String id, final ApiCallback<Void> _callback) throws ApiException {

        HttpRequest localVarCall = resetFactorsValidateBeforeCall(id, _callback, new ConfigurationOptions());
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
     ...
     */
    private void resetFactorsAsync(String id, final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = resetFactorsValidateBeforeCall(id, _callback, opts);
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
    ...
    public class APIresetFactorsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            resetFactorsAsync(id, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {
            resetFactorsAsync(id, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest resetPasswordCall(String id, final ApiCallback _callback) throws ApiException {
        return resetPasswordCall(id,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for resetPassword. Use any specified configuration options to override any other configuration for this request only.
     * @param id The unique identifier for the User having their password reset (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest resetPasswordCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/users/{id}/lifecycle/$resetpassword"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest resetPasswordValidateBeforeCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<Void> resetPasswordWithHttpInfo(String id) throws ApiException {
        HttpRequest localVarCall = resetPasswordValidateBeforeCall(id, null, new ConfigurationOptions());
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * ResetPassword: Reset Password
     * Resets the password of the specified UserUse any specified configuration options to override any other configuration for this request only
     * @param id The unique identifier for the User having their password reset (required)
     * @return ApiResponse&lt;Void&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<Void> resetPasswordWithHttpInfo(String id, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = resetPasswordValidateBeforeCall(id, null, opts);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * ResetPassword: Reset Password (asynchronously)
     * Resets the password of the specified User
     * @param id The unique identifier for the User having their password reset (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void resetPasswordAsync(String id, final ApiCallback<Void> _callback) throws ApiException {

        HttpRequest localVarCall = resetPasswordValidateBeforeCall(id, _callback, new ConfigurationOptions());
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
     ...
     */
    private void resetPasswordAsync(String id, final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = resetPasswordValidateBeforeCall(id, _callback, opts);
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
    ...
    public class APIresetPasswordRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            resetPasswordAsync(id, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {
            resetPasswordAsync(id, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest sendActivationEmailCall(String id, final ApiCallback _callback) throws ApiException {
        return sendActivationEmailCall(id,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for sendActivationEmail. Use any specified configuration options to override any other configuration for this request only.
     * @param id The unique identifier for the User to be activated (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest sendActivationEmailCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/users/{id}/lifecycle/$activate"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest sendActivationEmailValidateBeforeCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<Void> sendActivationEmailWithHttpInfo(String id) throws ApiException {
        HttpRequest localVarCall = sendActivationEmailValidateBeforeCall(id, null, new ConfigurationOptions());
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * SendActivationEmail: Sends an activation email to the User
     * Sends an activation email to the specified UserUse any specified configuration options to override any other configuration for this request only
     * @param id The unique identifier for the User to be activated (required)
     * @return ApiResponse&lt;Void&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<Void> sendActivationEmailWithHttpInfo(String id, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = sendActivationEmailValidateBeforeCall(id, null, opts);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * SendActivationEmail: Sends an activation email to the User (asynchronously)
     * Sends an activation email to the specified User
     * @param id The unique identifier for the User to be activated (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void sendActivationEmailAsync(String id, final ApiCallback<Void> _callback) throws ApiException {

        HttpRequest localVarCall = sendActivationEmailValidateBeforeCall(id, _callback, new ConfigurationOptions());
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
     ...
     */
    private void sendActivationEmailAsync(String id, final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = sendActivationEmailValidateBeforeCall(id, _callback, opts);
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
    ...
    public class APIsendActivationEmailRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            sendActivationEmailAsync(id, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {
            sendActivationEmailAsync(id, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest unlockUserCall(String id, final ApiCallback _callback) throws ApiException {
        return unlockUserCall(id,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for unlockUser. Use any specified configuration options to override any other configuration for this request only.
     * @param id The unique identifier for the User to be unlocked (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest unlockUserCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/users/{id}/lifecycle/$unlock"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest unlockUserValidateBeforeCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<Void> unlockUserWithHttpInfo(String id) throws ApiException {
        HttpRequest localVarCall = unlockUserValidateBeforeCall(id, null, new ConfigurationOptions());
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * UnlockUser: Unlock User
     * Unlocks the specified UserUse any specified configuration options to override any other configuration for this request only
     * @param id The unique identifier for the User to be unlocked (required)
     * @return ApiResponse&lt;Void&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<Void> unlockUserWithHttpInfo(String id, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = unlockUserValidateBeforeCall(id, null, opts);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * UnlockUser: Unlock User (asynchronously)
     * Unlocks the specified User
     * @param id The unique identifier for the User to be unlocked (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void unlockUserAsync(String id, final ApiCallback<Void> _callback) throws ApiException {

        HttpRequest localVarCall = unlockUserValidateBeforeCall(id, _callback, new ConfigurationOptions());
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
     ...
     */
    private void unlockUserAsync(String id, final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = unlockUserValidateBeforeCall(id, _callback, opts);
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
    ...
    public class APIunlockUserRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {
            unlockUserAsync(id, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest unsuspendUserCall(String id, final ApiCallback _callback) throws ApiException {
        return unsuspendUserCall(id,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for unsuspendUser. Use any specified configuration options to override any other configuration for this request only.
     * @param id The unique identifier for the User to Unsuspend (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest unsuspendUserCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/identity/api/users/{id}/lifecycle/$unsuspend"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest unsuspendUserValidateBeforeCall(String id, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<Void> unsuspendUserWithHttpInfo(String id) throws ApiException {
        HttpRequest localVarCall = unsuspendUserValidateBeforeCall(id, null, new ConfigurationOptions());
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * [EXPERIMENTAL] UnsuspendUser: Unsuspend user
     * Unsuspend the userUse any specified configuration options to override any other configuration for this request only
     * @param id The unique identifier for the User to Unsuspend (required)
     * @return ApiResponse&lt;Void&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<Void> unsuspendUserWithHttpInfo(String id, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = unsuspendUserValidateBeforeCall(id, null, opts);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * [EXPERIMENTAL] UnsuspendUser: Unsuspend user (asynchronously)
     * Unsuspend the user
     * @param id The unique identifier for the User to Unsuspend (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void unsuspendUserAsync(String id, final ApiCallback<Void> _callback) throws ApiException {

        HttpRequest localVarCall = unsuspendUserValidateBeforeCall(id, _callback, new ConfigurationOptions());
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
     ...
     */
    private void unsuspendUserAsync(String id, final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = unsuspendUserValidateBeforeCall(id, _callback, opts);
        localVarApiClient.executeAsync(localVarCall, _callback);
    }
    ...
    public class APIunsuspendUserRequest {
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            unsuspendUserAsync(id, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<Void> _callback, ConfigurationOptions opts) throws ApiException {
            unsuspendUserAsync(id, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateUserCall(String id, UpdateUserRequest updateUserRequest, final ApiCallback _callback) throws ApiException {
        return updateUserCall(id, updateUserRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateUser. Use any specified configuration options to override any other configuration for this request only.
     * @param id The unique identifier for the User to be updated (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateUserRequest The new definition of the User (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updateUserCall(String id, UpdateUserRequest updateUserRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateUserValidateBeforeCall(String id, UpdateUserRequest updateUserRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    private ApiResponse<UserResponse> updateUserWithHttpInfo(String id, UpdateUserRequest updateUserRequest) throws ApiException {
        HttpRequest localVarCall = updateUserValidateBeforeCall(id, updateUserRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * UpdateUser: Update User
     * Updates the specified UserUse any specified configuration options to override any other configuration for this request only
     * @param id The unique identifier for the User to be updated (required)
     * @param updateUserRequest The new definition of the User (required)
     * @return ApiResponse&lt;UserResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<UserResponse> updateUserWithHttpInfo(String id, UpdateUserRequest updateUserRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateUserValidateBeforeCall(id, updateUserRequest, null, opts);
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpdateUser: Update User (asynchronously)
     * Updates the specified User
     * @param id The unique identifier for the User to be updated (required)
     * @param updateUserRequest The new definition of the User (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void updateUserAsync(String id, UpdateUserRequest updateUserRequest, final ApiCallback<UserResponse> _callback) throws ApiException {

        HttpRequest localVarCall = updateUserValidateBeforeCall(id, updateUserRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateUserAsync(String id, UpdateUserRequest updateUserRequest, final ApiCallback<UserResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateUserValidateBeforeCall(id, updateUserRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UserResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateUserRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserResponse> _callback) throws ApiException {
            updateUserAsync(id, updateUserRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserResponse> _callback, ConfigurationOptions opts) throws ApiException {
            updateUserAsync(id, updateUserRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateUserSchemaCall(UpdateUserSchemaRequest updateUserSchemaRequest, final ApiCallback _callback) throws ApiException {
        return updateUserSchemaCall(updateUserSchemaRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateUserSchema. Use any specified configuration options to override any other configuration for this request only.
     * @param updateUserSchemaRequest The new User Schema (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updateUserSchemaCall(UpdateUserSchemaRequest updateUserSchemaRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateUserSchemaValidateBeforeCall(UpdateUserSchemaRequest updateUserSchemaRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<UserSchemaResponse> updateUserSchemaWithHttpInfo(UpdateUserSchemaRequest updateUserSchemaRequest) throws ApiException {
        HttpRequest localVarCall = updateUserSchemaValidateBeforeCall(updateUserSchemaRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserSchemaResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * [EARLY ACCESS] UpdateUserSchema: Update User Schema
     * Update the User SchemaUse any specified configuration options to override any other configuration for this request only
     * @param updateUserSchemaRequest The new User Schema (required)
     * @return ApiResponse&lt;UserSchemaResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<UserSchemaResponse> updateUserSchemaWithHttpInfo(UpdateUserSchemaRequest updateUserSchemaRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateUserSchemaValidateBeforeCall(updateUserSchemaRequest, null, opts);
        Type localVarReturnType = new TypeReference<UserSchemaResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] UpdateUserSchema: Update User Schema (asynchronously)
     * Update the User Schema
     * @param updateUserSchemaRequest The new User Schema (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void updateUserSchemaAsync(UpdateUserSchemaRequest updateUserSchemaRequest, final ApiCallback<UserSchemaResponse> _callback) throws ApiException {

        HttpRequest localVarCall = updateUserSchemaValidateBeforeCall(updateUserSchemaRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<UserSchemaResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateUserSchemaAsync(UpdateUserSchemaRequest updateUserSchemaRequest, final ApiCallback<UserSchemaResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateUserSchemaValidateBeforeCall(updateUserSchemaRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<UserSchemaResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateUserSchemaRequest {
         ...
         */
        public void executeAsync(final ApiCallback<UserSchemaResponse> _callback) throws ApiException {
            updateUserSchemaAsync(updateUserSchemaRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<UserSchemaResponse> _callback, ConfigurationOptions opts) throws ApiException {
            updateUserSchemaAsync(updateUserSchemaRequest, _callback, opts);
        }
    }
