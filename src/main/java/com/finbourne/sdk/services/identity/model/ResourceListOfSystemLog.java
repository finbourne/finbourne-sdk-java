 ...
 */
@JsonPropertyOrder({
  ResourceListOfSystemLog.JSON_PROPERTY_VALUES,
  ResourceListOfSystemLog.JSON_PROPERTY_HREF,
  ResourceListOfSystemLog.JSON_PROPERTY_LINKS,
  ResourceListOfSystemLog.JSON_PROPERTY_NEXT_PAGE,
  ResourceListOfSystemLog.JSON_PROPERTY_PREVIOUS_PAGE
})
...
public class ResourceListOfSystemLog {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ResourceListOfSystemLog
   */
  public static ResourceListOfSystemLog fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ResourceListOfSystemLog.class);
  }
