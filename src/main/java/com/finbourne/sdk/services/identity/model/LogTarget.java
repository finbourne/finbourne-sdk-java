 ...
 */
@JsonPropertyOrder({
  LogTarget.JSON_PROPERTY_ID,
  LogTarget.JSON_PROPERTY_TYPE,
  LogTarget.JSON_PROPERTY_ALTERNATE_ID,
  LogTarget.JSON_PROPERTY_DISPLAY_NAME,
  LogTarget.JSON_PROPERTY_DETAIL_ENTRY
})
...
public class LogTarget {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to LogTarget
   */
  public static LogTarget fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, LogTarget.class);
  }
