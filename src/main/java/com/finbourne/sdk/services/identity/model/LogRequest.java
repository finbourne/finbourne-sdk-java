 ...
 */
@JsonPropertyOrder({
  LogRequest.JSON_PROPERTY_IP_CHAIN
})
...
public class LogRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to LogRequest
   */
  public static LogRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, LogRequest.class);
  }
