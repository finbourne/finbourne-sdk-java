 ...
 */
@JsonPropertyOrder({
  CreateExternalTokenIssuerRequest.JSON_PROPERTY_CODE,
  CreateExternalTokenIssuerRequest.JSON_PROPERTY_ISSUER,
  CreateExternalTokenIssuerRequest.JSON_PROPERTY_AUDIENCE,
  CreateExternalTokenIssuerRequest.JSON_PROPERTY_DESCRIPTION,
  CreateExternalTokenIssuerRequest.JSON_PROPERTY_CLAIM_MAPPINGS,
  CreateExternalTokenIssuerRequest.JSON_PROPERTY_LOGOUT_URL
})
...
public class CreateExternalTokenIssuerRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to CreateExternalTokenIssuerRequest
   */
  public static CreateExternalTokenIssuerRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, CreateExternalTokenIssuerRequest.class);
  }
