 ...
 */
@JsonPropertyOrder({
  UpdateNetworkZoneRequest.JSON_PROPERTY_DESCRIPTION,
  UpdateNetworkZoneRequest.JSON_PROPERTY_NETWORK_ZONE_I_PS,
  UpdateNetworkZoneRequest.JSON_PROPERTY_ACTION,
  UpdateNetworkZoneRequest.JSON_PROPERTY_APPLY_RULES,
  UpdateNetworkZoneRequest.JSON_PROPERTY_HIERARCHY
})
...
public class UpdateNetworkZoneRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to UpdateNetworkZoneRequest
   */
  public static UpdateNetworkZoneRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, UpdateNetworkZoneRequest.class);
  }
