 ...
 */
@JsonPropertyOrder({
  SupportAccessRequest.JSON_PROPERTY_DURATION,
  SupportAccessRequest.JSON_PROPERTY_DESCRIPTION,
  SupportAccessRequest.JSON_PROPERTY_PERMITTED_ROLES
})
...
public class SupportAccessRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to SupportAccessRequest
   */
  public static SupportAccessRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, SupportAccessRequest.class);
  }
