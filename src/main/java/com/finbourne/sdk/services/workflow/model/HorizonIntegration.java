...
public class HorizonIntegration {
  ...
  public enum TypeEnum {
    HORIZON_INTEGRATION("HorizonIntegration");
  ...
  public HorizonIntegration type(TypeEnum type) {
    this.type = type;
    return this;
  }
 ...
 public int hashCode() {
  ...
  /**
   * Create an instance of HorizonIntegration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HorizonIntegration
   * @throws java.io.IOException if the JSON string is invalid with respect to HorizonIntegration
   */
  public static HorizonIntegration fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, HorizonIntegration.class);
  }

  /**
   * Convert an instance of HorizonIntegration to an JSON string
   *
   * @return JSON string
   */
