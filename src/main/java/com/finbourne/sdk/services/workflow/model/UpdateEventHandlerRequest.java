 ...
 */
@JsonPropertyOrder({
  UpdateEventHandlerRequest.JSON_PROPERTY_DISPLAY_NAME,
  UpdateEventHandlerRequest.JSON_PROPERTY_DESCRIPTION,
  UpdateEventHandlerRequest.JSON_PROPERTY_STATUS,
  UpdateEventHandlerRequest.JSON_PROPERTY_EVENT_MATCHING_PATTERN,
  UpdateEventHandlerRequest.JSON_PROPERTY_SCHEDULE_MATCHING_PATTERN,
  UpdateEventHandlerRequest.JSON_PROPERTY_RUN_AS_USER_ID,
  UpdateEventHandlerRequest.JSON_PROPERTY_TASK_DEFINITION_ID,
  UpdateEventHandlerRequest.JSON_PROPERTY_TASK_DEFINITION_AS_AT,
  UpdateEventHandlerRequest.JSON_PROPERTY_TASK_ACTIVITY
})
...
public class UpdateEventHandlerRequest {
  ...
  public UpdateEventHandlerRequest scheduleMatchingPattern(ScheduleMatchingPattern scheduleMatchingPattern) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayName, updateEventHandlerRequest.displayName) &&
        ...
        Objects.equals(this.scheduleMatchingPattern, updateEventHandlerRequest.scheduleMatchingPattern) &&
  ...
  @Override
 public int hashCode() {
    return Objects.hash(displayName, description, status, eventMatchingPattern, scheduleMatchingPattern, runAsUserId, taskDefinitionId, taskDefinitionAsAt, taskActivity);
  }
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to UpdateEventHandlerRequest
   */
  public static UpdateEventHandlerRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, UpdateEventHandlerRequest.class);
  }
