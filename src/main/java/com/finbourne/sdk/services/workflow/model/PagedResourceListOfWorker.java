 ...
 */
@JsonPropertyOrder({
  PagedResourceListOfWorker.JSON_PROPERTY_NEXT_PAGE,
  PagedResourceListOfWorker.JSON_PROPERTY_PREVIOUS_PAGE,
  PagedResourceListOfWorker.JSON_PROPERTY_VALUES,
  PagedResourceListOfWorker.JSON_PROPERTY_HREF,
  PagedResourceListOfWorker.JSON_PROPERTY_LINKS
})
...
public class PagedResourceListOfWorker {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to PagedResourceListOfWorker
   */
  public static PagedResourceListOfWorker fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, PagedResourceListOfWorker.class);
  }
