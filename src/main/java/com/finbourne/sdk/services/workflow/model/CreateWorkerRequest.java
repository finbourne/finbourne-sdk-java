 ...
 */
@JsonPropertyOrder({
  CreateWorkerRequest.JSON_PROPERTY_ID,
  CreateWorkerRequest.JSON_PROPERTY_DISPLAY_NAME,
  CreateWorkerRequest.JSON_PROPERTY_DESCRIPTION,
  CreateWorkerRequest.JSON_PROPERTY_WORKER_CONFIGURATION
})
...
public class CreateWorkerRequest {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to CreateWorkerRequest
   */
  public static CreateWorkerRequest fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, CreateWorkerRequest.class);
  }
