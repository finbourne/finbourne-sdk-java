 ...
 */
@JsonPropertyOrder({
  EventHandler.JSON_PROPERTY_ID,
  EventHandler.JSON_PROPERTY_VERSION,
  EventHandler.JSON_PROPERTY_DISPLAY_NAME,
  EventHandler.JSON_PROPERTY_DESCRIPTION,
  EventHandler.JSON_PROPERTY_STATUS,
  EventHandler.JSON_PROPERTY_EVENT_MATCHING_PATTERN,
  EventHandler.JSON_PROPERTY_SCHEDULE_MATCHING_PATTERN,
  EventHandler.JSON_PROPERTY_RUN_AS_USER_ID,
  EventHandler.JSON_PROPERTY_TASK_DEFINITION_ID,
  EventHandler.JSON_PROPERTY_TASK_DEFINITION_AS_AT,
  EventHandler.JSON_PROPERTY_TASK_ACTIVITY
})
...
public class EventHandler {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to EventHandler
   */
  public static EventHandler fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, EventHandler.class);
  }
