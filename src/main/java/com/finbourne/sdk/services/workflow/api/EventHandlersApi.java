...
public class EventHandlersApi {
     ...
     */
    private HttpRequest createEventHandlerCall(CreateEventHandlerRequest createEventHandlerRequest, final ApiCallback _callback) throws ApiException {
        return createEventHandlerCall(createEventHandlerRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createEventHandler. Use any specified configuration options to override any other configuration for this request only.
     * @param createEventHandlerRequest The data to create an Event Handler (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createEventHandlerCall(CreateEventHandlerRequest createEventHandlerRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/workflow/api/eventhandlers";
    ...
    private HttpRequest createEventHandlerValidateBeforeCall(CreateEventHandlerRequest createEventHandlerRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<EventHandler> createEventHandlerWithHttpInfo(CreateEventHandlerRequest createEventHandlerRequest) throws ApiException {
        HttpRequest localVarCall = createEventHandlerValidateBeforeCall(createEventHandlerRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
    ...
    private ApiResponse<EventHandler> createEventHandlerWithHttpInfo(CreateEventHandlerRequest createEventHandlerRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createEventHandlerValidateBeforeCall(createEventHandlerRequest, null, opts);
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CreateEventHandler: Create a new Event Handler (asynchronously)
     * 
     * @param createEventHandlerRequest The data to create an Event Handler (required)
     ...
     */
    private void createEventHandlerAsync(CreateEventHandlerRequest createEventHandlerRequest, final ApiCallback<EventHandler> _callback) throws ApiException {

        HttpRequest localVarCall = createEventHandlerValidateBeforeCall(createEventHandlerRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
     ...
     */
    private void createEventHandlerAsync(CreateEventHandlerRequest createEventHandlerRequest, final ApiCallback<EventHandler> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createEventHandlerValidateBeforeCall(createEventHandlerRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateEventHandlerRequest {
         ...
         */
        public void executeAsync(final ApiCallback<EventHandler> _callback) throws ApiException {
            createEventHandlerAsync(createEventHandlerRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<EventHandler> _callback, ConfigurationOptions opts) throws ApiException {
            createEventHandlerAsync(createEventHandlerRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteEventHandlerCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteEventHandlerCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteEventHandler. Use any specified configuration options to override any other configuration for this request only.
     * @param scope Scope of the event handler to be deleted (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code Code of the event handler to be deleted (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteEventHandlerCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/workflow/api/eventhandlers/{scope}/{code}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteEventHandlerValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<DeletedEntityResponse> deleteEventHandlerWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteEventHandlerValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    /**
     * DeleteEventHandler: Delete an Event Handler
     * If the Event Handler does not exist a failure will be returnedUse any specified configuration options to override any other configuration for this request only
     * @param scope Scope of the event handler to be deleted (required)
     * @param code Code of the event handler to be deleted (required)
     * @return ApiResponse&lt;DeletedEntityResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    private ApiResponse<DeletedEntityResponse> deleteEventHandlerWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteEventHandlerValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * DeleteEventHandler: Delete an Event Handler (asynchronously)
     * If the Event Handler does not exist a failure will be returned
     * @param scope Scope of the event handler to be deleted (required)
     * @param code Code of the event handler to be deleted (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void deleteEventHandlerAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        HttpRequest localVarCall = deleteEventHandlerValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteEventHandlerAsync(String scope, String code, final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteEventHandlerValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteEventHandlerRequest {
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
            deleteEventHandlerAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<DeletedEntityResponse> _callback, ConfigurationOptions opts) throws ApiException {
            deleteEventHandlerAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getEventHandlerCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        return getEventHandlerCall(scope, code, asAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getEventHandler. Use any specified configuration options to override any other configuration for this request only.
     * @param scope Scope of the event handler (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code Code of the event handler (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to retrieve the event handler. Defaults to returning the latest version of the event handler if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getEventHandlerCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getEventHandlerValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<EventHandler> getEventHandlerWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        HttpRequest localVarCall = getEventHandlerValidateBeforeCall(scope, code, asAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    /**
     * GetEventHandler: Get an Event Handler
     * Will return a NotFound failure if the event handler does not existUse any specified configuration options to override any other configuration for this request only
     * @param scope Scope of the event handler (required)
     * @param code Code of the event handler (required)
     * @param asAt The asAt datetime at which to retrieve the event handler. Defaults to returning the latest version of the event handler if not specified. (optional)
     * @return ApiResponse&lt;EventHandler&gt;
    ...
    private ApiResponse<EventHandler> getEventHandlerWithHttpInfo(String scope, String code, OffsetDateTime asAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getEventHandlerValidateBeforeCall(scope, code, asAt, null, opts);
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetEventHandler: Get an Event Handler (asynchronously)
     * Will return a NotFound failure if the event handler does not exist
     * @param scope Scope of the event handler (required)
     * @param code Code of the event handler (required)
     * @param asAt The asAt datetime at which to retrieve the event handler. Defaults to returning the latest version of the event handler if not specified. (optional)
     ...
     */
    private void getEventHandlerAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<EventHandler> _callback) throws ApiException {

        HttpRequest localVarCall = getEventHandlerValidateBeforeCall(scope, code, asAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getEventHandlerAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<EventHandler> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getEventHandlerValidateBeforeCall(scope, code, asAt, _callback, opts);
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetEventHandlerRequest {
         ...
         */
        public void executeAsync(final ApiCallback<EventHandler> _callback) throws ApiException {
            getEventHandlerAsync(scope, code, asAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<EventHandler> _callback, ConfigurationOptions opts) throws ApiException {
            getEventHandlerAsync(scope, code, asAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listEventHandlersCall(OffsetDateTime asAt, String filter, Integer limit, String page, final ApiCallback _callback) throws ApiException {
        return listEventHandlersCall(asAt, filter, limit, page,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listEventHandlers. Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The asAt datetime at which to list the Event Handlers. Defaults to return the latest version of each Event Handler if not specified. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listEventHandlersCall(OffsetDateTime asAt, String filter, Integer limit, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listEventHandlersValidateBeforeCall(OffsetDateTime asAt, String filter, Integer limit, String page, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<PagedResourceListOfEventHandler> listEventHandlersWithHttpInfo(OffsetDateTime asAt, String filter, Integer limit, String page) throws ApiException {
        HttpRequest localVarCall = listEventHandlersValidateBeforeCall(asAt, filter, limit, page, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfEventHandler>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<PagedResourceListOfEventHandler> listEventHandlersWithHttpInfo(OffsetDateTime asAt, String filter, Integer limit, String page, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listEventHandlersValidateBeforeCall(asAt, filter, limit, page, null, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfEventHandler>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListEventHandlers: List Event Handlers (asynchronously)
     * 
     * @param asAt The asAt datetime at which to list the Event Handlers. Defaults to return the latest version of each Event Handler if not specified. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here: https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional, default to 10)
     ...
     */
    private void listEventHandlersAsync(OffsetDateTime asAt, String filter, Integer limit, String page, final ApiCallback<PagedResourceListOfEventHandler> _callback) throws ApiException {

        HttpRequest localVarCall = listEventHandlersValidateBeforeCall(asAt, filter, limit, page, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<PagedResourceListOfEventHandler>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listEventHandlersAsync(OffsetDateTime asAt, String filter, Integer limit, String page, final ApiCallback<PagedResourceListOfEventHandler> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listEventHandlersValidateBeforeCall(asAt, filter, limit, page, _callback, opts);
        Type localVarReturnType = new TypeReference<PagedResourceListOfEventHandler>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistEventHandlersRequest {
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfEventHandler> _callback) throws ApiException {
            listEventHandlersAsync(asAt, filter, limit, page, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<PagedResourceListOfEventHandler> _callback, ConfigurationOptions opts) throws ApiException {
            listEventHandlersAsync(asAt, filter, limit, page, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateEventHandlerCall(String scope, String code, UpdateEventHandlerRequest updateEventHandlerRequest, final ApiCallback _callback) throws ApiException {
        return updateEventHandlerCall(scope, code, updateEventHandlerRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateEventHandler. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope that identifies an Event Handler (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code that identifies an Event Handler (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateEventHandlerRequest The data to update an Event Handler (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updateEventHandlerCall(String scope, String code, UpdateEventHandlerRequest updateEventHandlerRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateEventHandlerValidateBeforeCall(String scope, String code, UpdateEventHandlerRequest updateEventHandlerRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<EventHandler> updateEventHandlerWithHttpInfo(String scope, String code, UpdateEventHandlerRequest updateEventHandlerRequest) throws ApiException {
        HttpRequest localVarCall = updateEventHandlerValidateBeforeCall(scope, code, updateEventHandlerRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<EventHandler> updateEventHandlerWithHttpInfo(String scope, String code, UpdateEventHandlerRequest updateEventHandlerRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateEventHandlerValidateBeforeCall(scope, code, updateEventHandlerRequest, null, opts);
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpdateEventHandler: Update an existing Event handler (asynchronously)
     * 
     * @param scope The scope that identifies an Event Handler (required)
     * @param code The code that identifies an Event Handler (required)
     * @param updateEventHandlerRequest The data to update an Event Handler (required)
     ...
     */
    private void updateEventHandlerAsync(String scope, String code, UpdateEventHandlerRequest updateEventHandlerRequest, final ApiCallback<EventHandler> _callback) throws ApiException {

        HttpRequest localVarCall = updateEventHandlerValidateBeforeCall(scope, code, updateEventHandlerRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateEventHandlerAsync(String scope, String code, UpdateEventHandlerRequest updateEventHandlerRequest, final ApiCallback<EventHandler> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateEventHandlerValidateBeforeCall(scope, code, updateEventHandlerRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<EventHandler>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateEventHandlerRequest {
         ...
         */
        public void executeAsync(final ApiCallback<EventHandler> _callback) throws ApiException {
            updateEventHandlerAsync(scope, code, updateEventHandlerRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<EventHandler> _callback, ConfigurationOptions opts) throws ApiException {
            updateEventHandlerAsync(scope, code, updateEventHandlerRequest, _callback, opts);
        }
    }
