...
public class HistoricallyExecutedQueriesApi {
     ...
     */
    private HttpRequest cancelHistoryCall(String executionId, final ApiCallback _callback) throws ApiException {
        return cancelHistoryCall(executionId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for cancelHistory. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest cancelHistoryCall(String executionId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/honeycomb/api/History/{executionId}"
    ...
    private HttpRequest cancelHistoryValidateBeforeCall(String executionId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<BackgroundQueryCancelResponse> cancelHistoryWithHttpInfo(String executionId) throws ApiException {
        HttpRequest localVarCall = cancelHistoryValidateBeforeCall(executionId, null, new ConfigurationOptions());
    ...
    private ApiResponse<BackgroundQueryCancelResponse> cancelHistoryWithHttpInfo(String executionId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = cancelHistoryValidateBeforeCall(executionId, null, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryCancelResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CancelHistory: Cancel / Clear data from a history search (asynchronously)
     * Cancel the query (if still running) / clear the data (if already returned) The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t exist and is not running. 
     * @param executionId ExecutionId returned when starting the query (required)
     ...
     */
    private void cancelHistoryAsync(String executionId, final ApiCallback<BackgroundQueryCancelResponse> _callback) throws ApiException {

        HttpRequest localVarCall = cancelHistoryValidateBeforeCall(executionId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundQueryCancelResponse>(){}.getType();
     ...
     */
    private void cancelHistoryAsync(String executionId, final ApiCallback<BackgroundQueryCancelResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = cancelHistoryValidateBeforeCall(executionId, _callback, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryCancelResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcancelHistoryRequest {
        ...
        public void executeAsync(final ApiCallback<BackgroundQueryCancelResponse> _callback) throws ApiException {
            cancelHistoryAsync(executionId, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<BackgroundQueryCancelResponse> _callback, ConfigurationOptions opts) throws ApiException {
            cancelHistoryAsync(executionId, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest fetchHistoryResultHistogramCall(String executionId, String bucketSize, String filter, Boolean jsonProper, final ApiCallback _callback) throws ApiException {
        return fetchHistoryResultHistogramCall(executionId, bucketSize, filter, jsonProper,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for fetchHistoryResultHistogram. Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest fetchHistoryResultHistogramCall(String executionId, String bucketSize, String filter, Boolean jsonProper, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/History/{executionId}/histogram"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest fetchHistoryResultHistogramValidateBeforeCall(String executionId, String bucketSize, String filter, Boolean jsonProper, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'executionId' is set
        if (executionId == null) {
    ...
    private ApiResponse<String> fetchHistoryResultHistogramWithHttpInfo(String executionId, String bucketSize, String filter, Boolean jsonProper) throws ApiException {
        HttpRequest localVarCall = fetchHistoryResultHistogramValidateBeforeCall(executionId, bucketSize, filter, jsonProper, null, new ConfigurationOptions());
    ...
    private ApiResponse<String> fetchHistoryResultHistogramWithHttpInfo(String executionId, String bucketSize, String filter, Boolean jsonProper, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = fetchHistoryResultHistogramValidateBeforeCall(executionId, bucketSize, filter, jsonProper, null, opts);
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * FetchHistoryResultHistogram: Make a histogram of results of a history search (asynchronously)
     * Fetch the histogram in Json format (if available, or if not simply being informed it is not yet ready) The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param bucketSize Optional histogram bucket width.  If not provided a set number of buckets between start/end range will be generated. (optional)
     * @param filter An ODATA filter per Finbourne.Filtering syntax. (optional)
     ...
     */
    private void fetchHistoryResultHistogramAsync(String executionId, String bucketSize, String filter, Boolean jsonProper, final ApiCallback<String> _callback) throws ApiException {

        HttpRequest localVarCall = fetchHistoryResultHistogramValidateBeforeCall(executionId, bucketSize, filter, jsonProper, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void fetchHistoryResultHistogramAsync(String executionId, String bucketSize, String filter, Boolean jsonProper, final ApiCallback<String> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = fetchHistoryResultHistogramValidateBeforeCall(executionId, bucketSize, filter, jsonProper, _callback, opts);
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIfetchHistoryResultHistogramRequest {
        ...
        public void executeAsync(final ApiCallback<String> _callback) throws ApiException {
            fetchHistoryResultHistogramAsync(executionId, bucketSize, filter, jsonProper, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<String> _callback, ConfigurationOptions opts) throws ApiException {
            fetchHistoryResultHistogramAsync(executionId, bucketSize, filter, jsonProper, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest fetchHistoryResultJsonCall(String executionId, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Boolean jsonProper, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for fetchHistoryResultJson. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest fetchHistoryResultJsonCall(String executionId, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Boolean jsonProper, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/History/{executionId}/json"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest fetchHistoryResultJsonValidateBeforeCall(String executionId, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Boolean jsonProper, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'executionId' is set
        if (executionId == null) {
    ...
    private ApiResponse<String> fetchHistoryResultJsonWithHttpInfo(String executionId, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Boolean jsonProper) throws ApiException {
        HttpRequest localVarCall = fetchHistoryResultJsonValidateBeforeCall(executionId, sortBy, filter, select, groupBy, limit, page, jsonProper, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<String> fetchHistoryResultJsonWithHttpInfo(String executionId, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Boolean jsonProper, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = fetchHistoryResultJsonValidateBeforeCall(executionId, sortBy, filter, select, groupBy, limit, page, jsonProper, null, opts);
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * FetchHistoryResultJson: Fetch JSON results from a query history search (asynchronously)
     * Fetch the data in Json format (if available, or if not simply being informed it is not yet ready) The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional)
     * @param filter An ODATA filter per Finbourne.Filtering syntax. (optional)
     ...
     */
    private void fetchHistoryResultJsonAsync(String executionId, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Boolean jsonProper, final ApiCallback<String> _callback) throws ApiException {

        HttpRequest localVarCall = fetchHistoryResultJsonValidateBeforeCall(executionId, sortBy, filter, select, groupBy, limit, page, jsonProper, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void fetchHistoryResultJsonAsync(String executionId, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Boolean jsonProper, final ApiCallback<String> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = fetchHistoryResultJsonValidateBeforeCall(executionId, sortBy, filter, select, groupBy, limit, page, jsonProper, _callback, opts);
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIfetchHistoryResultJsonRequest {
         ...
         */
        public void executeAsync(final ApiCallback<String> _callback) throws ApiException {
            fetchHistoryResultJsonAsync(executionId, sortBy, filter, select, groupBy, limit, page, jsonProper, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<String> _callback, ConfigurationOptions opts) throws ApiException {
            fetchHistoryResultJsonAsync(executionId, sortBy, filter, select, groupBy, limit, page, jsonProper, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getHistoryCall(OffsetDateTime startAt, OffsetDateTime endAt, String freeTextSearch, Boolean showAll, final ApiCallback _callback) throws ApiException {
     ...
     * @param startAt Date time to start the search from.  Will default to Now - 1 Day (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param endAt Date time to end the search at.  Defaults to now. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param freeTextSearch Some test that must be in at least one field returned. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param showAll For users with extra permissions, they may optionally see other users&#39; queries. (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getHistoryCall(OffsetDateTime startAt, OffsetDateTime endAt, String freeTextSearch, Boolean showAll, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/History";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getHistoryValidateBeforeCall(OffsetDateTime startAt, OffsetDateTime endAt, String freeTextSearch, Boolean showAll, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<BackgroundQueryResponse> getHistoryWithHttpInfo(OffsetDateTime startAt, OffsetDateTime endAt, String freeTextSearch, Boolean showAll) throws ApiException {
        HttpRequest localVarCall = getHistoryValidateBeforeCall(startAt, endAt, freeTextSearch, showAll, null, new ConfigurationOptions());
    ...
    /**
     * GetHistory: Start a background history search
     *  Starts to load the historical query logs for a certain time range, search criteria, etc.  The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden Use any specified configuration options to override any other configuration for this request only
     * @param startAt Date time to start the search from.  Will default to Now - 1 Day (optional)
     * @param endAt Date time to end the search at.  Defaults to now. (optional)
     * @param freeTextSearch Some test that must be in at least one field returned. (optional)
     * @param showAll For users with extra permissions, they may optionally see other users&#39; queries. (optional, default to false)
    ...
    private ApiResponse<BackgroundQueryResponse> getHistoryWithHttpInfo(OffsetDateTime startAt, OffsetDateTime endAt, String freeTextSearch, Boolean showAll, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getHistoryValidateBeforeCall(startAt, endAt, freeTextSearch, showAll, null, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetHistory: Start a background history search (asynchronously)
     *  Starts to load the historical query logs for a certain time range, search criteria, etc.  The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden 
     * @param startAt Date time to start the search from.  Will default to Now - 1 Day (optional)
     * @param endAt Date time to end the search at.  Defaults to now. (optional)
     * @param freeTextSearch Some test that must be in at least one field returned. (optional)
     ...
     */
    private void getHistoryAsync(OffsetDateTime startAt, OffsetDateTime endAt, String freeTextSearch, Boolean showAll, final ApiCallback<BackgroundQueryResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getHistoryValidateBeforeCall(startAt, endAt, freeTextSearch, showAll, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundQueryResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getHistoryAsync(OffsetDateTime startAt, OffsetDateTime endAt, String freeTextSearch, Boolean showAll, final ApiCallback<BackgroundQueryResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getHistoryValidateBeforeCall(startAt, endAt, freeTextSearch, showAll, _callback, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetHistoryRequest {
        ...
        public void executeAsync(final ApiCallback<BackgroundQueryResponse> _callback) throws ApiException {
            getHistoryAsync(startAt, endAt, freeTextSearch, showAll, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<BackgroundQueryResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getHistoryAsync(startAt, endAt, freeTextSearch, showAll, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getProgressOfHistoryCall(String executionId, final ApiCallback _callback) throws ApiException {
        return getProgressOfHistoryCall(executionId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getProgressOfHistory. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getProgressOfHistoryCall(String executionId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getProgressOfHistoryValidateBeforeCall(String executionId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'executionId' is set
        if (executionId == null) {
    ...
    private ApiResponse<BackgroundQueryProgressResponse> getProgressOfHistoryWithHttpInfo(String executionId) throws ApiException {
        HttpRequest localVarCall = getProgressOfHistoryValidateBeforeCall(executionId, null, new ConfigurationOptions());
    ...
    private ApiResponse<BackgroundQueryProgressResponse> getProgressOfHistoryWithHttpInfo(String executionId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getProgressOfHistoryValidateBeforeCall(executionId, null, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetProgressOfHistory: View progress of a history search (asynchronously)
     * View progress information (up until this point) of previously started History query The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t exist and is not running. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void getProgressOfHistoryAsync(String executionId, final ApiCallback<BackgroundQueryProgressResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getProgressOfHistoryValidateBeforeCall(executionId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getProgressOfHistoryAsync(String executionId, final ApiCallback<BackgroundQueryProgressResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getProgressOfHistoryValidateBeforeCall(executionId, _callback, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetProgressOfHistoryRequest {
        ...
        public void executeAsync(final ApiCallback<BackgroundQueryProgressResponse> _callback) throws ApiException {
            getProgressOfHistoryAsync(executionId, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<BackgroundQueryProgressResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getProgressOfHistoryAsync(executionId, _callback, opts);
        }
    }
