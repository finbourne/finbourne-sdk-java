...
import com.finbourne.sdk.services.luminesce.model.MultiQueryDefinitionType;
...
public class MultiQueryExecutionApi {
     ...
     */
    private HttpRequest cancelMultiQueryCall(String executionId, final ApiCallback _callback) throws ApiException {
        return cancelMultiQueryCall(executionId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for cancelMultiQuery. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest cancelMultiQueryCall(String executionId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/honeycomb/api/MultiQueryBackground/{executionId}"
    ...
    private HttpRequest cancelMultiQueryValidateBeforeCall(String executionId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<BackgroundQueryCancelResponse> cancelMultiQueryWithHttpInfo(String executionId) throws ApiException {
        HttpRequest localVarCall = cancelMultiQueryValidateBeforeCall(executionId, null, new ConfigurationOptions());
    ...
    private ApiResponse<BackgroundQueryCancelResponse> cancelMultiQueryWithHttpInfo(String executionId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = cancelMultiQueryValidateBeforeCall(executionId, null, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryCancelResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CancelMultiQuery: Cancel / Clear a previously started query-set (asynchronously)
     * Cancel the query-set (if still running) / clear the data (if already returned) The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t exist and is not running. 
     * @param executionId ExecutionId returned when starting the query (required)
     ...
     */
    private void cancelMultiQueryAsync(String executionId, final ApiCallback<BackgroundQueryCancelResponse> _callback) throws ApiException {

        HttpRequest localVarCall = cancelMultiQueryValidateBeforeCall(executionId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundQueryCancelResponse>(){}.getType();
     ...
     */
    private void cancelMultiQueryAsync(String executionId, final ApiCallback<BackgroundQueryCancelResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = cancelMultiQueryValidateBeforeCall(executionId, _callback, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryCancelResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcancelMultiQueryRequest {
        ...
        public void executeAsync(final ApiCallback<BackgroundQueryCancelResponse> _callback) throws ApiException {
            cancelMultiQueryAsync(executionId, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<BackgroundQueryCancelResponse> _callback, ConfigurationOptions opts) throws ApiException {
            cancelMultiQueryAsync(executionId, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getProgressOfMultiQueryCall(String executionId, final ApiCallback _callback) throws ApiException {
        return getProgressOfMultiQueryCall(executionId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getProgressOfMultiQuery. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getProgressOfMultiQueryCall(String executionId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getProgressOfMultiQueryValidateBeforeCall(String executionId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'executionId' is set
        if (executionId == null) {
    ...
    private ApiResponse<BackgroundMultiQueryProgressResponse> getProgressOfMultiQueryWithHttpInfo(String executionId) throws ApiException {
        HttpRequest localVarCall = getProgressOfMultiQueryValidateBeforeCall(executionId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundMultiQueryProgressResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<BackgroundMultiQueryProgressResponse> getProgressOfMultiQueryWithHttpInfo(String executionId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getProgressOfMultiQueryValidateBeforeCall(executionId, null, opts);
        Type localVarReturnType = new TypeReference<BackgroundMultiQueryProgressResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetProgressOfMultiQuery: View progress of the entire query-set load (asynchronously)
     * View progress information (up until this point) for the entire query-set The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t exist and is not running. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void getProgressOfMultiQueryAsync(String executionId, final ApiCallback<BackgroundMultiQueryProgressResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getProgressOfMultiQueryValidateBeforeCall(executionId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundMultiQueryProgressResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getProgressOfMultiQueryAsync(String executionId, final ApiCallback<BackgroundMultiQueryProgressResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getProgressOfMultiQueryValidateBeforeCall(executionId, _callback, opts);
        Type localVarReturnType = new TypeReference<BackgroundMultiQueryProgressResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetProgressOfMultiQueryRequest {
         ...
         */
        public void executeAsync(final ApiCallback<BackgroundMultiQueryProgressResponse> _callback) throws ApiException {
            getProgressOfMultiQueryAsync(executionId, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<BackgroundMultiQueryProgressResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getProgressOfMultiQueryAsync(executionId, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest startQueriesCall(MultiQueryDefinitionType type, String body, OffsetDateTime asAt, OffsetDateTime effectiveAt, Integer limit1, Integer limit2, String input1, String input2, String input3, Integer timeoutSeconds, Integer keepForSeconds, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for startQueries. Use any specified configuration options to override any other configuration for this request only.
     * @param type An enum value defining the set of statements being executed (required). Use any specified configuration options to override any other configuration for this request only.
     * @param body A \&quot;search\&quot; value (e.g. &#39;Apple&#39; on an instrument search, a &#x60;Finbourne.Filtering&#x60; expression of Insights, etc.) In the cases where \&quot;Nothing\&quot; is valid for a &#x60;Finbourne.Filtering&#x60; expression, pass &#x60;True&#x60;. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param asAt The AsAt time used by any bitemporal provider in the queries. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param effectiveAt The EffectiveAt time used by any bitemporal provider in the queries. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit1 A limit that is applied to first-level queries (e.g. Instruments themselves) (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit2 A limit that is applied to second-level queries (e.g. Holdings based on the set of Instruments found) (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param input1 A value available to queries, these vary by &#39;type&#39; and are only used by some types at all. e.g. a start-date of some sort (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param input2 A second value available to queries, these vary by &#39;type&#39; and are only used by some types at all. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param input3 A third value available to queries, these vary by &#39;type&#39; and are only used by some types at all. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param timeoutSeconds Maximum time the query may run for, in seconds: &lt;0 → ∞, 0 → 1200s (20m) (optional, default to 0). Use any specified configuration options to override any other configuration for this request only.
     * @param keepForSeconds Maximum time the result may be kept for, in seconds: &lt;0 → 1200 (20m), 0 → 28800 (8h), max &#x3D; 2,678,400 (31d) (optional, default to 0)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    private HttpRequest startQueriesCall(MultiQueryDefinitionType type, String body, OffsetDateTime asAt, OffsetDateTime effectiveAt, Integer limit1, Integer limit2, String input1, String input2, String input3, Integer timeoutSeconds, Integer keepForSeconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/MultiQueryBackground";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest startQueriesValidateBeforeCall(MultiQueryDefinitionType type, String body, OffsetDateTime asAt, OffsetDateTime effectiveAt, Integer limit1, Integer limit2, String input1, String input2, String input3, Integer timeoutSeconds, Integer keepForSeconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<BackgroundMultiQueryResponse> startQueriesWithHttpInfo(MultiQueryDefinitionType type, String body, OffsetDateTime asAt, OffsetDateTime effectiveAt, Integer limit1, Integer limit2, String input1, String input2, String input3, Integer timeoutSeconds, Integer keepForSeconds) throws ApiException {
        HttpRequest localVarCall = startQueriesValidateBeforeCall(type, body, asAt, effectiveAt, limit1, limit2, input1, input2, input3, timeoutSeconds, keepForSeconds, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundMultiQueryResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<BackgroundMultiQueryResponse> startQueriesWithHttpInfo(MultiQueryDefinitionType type, String body, OffsetDateTime asAt, OffsetDateTime effectiveAt, Integer limit1, Integer limit2, String input1, String input2, String input3, Integer timeoutSeconds, Integer keepForSeconds, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = startQueriesValidateBeforeCall(type, body, asAt, effectiveAt, limit1, limit2, input1, input2, input3, timeoutSeconds, keepForSeconds, null, opts);
        Type localVarReturnType = new TypeReference<BackgroundMultiQueryResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * StartQueries: Run a given set of Sql queries in the background (asynchronously)
     *  Allow for starting a potentially long running query and getting back an immediate response with how to  - fetch the data in various formats (if available, or if not simply being informed it is not yet ready), on a per result basis - view progress information (up until this point), for all results in one go - cancel the queries (if still running) / clear the data (if already returned)  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - there was something wrong with your query syntax (the issue was detected at parse-time) - 401 Unauthorized - 403 Forbidden 
     * @param type An enum value defining the set of statements being executed (required)
     * @param body A \&quot;search\&quot; value (e.g. &#39;Apple&#39; on an instrument search, a &#x60;Finbourne.Filtering&#x60; expression of Insights, etc.) In the cases where \&quot;Nothing\&quot; is valid for a &#x60;Finbourne.Filtering&#x60; expression, pass &#x60;True&#x60;. (required)
     * @param asAt The AsAt time used by any bitemporal provider in the queries. (optional)
     ...
     */
    private void startQueriesAsync(MultiQueryDefinitionType type, String body, OffsetDateTime asAt, OffsetDateTime effectiveAt, Integer limit1, Integer limit2, String input1, String input2, String input3, Integer timeoutSeconds, Integer keepForSeconds, final ApiCallback<BackgroundMultiQueryResponse> _callback) throws ApiException {

        HttpRequest localVarCall = startQueriesValidateBeforeCall(type, body, asAt, effectiveAt, limit1, limit2, input1, input2, input3, timeoutSeconds, keepForSeconds, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundMultiQueryResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    private void startQueriesAsync(MultiQueryDefinitionType type, String body, OffsetDateTime asAt, OffsetDateTime effectiveAt, Integer limit1, Integer limit2, String input1, String input2, String input3, Integer timeoutSeconds, Integer keepForSeconds, final ApiCallback<BackgroundMultiQueryResponse> _callback, ConfigurationOptions opts) throws ApiException {
        ...
        HttpRequest localVarCall = startQueriesValidateBeforeCall(type, body, asAt, effectiveAt, limit1, limit2, input1, input2, input3, timeoutSeconds, keepForSeconds, _callback, opts);
        Type localVarReturnType = new TypeReference<BackgroundMultiQueryResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIstartQueriesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<BackgroundMultiQueryResponse> _callback) throws ApiException {
            startQueriesAsync(type, body, asAt, effectiveAt, limit1, limit2, input1, input2, input3, timeoutSeconds, keepForSeconds, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<BackgroundMultiQueryResponse> _callback, ConfigurationOptions opts) throws ApiException {
            startQueriesAsync(type, body, asAt, effectiveAt, limit1, limit2, input1, input2, input3, timeoutSeconds, keepForSeconds, _callback, opts);
        }
    }
