...
import com.finbourne.sdk.services.luminesce.model.SqlExecutionFlags;
...
public class SqlBackgroundExecutionApi {
     ...
     */
    private HttpRequest cancelQueryCall(String executionId, final ApiCallback _callback) throws ApiException {
        return cancelQueryCall(executionId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for cancelQuery. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest cancelQueryCall(String executionId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}"
    ...
    private HttpRequest cancelQueryValidateBeforeCall(String executionId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<BackgroundQueryCancelResponse> cancelQueryWithHttpInfo(String executionId) throws ApiException {
        HttpRequest localVarCall = cancelQueryValidateBeforeCall(executionId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundQueryCancelResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CancelQuery: Cancel / Clear data from a previously run query
     * Cancel the query (if still running) / clear the data (if already returned) The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t exist and is not running or the calling user did not run the query. Use any specified configuration options to override any other configuration for this request only
     * @param executionId ExecutionId returned when starting the query (required)
     * @return ApiResponse&lt;BackgroundQueryCancelResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
    ...
    private ApiResponse<BackgroundQueryCancelResponse> cancelQueryWithHttpInfo(String executionId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = cancelQueryValidateBeforeCall(executionId, null, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryCancelResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CancelQuery: Cancel / Clear data from a previously run query (asynchronously)
     * Cancel the query (if still running) / clear the data (if already returned) The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t exist and is not running or the calling user did not run the query. 
     * @param executionId ExecutionId returned when starting the query (required)
     ...
     */
    private void cancelQueryAsync(String executionId, final ApiCallback<BackgroundQueryCancelResponse> _callback) throws ApiException {

        HttpRequest localVarCall = cancelQueryValidateBeforeCall(executionId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundQueryCancelResponse>(){}.getType();
     ...
     */
    private void cancelQueryAsync(String executionId, final ApiCallback<BackgroundQueryCancelResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = cancelQueryValidateBeforeCall(executionId, _callback, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryCancelResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcancelQueryRequest {
         ...
         */
        public void executeAsync(final ApiCallback<BackgroundQueryCancelResponse> _callback) throws ApiException {
            cancelQueryAsync(executionId, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<BackgroundQueryCancelResponse> _callback, ConfigurationOptions opts) throws ApiException {
            cancelQueryAsync(executionId, _callback, opts);
        }
    }
    ...
    /**
     * Build call for fetchQueryResultCsv. Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param page 0-N based on chunk sized determined by the limit, ignored if limit &lt; 1. (optional, default to 0). Use any specified configuration options to override any other configuration for this request only.
    ...
    private HttpRequest fetchQueryResultCsvCall(String executionId, Boolean download, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, String delimiter, String escape, String dateTimeFormat, Integer loadWaitMilliseconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/csv"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    /**
     * FetchQueryResultCsv: Fetch the result of a query as CSV (asynchronously)
     * Fetch the data in the format of the method&#39;s name (if available, or if not simply being informed it is not yet ready).  The following error codes are to be anticipated most with standard Problem Detail reports: - 400 BadRequest : Something failed with the execution of your query - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional)
    ...
    private HttpRequest fetchQueryResultExcelCall(String executionId, String sortBy, String filter, String select, String groupBy, String dateTimeFormat, Integer loadWaitMilliseconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/excel"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    /**
     * FetchQueryResultExcel: Fetch the result of a query as an Excel file (asynchronously)
     * Fetch the data in the format of the method&#39;s name (if available, or if not simply being informed it is not yet ready).  The following error codes are to be anticipated most with standard Problem Detail reports: - 400 BadRequest : Something failed with the execution of your query - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional)
     * @param filter An ODATA filter per Finbourne.Filtering syntax. (optional)
     ...
     */
    private HttpRequest fetchQueryResultHistogramCall(String executionId, String timestampFieldName, OffsetDateTime startAt, OffsetDateTime endAt, String bucketSize, String filter, Boolean jsonProper, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Build call for fetchQueryResultHistogram. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required). Use any specified configuration options to override any other configuration for this request only.
     * @param timestampFieldName Name of the timestamp field used in building the histogram (required). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest fetchQueryResultHistogramCall(String executionId, String timestampFieldName, OffsetDateTime startAt, OffsetDateTime endAt, String bucketSize, String filter, Boolean jsonProper, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/histogram"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest fetchQueryResultHistogramValidateBeforeCall(String executionId, String timestampFieldName, OffsetDateTime startAt, OffsetDateTime endAt, String bucketSize, String filter, Boolean jsonProper, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'executionId' is set
        if (executionId == null) {
    ...
    private ApiResponse<String> fetchQueryResultHistogramWithHttpInfo(String executionId, String timestampFieldName, OffsetDateTime startAt, OffsetDateTime endAt, String bucketSize, String filter, Boolean jsonProper) throws ApiException {
        HttpRequest localVarCall = fetchQueryResultHistogramValidateBeforeCall(executionId, timestampFieldName, startAt, endAt, bucketSize, filter, jsonProper, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<String> fetchQueryResultHistogramWithHttpInfo(String executionId, String timestampFieldName, OffsetDateTime startAt, OffsetDateTime endAt, String bucketSize, String filter, Boolean jsonProper, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = fetchQueryResultHistogramValidateBeforeCall(executionId, timestampFieldName, startAt, endAt, bucketSize, filter, jsonProper, null, opts);
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * FetchQueryResultHistogram: Construct a histogram of the result of a query (asynchronously)
     * Fetch the histogram in Json format (if available, or if not simply being informed it is not yet ready) The following error codes are to be anticipated with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param timestampFieldName Name of the timestamp field used in building the histogram (required)
     * @param startAt Start point (of the timestampFieldName field) for the histogram (optional)
     ...
     */
    private void fetchQueryResultHistogramAsync(String executionId, String timestampFieldName, OffsetDateTime startAt, OffsetDateTime endAt, String bucketSize, String filter, Boolean jsonProper, final ApiCallback<String> _callback) throws ApiException {

        HttpRequest localVarCall = fetchQueryResultHistogramValidateBeforeCall(executionId, timestampFieldName, startAt, endAt, bucketSize, filter, jsonProper, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void fetchQueryResultHistogramAsync(String executionId, String timestampFieldName, OffsetDateTime startAt, OffsetDateTime endAt, String bucketSize, String filter, Boolean jsonProper, final ApiCallback<String> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = fetchQueryResultHistogramValidateBeforeCall(executionId, timestampFieldName, startAt, endAt, bucketSize, filter, jsonProper, _callback, opts);
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIfetchQueryResultHistogramRequest {
         ...
         */
        public void executeAsync(final ApiCallback<String> _callback) throws ApiException {
            fetchQueryResultHistogramAsync(executionId, timestampFieldName, startAt, endAt, bucketSize, filter, jsonProper, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<String> _callback, ConfigurationOptions opts) throws ApiException {
            fetchQueryResultHistogramAsync(executionId, timestampFieldName, startAt, endAt, bucketSize, filter, jsonProper, _callback, opts);
        }
    }
    ...
    private HttpRequest fetchQueryResultJsonCall(String executionId, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Integer loadWaitMilliseconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/json"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    /**
     * FetchQueryResultJson: Fetch the result of a query as a JSON string (asynchronously)
     *  *Please move to &#39;/jsonProper&#39; instead.  This may be marked as Deprecated in the future.*  Fetch the data in the format of the method&#39;s name (if available, or if not simply being informed it is not yet ready).  The following error codes are to be anticipated most with standard Problem Detail reports: - 400 BadRequest : Something failed with the execution of your query - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional)
     * @param filter An ODATA filter per Finbourne.Filtering syntax. (optional)
    ...
    /**
     * Build call for fetchQueryResultJsonProper. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required). Use any specified configuration options to override any other configuration for this request only.
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter An ODATA filter per Finbourne.Filtering syntax. (optional). Use any specified configuration options to override any other configuration for this request only.
    ...
    private HttpRequest fetchQueryResultJsonProperCall(String executionId, Boolean download, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Integer loadWaitMilliseconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/jsonProper"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    /**
     * FetchQueryResultJsonProper: Fetch the result of a query as JSON (asynchronously)
     * Fetch the data in the format of the method&#39;s name (if available, or if not simply being informed it is not yet ready).  The following error codes are to be anticipated most with standard Problem Detail reports: - 400 BadRequest : Something failed with the execution of your query - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional)
    ...
    /**
     * Build call for fetchQueryResultJsonProperWithLineage. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required). Use any specified configuration options to override any other configuration for this request only.
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter An ODATA filter per Finbourne.Filtering syntax. (optional). Use any specified configuration options to override any other configuration for this request only.
    ...
    private HttpRequest fetchQueryResultJsonProperWithLineageCall(String executionId, Boolean download, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Integer loadWaitMilliseconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/jsonProperWithLineage"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    /**
     * FetchQueryResultJsonProperWithLineage: Fetch the result of a query as JSON, but including a Lineage Node (if available) (asynchronously)
     * Fetch the data in proper Json format (if available, or if not simply being informed it is not yet ready) But embeds the data under a &#x60;Data&#x60; node and Lineage (if requested when starting the execution) under a &#x60;Lineage&#x60; node. Lineage is just for the &#39;raw query&#39; it ignores all of these parameters: sortBy, filter, select, groupBy and limit.  The following error codes are to be anticipated most with standard Problem Detail reports: - 400 BadRequest : Something failed with the execution of your query - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional)
    ...
    private HttpRequest fetchQueryResultParquetCall(String executionId, String sortBy, String filter, String select, String groupBy, Integer loadWaitMilliseconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/parquet"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    /**
     * FetchQueryResultParquet: Fetch the result of a query as Parquet (asynchronously)
     * Fetch the data in the format of the method&#39;s name (if available, or if not simply being informed it is not yet ready).  The following error codes are to be anticipated most with standard Problem Detail reports: - 400 BadRequest : Something failed with the execution of your query - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional)
     * @param filter An ODATA filter per Finbourne.Filtering syntax. (optional)
    ...
    /**
     * Build call for fetchQueryResultPipe. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required). Use any specified configuration options to override any other configuration for this request only.
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter An ODATA filter per Finbourne.Filtering syntax. (optional). Use any specified configuration options to override any other configuration for this request only.
    ...
    private HttpRequest fetchQueryResultPipeCall(String executionId, Boolean download, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, String dateTimeFormat, Integer loadWaitMilliseconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/pipe"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    /**
     * FetchQueryResultPipe: Fetch the result of a query as pipe-delimited (asynchronously)
     * Fetch the data in the format of the method&#39;s name (if available, or if not simply being informed it is not yet ready).  The following error codes are to be anticipated most with standard Problem Detail reports: - 400 BadRequest : Something failed with the execution of your query - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional)
    ...
    private HttpRequest fetchQueryResultSqliteCall(String executionId, String sortBy, String filter, String select, String groupBy, Integer loadWaitMilliseconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/sqlite"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    /**
     * FetchQueryResultSqlite: Fetch the result of a query as SqLite (asynchronously)
     * Fetch the data in the format of the method&#39;s name (if available, or if not simply being informed it is not yet ready).  The following error codes are to be anticipated most with standard Problem Detail reports: - 400 BadRequest : Something failed with the execution of your query - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional)
     * @param filter An ODATA filter per Finbourne.Filtering syntax. (optional)
    ...
    /**
     * Build call for fetchQueryResultXml. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required). Use any specified configuration options to override any other configuration for this request only.
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter An ODATA filter per Finbourne.Filtering syntax. (optional). Use any specified configuration options to override any other configuration for this request only.
    ...
    private HttpRequest fetchQueryResultXmlCall(String executionId, Boolean download, String sortBy, String filter, String select, String groupBy, Integer limit, Integer page, Integer loadWaitMilliseconds, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/xml"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    /**
     * FetchQueryResultXml: Fetch the result of a query as XML (asynchronously)
     * Fetch the data in the format of the method&#39;s name (if available, or if not simply being informed it is not yet ready).  The following error codes are to be anticipated most with standard Problem Detail reports: - 400 BadRequest : Something failed with the execution of your query - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t (yet) exist or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
     * @param sortBy Order the results by these fields.             Use the &#x60;-&#x60; sign to denote descending order, e.g. &#x60;-MyFieldName&#x60;.  Numeric indexes may be used also, e.g. &#x60;2,-3&#x60;.             Multiple fields can be denoted by a comma e.g. &#x60;-MyFieldName,AnotherFieldName,-AFurtherFieldName&#x60;.             Default is null, the sort order specified in the query itself. (optional)
     ...
     */
    private HttpRequest getHistoricalFeedbackCall(String executionId, Integer nextMessageWaitSeconds, OffsetDateTime startedAt, final ApiCallback _callback) throws ApiException {
        return getHistoricalFeedbackCall(executionId, nextMessageWaitSeconds, startedAt,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getHistoricalFeedback. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required). Use any specified configuration options to override any other configuration for this request only.
     * @param nextMessageWaitSeconds An override to the internal default for the number of seconds to wait for stream-messages. Meant to help understand 404s that would seem on the surface to be incorrect. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param startedAt Performance will be hugely improved if thet time (in UTC) when the query was started is provided. It will also significantly decrease the chances of a 404 where there really is data, as it can help to disambiguate between &#39;there is no query with this executionId&#39; and &#39;there is such a query but we couldn&#39;t wait long enough for it to come back from the Feedback Stream&#39;. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getHistoricalFeedbackCall(String executionId, Integer nextMessageWaitSeconds, OffsetDateTime startedAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground/{executionId}/historicalFeedback"
            .replace("{" + "executionId" + "}", localVarApiClient.escapeString(executionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getHistoricalFeedbackValidateBeforeCall(String executionId, Integer nextMessageWaitSeconds, OffsetDateTime startedAt, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'executionId' is set
        if (executionId == null) {
    ...
    private ApiResponse<BackgroundQueryProgressResponse> getHistoricalFeedbackWithHttpInfo(String executionId, Integer nextMessageWaitSeconds, OffsetDateTime startedAt) throws ApiException {
        HttpRequest localVarCall = getHistoricalFeedbackValidateBeforeCall(executionId, nextMessageWaitSeconds, startedAt, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<BackgroundQueryProgressResponse> getHistoricalFeedbackWithHttpInfo(String executionId, Integer nextMessageWaitSeconds, OffsetDateTime startedAt, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getHistoricalFeedbackValidateBeforeCall(executionId, nextMessageWaitSeconds, startedAt, null, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetHistoricalFeedback: View historical query progress (for older queries) (asynchronously)
     * View full progress information, including historical feedback for queries which have passed their &#x60;keepForSeconds&#x60; time, so long as they were executed in the last 31 days.  This method is slow by its nature of looking at the stream of historical feedback data.   On the other hand under some circumstances this can fail to wait long enough and return 404s where really there is data. To help with this &#x60;nextMessageWaitSeconds&#x60; may be specified to non-default values larger then the 2-7s used internally.  Unlike most methods here this may be called by a user that did not run the original query, if your entitlements allow this, as this is pure telemetry information.  The following error codes are to be anticipated most with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t exist and is not running. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param nextMessageWaitSeconds An override to the internal default for the number of seconds to wait for stream-messages. Meant to help understand 404s that would seem on the surface to be incorrect. (optional)
     * @param startedAt Performance will be hugely improved if thet time (in UTC) when the query was started is provided. It will also significantly decrease the chances of a 404 where there really is data, as it can help to disambiguate between &#39;there is no query with this executionId&#39; and &#39;there is such a query but we couldn&#39;t wait long enough for it to come back from the Feedback Stream&#39;. (optional)
     ...
     */
    private void getHistoricalFeedbackAsync(String executionId, Integer nextMessageWaitSeconds, OffsetDateTime startedAt, final ApiCallback<BackgroundQueryProgressResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getHistoricalFeedbackValidateBeforeCall(executionId, nextMessageWaitSeconds, startedAt, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getHistoricalFeedbackAsync(String executionId, Integer nextMessageWaitSeconds, OffsetDateTime startedAt, final ApiCallback<BackgroundQueryProgressResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getHistoricalFeedbackValidateBeforeCall(executionId, nextMessageWaitSeconds, startedAt, _callback, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetHistoricalFeedbackRequest {
         ...
         */
        public void executeAsync(final ApiCallback<BackgroundQueryProgressResponse> _callback) throws ApiException {
            getHistoricalFeedbackAsync(executionId, nextMessageWaitSeconds, startedAt, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<BackgroundQueryProgressResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getHistoricalFeedbackAsync(executionId, nextMessageWaitSeconds, startedAt, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getProgressOfCall(String executionId, Boolean buildFromLogs, Boolean includeAllFeedback, final ApiCallback _callback) throws ApiException {
        return getProgressOfCall(executionId, buildFromLogs, includeAllFeedback,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getProgressOf. Use any specified configuration options to override any other configuration for this request only.
     * @param executionId ExecutionId returned when starting the query (required). Use any specified configuration options to override any other configuration for this request only.
     * @param buildFromLogs Should the response state be build from query logs if missing from the shared-db-state?  Deprecated. Regardless of the value here it is now the case that:  False [and now even True] will mean &#x60;404 Not Found&#x60; in cases where it was a real query but has passed its &#x60;keepForSeconds&#x60; since the query completed (as well as &#39;this was not a query at all&#39; of course) (optional, default to false). Use any specified configuration options to override any other configuration for this request only.
     * @param includeAllFeedback Should all the feedback be returned?  As opposed to just the new feedback. (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getProgressOfCall(String executionId, Boolean buildFromLogs, Boolean includeAllFeedback, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getProgressOfValidateBeforeCall(String executionId, Boolean buildFromLogs, Boolean includeAllFeedback, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'executionId' is set
        if (executionId == null) {
    ...
    private ApiResponse<BackgroundQueryProgressResponse> getProgressOfWithHttpInfo(String executionId, Boolean buildFromLogs, Boolean includeAllFeedback) throws ApiException {
        HttpRequest localVarCall = getProgressOfValidateBeforeCall(executionId, buildFromLogs, includeAllFeedback, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<BackgroundQueryProgressResponse> getProgressOfWithHttpInfo(String executionId, Boolean buildFromLogs, Boolean includeAllFeedback, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getProgressOfValidateBeforeCall(executionId, buildFromLogs, includeAllFeedback, null, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetProgressOf: View query progress up to this point. (asynchronously)
     * View progress information (up until this point and starting from the last point requested) The following error codes are to be anticipated most with standard Problem Detail reports: - 401 Unauthorized - 403 Forbidden - 404 Not Found : The requested query result doesn&#39;t exist and is not running or the calling user did not run the query. - 429 Too Many Requests : Please try your request again soon   1. The query has been executed successfully in the past yet the server-instance receiving this request (e.g. from a load balancer) doesn&#39;t yet have this data available.   1. By virtue of the request you have just placed this will have started to load from the persisted cache and will soon be available.   1. It is also the case that the original server-instance to process the original query is likely to already be able to service this request.
     * @param executionId ExecutionId returned when starting the query (required)
     * @param buildFromLogs Should the response state be build from query logs if missing from the shared-db-state?  Deprecated. Regardless of the value here it is now the case that:  False [and now even True] will mean &#x60;404 Not Found&#x60; in cases where it was a real query but has passed its &#x60;keepForSeconds&#x60; since the query completed (as well as &#39;this was not a query at all&#39; of course) (optional, default to false)
     * @param includeAllFeedback Should all the feedback be returned?  As opposed to just the new feedback. (optional, default to false)
     ...
     */
    private void getProgressOfAsync(String executionId, Boolean buildFromLogs, Boolean includeAllFeedback, final ApiCallback<BackgroundQueryProgressResponse> _callback) throws ApiException {

        HttpRequest localVarCall = getProgressOfValidateBeforeCall(executionId, buildFromLogs, includeAllFeedback, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getProgressOfAsync(String executionId, Boolean buildFromLogs, Boolean includeAllFeedback, final ApiCallback<BackgroundQueryProgressResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getProgressOfValidateBeforeCall(executionId, buildFromLogs, includeAllFeedback, _callback, opts);
        Type localVarReturnType = new TypeReference<BackgroundQueryProgressResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetProgressOfRequest {
         ...
         */
        public void executeAsync(final ApiCallback<BackgroundQueryProgressResponse> _callback) throws ApiException {
            getProgressOfAsync(executionId, buildFromLogs, includeAllFeedback, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<BackgroundQueryProgressResponse> _callback, ConfigurationOptions opts) throws ApiException {
            getProgressOfAsync(executionId, buildFromLogs, includeAllFeedback, _callback, opts);
        }
    }
    ...
    /**
     * Build call for startQuery. Use any specified configuration options to override any other configuration for this request only.
     * @param body The LuminesceSql query to kick off. (required). Use any specified configuration options to override any other configuration for this request only.
     * @param executionId An explicit ExecutionId to use.  This must be blank OR assigned to a valid GUID-as-a-string. It might be ignored / replaced, for example if using the query cache and a cached query is found. (optional). Use any specified configuration options to override any other configuration for this request only.
    ...
    private HttpRequest startQueryCall(String body, String executionId, Map<String, String> scalarParameters, String queryName, Integer timeoutSeconds, Integer keepForSeconds, SqlExecutionFlags executionFlags, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/honeycomb/api/SqlBackground";
    ...
    /**
     * StartQuery: Start to Execute Sql in the background (asynchronously)
     *  Allow for starting a potentially long running query and getting back an immediate response with how to  - fetch the data in various formats (if available, or if not simply being informed it is not yet ready) - view progress information (up until this point) - cancel the query (if still running) / clear the data (if already returned)  This can still error on things like an outright syntax error, but more runtime errors (e.g. from providers) will not cause this to error (that will happen when attempting to fetch data)  Here is an example that intentionally takes one minute to run:  &#x60;&#x60;&#x60;sql select Str, Takes500Ms from Testing1K where UseLinq &#x3D; true and [Int] &lt;&#x3D; 120 &#x60;&#x60;&#x60;  This is the only place in the Luminesce WebAPI where the following is supported. This will allow for the same user running a character-identical query not kick off a new query but simply be returned a reference  to the already running one for up to &#x60;N&#x60; seconds (where &#x60;N&#x60; should be &#x60;&lt;&#x3D;&#x60; &#x60;keepForSeconds&#x60;).  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - there was something wrong with your query syntax (the issue was detected at parse-time) - 401 Unauthorized - 403 Forbidden 
     * @param body The LuminesceSql query to kick off. (required)
     * @param executionId An explicit ExecutionId to use.  This must be blank OR assigned to a valid GUID-as-a-string. It might be ignored / replaced, for example if using the query cache and a cached query is found. (optional)
     * @param scalarParameters Json encoded dictionary of key-value pairs for scalar parameter values to use in the sql execution. (optional)
