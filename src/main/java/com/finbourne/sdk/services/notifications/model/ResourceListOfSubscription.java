 ...
 */
@JsonPropertyOrder({
  ResourceListOfSubscription.JSON_PROPERTY_VALUES,
  ResourceListOfSubscription.JSON_PROPERTY_HREF,
  ResourceListOfSubscription.JSON_PROPERTY_LINKS,
  ResourceListOfSubscription.JSON_PROPERTY_NEXT_PAGE,
  ResourceListOfSubscription.JSON_PROPERTY_PREVIOUS_PAGE
})
...
public class ResourceListOfSubscription {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to ResourceListOfSubscription
   */
  public static ResourceListOfSubscription fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, ResourceListOfSubscription.class);
  }
