 ...
 */
@JsonPropertyOrder({
  AmazonSqsPrincipalAuthNotificationTypeResponse.JSON_PROPERTY_TYPE,
  AmazonSqsPrincipalAuthNotificationTypeResponse.JSON_PROPERTY_BODY,
  AmazonSqsPrincipalAuthNotificationTypeResponse.JSON_PROPERTY_QUEUE_URL_REF
})
...
public class AmazonSqsPrincipalAuthNotificationTypeResponse {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to AmazonSqsPrincipalAuthNotificationTypeResponse
   */
  public static AmazonSqsPrincipalAuthNotificationTypeResponse fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, AmazonSqsPrincipalAuthNotificationTypeResponse.class);
  }
