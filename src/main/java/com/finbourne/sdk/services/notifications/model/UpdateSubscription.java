 ...
 */
@JsonPropertyOrder({
  UpdateSubscription.JSON_PROPERTY_DISPLAY_NAME,
  UpdateSubscription.JSON_PROPERTY_DESCRIPTION,
  UpdateSubscription.JSON_PROPERTY_STATUS,
  UpdateSubscription.JSON_PROPERTY_MATCHING_PATTERN,
  UpdateSubscription.JSON_PROPERTY_USE_AS_AUTH
})
...
public class UpdateSubscription {
 ...
 public int hashCode() {
   ...
   * @throws java.io.IOException if the JSON string is invalid with respect to UpdateSubscription
   */
  public static UpdateSubscription fromJson(String jsonString) throws java.io.IOException {
    return JSON.getMapper().readValue(jsonString, UpdateSubscription.class);
  }
