...
public class EventTypesApi {
     ...
     */
    private HttpRequest getEventTypeCall(String eventType, final ApiCallback _callback) throws ApiException {
        return getEventTypeCall(eventType,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getEventType. Use any specified configuration options to override any other configuration for this request only.
     * @param eventType The event type to retrieve schema for. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getEventTypeCall(String eventType, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/notification/api/eventtypes/{eventType}"
    ...
    private HttpRequest getEventTypeValidateBeforeCall(String eventType, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<EventTypeSchema> getEventTypeWithHttpInfo(String eventType) throws ApiException {
        HttpRequest localVarCall = getEventTypeValidateBeforeCall(eventType, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<EventTypeSchema>(){}.getType();
    ...
    private ApiResponse<EventTypeSchema> getEventTypeWithHttpInfo(String eventType, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getEventTypeValidateBeforeCall(eventType, null, opts);
        Type localVarReturnType = new TypeReference<EventTypeSchema>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetEventType: Gets the specified event type schema. (asynchronously)
     * 
     * @param eventType The event type to retrieve schema for. (required)
     ...
     */
    private void getEventTypeAsync(String eventType, final ApiCallback<EventTypeSchema> _callback) throws ApiException {

        HttpRequest localVarCall = getEventTypeValidateBeforeCall(eventType, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<EventTypeSchema>(){}.getType();
     ...
     */
    private void getEventTypeAsync(String eventType, final ApiCallback<EventTypeSchema> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getEventTypeValidateBeforeCall(eventType, _callback, opts);
        Type localVarReturnType = new TypeReference<EventTypeSchema>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetEventTypeRequest {
         ...
         */
        public void executeAsync(final ApiCallback<EventTypeSchema> _callback) throws ApiException {
            getEventTypeAsync(eventType, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<EventTypeSchema> _callback, ConfigurationOptions opts) throws ApiException {
            getEventTypeAsync(eventType, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listEventTypesCall(final ApiCallback _callback) throws ApiException {
     ...
     */
    private HttpRequest listEventTypesCall(final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/notification/api/eventtypes";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listEventTypesValidateBeforeCall(final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfEventTypeSchema> listEventTypesWithHttpInfo() throws ApiException {
        HttpRequest localVarCall = listEventTypesValidateBeforeCall(null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfEventTypeSchema>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListOfEventTypeSchema> listEventTypesWithHttpInfo(ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listEventTypesValidateBeforeCall(null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfEventTypeSchema>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListEventTypes: Lists all of the available event types. (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     * @http.response.details
     ...
     */
    private void listEventTypesAsync(final ApiCallback<ResourceListOfEventTypeSchema> _callback) throws ApiException {

        HttpRequest localVarCall = listEventTypesValidateBeforeCall(_callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfEventTypeSchema>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listEventTypesAsync(final ApiCallback<ResourceListOfEventTypeSchema> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listEventTypesValidateBeforeCall(_callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfEventTypeSchema>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistEventTypesRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfEventTypeSchema> _callback) throws ApiException {
            listEventTypesAsync(_callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfEventTypeSchema> _callback, ConfigurationOptions opts) throws ApiException {
            listEventTypesAsync(_callback, opts);
        }
    }
