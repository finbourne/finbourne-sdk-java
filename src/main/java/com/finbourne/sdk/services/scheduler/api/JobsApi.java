...
import com.finbourne.sdk.services.scheduler.model.JobRunResult;
...
public class JobsApi {
     ...
     */
    private HttpRequest createJobCall(CreateJobRequest createJobRequest, final ApiCallback _callback) throws ApiException {
        return createJobCall(createJobRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for createJob. Use any specified configuration options to override any other configuration for this request only.
     * @param createJobRequest The request to create a new job (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest createJobCall(CreateJobRequest createJobRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        ...
        String localVarPath = "/scheduler2/api/jobs";
    ...
    private HttpRequest createJobValidateBeforeCall(CreateJobRequest createJobRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<JobDefinition> createJobWithHttpInfo(CreateJobRequest createJobRequest) throws ApiException {
        HttpRequest localVarCall = createJobValidateBeforeCall(createJobRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<JobDefinition>(){}.getType();
    ...
    private ApiResponse<JobDefinition> createJobWithHttpInfo(CreateJobRequest createJobRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = createJobValidateBeforeCall(createJobRequest, null, opts);
        Type localVarReturnType = new TypeReference<JobDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * CreateJob: Create a new job (asynchronously)
     * 
     * @param createJobRequest The request to create a new job (required)
     ...
     */
    private void createJobAsync(CreateJobRequest createJobRequest, final ApiCallback<JobDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = createJobValidateBeforeCall(createJobRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<JobDefinition>(){}.getType();
     ...
     */
    private void createJobAsync(CreateJobRequest createJobRequest, final ApiCallback<JobDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = createJobValidateBeforeCall(createJobRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<JobDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIcreateJobRequest {
         ...
         */
        public void executeAsync(final ApiCallback<JobDefinition> _callback) throws ApiException {
            createJobAsync(createJobRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<JobDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            createJobAsync(createJobRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest deleteJobCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return deleteJobCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for deleteJob. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the job (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the job (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest deleteJobCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/scheduler2/api/jobs/{scope}/{code}"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest deleteJobValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfScheduleDefinition> deleteJobWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = deleteJobValidateBeforeCall(scope, code, null, new ConfigurationOptions());
    ...
    private ApiResponse<ResourceListOfScheduleDefinition> deleteJobWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = deleteJobValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfScheduleDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void deleteJobAsync(String scope, String code, final ApiCallback<ResourceListOfScheduleDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = deleteJobValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfScheduleDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void deleteJobAsync(String scope, String code, final ApiCallback<ResourceListOfScheduleDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = deleteJobValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfScheduleDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIdeleteJobRequest {
        ...
        public void executeAsync(final ApiCallback<ResourceListOfScheduleDefinition> _callback) throws ApiException {
            deleteJobAsync(scope, code, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<ResourceListOfScheduleDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            deleteJobAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getHistoryCall(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        return getHistoryCall(page, sortBy, start, limit, filter,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getHistory. Use any specified configuration options to override any other configuration for this request only.
     ...
     * @param start This field is obsolete, the value of this field would not be considered. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param limit When paginating, limit the number of returned results to this many. Defaults to 2000 if not specified. Maximum is 5000. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param filter Expression to filter the result set. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getHistoryCall(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/scheduler2/api/jobs/history";
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getHistoryValidateBeforeCall(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfJobHistory> getHistoryWithHttpInfo(String page, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = getHistoryValidateBeforeCall(page, sortBy, start, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfJobHistory>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListOfJobHistory> getHistoryWithHttpInfo(String page, List<String> sortBy, Integer start, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getHistoryValidateBeforeCall(page, sortBy, start, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfJobHistory>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetHistory: Get the history of job runs (asynchronously)
     * 
     * @param page The pagination token to use to continue listing instruments from a previous call to list instruments.             This value is returned from the previous call. If a pagination token is provided the sortBy and filter fields             must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     * @param sortBy Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName. (optional)
     * @param start This field is obsolete, the value of this field would not be considered. (optional)
     ...
     */
    private void getHistoryAsync(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfJobHistory> _callback) throws ApiException {

        HttpRequest localVarCall = getHistoryValidateBeforeCall(page, sortBy, start, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfJobHistory>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getHistoryAsync(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfJobHistory> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getHistoryValidateBeforeCall(page, sortBy, start, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfJobHistory>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetHistoryRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfJobHistory> _callback) throws ApiException {
            getHistoryAsync(page, sortBy, start, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfJobHistory> _callback, ConfigurationOptions opts) throws ApiException {
            getHistoryAsync(page, sortBy, start, limit, filter, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getJobConsoleOutputCall(String runId, final ApiCallback _callback) throws ApiException {
        return getJobConsoleOutputCall(runId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getJobConsoleOutput. Use any specified configuration options to override any other configuration for this request only.
     * @param runId The RunId of the job run (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getJobConsoleOutputCall(String runId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/scheduler2/api/jobs/history/{runId}/console"
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getJobConsoleOutputValidateBeforeCall(String runId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<String> getJobConsoleOutputWithHttpInfo(String runId) throws ApiException {
        HttpRequest localVarCall = getJobConsoleOutputValidateBeforeCall(runId, null, new ConfigurationOptions());
    ...
    private ApiResponse<String> getJobConsoleOutputWithHttpInfo(String runId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getJobConsoleOutputValidateBeforeCall(runId, null, opts);
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetJobConsoleOutput: Gets the console output of a specific job run (asynchronously)
     * 
     * @param runId The RunId of the job run (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void getJobConsoleOutputAsync(String runId, final ApiCallback<String> _callback) throws ApiException {

        HttpRequest localVarCall = getJobConsoleOutputValidateBeforeCall(runId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getJobConsoleOutputAsync(String runId, final ApiCallback<String> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getJobConsoleOutputValidateBeforeCall(runId, _callback, opts);
        Type localVarReturnType = new TypeReference<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetJobConsoleOutputRequest {
        ...
        public void executeAsync(final ApiCallback<String> _callback) throws ApiException {
            getJobConsoleOutputAsync(runId, _callback);
        }
        ...
        public void executeAsync(final ApiCallback<String> _callback, ConfigurationOptions opts) throws ApiException {
            getJobConsoleOutputAsync(runId, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getRunHistoryCall(String runId, final ApiCallback _callback) throws ApiException {
        return getRunHistoryCall(runId,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getRunHistory. Use any specified configuration options to override any other configuration for this request only.
     * @param runId The unique ID of the run (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest getRunHistoryCall(String runId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/scheduler2/api/jobs/history/{runId}"
            .replace("{" + "runId" + "}", localVarApiClient.escapeString(runId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getRunHistoryValidateBeforeCall(String runId, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'runId' is set
        if (runId == null) {
    ...
    private ApiResponse<JobRunResult> getRunHistoryWithHttpInfo(String runId) throws ApiException {
        HttpRequest localVarCall = getRunHistoryValidateBeforeCall(runId, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<JobRunResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<JobRunResult> getRunHistoryWithHttpInfo(String runId, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getRunHistoryValidateBeforeCall(runId, null, opts);
        Type localVarReturnType = new TypeReference<JobRunResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetRunHistory: Get the history for a single job run (asynchronously)
     * 
     * @param runId The unique ID of the run (required)
     * @param _callback The callback to be executed when the API call finishes
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    private void getRunHistoryAsync(String runId, final ApiCallback<JobRunResult> _callback) throws ApiException {

        HttpRequest localVarCall = getRunHistoryValidateBeforeCall(runId, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<JobRunResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getRunHistoryAsync(String runId, final ApiCallback<JobRunResult> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getRunHistoryValidateBeforeCall(runId, _callback, opts);
        Type localVarReturnType = new TypeReference<JobRunResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetRunHistoryRequest {
         ...
         */
        public void executeAsync(final ApiCallback<JobRunResult> _callback) throws ApiException {
            getRunHistoryAsync(runId, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<JobRunResult> _callback, ConfigurationOptions opts) throws ApiException {
            getRunHistoryAsync(runId, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest getSchedulesForAJobCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        return getSchedulesForAJobCall(scope, code,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for getSchedulesForAJob. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the job (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the job (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    private HttpRequest getSchedulesForAJobCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/scheduler2/api/jobs/{scope}/{code}/schedules"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest getSchedulesForAJobValidateBeforeCall(String scope, String code, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<ResourceListOfScheduleDefinition> getSchedulesForAJobWithHttpInfo(String scope, String code) throws ApiException {
        HttpRequest localVarCall = getSchedulesForAJobValidateBeforeCall(scope, code, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfScheduleDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListOfScheduleDefinition> getSchedulesForAJobWithHttpInfo(String scope, String code, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = getSchedulesForAJobValidateBeforeCall(scope, code, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfScheduleDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * GetSchedulesForAJob: Get all the schedules for a single job (asynchronously)
     * 
     * @param scope The scope of the job (required)
     * @param code The code of the job (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    private void getSchedulesForAJobAsync(String scope, String code, final ApiCallback<ResourceListOfScheduleDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = getSchedulesForAJobValidateBeforeCall(scope, code, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfScheduleDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void getSchedulesForAJobAsync(String scope, String code, final ApiCallback<ResourceListOfScheduleDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = getSchedulesForAJobValidateBeforeCall(scope, code, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfScheduleDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIgetSchedulesForAJobRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfScheduleDefinition> _callback) throws ApiException {
            getSchedulesForAJobAsync(scope, code, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfScheduleDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            getSchedulesForAJobAsync(scope, code, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest listJobsCall(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        return listJobsCall(page, sortBy, start, limit, filter,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for listJobs. Use any specified configuration options to override any other configuration for this request only.
     * @param page The pagination token to use to continue listing instruments from a previous call to list instruments.             This value is returned from the previous call. If a pagination token is provided the sortBy and filter fields             must not have changed since the original request. Also, if set, a start value cannot be provided. (optional). Use any specified configuration options to override any other configuration for this request only.
     * @param sortBy Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName. (optional). Use any specified configuration options to override any other configuration for this request only.
     ...
     */
    private HttpRequest listJobsCall(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest listJobsValidateBeforeCall(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
    ...
    private ApiResponse<ResourceListOfJobDefinition> listJobsWithHttpInfo(String page, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        HttpRequest localVarCall = listJobsValidateBeforeCall(page, sortBy, start, limit, filter, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfJobDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<ResourceListOfJobDefinition> listJobsWithHttpInfo(String page, List<String> sortBy, Integer start, Integer limit, String filter, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = listJobsValidateBeforeCall(page, sortBy, start, limit, filter, null, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfJobDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * ListJobs: List the available jobs (asynchronously)
     * 
     * @param page The pagination token to use to continue listing instruments from a previous call to list instruments.             This value is returned from the previous call. If a pagination token is provided the sortBy and filter fields             must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     * @param sortBy Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName. (optional)
     * @param start When paginating, skip this number of results. (optional)
     ...
     */
    private void listJobsAsync(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfJobDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = listJobsValidateBeforeCall(page, sortBy, start, limit, filter, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<ResourceListOfJobDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void listJobsAsync(String page, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfJobDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = listJobsValidateBeforeCall(page, sortBy, start, limit, filter, _callback, opts);
        Type localVarReturnType = new TypeReference<ResourceListOfJobDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIlistJobsRequest {
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfJobDefinition> _callback) throws ApiException {
            listJobsAsync(page, sortBy, start, limit, filter, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<ResourceListOfJobDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            listJobsAsync(page, sortBy, start, limit, filter, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest runJobCall(String scope, String code, StartJobRequest startJobRequest, final ApiCallback _callback) throws ApiException {
        return runJobCall(scope, code, startJobRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for runJob. Use any specified configuration options to override any other configuration for this request only.
     * @param scope The scope of the job (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code The code of the job (required). Use any specified configuration options to override any other configuration for this request only.
     * @param startJobRequest The request for starting job (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest runJobCall(String scope, String code, StartJobRequest startJobRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/scheduler2/api/jobs/{scope}/{code}/$run"
            .replace("{" + "scope" + "}", localVarApiClient.escapeString(scope.toString()))
            .replace("{" + "code" + "}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest runJobValidateBeforeCall(String scope, String code, StartJobRequest startJobRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<StartJobResponse> runJobWithHttpInfo(String scope, String code, StartJobRequest startJobRequest) throws ApiException {
        HttpRequest localVarCall = runJobValidateBeforeCall(scope, code, startJobRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<StartJobResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<StartJobResponse> runJobWithHttpInfo(String scope, String code, StartJobRequest startJobRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = runJobValidateBeforeCall(scope, code, startJobRequest, null, opts);
        Type localVarReturnType = new TypeReference<StartJobResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    private void runJobAsync(String scope, String code, StartJobRequest startJobRequest, final ApiCallback<StartJobResponse> _callback) throws ApiException {

        HttpRequest localVarCall = runJobValidateBeforeCall(scope, code, startJobRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<StartJobResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void runJobAsync(String scope, String code, StartJobRequest startJobRequest, final ApiCallback<StartJobResponse> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = runJobValidateBeforeCall(scope, code, startJobRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<StartJobResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIrunJobRequest {
         ...
         */
        public void executeAsync(final ApiCallback<StartJobResponse> _callback) throws ApiException {
            runJobAsync(scope, code, startJobRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<StartJobResponse> _callback, ConfigurationOptions opts) throws ApiException {
            runJobAsync(scope, code, startJobRequest, _callback, opts);
        }
    }
     ...
     */
    private HttpRequest updateJobCall(String scope, String code, UpdateJobRequest updateJobRequest, final ApiCallback _callback) throws ApiException {
        return updateJobCall(scope, code, updateJobRequest,  _callback, new ConfigurationOptions());
    }

    /**
     * Build call for updateJob. Use any specified configuration options to override any other configuration for this request only.
     * @param scope  (required). Use any specified configuration options to override any other configuration for this request only.
     * @param code  (required). Use any specified configuration options to override any other configuration for this request only.
     * @param updateJobRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    private HttpRequest updateJobCall(String scope, String code, UpdateJobRequest updateJobRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private HttpRequest updateJobValidateBeforeCall(String scope, String code, UpdateJobRequest updateJobRequest, final ApiCallback _callback, ConfigurationOptions opts) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
    ...
    private ApiResponse<JobDefinition> updateJobWithHttpInfo(String scope, String code, UpdateJobRequest updateJobRequest) throws ApiException {
        HttpRequest localVarCall = updateJobValidateBeforeCall(scope, code, updateJobRequest, null, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<JobDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    private ApiResponse<JobDefinition> updateJobWithHttpInfo(String scope, String code, UpdateJobRequest updateJobRequest, ConfigurationOptions opts) throws ApiException {
        HttpRequest localVarCall = updateJobValidateBeforeCall(scope, code, updateJobRequest, null, opts);
        Type localVarReturnType = new TypeReference<JobDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * UpdateJob: Update a JobDefinition (asynchronously)
     * 
     * @param scope  (required)
     * @param code  (required)
     * @param updateJobRequest  (required)
     ...
     */
    private void updateJobAsync(String scope, String code, UpdateJobRequest updateJobRequest, final ApiCallback<JobDefinition> _callback) throws ApiException {

        HttpRequest localVarCall = updateJobValidateBeforeCall(scope, code, updateJobRequest, _callback, new ConfigurationOptions());
        Type localVarReturnType = new TypeReference<JobDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
     ...
     */
    private void updateJobAsync(String scope, String code, UpdateJobRequest updateJobRequest, final ApiCallback<JobDefinition> _callback, ConfigurationOptions opts) throws ApiException {

        HttpRequest localVarCall = updateJobValidateBeforeCall(scope, code, updateJobRequest, _callback, opts);
        Type localVarReturnType = new TypeReference<JobDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    }
    ...
    public class APIupdateJobRequest {
         ...
         */
        public void executeAsync(final ApiCallback<JobDefinition> _callback) throws ApiException {
            updateJobAsync(scope, code, updateJobRequest, _callback);
        }
         ...
         */
        public void executeAsync(final ApiCallback<JobDefinition> _callback, ConfigurationOptions opts) throws ApiException {
            updateJobAsync(scope, code, updateJobRequest, _callback, opts);
        }
    }
