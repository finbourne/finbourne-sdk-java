...
|------------- | ------------- | -------------|
| [**createDerivedPortfolio**](DerivedTransactionPortfoliosApi.md#createDerivedPortfolio) | **POST** /api/api/derivedtransactionportfolios/{scope} | CreateDerivedPortfolio: Create derived portfolio |
| [**deleteDerivedPortfolioDetails**](DerivedTransactionPortfoliosApi.md#deleteDerivedPortfolioDetails) | **DELETE** /api/api/derivedtransactionportfolios/{scope}/{code}/details | [EARLY ACCESS] DeleteDerivedPortfolioDetails: Delete derived portfolio details |
...
import com.finbourne.sdk.services.lusid.api.DerivedTransactionPortfoliosApi;
