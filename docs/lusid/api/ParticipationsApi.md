...
|------------- | ------------- | -------------|
| [**deleteParticipation**](ParticipationsApi.md#deleteParticipation) | **DELETE** /api/api/participations/{scope}/{code} | [EARLY ACCESS] DeleteParticipation: Delete participation |
| [**getParticipation**](ParticipationsApi.md#getParticipation) | **GET** /api/api/participations/{scope}/{code} | [EARLY ACCESS] GetParticipation: Get Participation |
| [**listParticipations**](ParticipationsApi.md#listParticipations) | **GET** /api/api/participations | [EARLY ACCESS] ListParticipations: List Participations |
| [**upsertParticipations**](ParticipationsApi.md#upsertParticipations) | **POST** /api/api/participations | [EARLY ACCESS] UpsertParticipations: Upsert Participation |
...
import com.finbourne.sdk.services.lusid.api.ParticipationsApi;
