...
|------------- | ------------- | -------------|
| [**createCustomEntityType**](CustomEntityTypesApi.md#createCustomEntityType) | **POST** /api/api/customentitytypes | [EARLY ACCESS] CreateCustomEntityType: Define a new Custom Entity Type. |
| [**deleteCustomEntityType**](CustomEntityTypesApi.md#deleteCustomEntityType) | **DELETE** /api/api/customentitytypes/{entityType} | [EARLY ACCESS] DeleteCustomEntityType: Delete a Custom Entity type. |
| [**getCustomEntityType**](CustomEntityTypesApi.md#getCustomEntityType) | **GET** /api/api/customentitytypes/{entityType} | [EARLY ACCESS] GetCustomEntityType: Get a Custom Entity Type. |
| [**listCustomEntityTypes**](CustomEntityTypesApi.md#listCustomEntityTypes) | **GET** /api/api/customentitytypes | [EARLY ACCESS] ListCustomEntityTypes: List Custom Entity Types. |
| [**updateCustomEntityType**](CustomEntityTypesApi.md#updateCustomEntityType) | **PUT** /api/api/customentitytypes/{entityType} | [EARLY ACCESS] UpdateCustomEntityType: Modify an existing Custom Entity Type. |
...
import com.finbourne.sdk.services.lusid.api.CustomEntityTypesApi;
...
> DeletedEntityResponse deleteCustomEntityType(entityType)
...
public class CustomEntityTypesApiExample {
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException, ApiConfigurationException, FinbourneTokenException {
        ...
        try {
            // uncomment the below to set overrides at the request level
            // DeletedEntityResponse result = apiInstance.deleteCustomEntityType(entityType).execute(opts);

            DeletedEntityResponse result = apiInstance.deleteCustomEntityType(entityType).execute();
            System.out.println(result.toJson());
        } catch (ApiException e) {
            System.err.println("Exception when calling CustomEntityTypesApi#deleteCustomEntityType");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            e.printStackTrace();
        }
