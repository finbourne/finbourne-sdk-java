...
|------------- | ------------- | -------------|
| [**createTaxRuleSet**](TaxRuleSetsApi.md#createTaxRuleSet) | **POST** /api/api/tax/rulesets | [EXPERIMENTAL] CreateTaxRuleSet: Create a tax rule set. |
| [**deleteTaxRuleSet**](TaxRuleSetsApi.md#deleteTaxRuleSet) | **DELETE** /api/api/tax/rulesets/{scope}/{code} | [EXPERIMENTAL] DeleteTaxRuleSet: Delete a tax rule set. |
| [**getTaxRuleSet**](TaxRuleSetsApi.md#getTaxRuleSet) | **GET** /api/api/tax/rulesets/{scope}/{code} | [EXPERIMENTAL] GetTaxRuleSet: Retrieve the definition of single tax rule set. |
| [**listTaxRuleSets**](TaxRuleSetsApi.md#listTaxRuleSets) | **GET** /api/api/tax/rulesets | [EXPERIMENTAL] ListTaxRuleSets: List tax rule sets. |
| [**updateTaxRuleSet**](TaxRuleSetsApi.md#updateTaxRuleSet) | **PUT** /api/api/tax/rulesets/{scope}/{code} | [EXPERIMENTAL] UpdateTaxRuleSet: Update a tax rule set. |
...
import com.finbourne.sdk.services.lusid.api.TaxRuleSetsApi;
