...
| [**queryTradeTickets**](InstrumentEventsApi.md#queryTradeTickets) | **POST** /api/api/instrumentevents/$queryTradeTickets | QueryTradeTickets: Returns a list of trade tickets based on the holdings of the portfolios and date range specified in the query. |
