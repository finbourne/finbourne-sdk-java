...
|------------- | ------------- | -------------|
| [**createSequence**](SequencesApi.md#createSequence) | **POST** /api/api/sequences/{scope} | [EARLY ACCESS] CreateSequence: Create a new sequence |
| [**deleteSequence**](SequencesApi.md#deleteSequence) | **DELETE** /api/api/sequences/{scope}/{code} | [EARLY ACCESS] DeleteSequence: Delete a sequence |
| [**getSequence**](SequencesApi.md#getSequence) | **GET** /api/api/sequences/{scope}/{code} | [EARLY ACCESS] GetSequence: Get a specified sequence |
| [**listSequences**](SequencesApi.md#listSequences) | **GET** /api/api/sequences | [EARLY ACCESS] ListSequences: List Sequences |
...
import com.finbourne.sdk.services.lusid.api.SequencesApi;
