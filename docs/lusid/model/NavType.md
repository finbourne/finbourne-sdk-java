# com.finbourne.sdk.services.lusid.model.NavType
classname NavType
...
------------ | ------------- | ------------- | -------------
**status** | **String** | The Status of the Nav Type. Available values: Active, Inactive. | [default to String]
...
@javax.annotation.Nullable String transactionTemplateScope = "example transactionTemplateScope";
