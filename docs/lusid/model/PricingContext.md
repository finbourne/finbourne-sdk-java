# com.finbourne.sdk.services.lusid.model.PricingContext
classname PricingContext
...
@javax.annotation.Nullable List<VendorModelRule> modelRules = new List<VendorModelRule>();
@javax.annotation.Nullable Map<String, ModelSelection> modelChoice = new Map<String, ModelSelection>();
PricingOptions options = new PricingOptions();
@javax.annotation.Nullable List<ResultKeyRule> resultDataRules = new List<ResultKeyRule>();
HoldingPricingInfo holdingPricingInfo = new HoldingPricingInfo();
@javax.annotation.Nullable String accrualDefinition = "example accrualDefinition";
