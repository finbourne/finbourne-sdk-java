# com.finbourne.sdk.services.lusid.model.ReverseStressRequest
classname ReverseStressRequest
...
**reportCurrency** | **String** | Three letter ISO currency string to report in. If absent the portfolio&#39;s own currency is used,  which makes the target ambiguous across a multi-currency portfolio group - supply it there. | [optional] [default to String]
...
@javax.annotation.Nullable String metric = "example metric";
