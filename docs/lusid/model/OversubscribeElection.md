# com.finbourne.sdk.services.lusid.model.OversubscribeElection
classname OversubscribeElection
...
```java
import com.finbourne.sdk.services.lusid.model.OversubscribeElection;
import java.util.*;
