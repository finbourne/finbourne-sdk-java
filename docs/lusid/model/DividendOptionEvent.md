# com.finbourne.sdk.services.lusid.model.DividendOptionEvent
classname DividendOptionEvent
DVOP
...
```java
import com.finbourne.sdk.services.lusid.model.DividendOptionEvent;
import java.util.*;
