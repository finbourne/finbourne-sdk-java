# com.finbourne.sdk.services.lusid.model.ShareClass
...
@javax.annotation.Nullable List<SimpleRoundingConvention> roundingConventionsPrice = new List<SimpleRoundingConvention>();
