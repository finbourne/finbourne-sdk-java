# com.finbourne.sdk.services.lusid.model.MarketDataKeyRule
...
**quoteType** | **String** | Available values: Price, Spread, Rate, LogNormalVol, NormalVol, ParSpread, IsdaSpread, Upfront, Index, Ratio, Delta, PoolFactor, InflationAssumption, DirtyPrice, PrincipalWriteOff, InterestDeferred, InterestShortfall, ConstituentWeightFactor, ForwardPrice, DiscountFactor. | [default to String]
...
@javax.annotation.Nullable String field = "example field";
...
@javax.annotation.Nullable String mask = "example mask";
@javax.annotation.Nullable String sourceSystem = "example sourceSystem";
