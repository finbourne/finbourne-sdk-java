# com.finbourne.sdk.services.lusid.model.FinalisedValuationPoint
classname FinalisedValuationPoint
...
```java
import com.finbourne.sdk.services.lusid.model.FinalisedValuationPoint;
import java.util.*;
import java.lang.System;
import java.net.URI;

String code = "example code";
@javax.annotation.Nullable String finalisedFromVariant = "example finalisedFromVariant";
