# com.finbourne.sdk.services.lusid.model.OutputTransaction
...
@javax.annotation.Nullable java.math.BigDecimal transactionToPortfolioRate = new java.math.BigDecimal("100.00");
...
@javax.annotation.Nullable List<RealisedGainLoss> realisedGainLoss = new List<RealisedGainLoss>();
@javax.annotation.Nullable List<Long> holdingIds = new List<Long>();
@javax.annotation.Nullable String sourceType = "example sourceType";
@javax.annotation.Nullable String sourceInstrumentEventId = "example sourceInstrumentEventId";
...
@javax.annotation.Nullable List<Economics> economics = new List<Economics>();
DataModelMembership dataModelMembership = new DataModelMembership();
@javax.annotation.Nullable Integer sequence = new Integer("100.00");
@javax.annotation.Nullable Integer sequencePriority = new Integer("100.00");
