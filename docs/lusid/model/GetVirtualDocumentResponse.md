# com.finbourne.sdk.services.lusid.model.GetVirtualDocumentResponse
classname GetVirtualDocumentResponse
...
@javax.annotation.Nullable Map<String, VirtualDocument> values = new Map<String, VirtualDocument>();
