# com.finbourne.sdk.services.lusid.model.TotalReturnSwap
classname TotalReturnSwap
...
**assetLeg** | [**AssetLeg**](AssetLeg.md) |  | [default to AssetLeg]
...
```java
import com.finbourne.sdk.services.lusid.model.TotalReturnSwap;
import java.util.*;
