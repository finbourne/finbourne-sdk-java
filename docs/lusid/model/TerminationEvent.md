# com.finbourne.sdk.services.lusid.model.TerminationEvent
classname TerminationEvent
...
```java
import com.finbourne.sdk.services.lusid.model.TerminationEvent;
import java.util.*;
...
@javax.annotation.Nullable String triggeringEventId = "example triggeringEventId";
String settlementMethod = "example settlementMethod";
@javax.annotation.Nullable java.math.BigDecimal assetSettlementAmount = new java.math.BigDecimal("100.00");
@javax.annotation.Nullable java.math.BigDecimal fundingAccruedAmount = new java.math.BigDecimal("100.00");
@javax.annotation.Nullable java.math.BigDecimal terminationAmount = new java.math.BigDecimal("100.00");
