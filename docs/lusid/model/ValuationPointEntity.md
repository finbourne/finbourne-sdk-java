# com.finbourne.sdk.services.lusid.model.ValuationPointEntity
classname ValuationPointEntity
...
**prevailingValuationPoint** | [**FundCalendarEntry**](FundCalendarEntry.md) |  | [optional] [default to FundCalendarEntry]
**deletedValuationPoint** | [**FundCalendarEntry**](FundCalendarEntry.md) |  | [optional] [default to FundCalendarEntry]
...
**previewedValuationPoint** | [**FundCalendarEntry**](FundCalendarEntry.md) |  | [optional] [default to FundCalendarEntry]
...
FundCalendarEntry prevailingValuationPoint = new FundCalendarEntry();
FundCalendarEntry deletedValuationPoint = new FundCalendarEntry();
@javax.annotation.Nullable String previewedStatus = "example previewedStatus";
FundCalendarEntry previewedValuationPoint = new FundCalendarEntry();
@javax.annotation.Nullable List<Link> links = new List<Link>();


ValuationPointEntity valuationPointEntityInstance = new ValuationPointEntity()
    .href(href)
    ...
    .prevailingValuationPoint(prevailingValuationPoint)
    .deletedValuationPoint(deletedValuationPoint)
    .previewedStatus(previewedStatus)
    .previewedValuationPoint(previewedValuationPoint)
    .links(links);
```
