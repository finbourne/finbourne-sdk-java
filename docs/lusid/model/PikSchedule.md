...
@javax.annotation.Nullable java.math.BigDecimal pikMargin = new java.math.BigDecimal("100.00");
...
@javax.annotation.Nullable String pikInterestBasis = "example pikInterestBasis";
