# com.finbourne.sdk.services.lusid.model.CreateRecDefinitionRequest
classname CreateRecDefinitionRequest
...
```java
import com.finbourne.sdk.services.lusid.model.CreateRecDefinitionRequest;
import java.util.*;
