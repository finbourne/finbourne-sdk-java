# com.finbourne.sdk.services.lusid.model.BoolListComplianceParameter
classname BoolListComplianceParameter
...
```java
import com.finbourne.sdk.services.lusid.model.BoolListComplianceParameter;
import java.util.*;
...
BoolListComplianceParameter boolListComplianceParameterInstance = new BoolListComplianceParameter()
    .value(value);
```
