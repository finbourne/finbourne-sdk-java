# com.finbourne.sdk.services.lusid.model.PikBondInterestEvent
classname PikBondInterestEvent
...
```java
import com.finbourne.sdk.services.lusid.model.PikBondInterestEvent;
import java.util.*;
...
@javax.annotation.Nullable java.math.BigDecimal deliveryPrice = new java.math.BigDecimal("100.00");
@javax.annotation.Nullable java.math.BigDecimal deliveredContractSize = new java.math.BigDecimal("100.00");
@javax.annotation.Nullable java.math.BigDecimal deliveredCurrentFacePerUnit = new java.math.BigDecimal("100.00");
@javax.annotation.Nullable java.math.BigDecimal deliveredAccruedPerUnit = new java.math.BigDecimal("100.00");
@javax.annotation.Nullable String fractionalUnitsRoundingConvention = "example fractionalUnitsRoundingConvention";
@javax.annotation.Nullable Integer fractionalUnitsDecimalPlaces = new Integer("100.00");
