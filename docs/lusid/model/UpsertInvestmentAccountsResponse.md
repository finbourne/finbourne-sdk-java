# com.finbourne.sdk.services.lusid.model.UpsertInvestmentAccountsResponse
classname UpsertInvestmentAccountsResponse
...
@javax.annotation.Nullable Map<String, InvestmentAccount> values = new Map<String, InvestmentAccount>();
