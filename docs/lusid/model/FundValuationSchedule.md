# com.finbourne.sdk.services.lusid.model.FundValuationSchedule
classname FundValuationSchedule
...
@javax.annotation.Nullable String rollConvention = "example rollConvention";
@javax.annotation.Nullable List<String> holidayCalendars = new List<String>();
@javax.annotation.Nullable List<String> valuationDateTimes = new List<String>();
