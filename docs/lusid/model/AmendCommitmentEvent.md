# com.finbourne.sdk.services.lusid.model.AmendCommitmentEvent
classname AmendCommitmentEvent
...
```java
import com.finbourne.sdk.services.lusid.model.AmendCommitmentEvent;
import java.util.*;
