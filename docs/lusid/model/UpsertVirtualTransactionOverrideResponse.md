# com.finbourne.sdk.services.lusid.model.UpsertVirtualTransactionOverrideResponse
classname UpsertVirtualTransactionOverrideResponse
...
```java
import com.finbourne.sdk.services.lusid.model.UpsertVirtualTransactionOverrideResponse;
import java.util.*;
...
@javax.annotation.Nullable Map<String, List<StoredOverrideDefinition>> overrides = new Map<String, List<StoredOverrideDefinition>>();
