# com.finbourne.sdk.services.lusid.model.AllocationGroup
classname AllocationGroup
...
@javax.annotation.Nullable List<AllocationGroupClass> classes = new List<AllocationGroupClass>();
