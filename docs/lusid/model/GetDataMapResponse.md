# com.finbourne.sdk.services.lusid.model.GetDataMapResponse
classname GetDataMapResponse
...
@javax.annotation.Nullable Map<String, DataMapping> values = new Map<String, DataMapping>();
