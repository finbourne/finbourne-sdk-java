# com.finbourne.sdk.services.lusid.model.MarketContext
...
@javax.annotation.Nullable List<MarketDataKeyRule> marketRules = new List<MarketDataKeyRule>();
@javax.annotation.Nullable MarketContextSuppliers suppliers = new MarketContextSuppliers();
MarketOptions options = new MarketOptions();
@javax.annotation.Nullable List<MarketDataSpecificRule> specificRules = new List<MarketDataSpecificRule>();
@javax.annotation.Nullable List<GroupOfMarketDataKeyRules> groupedMarketRules = new List<GroupOfMarketDataKeyRules>();
