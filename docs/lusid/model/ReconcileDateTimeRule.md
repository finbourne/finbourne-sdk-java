# com.finbourne.sdk.services.lusid.model.ReconcileDateTimeRule
classname ReconcileDateTimeRule
...
```java
import com.finbourne.sdk.services.lusid.model.ReconcileDateTimeRule;
import java.util.*;
