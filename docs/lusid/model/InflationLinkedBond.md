# com.finbourne.sdk.services.lusid.model.InflationLinkedBond
classname InflationLinkedBond
...
@javax.annotation.Nullable OffsetDateTime baseCPIDate = OffsetDateTime.now();
