...
|------------- | ------------- | -------------|
| [**listDeliveries**](DeliveriesApi.md#listDeliveries) | **GET** /notification/api/deliveries | ListDeliveries: List Deliveries |
...
import com.finbourne.sdk.services.notifications.api.DeliveriesApi;
