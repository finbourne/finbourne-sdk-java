...
|------------- | ------------- | -------------|
| [**createApplication**](ApplicationsApi.md#createApplication) | **POST** /identity/api/applications | [EARLY ACCESS] CreateApplication: Create Application |
| [**deleteApplication**](ApplicationsApi.md#deleteApplication) | **DELETE** /identity/api/applications/{id} | [EARLY ACCESS] DeleteApplication: Delete Application |
| [**getApplication**](ApplicationsApi.md#getApplication) | **GET** /identity/api/applications/{id} | GetApplication: Get Application |
| [**listApplications**](ApplicationsApi.md#listApplications) | **GET** /identity/api/applications | ListApplications: List Applications |
| [**rotateApplicationSecrets**](ApplicationsApi.md#rotateApplicationSecrets) | **POST** /identity/api/applications/{id}/lifecycle/$newsecret | [EARLY ACCESS] RotateApplicationSecrets: Rotate Application Secrets |
...
import com.finbourne.sdk.services.identity.api.ApplicationsApi;
