...
|------------- | ------------- | -------------|
| [**createMcpTool**](McpToolsApi.md#createMcpTool) | **POST** /identity/api/mcptools/{scope}/{code} | [EARLY ACCESS] CreateMcpTool: Create an MCP Tool |
| [**deleteMcpTool**](McpToolsApi.md#deleteMcpTool) | **DELETE** /identity/api/mcptools/{scope}/{code} | [EARLY ACCESS] DeleteMcpTool: Delete an MCP Tool |
| [**getMcpTool**](McpToolsApi.md#getMcpTool) | **GET** /identity/api/mcptools/{scope}/{code} | [EARLY ACCESS] GetMcpTool: Get an MCP Tool |
| [**listMcpTools**](McpToolsApi.md#listMcpTools) | **GET** /identity/api/mcptools | [EARLY ACCESS] ListMcpTools: List all MCP Tools |
| [**updateMcpTool**](McpToolsApi.md#updateMcpTool) | **PUT** /identity/api/mcptools/{scope}/{code} | [EARLY ACCESS] UpdateMcpTool: Update an MCP Tool |
...
import com.finbourne.sdk.services.identity.api.McpToolsApi;
