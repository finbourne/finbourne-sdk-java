...
|------------- | ------------- | -------------|
| [**listQueryableFields**](LogMetadataApi.md#listQueryableFields) | **GET** /insights/api/metadata/logs | [EARLY ACCESS] ListQueryableFields: List the queryable fields for every supported log type. |
...
import com.finbourne.sdk.services.insights.api.LogMetadataApi;
