...
|------------- | ------------- | -------------|
| [**getAccessEvaluationLog**](AccessEvaluationsApi.md#getAccessEvaluationLog) | **GET** /insights/api/access/{id} | [EARLY ACCESS] GetAccessEvaluationLog: Get the log for a specific access evaluation. This endpoint will be deprecated in the near future. |
| [**listAccessEvaluationLogs**](AccessEvaluationsApi.md#listAccessEvaluationLogs) | **GET** /insights/api/access | [EARLY ACCESS] ListAccessEvaluationLogs: List the logs for access evaluations. |
...
import com.finbourne.sdk.services.insights.api.AccessEvaluationsApi;
