...
|------------- | ------------- | -------------|
| [**createEntry**](AuditingApi.md#createEntry) | **POST** /insights/api/auditing/entries | [EARLY ACCESS] CreateEntry: Create (persist) and audit entry.. |
| [**getProcesses**](AuditingApi.md#getProcesses) | **GET** /insights/api/auditing/processes | [EARLY ACCESS] GetProcesses: Get the latest audit entry for each process. |
| [**listEntries**](AuditingApi.md#listEntries) | **GET** /insights/api/auditing/entries | [EARLY ACCESS] ListEntries: Get the audit entries. |
...
import com.finbourne.sdk.services.insights.api.AuditingApi;
