# com.finbourne.sdk.services.workflow.model.WorkerConfiguration
classname WorkerConfiguration
...
```java
import com.finbourne.sdk.services.workflow.model.WorkerConfiguration;
import java.util.*;
